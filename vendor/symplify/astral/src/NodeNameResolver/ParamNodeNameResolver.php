...
final class ParamNodeNameResolver implements \ConfigTransformer202203064\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202203064\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202203064\PhpParser\Node\Param;
    }
    /**
     * @param Param $node
     */
    public function resolve(\ConfigTransformer202203064\PhpParser\Node $node) : ?string
    {
        ...
        if ($paramName instanceof \ConfigTransformer202203064\PhpParser\Node\Expr) {
            return null;
        }
        return $paramName;
    }
