...
final class ParamNodeNameResolver implements \ConfigTransformer202109303\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer202109303\PhpParser\Node\Param;
    }
    /**
     * @param \PhpParser\Node $node
     */
    public function resolve($node) : ?string
    {
        ...
        if ($paramName instanceof \ConfigTransformer202109303\PhpParser\Node\Expr) {
            return null;
        }
        return $paramName;
    }
