...
final class ParamNodeNameResolver implements \ConfigTransformer2021120610\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer2021120610\PhpParser\Node\Param;
    }
    /**
     * @param \PhpParser\Node $node
     */
    public function resolve($node) : ?string
    {
        ...
        if ($paramName instanceof \ConfigTransformer2021120610\PhpParser\Node\Expr) {
            return null;
        }
        return $paramName;
    }
