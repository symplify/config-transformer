...
final class FuncCallNodeNameResolver implements \ConfigTransformer202204178\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202204178\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202204178\PhpParser\Node\Expr\FuncCall;
    }
    /**
     * @param FuncCall $node
     */
