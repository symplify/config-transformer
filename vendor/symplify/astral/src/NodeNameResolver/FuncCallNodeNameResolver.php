...
final class FuncCallNodeNameResolver implements \ConfigTransformer202206065\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202206065\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202206065\PhpParser\Node\Expr\FuncCall;
    }
    /**
     * @param FuncCall $node
     */
