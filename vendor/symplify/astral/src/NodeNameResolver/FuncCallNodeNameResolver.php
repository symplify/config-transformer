...
final class FuncCallNodeNameResolver implements \ConfigTransformer202107063\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202107063\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202107063\PhpParser\Node\Expr\FuncCall;
    }
    /**
     * @param FuncCall $node
     */
