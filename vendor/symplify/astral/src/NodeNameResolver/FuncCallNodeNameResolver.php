...
final class FuncCallNodeNameResolver implements \ConfigTransformer202107037\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202107037\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202107037\PhpParser\Node\Expr\FuncCall;
    }
    /**
     * @param FuncCall $node
     */
