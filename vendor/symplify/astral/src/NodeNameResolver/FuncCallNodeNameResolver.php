...
final class FuncCallNodeNameResolver implements \ConfigTransformer202106202\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202106202\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202106202\PhpParser\Node\Expr\FuncCall;
    }
    /**
     * @param FuncCall $node
     */
