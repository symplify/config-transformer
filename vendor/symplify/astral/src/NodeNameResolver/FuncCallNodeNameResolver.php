...
final class FuncCallNodeNameResolver implements \ConfigTransformer202107065\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202107065\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202107065\PhpParser\Node\Expr\FuncCall;
    }
    /**
     * @param FuncCall $node
     */
