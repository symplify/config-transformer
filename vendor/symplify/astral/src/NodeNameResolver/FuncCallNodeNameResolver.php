...
final class FuncCallNodeNameResolver implements \ConfigTransformer202204142\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202204142\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202204142\PhpParser\Node\Expr\FuncCall;
    }
    /**
     * @param FuncCall $node
     */
