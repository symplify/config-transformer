...
final class PropertyNodeNameResolver implements \ConfigTransformer202201274\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201274\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201274\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
