...
final class PropertyNodeNameResolver implements \ConfigTransformer202202198\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202202198\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202202198\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
