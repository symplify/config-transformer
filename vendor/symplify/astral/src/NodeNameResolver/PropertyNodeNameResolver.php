...
final class PropertyNodeNameResolver implements \ConfigTransformer202205010\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205010\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202205010\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
