...
final class PropertyNodeNameResolver implements \ConfigTransformer202205143\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205143\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202205143\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
