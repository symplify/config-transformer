...
final class PropertyNodeNameResolver implements \ConfigTransformer202106263\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202106263\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202106263\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
