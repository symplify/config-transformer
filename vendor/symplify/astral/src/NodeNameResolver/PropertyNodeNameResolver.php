...
final class PropertyNodeNameResolver implements \ConfigTransformer202202248\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202202248\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202202248\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
