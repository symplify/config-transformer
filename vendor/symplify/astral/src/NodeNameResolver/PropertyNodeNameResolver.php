...
final class PropertyNodeNameResolver implements \ConfigTransformer202202210\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202202210\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202202210\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
