...
final class PropertyNodeNameResolver implements \ConfigTransformer202204172\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202204172\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202204172\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
