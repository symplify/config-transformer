...
final class PropertyNodeNameResolver implements \ConfigTransformer2021062210\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer2021062210\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer2021062210\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
