...
final class PropertyNodeNameResolver implements \ConfigTransformer202203077\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202203077\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202203077\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
