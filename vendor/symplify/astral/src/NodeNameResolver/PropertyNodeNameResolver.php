...
final class PropertyNodeNameResolver implements \ConfigTransformer202205249\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205249\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202205249\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
