...
final class PropertyNodeNameResolver implements \ConfigTransformer202112316\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202112316\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202112316\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
