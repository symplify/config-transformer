...
final class PropertyNodeNameResolver implements \ConfigTransformer202201156\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201156\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201156\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
