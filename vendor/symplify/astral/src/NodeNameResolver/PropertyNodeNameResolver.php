...
final class PropertyNodeNameResolver implements \ConfigTransformer202201303\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201303\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201303\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
