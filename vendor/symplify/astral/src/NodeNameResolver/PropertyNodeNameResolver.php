...
final class PropertyNodeNameResolver implements \ConfigTransformer202202215\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202202215\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202202215\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
