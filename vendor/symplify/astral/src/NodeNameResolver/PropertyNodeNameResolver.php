...
final class PropertyNodeNameResolver implements \ConfigTransformer202107050\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202107050\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202107050\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
