...
final class PropertyNodeNameResolver implements \ConfigTransformer202201153\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201153\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201153\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
