...
final class PropertyNodeNameResolver implements \ConfigTransformer202205306\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205306\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202205306\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
