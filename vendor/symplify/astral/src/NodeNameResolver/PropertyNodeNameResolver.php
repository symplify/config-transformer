...
final class PropertyNodeNameResolver implements \ConfigTransformer202112108\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202112108\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202112108\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
