...
final class PropertyNodeNameResolver implements \ConfigTransformer202107071\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202107071\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202107071\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
