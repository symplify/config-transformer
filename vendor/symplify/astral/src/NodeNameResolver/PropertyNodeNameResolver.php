...
final class PropertyNodeNameResolver implements \ConfigTransformer202203064\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202203064\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202203064\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
