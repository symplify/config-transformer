...
final class PropertyNodeNameResolver implements \ConfigTransformer202204142\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202204142\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202204142\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
