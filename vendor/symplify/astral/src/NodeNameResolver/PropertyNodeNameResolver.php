...
final class PropertyNodeNameResolver implements \ConfigTransformer202204178\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202204178\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202204178\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
