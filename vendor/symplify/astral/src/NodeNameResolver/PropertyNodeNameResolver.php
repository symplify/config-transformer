...
final class PropertyNodeNameResolver implements \ConfigTransformer202203034\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202203034\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202203034\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
