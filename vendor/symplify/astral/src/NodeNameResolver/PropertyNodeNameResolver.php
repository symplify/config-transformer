...
final class PropertyNodeNameResolver implements \ConfigTransformer202201240\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201240\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201240\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
