...
final class PropertyNodeNameResolver implements \ConfigTransformer202206010\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202206010\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202206010\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
