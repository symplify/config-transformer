...
final class PropertyNodeNameResolver implements \ConfigTransformer202205134\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205134\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202205134\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
