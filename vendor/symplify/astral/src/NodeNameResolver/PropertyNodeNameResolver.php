...
final class PropertyNodeNameResolver implements \ConfigTransformer202201179\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201179\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201179\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
