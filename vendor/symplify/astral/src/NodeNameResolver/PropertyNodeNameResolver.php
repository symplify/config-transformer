...
final class PropertyNodeNameResolver implements \ConfigTransformer202202200\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202202200\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202202200\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
