...
final class PropertyNodeNameResolver implements \ConfigTransformer202203082\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202203082\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202203082\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
