...
final class PropertyNodeNameResolver implements \ConfigTransformer202204039\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202204039\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202204039\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
