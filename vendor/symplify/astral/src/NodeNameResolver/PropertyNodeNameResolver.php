...
final class PropertyNodeNameResolver implements \ConfigTransformer202203039\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202203039\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202203039\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
