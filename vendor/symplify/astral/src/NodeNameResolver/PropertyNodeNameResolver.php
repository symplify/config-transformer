...
final class PropertyNodeNameResolver implements \ConfigTransformer202107056\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202107056\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202107056\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
