...
final class PropertyNodeNameResolver implements \ConfigTransformer202202185\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202202185\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202202185\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
