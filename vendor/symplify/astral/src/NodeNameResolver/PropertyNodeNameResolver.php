...
final class PropertyNodeNameResolver implements \ConfigTransformer202201241\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201241\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201241\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
