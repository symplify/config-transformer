...
final class PropertyNodeNameResolver implements \ConfigTransformer202201236\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201236\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201236\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
