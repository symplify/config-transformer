...
final class PropertyNodeNameResolver implements \ConfigTransformer202204152\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202204152\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202204152\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
