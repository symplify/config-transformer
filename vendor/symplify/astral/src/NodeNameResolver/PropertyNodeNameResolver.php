...
final class PropertyNodeNameResolver implements \ConfigTransformer202107033\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202107033\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202107033\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
