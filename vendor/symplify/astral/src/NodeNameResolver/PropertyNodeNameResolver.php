...
final class PropertyNodeNameResolver implements \ConfigTransformer202202152\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202202152\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202202152\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
