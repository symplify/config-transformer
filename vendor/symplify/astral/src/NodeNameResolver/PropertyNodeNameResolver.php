...
final class PropertyNodeNameResolver implements \ConfigTransformer202106111\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202106111\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202106111\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
