...
final class PropertyNodeNameResolver implements \ConfigTransformer202201310\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201310\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201310\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
