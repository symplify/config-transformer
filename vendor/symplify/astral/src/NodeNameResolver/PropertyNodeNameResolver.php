...
final class PropertyNodeNameResolver implements \ConfigTransformer202203055\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202203055\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202203055\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
