...
final class PropertyNodeNameResolver implements \ConfigTransformer202203029\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202203029\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202203029\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
