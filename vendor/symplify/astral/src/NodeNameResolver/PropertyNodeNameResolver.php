...
final class PropertyNodeNameResolver implements \ConfigTransformer202201163\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201163\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201163\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
