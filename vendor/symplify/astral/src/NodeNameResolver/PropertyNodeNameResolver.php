...
final class PropertyNodeNameResolver implements \ConfigTransformer202205128\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205128\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202205128\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
