...
final class PropertyNodeNameResolver implements \ConfigTransformer202201075\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201075\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201075\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
