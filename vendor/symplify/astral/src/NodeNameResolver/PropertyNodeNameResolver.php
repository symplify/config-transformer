...
final class PropertyNodeNameResolver implements \ConfigTransformer202206013\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202206013\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202206013\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
