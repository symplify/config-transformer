...
final class PropertyNodeNameResolver implements \ConfigTransformer202202199\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202202199\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202202199\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
