...
final class PropertyNodeNameResolver implements \ConfigTransformer202201248\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201248\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201248\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
