...
final class PropertyNodeNameResolver implements \ConfigTransformer202204146\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202204146\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202204146\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
