...
final class PropertyNodeNameResolver implements \ConfigTransformer202206021\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202206021\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202206021\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
