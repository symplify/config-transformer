...
final class PropertyNodeNameResolver implements \ConfigTransformer202112315\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202112315\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202112315\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
