...
final class PropertyNodeNameResolver implements \ConfigTransformer202112121\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202112121\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202112121\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
