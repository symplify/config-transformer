...
final class PropertyNodeNameResolver implements \ConfigTransformer202205122\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205122\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202205122\PhpParser\Node\Stmt\Property;
    }
    /**
     * @param Property $node
     */
