...
use ConfigTransformer202106194\PhpParser\Node\Attribute;
use ConfigTransformer202106194\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202106194\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202106194\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202106194\PhpParser\Node\Attribute;
    }
    /**
