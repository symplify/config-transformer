...
use ConfigTransformer2022053010\PhpParser\Node\Attribute;
use ConfigTransformer2022053010\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer2022053010\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer2022053010\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer2022053010\PhpParser\Node\Attribute;
    }
    /**
