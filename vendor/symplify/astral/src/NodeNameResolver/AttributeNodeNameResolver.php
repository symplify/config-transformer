...
use ConfigTransformer202204172\PhpParser\Node\Attribute;
use ConfigTransformer202204172\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202204172\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202204172\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202204172\PhpParser\Node\Attribute;
    }
    /**
