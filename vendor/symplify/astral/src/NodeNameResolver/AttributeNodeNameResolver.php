...
use ConfigTransformer202206010\PhpParser\Node\Attribute;
use ConfigTransformer202206010\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202206010\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202206010\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202206010\PhpParser\Node\Attribute;
    }
    /**
