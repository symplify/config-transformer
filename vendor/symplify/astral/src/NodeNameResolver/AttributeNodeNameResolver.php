...
use ConfigTransformer202106207\PhpParser\Node\Attribute;
use ConfigTransformer202106207\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202106207\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202106207\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202106207\PhpParser\Node\Attribute;
    }
    /**
