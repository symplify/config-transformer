...
use ConfigTransformer202112166\PhpParser\Node\Attribute;
use ConfigTransformer202112166\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202112166\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202112166\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202112166\PhpParser\Node\Attribute;
    }
    /**
