...
use ConfigTransformer202204166\PhpParser\Node\Attribute;
use ConfigTransformer202204166\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202204166\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202204166\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202204166\PhpParser\Node\Attribute;
    }
    /**
