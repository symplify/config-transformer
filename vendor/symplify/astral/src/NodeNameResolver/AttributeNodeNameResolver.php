...
use ConfigTransformer202201245\PhpParser\Node\Attribute;
use ConfigTransformer202201245\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202201245\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201245\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201245\PhpParser\Node\Attribute;
    }
    /**
