...
use ConfigTransformer202203257\PhpParser\Node\Attribute;
use ConfigTransformer202203257\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202203257\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202203257\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202203257\PhpParser\Node\Attribute;
    }
    /**
