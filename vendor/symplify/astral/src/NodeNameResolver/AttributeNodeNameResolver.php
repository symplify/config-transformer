...
use ConfigTransformer202202200\PhpParser\Node\Attribute;
use ConfigTransformer202202200\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202202200\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202202200\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202202200\PhpParser\Node\Attribute;
    }
    /**
