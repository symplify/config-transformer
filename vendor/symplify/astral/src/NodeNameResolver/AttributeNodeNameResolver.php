...
use ConfigTransformer202201250\PhpParser\Node\Attribute;
use ConfigTransformer202201250\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202201250\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201250\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201250\PhpParser\Node\Attribute;
    }
    /**
