...
use ConfigTransformer202106279\PhpParser\Node\Attribute;
use ConfigTransformer202106279\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202106279\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202106279\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202106279\PhpParser\Node\Attribute;
    }
    /**
