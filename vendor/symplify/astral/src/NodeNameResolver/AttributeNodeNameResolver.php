...
use ConfigTransformer202107032\PhpParser\Node\Attribute;
use ConfigTransformer202107032\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202107032\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202107032\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202107032\PhpParser\Node\Attribute;
    }
    /**
