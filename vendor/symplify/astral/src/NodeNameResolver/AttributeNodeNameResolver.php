...
use ConfigTransformer202206069\PhpParser\Node\Attribute;
use ConfigTransformer202206069\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202206069\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202206069\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202206069\PhpParser\Node\Attribute;
    }
    /**
