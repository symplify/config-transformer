...
use ConfigTransformer202202249\PhpParser\Node\Attribute;
use ConfigTransformer202202249\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202202249\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202202249\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202202249\PhpParser\Node\Attribute;
    }
    /**
