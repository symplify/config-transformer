...
use ConfigTransformer202203177\PhpParser\Node\Attribute;
use ConfigTransformer202203177\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202203177\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202203177\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202203177\PhpParser\Node\Attribute;
    }
    /**
