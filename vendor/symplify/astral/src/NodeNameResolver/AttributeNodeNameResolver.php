...
use ConfigTransformer202201202\PhpParser\Node\Attribute;
use ConfigTransformer202201202\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202201202\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201202\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201202\PhpParser\Node\Attribute;
    }
    /**
