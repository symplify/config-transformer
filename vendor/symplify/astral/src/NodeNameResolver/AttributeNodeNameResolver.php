...
use ConfigTransformer202206019\PhpParser\Node\Attribute;
use ConfigTransformer202206019\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202206019\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202206019\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202206019\PhpParser\Node\Attribute;
    }
    /**
