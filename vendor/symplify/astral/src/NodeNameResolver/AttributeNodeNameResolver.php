...
use ConfigTransformer202205033\PhpParser\Node\Attribute;
use ConfigTransformer202205033\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202205033\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205033\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202205033\PhpParser\Node\Attribute;
    }
    /**
