...
use ConfigTransformer202203073\PhpParser\Node\Attribute;
use ConfigTransformer202203073\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202203073\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202203073\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202203073\PhpParser\Node\Attribute;
    }
    /**
