...
use ConfigTransformer202201309\PhpParser\Node\Attribute;
use ConfigTransformer202201309\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202201309\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201309\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201309\PhpParser\Node\Attribute;
    }
    /**
