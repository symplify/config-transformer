...
use ConfigTransformer202205143\PhpParser\Node\Attribute;
use ConfigTransformer202205143\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202205143\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205143\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202205143\PhpParser\Node\Attribute;
    }
    /**
