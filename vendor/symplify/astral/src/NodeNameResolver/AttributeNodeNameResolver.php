...
use ConfigTransformer202205170\PhpParser\Node\Attribute;
use ConfigTransformer202205170\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202205170\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205170\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202205170\PhpParser\Node\Attribute;
    }
    /**
