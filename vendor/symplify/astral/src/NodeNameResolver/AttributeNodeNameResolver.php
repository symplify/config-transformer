...
use ConfigTransformer202201244\PhpParser\Node\Attribute;
use ConfigTransformer202201244\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202201244\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201244\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201244\PhpParser\Node\Attribute;
    }
    /**
