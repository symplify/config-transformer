...
use ConfigTransformer202204161\PhpParser\Node\Attribute;
use ConfigTransformer202204161\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202204161\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202204161\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202204161\PhpParser\Node\Attribute;
    }
    /**
