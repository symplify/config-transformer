...
use ConfigTransformer202202199\PhpParser\Node\Attribute;
use ConfigTransformer202202199\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202202199\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202202199\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202202199\PhpParser\Node\Attribute;
    }
    /**
