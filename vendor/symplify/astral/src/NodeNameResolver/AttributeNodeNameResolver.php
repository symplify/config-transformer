...
use ConfigTransformer202107080\PhpParser\Node\Attribute;
use ConfigTransformer202107080\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202107080\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202107080\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202107080\PhpParser\Node\Attribute;
    }
    /**
