...
use ConfigTransformer202106181\PhpParser\Node\Attribute;
use ConfigTransformer202106181\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202106181\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202106181\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202106181\PhpParser\Node\Attribute;
    }
    /**
