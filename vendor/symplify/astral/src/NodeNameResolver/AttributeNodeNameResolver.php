...
use ConfigTransformer202106183\PhpParser\Node\Attribute;
use ConfigTransformer202106183\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202106183\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202106183\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202106183\PhpParser\Node\Attribute;
    }
    /**
