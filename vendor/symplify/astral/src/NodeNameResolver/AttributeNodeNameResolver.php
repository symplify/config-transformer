...
use ConfigTransformer202205121\PhpParser\Node\Attribute;
use ConfigTransformer202205121\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202205121\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205121\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202205121\PhpParser\Node\Attribute;
    }
    /**
