...
use ConfigTransformer202206044\PhpParser\Node\Attribute;
use ConfigTransformer202206044\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202206044\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202206044\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202206044\PhpParser\Node\Attribute;
    }
    /**
