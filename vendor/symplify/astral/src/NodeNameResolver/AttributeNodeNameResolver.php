...
use ConfigTransformer2021061810\PhpParser\Node\Attribute;
use ConfigTransformer2021061810\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer2021061810\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer2021061810\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer2021061810\PhpParser\Node\Attribute;
    }
    /**
