...
use ConfigTransformer202205128\PhpParser\Node\Attribute;
use ConfigTransformer202205128\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202205128\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205128\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202205128\PhpParser\Node\Attribute;
    }
    /**
