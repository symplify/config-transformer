...
use ConfigTransformer202201249\PhpParser\Node\Attribute;
use ConfigTransformer202201249\Symplify\Astral\Contract\NodeNameResolverInterface;
final class AttributeNodeNameResolver implements \ConfigTransformer202201249\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201249\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201249\PhpParser\Node\Attribute;
    }
    /**
