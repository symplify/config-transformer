...
final class ArgNodeNameResolver implements \ConfigTransformer2021120210\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer2021120210\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
