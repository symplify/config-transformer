...
final class ArgNodeNameResolver implements \ConfigTransformer202203132\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202203132\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202203132\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
