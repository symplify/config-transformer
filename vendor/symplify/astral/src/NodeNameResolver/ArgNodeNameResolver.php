...
final class ArgNodeNameResolver implements \ConfigTransformer202201076\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201076\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201076\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
