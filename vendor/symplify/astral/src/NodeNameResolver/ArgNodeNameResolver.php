...
final class ArgNodeNameResolver implements \ConfigTransformer202205015\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205015\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202205015\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
