...
final class ArgNodeNameResolver implements \ConfigTransformer2021110310\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer2021110310\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
