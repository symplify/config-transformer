...
final class ArgNodeNameResolver implements \ConfigTransformer202206052\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202206052\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202206052\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
