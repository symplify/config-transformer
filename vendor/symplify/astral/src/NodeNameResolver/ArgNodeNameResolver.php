...
final class ArgNodeNameResolver implements \ConfigTransformer202203064\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202203064\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202203064\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
