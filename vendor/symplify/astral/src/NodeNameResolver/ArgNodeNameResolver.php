...
final class ArgNodeNameResolver implements \ConfigTransformer202205301\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205301\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202205301\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
