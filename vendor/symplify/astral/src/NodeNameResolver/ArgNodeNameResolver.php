...
final class ArgNodeNameResolver implements \ConfigTransformer2021120610\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer2021120610\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
