...
final class ArgNodeNameResolver implements \ConfigTransformer202201167\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201167\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201167\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
