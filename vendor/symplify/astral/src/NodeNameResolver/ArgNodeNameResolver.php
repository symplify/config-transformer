...
final class ArgNodeNameResolver implements \ConfigTransformer202202249\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202202249\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202202249\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
