...
final class ArgNodeNameResolver implements \ConfigTransformer202112302\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202112302\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202112302\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
