...
final class ArgNodeNameResolver implements \ConfigTransformer202201151\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201151\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201151\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
