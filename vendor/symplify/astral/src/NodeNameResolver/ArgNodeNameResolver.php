...
final class ArgNodeNameResolver implements \ConfigTransformer202107036\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202107036\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202107036\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
