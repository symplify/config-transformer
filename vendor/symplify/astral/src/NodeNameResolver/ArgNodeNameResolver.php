...
final class ArgNodeNameResolver implements \ConfigTransformer202112079\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer202112079\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
