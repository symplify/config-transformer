...
final class ArgNodeNameResolver implements \ConfigTransformer202111274\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer202111274\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
