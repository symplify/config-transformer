...
final class ArgNodeNameResolver implements \ConfigTransformer202109303\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer202109303\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
