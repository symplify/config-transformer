...
final class ArgNodeNameResolver implements \ConfigTransformer202106184\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202106184\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202106184\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
