...
final class ArgNodeNameResolver implements \ConfigTransformer202202207\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202202207\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202202207\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
