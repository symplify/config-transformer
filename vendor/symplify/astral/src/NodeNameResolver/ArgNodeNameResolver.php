...
final class ArgNodeNameResolver implements \ConfigTransformer202205249\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205249\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202205249\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
