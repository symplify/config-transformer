...
final class ArgNodeNameResolver implements \ConfigTransformer202111303\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer202111303\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
