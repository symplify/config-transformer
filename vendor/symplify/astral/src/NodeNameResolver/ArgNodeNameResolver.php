...
final class ArgNodeNameResolver implements \ConfigTransformer202107264\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer202107264\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
