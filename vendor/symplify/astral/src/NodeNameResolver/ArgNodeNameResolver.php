...
final class ArgNodeNameResolver implements \ConfigTransformer2021110110\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer2021110110\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
