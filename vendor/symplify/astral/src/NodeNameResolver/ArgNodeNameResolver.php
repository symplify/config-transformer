...
final class ArgNodeNameResolver implements \ConfigTransformer202107054\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202107054\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202107054\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
