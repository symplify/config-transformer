...
final class ArgNodeNameResolver implements \ConfigTransformer202112141\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202112141\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202112141\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
