...
final class ArgNodeNameResolver implements \ConfigTransformer202107252\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer202107252\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
