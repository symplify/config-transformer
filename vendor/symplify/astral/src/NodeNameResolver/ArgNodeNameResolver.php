...
final class ArgNodeNameResolver implements \ConfigTransformer202201208\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201208\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201208\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
