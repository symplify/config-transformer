...
final class ArgNodeNameResolver implements \ConfigTransformer202108110\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer202108110\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
