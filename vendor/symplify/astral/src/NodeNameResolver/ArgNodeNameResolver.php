...
final class ArgNodeNameResolver implements \ConfigTransformer202106265\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202106265\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202106265\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
