...
final class ArgNodeNameResolver implements \ConfigTransformer202206048\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202206048\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202206048\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
