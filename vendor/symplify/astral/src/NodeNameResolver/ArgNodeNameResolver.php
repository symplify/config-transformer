...
final class ArgNodeNameResolver implements \ConfigTransformer202202219\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202202219\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202202219\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
