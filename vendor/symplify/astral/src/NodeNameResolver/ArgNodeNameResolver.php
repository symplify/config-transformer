...
final class ArgNodeNameResolver implements \ConfigTransformer202202161\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202202161\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202202161\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
