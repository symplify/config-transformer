...
final class ArgNodeNameResolver implements \ConfigTransformer202203157\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202203157\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202203157\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
