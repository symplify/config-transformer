...
final class ArgNodeNameResolver implements \ConfigTransformer202107032\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202107032\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202107032\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
