...
final class ArgNodeNameResolver implements \ConfigTransformer202201249\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201249\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201249\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
