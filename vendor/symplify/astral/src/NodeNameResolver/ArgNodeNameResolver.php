...
final class ArgNodeNameResolver implements \ConfigTransformer202107076\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202107076\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202107076\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
