...
final class ArgNodeNameResolver implements \ConfigTransformer202112066\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer202112066\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
