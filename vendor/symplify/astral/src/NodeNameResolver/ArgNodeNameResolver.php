...
final class ArgNodeNameResolver implements \ConfigTransformer202112315\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202112315\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202112315\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
