...
final class ArgNodeNameResolver implements \ConfigTransformer202205010\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205010\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202205010\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
