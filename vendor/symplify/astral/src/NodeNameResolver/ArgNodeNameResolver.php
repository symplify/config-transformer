...
final class ArgNodeNameResolver implements \ConfigTransformer202108236\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer202108236\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
