...
final class ArgNodeNameResolver implements \ConfigTransformer202202134\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202202134\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202202134\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
