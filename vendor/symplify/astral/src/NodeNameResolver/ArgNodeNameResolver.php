...
final class ArgNodeNameResolver implements \ConfigTransformer202201158\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201158\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201158\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
