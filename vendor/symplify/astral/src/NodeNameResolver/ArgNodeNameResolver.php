...
final class ArgNodeNameResolver implements \ConfigTransformer202110251\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer202110251\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
