...
final class ArgNodeNameResolver implements \ConfigTransformer202111019\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer202111019\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
