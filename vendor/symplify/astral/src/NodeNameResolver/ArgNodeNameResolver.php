...
final class ArgNodeNameResolver implements \ConfigTransformer202206055\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202206055\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202206055\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
