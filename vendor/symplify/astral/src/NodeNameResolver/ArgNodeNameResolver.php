...
final class ArgNodeNameResolver implements \ConfigTransformer202111308\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer202111308\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
