...
final class ArgNodeNameResolver implements \ConfigTransformer2022041410\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer2022041410\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer2022041410\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
