...
final class ArgNodeNameResolver implements \ConfigTransformer2021110410\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer2021110410\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
