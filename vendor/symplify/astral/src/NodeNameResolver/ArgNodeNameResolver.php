...
final class ArgNodeNameResolver implements \ConfigTransformer202202203\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202202203\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202202203\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
