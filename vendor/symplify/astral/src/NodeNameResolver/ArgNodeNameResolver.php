...
final class ArgNodeNameResolver implements \ConfigTransformer2021082510\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer2021082510\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
