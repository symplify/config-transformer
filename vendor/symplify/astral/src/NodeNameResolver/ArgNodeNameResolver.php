...
final class ArgNodeNameResolver implements \ConfigTransformer202112238\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202112238\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202112238\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
