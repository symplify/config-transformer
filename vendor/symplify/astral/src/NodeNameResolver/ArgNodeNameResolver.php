...
final class ArgNodeNameResolver implements \ConfigTransformer202206012\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202206012\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202206012\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
