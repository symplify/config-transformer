...
final class ArgNodeNameResolver implements \ConfigTransformer202201160\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201160\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201160\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
