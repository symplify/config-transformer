...
final class ArgNodeNameResolver implements \ConfigTransformer202201179\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201179\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202201179\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
