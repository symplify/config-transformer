...
final class ArgNodeNameResolver implements \ConfigTransformer202203075\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202203075\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202203075\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
