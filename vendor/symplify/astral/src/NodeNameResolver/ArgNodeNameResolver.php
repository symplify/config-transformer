...
final class ArgNodeNameResolver implements \ConfigTransformer202112083\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer202112083\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
