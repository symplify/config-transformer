...
final class ArgNodeNameResolver implements \ConfigTransformer202202240\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202202240\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202202240\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
