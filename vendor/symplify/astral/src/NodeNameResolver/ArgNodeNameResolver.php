...
final class ArgNodeNameResolver implements \ConfigTransformer202110315\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        return $node instanceof \ConfigTransformer202110315\PhpParser\Node\Arg;
    }
    /**
     * @param \PhpParser\Node $node
     */
