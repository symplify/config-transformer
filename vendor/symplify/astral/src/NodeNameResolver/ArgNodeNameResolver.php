...
final class ArgNodeNameResolver implements \ConfigTransformer202205122\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205122\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202205122\PhpParser\Node\Arg;
    }
    /**
     * @param Arg $node
     */
