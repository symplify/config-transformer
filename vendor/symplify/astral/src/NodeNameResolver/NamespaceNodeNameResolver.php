...
final class NamespaceNodeNameResolver implements \ConfigTransformer202205168\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205168\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202205168\PhpParser\Node\Stmt\Namespace_;
    }
    /**
