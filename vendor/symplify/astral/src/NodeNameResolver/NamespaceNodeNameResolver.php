...
final class NamespaceNodeNameResolver implements \ConfigTransformer202206045\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202206045\PhpParser\Node $node) : bool
    {
        return $node instanceof \ConfigTransformer202206045\PhpParser\Node\Stmt\Namespace_;
    }
    /**
