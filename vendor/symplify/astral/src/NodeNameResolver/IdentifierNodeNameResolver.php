...
final class IdentifierNodeNameResolver implements \ConfigTransformer202204152\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202204152\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202204152\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202204152\PhpParser\Node\Name;
    }
    /**
