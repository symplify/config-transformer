...
final class IdentifierNodeNameResolver implements \ConfigTransformer202205302\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205302\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202205302\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202205302\PhpParser\Node\Name;
    }
    /**
