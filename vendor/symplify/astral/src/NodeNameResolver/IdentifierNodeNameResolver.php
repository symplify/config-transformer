...
final class IdentifierNodeNameResolver implements \ConfigTransformer202106121\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202106121\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202106121\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202106121\PhpParser\Node\Name;
    }
    /**
