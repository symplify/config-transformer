...
final class IdentifierNodeNameResolver implements \ConfigTransformer2021062210\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer2021062210\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer2021062210\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer2021062210\PhpParser\Node\Name;
    }
    /**
