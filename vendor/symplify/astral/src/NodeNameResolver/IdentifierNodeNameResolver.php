...
final class IdentifierNodeNameResolver implements \ConfigTransformer202206055\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202206055\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202206055\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202206055\PhpParser\Node\Name;
    }
    /**
