...
final class IdentifierNodeNameResolver implements \ConfigTransformer202203257\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202203257\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202203257\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202203257\PhpParser\Node\Name;
    }
    /**
