...
final class IdentifierNodeNameResolver implements \ConfigTransformer202112303\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202112303\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202112303\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202112303\PhpParser\Node\Name;
    }
    /**
