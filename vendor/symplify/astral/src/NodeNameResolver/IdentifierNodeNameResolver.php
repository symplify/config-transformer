...
final class IdentifierNodeNameResolver implements \ConfigTransformer202107154\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        if ($node instanceof \ConfigTransformer202107154\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202107154\PhpParser\Node\Name;
    }
    /**
