...
final class IdentifierNodeNameResolver implements \ConfigTransformer202201179\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201179\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202201179\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202201179\PhpParser\Node\Name;
    }
    /**
