...
final class IdentifierNodeNameResolver implements \ConfigTransformer202202050\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202202050\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202202050\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202202050\PhpParser\Node\Name;
    }
    /**
