...
final class IdentifierNodeNameResolver implements \ConfigTransformer202205120\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205120\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202205120\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202205120\PhpParser\Node\Name;
    }
    /**
