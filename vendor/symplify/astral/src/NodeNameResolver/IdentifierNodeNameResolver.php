...
final class IdentifierNodeNameResolver implements \ConfigTransformer202205170\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205170\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202205170\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202205170\PhpParser\Node\Name;
    }
    /**
