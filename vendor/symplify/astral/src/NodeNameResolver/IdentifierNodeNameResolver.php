...
final class IdentifierNodeNameResolver implements \ConfigTransformer2022022110\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer2022022110\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer2022022110\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer2022022110\PhpParser\Node\Name;
    }
    /**
