...
final class IdentifierNodeNameResolver implements \ConfigTransformer202201167\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201167\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202201167\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202201167\PhpParser\Node\Name;
    }
    /**
