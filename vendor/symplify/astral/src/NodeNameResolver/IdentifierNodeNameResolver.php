...
final class IdentifierNodeNameResolver implements \ConfigTransformer202107032\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202107032\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202107032\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202107032\PhpParser\Node\Name;
    }
    /**
