...
final class IdentifierNodeNameResolver implements \ConfigTransformer202203082\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202203082\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202203082\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202203082\PhpParser\Node\Name;
    }
    /**
