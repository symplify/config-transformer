...
final class IdentifierNodeNameResolver implements \ConfigTransformer202201265\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202201265\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202201265\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202201265\PhpParser\Node\Name;
    }
    /**
