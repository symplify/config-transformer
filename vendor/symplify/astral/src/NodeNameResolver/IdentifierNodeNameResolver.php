...
final class IdentifierNodeNameResolver implements \ConfigTransformer2021090610\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        if ($node instanceof \ConfigTransformer2021090610\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer2021090610\PhpParser\Node\Name;
    }
    /**
