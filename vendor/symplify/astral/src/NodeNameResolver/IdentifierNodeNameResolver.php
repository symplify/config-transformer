...
final class IdentifierNodeNameResolver implements \ConfigTransformer202106124\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202106124\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202106124\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202106124\PhpParser\Node\Name;
    }
    /**
