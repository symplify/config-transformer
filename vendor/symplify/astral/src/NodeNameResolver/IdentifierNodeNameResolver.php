...
final class IdentifierNodeNameResolver implements \ConfigTransformer202206052\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202206052\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202206052\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202206052\PhpParser\Node\Name;
    }
    /**
