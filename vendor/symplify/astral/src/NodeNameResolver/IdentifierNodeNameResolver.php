...
final class IdentifierNodeNameResolver implements \ConfigTransformer202205015\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205015\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202205015\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202205015\PhpParser\Node\Name;
    }
    /**
