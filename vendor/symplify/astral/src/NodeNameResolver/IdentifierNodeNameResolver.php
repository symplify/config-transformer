...
final class IdentifierNodeNameResolver implements \ConfigTransformer2021061910\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer2021061910\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer2021061910\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer2021061910\PhpParser\Node\Name;
    }
    /**
