...
final class IdentifierNodeNameResolver implements \ConfigTransformer202112108\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202112108\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202112108\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202112108\PhpParser\Node\Name;
    }
    /**
