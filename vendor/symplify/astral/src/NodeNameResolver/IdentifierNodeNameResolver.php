...
final class IdentifierNodeNameResolver implements \ConfigTransformer202205316\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202205316\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202205316\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202205316\PhpParser\Node\Name;
    }
    /**
