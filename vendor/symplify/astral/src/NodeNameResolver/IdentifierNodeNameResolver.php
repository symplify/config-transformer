...
final class IdentifierNodeNameResolver implements \ConfigTransformer2021110310\Symplify\Astral\Contract\NodeNameResolverInterface
{
    /**
    ...
    {
        if ($node instanceof \ConfigTransformer2021110310\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer2021110310\PhpParser\Node\Name;
    }
    /**
     * @param \PhpParser\Node $node
     */
