...
final class IdentifierNodeNameResolver implements \ConfigTransformer202107080\Symplify\Astral\Contract\NodeNameResolverInterface
{
    public function match(\ConfigTransformer202107080\PhpParser\Node $node) : bool
    {
        if ($node instanceof \ConfigTransformer202107080\PhpParser\Node\Identifier) {
            return \true;
        }
        return $node instanceof \ConfigTransformer202107080\PhpParser\Node\Name;
    }
    /**
