 ...
 */
class SimplePhpDocNode extends \ConfigTransformer202206079\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocNode
{
    public function getParam(string $desiredParamName) : ?\ConfigTransformer202206079\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode
    {
    ...
    public function getParamType(string $desiredParamName) : ?\ConfigTransformer202206079\PHPStan\PhpDocParser\Ast\Type\TypeNode
    {
        $paramTagValueNode = $this->getParam($desiredParamName);
        if (!$paramTagValueNode instanceof \ConfigTransformer202206079\PHPStan\PhpDocParser\Ast\PhpDoc\ParamTagValueNode) {
            return null;
        }
