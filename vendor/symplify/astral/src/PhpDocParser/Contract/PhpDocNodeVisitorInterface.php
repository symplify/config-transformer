...
namespace ConfigTransformer202204161\Symplify\Astral\PhpDocParser\Contract;
...
interface PhpDocNodeVisitorInterface
{
     ...
     */
    public function enterNode(\ConfigTransformer202204161\PHPStan\PhpDocParser\Ast\Node $node);
    /**
    ...
    public function afterTraverse(\ConfigTransformer202204161\PHPStan\PhpDocParser\Ast\Node $node) : void;
}
