...
namespace ConfigTransformer202205218\Symplify\Astral\PhpDocParser\Contract;
...
interface PhpDocNodeVisitorInterface
{
     ...
     */
    public function enterNode(\ConfigTransformer202205218\PHPStan\PhpDocParser\Ast\Node $node);
    /**
    ...
    public function afterTraverse(\ConfigTransformer202205218\PHPStan\PhpDocParser\Ast\Node $node) : void;
}
