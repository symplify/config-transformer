 ...
 */
final class ParentConnectingPhpDocNodeVisitor extends \ConfigTransformer202205016\Symplify\Astral\PhpDocParser\PhpDocNodeVisitor\AbstractPhpDocNodeVisitor
{
    /**
     * @var Node[]
     */
    ...
    public function enterNode(\ConfigTransformer202205016\PHPStan\PhpDocParser\Ast\Node $node) : \ConfigTransformer202205016\PHPStan\PhpDocParser\Ast\Node
    {
        if ($this->stack !== []) {
            ...
            $node->setAttribute(\ConfigTransformer202205016\Symplify\Astral\PhpDocParser\ValueObject\PhpDocAttributeKey::PARENT, $parentNode);
        }
        $this->stack[] = $node;
        return $node;
    }
