 ...
 */
final class ParentConnectingPhpDocNodeVisitor extends \ConfigTransformer202206063\Symplify\Astral\PhpDocParser\PhpDocNodeVisitor\AbstractPhpDocNodeVisitor
{
    /**
     * @var Node[]
     */
    ...
    public function enterNode(\ConfigTransformer202206063\PHPStan\PhpDocParser\Ast\Node $node) : \ConfigTransformer202206063\PHPStan\PhpDocParser\Ast\Node
    {
        if ($this->stack !== []) {
            ...
            $node->setAttribute(\ConfigTransformer202206063\Symplify\Astral\PhpDocParser\ValueObject\PhpDocAttributeKey::PARENT, $parentNode);
        }
        $this->stack[] = $node;
        return $node;
    }
