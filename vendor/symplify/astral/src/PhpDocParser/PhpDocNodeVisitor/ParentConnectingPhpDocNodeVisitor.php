 ...
 */
final class ParentConnectingPhpDocNodeVisitor extends \ConfigTransformer2022041410\Symplify\Astral\PhpDocParser\PhpDocNodeVisitor\AbstractPhpDocNodeVisitor
{
    /**
     * @var Node[]
     */
    ...
    public function enterNode(\ConfigTransformer2022041410\PHPStan\PhpDocParser\Ast\Node $node) : \ConfigTransformer2022041410\PHPStan\PhpDocParser\Ast\Node
    {
        if ($this->stack !== []) {
            ...
            $node->setAttribute(\ConfigTransformer2022041410\Symplify\Astral\PhpDocParser\ValueObject\PhpDocAttributeKey::PARENT, $parentNode);
        }
        $this->stack[] = $node;
        return $node;
    }
