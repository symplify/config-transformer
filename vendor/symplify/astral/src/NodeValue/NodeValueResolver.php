...
use ConfigTransformer202109283\Symplify\Astral\NodeValue\NodeValueResolver\ClassConstFetchValueResolver;
use ConfigTransformer202109283\Symplify\Astral\NodeValue\NodeValueResolver\ConstFetchValueResolver;
use ConfigTransformer202109283\Symplify\Astral\NodeValue\NodeValueResolver\FuncCallValueResolver;
use ConfigTransformer202109283\Symplify\Astral\NodeValue\NodeValueResolver\MagicConstValueResolver;
...
final class NodeValueResolver
{
    ...
    public function __construct(\ConfigTransformer202109283\Symplify\Astral\Naming\SimpleNameResolver $simpleNameResolver, \ConfigTransformer202109283\Symplify\PackageBuilder\Php\TypeChecker $typeChecker, \ConfigTransformer202109283\Symplify\Astral\NodeFinder\SimpleNodeFinder $simpleNodeFinder)
    {
        ...
        $this->nodeValueResolvers[] = new \ConfigTransformer202109283\Symplify\Astral\NodeValue\NodeValueResolver\ClassConstFetchValueResolver($this->simpleNameResolver, $simpleNodeFinder);
        $this->nodeValueResolvers[] = new \ConfigTransformer202109283\Symplify\Astral\NodeValue\NodeValueResolver\ConstFetchValueResolver($this->simpleNameResolver);
        $this->nodeValueResolvers[] = new \ConfigTransformer202109283\Symplify\Astral\NodeValue\NodeValueResolver\MagicConstValueResolver();
        $this->nodeValueResolvers[] = new \ConfigTransformer202109283\Symplify\Astral\NodeValue\NodeValueResolver\FuncCallValueResolver($this->simpleNameResolver, $this->constExprEvaluator);
    }
    /**
