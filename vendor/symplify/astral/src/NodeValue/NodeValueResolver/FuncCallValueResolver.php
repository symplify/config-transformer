 ...
 */
final class FuncCallValueResolver implements \ConfigTransformer2021111010\Symplify\Astral\Contract\NodeValueResolver\NodeValueResolverInterface
{
    /**
    ...
    public function __construct(\ConfigTransformer2021111010\Symplify\Astral\Naming\SimpleNameResolver $simpleNameResolver, \ConfigTransformer2021111010\PhpParser\ConstExprEvaluator $constExprEvaluator)
    {
    ...
    {
        return \ConfigTransformer2021111010\PhpParser\Node\Expr\FuncCall::class;
    }
    /**
    ...
    public function resolve($expr, $currentFilePath)
    {
        ...
        if ($expr->name instanceof \ConfigTransformer2021111010\PhpParser\Node\Name) {
