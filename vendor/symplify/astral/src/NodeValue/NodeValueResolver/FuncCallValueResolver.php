 ...
 */
final class FuncCallValueResolver implements \ConfigTransformer202110013\Symplify\Astral\Contract\NodeValueResolver\NodeValueResolverInterface
{
    /**
    ...
    public function __construct(\ConfigTransformer202110013\Symplify\Astral\Naming\SimpleNameResolver $simpleNameResolver, \ConfigTransformer202110013\PhpParser\ConstExprEvaluator $constExprEvaluator)
    {
    ...
    {
        return \ConfigTransformer202110013\PhpParser\Node\Expr\FuncCall::class;
    }
    /**
    ...
    public function resolve($expr, $currentFilePath)
    {
        ...
        if ($expr->name instanceof \ConfigTransformer202110013\PhpParser\Node\Name) {
