...
namespace ConfigTransformer202109283\Symplify\Astral\NodeValue\NodeValueResolver;
...
use ConfigTransformer202109283\Symplify\Astral\Contract\NodeValueResolver\NodeValueResolverInterface;
 ...
 */
final class ClassConstFetchValueResolver implements \ConfigTransformer202109283\Symplify\Astral\Contract\NodeValueResolver\NodeValueResolverInterface
{
    /**
    ...
    public function __construct(\ConfigTransformer202109283\Symplify\Astral\Naming\SimpleNameResolver $simpleNameResolver, \ConfigTransformer202109283\Symplify\Astral\NodeFinder\SimpleNodeFinder $simpleNodeFinder)
    {
    ...
    {
        return \ConfigTransformer202109283\PhpParser\Node\Expr\ClassConstFetch::class;
    }
    /**
    ...
    public function resolve($expr, $currentFilePath)
    {
        ...
        if ($className === 'self') {
            $classLike = $this->simpleNodeFinder->findFirstParentByType($expr, \ConfigTransformer202109283\PhpParser\Node\Stmt\ClassLike::class);
