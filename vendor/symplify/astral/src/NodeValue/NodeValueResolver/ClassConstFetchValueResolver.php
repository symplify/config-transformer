...
use ConfigTransformer202111308\PhpParser\Node\Stmt\ClassLike;
 ...
 */
final class ClassConstFetchValueResolver implements \ConfigTransformer202111308\Symplify\Astral\Contract\NodeValueResolver\NodeValueResolverInterface
{
    /**
    ...
    public function __construct(\ConfigTransformer202111308\Symplify\Astral\Naming\SimpleNameResolver $simpleNameResolver, \ConfigTransformer202111308\Symplify\Astral\NodeFinder\SimpleNodeFinder $simpleNodeFinder)
    {
    ...
    {
        return \ConfigTransformer202111308\PhpParser\Node\Expr\ClassConstFetch::class;
    }
    /**
    ...
    public function resolve($expr, $currentFilePath)
    {
        ...
        if ($className === 'self') {
            $classLike = $this->simpleNodeFinder->findFirstParentByType($expr, \ConfigTransformer202111308\PhpParser\Node\Stmt\ClassLike::class);
            if (!$classLike instanceof \ConfigTransformer202111308\PhpParser\Node\Stmt\ClassLike) {
                return null;
            }
