...
use ConfigTransformer202109308\PhpParser\Node\Stmt\ClassLike;
 ...
 */
final class ClassConstFetchValueResolver implements \ConfigTransformer202109308\Symplify\Astral\Contract\NodeValueResolver\NodeValueResolverInterface
{
    /**
    ...
    public function __construct(\ConfigTransformer202109308\Symplify\Astral\Naming\SimpleNameResolver $simpleNameResolver, \ConfigTransformer202109308\Symplify\Astral\NodeFinder\SimpleNodeFinder $simpleNodeFinder)
    {
    ...
    {
        return \ConfigTransformer202109308\PhpParser\Node\Expr\ClassConstFetch::class;
    }
    /**
    ...
    public function resolve($expr, $currentFilePath)
    {
        ...
        if ($className === 'self') {
            $classLike = $this->simpleNodeFinder->findFirstParentByType($expr, \ConfigTransformer202109308\PhpParser\Node\Stmt\ClassLike::class);
            if (!$classLike instanceof \ConfigTransformer202109308\PhpParser\Node\Stmt\ClassLike) {
                return null;
            }
