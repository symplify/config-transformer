...
namespace ConfigTransformer202111013\Symplify\Astral\PhpParser;

use ConfigTransformer202111013\PhpParser\Node\Stmt;
use ConfigTransformer202111013\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202111013\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
