...
namespace ConfigTransformer202112060\Symplify\Astral\PhpParser;

use ConfigTransformer202112060\PhpParser\Node\Stmt;
use ConfigTransformer202112060\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202112060\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
