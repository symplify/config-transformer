...
namespace ConfigTransformer202202043\Symplify\Astral\PhpParser;

use ConfigTransformer202202043\PhpParser\Node\Stmt;
use ConfigTransformer202202043\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202202043\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
