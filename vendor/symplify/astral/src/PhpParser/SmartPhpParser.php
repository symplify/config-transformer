...
namespace ConfigTransformer2022022410\Symplify\Astral\PhpParser;

use ConfigTransformer2022022410\PhpParser\Node\Stmt;
use ConfigTransformer2022022410\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer2022022410\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
