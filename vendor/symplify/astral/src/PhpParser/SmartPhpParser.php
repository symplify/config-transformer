...
namespace ConfigTransformer2022051710\Symplify\Astral\PhpParser;

use ConfigTransformer2022051710\PhpParser\Node\Stmt;
use ConfigTransformer2022051710\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer2022051710\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
