...
namespace ConfigTransformer202201159\Symplify\Astral\PhpParser;

use ConfigTransformer202201159\PhpParser\Node\Stmt;
use ConfigTransformer202201159\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202201159\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
