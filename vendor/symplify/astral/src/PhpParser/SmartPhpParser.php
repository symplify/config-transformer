...
namespace ConfigTransformer202205168\Symplify\Astral\PhpParser;

use ConfigTransformer202205168\PhpParser\Node\Stmt;
use ConfigTransformer202205168\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202205168\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
