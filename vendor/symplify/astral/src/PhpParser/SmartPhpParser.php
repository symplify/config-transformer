...
namespace ConfigTransformer202111109\Symplify\Astral\PhpParser;

use ConfigTransformer202111109\PhpParser\Node\Stmt;
use ConfigTransformer202111109\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202111109\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
