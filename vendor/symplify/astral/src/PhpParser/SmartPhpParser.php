...
namespace ConfigTransformer202201179\Symplify\Astral\PhpParser;

use ConfigTransformer202201179\PhpParser\Node\Stmt;
use ConfigTransformer202201179\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202201179\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
