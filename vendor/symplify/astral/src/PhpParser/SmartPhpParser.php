...
namespace ConfigTransformer202202249\Symplify\Astral\PhpParser;

use ConfigTransformer202202249\PhpParser\Node\Stmt;
use ConfigTransformer202202249\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202202249\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
