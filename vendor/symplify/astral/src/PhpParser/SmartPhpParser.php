...
namespace ConfigTransformer202206055\Symplify\Astral\PhpParser;

use ConfigTransformer202206055\PhpParser\Node\Stmt;
use ConfigTransformer202206055\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202206055\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
