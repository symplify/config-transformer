...
namespace ConfigTransformer202204171\Symplify\Astral\PhpParser;

use ConfigTransformer202204171\PhpParser\Node\Stmt;
use ConfigTransformer202204171\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202204171\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
