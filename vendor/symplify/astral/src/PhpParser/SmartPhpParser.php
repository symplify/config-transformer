...
namespace ConfigTransformer202111232\Symplify\Astral\PhpParser;

use ConfigTransformer202111232\PhpParser\Node\Stmt;
use ConfigTransformer202111232\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202111232\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
