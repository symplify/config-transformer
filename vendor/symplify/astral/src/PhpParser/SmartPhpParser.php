...
namespace ConfigTransformer202111253\Symplify\Astral\PhpParser;

use ConfigTransformer202111253\PhpParser\Node\Stmt;
use ConfigTransformer202111253\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202111253\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
