...
namespace ConfigTransformer202204146\Symplify\Astral\PhpParser;

use ConfigTransformer202204146\PhpParser\Node\Stmt;
use ConfigTransformer202204146\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202204146\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
