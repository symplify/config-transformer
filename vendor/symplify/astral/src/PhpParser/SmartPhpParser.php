...
namespace ConfigTransformer202205170\Symplify\Astral\PhpParser;

use ConfigTransformer202205170\PhpParser\Node\Stmt;
use ConfigTransformer202205170\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202205170\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
