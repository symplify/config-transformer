...
namespace ConfigTransformer202206041\Symplify\Astral\PhpParser;

use ConfigTransformer202206041\PhpParser\Node\Stmt;
use ConfigTransformer202206041\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202206041\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
