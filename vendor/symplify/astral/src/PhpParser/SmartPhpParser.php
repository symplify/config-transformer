...
namespace ConfigTransformer202203177\Symplify\Astral\PhpParser;

use ConfigTransformer202203177\PhpParser\Node\Stmt;
use ConfigTransformer202203177\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202203177\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
