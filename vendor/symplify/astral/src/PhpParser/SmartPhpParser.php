...
namespace ConfigTransformer202112088\Symplify\Astral\PhpParser;

use ConfigTransformer202112088\PhpParser\Node\Stmt;
use ConfigTransformer202112088\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202112088\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
