...
namespace ConfigTransformer202203077\Symplify\Astral\PhpParser;

use ConfigTransformer202203077\PhpParser\Node\Stmt;
use ConfigTransformer202203077\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202203077\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
