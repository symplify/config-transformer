...
namespace ConfigTransformer202205205\Symplify\Astral\PhpParser;

use ConfigTransformer202205205\PhpParser\Node\Stmt;
use ConfigTransformer202205205\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202205205\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
