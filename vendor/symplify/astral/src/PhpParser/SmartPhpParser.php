...
namespace ConfigTransformer202201160\Symplify\Astral\PhpParser;

use ConfigTransformer202201160\PhpParser\Node\Stmt;
use ConfigTransformer202201160\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202201160\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
