...
namespace ConfigTransformer2021110310\Symplify\Astral\PhpParser;

use ConfigTransformer2021110310\PhpParser\Node\Stmt;
use ConfigTransformer2021110310\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer2021110310\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
