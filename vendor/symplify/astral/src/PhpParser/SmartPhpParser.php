...
namespace ConfigTransformer202201250\Symplify\Astral\PhpParser;

use ConfigTransformer202201250\PhpParser\Node\Stmt;
use ConfigTransformer202201250\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202201250\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
