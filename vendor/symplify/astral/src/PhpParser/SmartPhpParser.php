...
namespace ConfigTransformer202206044\Symplify\Astral\PhpParser;

use ConfigTransformer202206044\PhpParser\Node\Stmt;
use ConfigTransformer202206044\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202206044\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
