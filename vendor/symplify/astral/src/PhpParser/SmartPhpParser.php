...
namespace ConfigTransformer202205120\Symplify\Astral\PhpParser;

use ConfigTransformer202205120\PhpParser\Node\Stmt;
use ConfigTransformer202205120\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202205120\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
