...
namespace ConfigTransformer202206056\Symplify\Astral\PhpParser;

use ConfigTransformer202206056\PhpParser\Node\Stmt;
use ConfigTransformer202206056\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202206056\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
