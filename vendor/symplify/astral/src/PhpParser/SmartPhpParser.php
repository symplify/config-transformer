...
namespace ConfigTransformer202203166\Symplify\Astral\PhpParser;

use ConfigTransformer202203166\PhpParser\Node\Stmt;
use ConfigTransformer202203166\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202203166\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
