...
namespace ConfigTransformer2022052210\Symplify\Astral\PhpParser;

use ConfigTransformer2022052210\PhpParser\Node\Stmt;
use ConfigTransformer2022052210\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer2022052210\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
