...
namespace ConfigTransformer202205302\Symplify\Astral\PhpParser;

use ConfigTransformer202205302\PhpParser\Node\Stmt;
use ConfigTransformer202205302\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202205302\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
