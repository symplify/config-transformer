...
namespace ConfigTransformer202203163\Symplify\Astral\PhpParser;

use ConfigTransformer202203163\PhpParser\Node\Stmt;
use ConfigTransformer202203163\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202203163\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
