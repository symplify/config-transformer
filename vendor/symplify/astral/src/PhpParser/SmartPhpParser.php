...
namespace ConfigTransformer202201308\Symplify\Astral\PhpParser;

use ConfigTransformer202201308\PhpParser\Node\Stmt;
use ConfigTransformer202201308\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202201308\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
