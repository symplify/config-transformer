...
namespace ConfigTransformer202204162\Symplify\Astral\PhpParser;

use ConfigTransformer202204162\PhpParser\Node\Stmt;
use ConfigTransformer202204162\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202204162\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
