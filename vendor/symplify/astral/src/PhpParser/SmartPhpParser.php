...
namespace ConfigTransformer202205305\Symplify\Astral\PhpParser;

use ConfigTransformer202205305\PhpParser\Node\Stmt;
use ConfigTransformer202205305\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202205305\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
