...
namespace ConfigTransformer202202050\Symplify\Astral\PhpParser;

use ConfigTransformer202202050\PhpParser\Node\Stmt;
use ConfigTransformer202202050\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202202050\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
