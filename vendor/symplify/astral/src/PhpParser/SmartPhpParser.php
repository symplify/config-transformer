...
namespace ConfigTransformer202112081\Symplify\Astral\PhpParser;

use ConfigTransformer202112081\PhpParser\Node\Stmt;
use ConfigTransformer202112081\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202112081\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
