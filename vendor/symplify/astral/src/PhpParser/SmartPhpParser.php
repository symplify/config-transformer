...
namespace ConfigTransformer202205135\Symplify\Astral\PhpParser;

use ConfigTransformer202205135\PhpParser\Node\Stmt;
use ConfigTransformer202205135\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202205135\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
