...
namespace ConfigTransformer2021120610\Symplify\Astral\PhpParser;

use ConfigTransformer2021120610\PhpParser\Node\Stmt;
use ConfigTransformer2021120610\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer2021120610\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
