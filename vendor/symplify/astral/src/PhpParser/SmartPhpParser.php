...
namespace ConfigTransformer202204161\Symplify\Astral\PhpParser;

use ConfigTransformer202204161\PhpParser\Node\Stmt;
use ConfigTransformer202204161\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202204161\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
