...
namespace ConfigTransformer202204178\Symplify\Astral\PhpParser;

use ConfigTransformer202204178\PhpParser\Node\Stmt;
use ConfigTransformer202204178\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202204178\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
