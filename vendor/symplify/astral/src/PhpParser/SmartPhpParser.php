...
namespace ConfigTransformer2021110410\Symplify\Astral\PhpParser;

use ConfigTransformer2021110410\PhpParser\Node\Stmt;
use ConfigTransformer2021110410\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer2021110410\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
