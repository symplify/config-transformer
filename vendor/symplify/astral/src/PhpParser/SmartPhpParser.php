...
namespace ConfigTransformer2022031610\Symplify\Astral\PhpParser;

use ConfigTransformer2022031610\PhpParser\Node\Stmt;
use ConfigTransformer2022031610\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer2022031610\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
