...
namespace ConfigTransformer202201264\Symplify\Astral\PhpParser;

use ConfigTransformer202201264\PhpParser\Node\Stmt;
use ConfigTransformer202201264\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202201264\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
