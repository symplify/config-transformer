...
namespace ConfigTransformer202205134\Symplify\Astral\PhpParser;

use ConfigTransformer202205134\PhpParser\Node\Stmt;
use ConfigTransformer202205134\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202205134\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
