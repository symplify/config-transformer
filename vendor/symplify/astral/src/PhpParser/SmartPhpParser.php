...
namespace ConfigTransformer202205300\Symplify\Astral\PhpParser;

use ConfigTransformer202205300\PhpParser\Node\Stmt;
use ConfigTransformer202205300\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202205300\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
