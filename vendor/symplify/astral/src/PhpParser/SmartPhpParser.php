...
namespace ConfigTransformer2022020510\Symplify\Astral\PhpParser;

use ConfigTransformer2022020510\PhpParser\Node\Stmt;
use ConfigTransformer2022020510\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer2022020510\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
