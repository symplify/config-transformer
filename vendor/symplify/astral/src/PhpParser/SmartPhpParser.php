...
namespace ConfigTransformer202201259\Symplify\Astral\PhpParser;

use ConfigTransformer202201259\PhpParser\Node\Stmt;
use ConfigTransformer202201259\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202201259\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
