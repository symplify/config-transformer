...
namespace ConfigTransformer202203164\Symplify\Astral\PhpParser;

use ConfigTransformer202203164\PhpParser\Node\Stmt;
use ConfigTransformer202203164\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202203164\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
