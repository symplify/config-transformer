...
namespace ConfigTransformer202111218\Symplify\Astral\PhpParser;

use ConfigTransformer202111218\PhpParser\Node\Stmt;
use ConfigTransformer202111218\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202111218\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
