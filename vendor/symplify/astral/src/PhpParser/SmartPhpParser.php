...
namespace ConfigTransformer202111133\Symplify\Astral\PhpParser;

use ConfigTransformer202111133\PhpParser\Node\Stmt;
use ConfigTransformer202111133\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202111133\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
