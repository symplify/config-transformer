...
namespace ConfigTransformer2021123110\Symplify\Astral\PhpParser;

use ConfigTransformer2021123110\PhpParser\Node\Stmt;
use ConfigTransformer2021123110\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer2021123110\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
