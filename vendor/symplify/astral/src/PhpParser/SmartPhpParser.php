...
namespace ConfigTransformer202112169\Symplify\Astral\PhpParser;

use ConfigTransformer202112169\PhpParser\Node\Stmt;
use ConfigTransformer202112169\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202112169\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
