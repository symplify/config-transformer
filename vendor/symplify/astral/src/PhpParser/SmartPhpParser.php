...
namespace ConfigTransformer202202076\Symplify\Astral\PhpParser;

use ConfigTransformer202202076\PhpParser\Node\Stmt;
use ConfigTransformer202202076\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202202076\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
