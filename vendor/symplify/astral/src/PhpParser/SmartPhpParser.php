...
namespace ConfigTransformer202201240\Symplify\Astral\PhpParser;

use ConfigTransformer202201240\PhpParser\Node\Stmt;
use ConfigTransformer202201240\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202201240\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
