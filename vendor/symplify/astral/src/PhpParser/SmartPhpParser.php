...
namespace ConfigTransformer202204298\Symplify\Astral\PhpParser;

use ConfigTransformer202204298\PhpParser\Node\Stmt;
use ConfigTransformer202204298\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202204298\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
