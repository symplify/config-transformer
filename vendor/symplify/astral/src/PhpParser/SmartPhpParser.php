...
namespace ConfigTransformer202201265\Symplify\Astral\PhpParser;

use ConfigTransformer202201265\PhpParser\Node\Stmt;
use ConfigTransformer202201265\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202201265\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
