...
namespace ConfigTransformer202204142\Symplify\Astral\PhpParser;

use ConfigTransformer202204142\PhpParser\Node\Stmt;
use ConfigTransformer202204142\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202204142\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
