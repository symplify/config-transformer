...
namespace ConfigTransformer202205214\Symplify\Astral\PhpParser;

use ConfigTransformer202205214\PhpParser\Node\Stmt;
use ConfigTransformer202205214\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202205214\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
