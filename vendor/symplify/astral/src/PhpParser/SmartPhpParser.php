...
namespace ConfigTransformer202112073\Symplify\Astral\PhpParser;

use ConfigTransformer202112073\PhpParser\Node\Stmt;
use ConfigTransformer202112073\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202112073\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
