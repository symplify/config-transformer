...
namespace ConfigTransformer202205126\Symplify\Astral\PhpParser;

use ConfigTransformer202205126\PhpParser\Node\Stmt;
use ConfigTransformer202205126\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202205126\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
