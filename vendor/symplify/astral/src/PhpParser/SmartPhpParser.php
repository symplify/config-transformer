...
namespace ConfigTransformer2021111010\Symplify\Astral\PhpParser;

use ConfigTransformer2021111010\PhpParser\Node\Stmt;
use ConfigTransformer2021111010\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer2021111010\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
