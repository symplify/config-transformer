...
namespace ConfigTransformer202111287\Symplify\Astral\PhpParser;

use ConfigTransformer202111287\PhpParser\Node\Stmt;
use ConfigTransformer202111287\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202111287\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
