...
namespace ConfigTransformer202112318\Symplify\Astral\PhpParser;

use ConfigTransformer202112318\PhpParser\Node\Stmt;
use ConfigTransformer202112318\PHPStan\Parser\Parser;
/**
...
final class SmartPhpParser
{
     ...
     */
    private $parser;
    public function __construct(\ConfigTransformer202112318\PHPStan\Parser\Parser $parser)
    {
        $this->parser = $parser;
    }
    /**
