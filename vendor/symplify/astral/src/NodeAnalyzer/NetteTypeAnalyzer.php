...
namespace ConfigTransformer20220608\Symplify\Astral\NodeAnalyzer;

use ConfigTransformer20220608\Nette\Application\UI\Template;
use ConfigTransformer20220608\PhpParser\Node\Expr;
use ConfigTransformer20220608\PhpParser\Node\Expr\PropertyFetch;
...
use ConfigTransformer20220608\Symplify\Astral\TypeAnalyzer\ContainsTypeAnalyser;
/**
 * @api
 */
final class NetteTypeAnalyzer
{
     ...
     */
    private const TEMPLATE_TYPES = ['ConfigTransformer20220608\\Nette\\Application\\UI\\Template', 'ConfigTransformer20220608\\Nette\\Application\\UI\\ITemplate', 'ConfigTransformer20220608\\Nette\\Bridges\\ApplicationLatte\\Template', 'ConfigTransformer20220608\\Nette\\Bridges\\ApplicationLatte\\DefaultTemplate'];
    /**
    ...
    public function isInsideComponentContainer(Scope $scope) : bool
    {
        ...
        // this type has getComponent() method
        return \is_a($className, 'ConfigTransformer20220608\\Nette\\ComponentModel\\Container', \true);
    }
    public function isInsideControl(Scope $scope) : bool
    {
        ...
        return \is_a($className, 'ConfigTransformer20220608\\Nette\\Application\\UI\\Control', \true);
    }
}
