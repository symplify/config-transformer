...
final class CallableNodeVisitor extends \ConfigTransformer202206079\PhpParser\NodeVisitorAbstract
{
    /**
    ...
    public function enterNode(\ConfigTransformer202206079\PhpParser\Node $node)
    {
        ...
        if ($originalNode instanceof \ConfigTransformer202206079\PhpParser\Node\Stmt && $newNode instanceof \ConfigTransformer202206079\PhpParser\Node\Expr) {
            return new \ConfigTransformer202206079\PhpParser\Node\Stmt\Expression($newNode);
        }
        return $newNode;
    }
}
