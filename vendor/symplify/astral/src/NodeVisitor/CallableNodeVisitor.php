...
namespace ConfigTransformer202205120\Symplify\Astral\NodeVisitor;
...
final class CallableNodeVisitor extends \ConfigTransformer202205120\PhpParser\NodeVisitorAbstract
{
    /**
    ...
    public function enterNode(\ConfigTransformer202205120\PhpParser\Node $node)
    {
        ...
        if ($originalNode instanceof \ConfigTransformer202205120\PhpParser\Node\Stmt && $newNode instanceof \ConfigTransformer202205120\PhpParser\Node\Expr) {
            return new \ConfigTransformer202205120\PhpParser\Node\Stmt\Expression($newNode);
        }
        return $newNode;
    }
}
