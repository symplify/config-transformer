...
namespace ConfigTransformer202203177\Symplify\Astral\NodeVisitor;
...
final class CallableNodeVisitor extends \ConfigTransformer202203177\PhpParser\NodeVisitorAbstract
{
    /**
    ...
    public function enterNode(\ConfigTransformer202203177\PhpParser\Node $node)
    {
        ...
        if ($originalNode instanceof \ConfigTransformer202203177\PhpParser\Node\Stmt && $newNode instanceof \ConfigTransformer202203177\PhpParser\Node\Expr) {
            return new \ConfigTransformer202203177\PhpParser\Node\Stmt\Expression($newNode);
        }
        return $newNode;
    }
}
