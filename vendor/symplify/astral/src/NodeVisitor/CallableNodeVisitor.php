...
namespace ConfigTransformer202206063\Symplify\Astral\NodeVisitor;
...
final class CallableNodeVisitor extends \ConfigTransformer202206063\PhpParser\NodeVisitorAbstract
{
    /**
    ...
    public function enterNode(\ConfigTransformer202206063\PhpParser\Node $node)
    {
        ...
        if ($originalNode instanceof \ConfigTransformer202206063\PhpParser\Node\Stmt && $newNode instanceof \ConfigTransformer202206063\PhpParser\Node\Expr) {
            return new \ConfigTransformer202206063\PhpParser\Node\Stmt\Expression($newNode);
        }
        return $newNode;
    }
}
