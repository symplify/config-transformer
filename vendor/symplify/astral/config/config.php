...
use ConfigTransformer202107037\PhpParser\NodeFinder;
...
return static function (\ConfigTransformer202107037\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('ConfigTransformer202107037\Symplify\Astral\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/HttpKernel', __DIR__ . '/../src/StaticFactory', __DIR__ . '/../src/ValueObject']);
    $services->set(\ConfigTransformer202107037\PhpParser\ConstExprEvaluator::class);
    $services->set(\ConfigTransformer202107037\Symplify\PackageBuilder\Php\TypeChecker::class);
    $services->set(\ConfigTransformer202107037\PhpParser\NodeFinder::class);
};
