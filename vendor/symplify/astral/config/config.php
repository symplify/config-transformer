...
use ConfigTransformer2021061110\PhpParser\ConstExprEvaluator;
...
return static function (\ConfigTransformer2021061110\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('ConfigTransformer2021061110\Symplify\Astral\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/HttpKernel', __DIR__ . '/../src/StaticFactory', __DIR__ . '/../src/ValueObject']);
    $services->set(\ConfigTransformer2021061110\PhpParser\ConstExprEvaluator::class);
    $services->set(\ConfigTransformer2021061110\Symplify\PackageBuilder\Php\TypeChecker::class);
