...
use ConfigTransformer2022022110\PHPStan\PhpDocParser\Parser\ConstExprParser;
use ConfigTransformer2022022110\PHPStan\PhpDocParser\Parser\PhpDocParser;
use ConfigTransformer2022022110\PHPStan\PhpDocParser\Parser\TypeParser;
...
return static function (\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('ConfigTransformer2022022110\Symplify\Astral\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/StaticFactory', __DIR__ . '/../src/ValueObject', __DIR__ . '/../src/NodeVisitor', __DIR__ . '/../src/PhpParser/SmartPhpParser.php', __DIR__ . '/../src/PhpDocParser/PhpDocNodeVisitor/CallablePhpDocNodeVisitor.php']);
    ...
    // phpdoc parser
    $services->set(\ConfigTransformer2022022110\PHPStan\PhpDocParser\Parser\PhpDocParser::class);
    $services->set(\ConfigTransformer2022022110\PHPStan\PhpDocParser\Lexer\Lexer::class);
    $services->set(\ConfigTransformer2022022110\PHPStan\PhpDocParser\Parser\TypeParser::class);
    $services->set(\ConfigTransformer2022022110\PHPStan\PhpDocParser\Parser\ConstExprParser::class);
};
