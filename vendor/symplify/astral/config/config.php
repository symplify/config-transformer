...
use ConfigTransformer202106129\PhpParser\ConstExprEvaluator;
...
return static function (\ConfigTransformer202106129\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('ConfigTransformer202106129\Symplify\Astral\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/HttpKernel', __DIR__ . '/../src/StaticFactory', __DIR__ . '/../src/ValueObject']);
    $services->set(\ConfigTransformer202106129\PhpParser\ConstExprEvaluator::class);
    $services->set(\ConfigTransformer202106129\Symplify\PackageBuilder\Php\TypeChecker::class);
