...
use ConfigTransformerPrefix202312\Nette\Utils\Json;
use ConfigTransformerPrefix202312\PhpParser\Node\Arg;
use ConfigTransformerPrefix202312\PhpParser\Node\Expr;
use ConfigTransformerPrefix202312\PhpParser\Node\Expr\Array_;
use ConfigTransformerPrefix202312\PhpParser\Node\Expr\ArrayItem;
use ConfigTransformerPrefix202312\PhpParser\Node\Expr\Assign;
use ConfigTransformerPrefix202312\PhpParser\Node\Expr\BinaryOp\Identical;
use ConfigTransformerPrefix202312\PhpParser\Node\Expr\MethodCall;
use ConfigTransformerPrefix202312\PhpParser\Node\Expr\Variable;
use ConfigTransformerPrefix202312\PhpParser\Node\Scalar\String_;
use ConfigTransformerPrefix202312\PhpParser\Node\Stmt;
use ConfigTransformerPrefix202312\PhpParser\Node\Stmt\Expression;
use ConfigTransformerPrefix202312\PhpParser\Node\Stmt\If_;
use ConfigTransformerPrefix202312\PhpParser\Node\Stmt\Return_;
