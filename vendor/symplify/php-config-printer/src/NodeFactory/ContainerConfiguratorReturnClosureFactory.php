...
use ConfigTransformerPrefix202310\Nette\Utils\Json;
use ConfigTransformerPrefix202310\PhpParser\Node\Arg;
use ConfigTransformerPrefix202310\PhpParser\Node\Expr;
use ConfigTransformerPrefix202310\PhpParser\Node\Expr\Array_;
use ConfigTransformerPrefix202310\PhpParser\Node\Expr\ArrayItem;
use ConfigTransformerPrefix202310\PhpParser\Node\Expr\Assign;
use ConfigTransformerPrefix202310\PhpParser\Node\Expr\BinaryOp\Identical;
...
use ConfigTransformerPrefix202310\PhpParser\Node\Stmt\If_;
use ConfigTransformerPrefix202310\PhpParser\Node\Stmt\Return_;
