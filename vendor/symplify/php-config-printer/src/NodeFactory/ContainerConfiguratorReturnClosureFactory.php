...
use ConfigTransformer202209\PhpParser\Node\Expr\Assign;
use ConfigTransformer202209\PhpParser\Node\Expr\BinaryOp\Identical;
...
use ConfigTransformer202209\PhpParser\Node\Stmt\If_;
