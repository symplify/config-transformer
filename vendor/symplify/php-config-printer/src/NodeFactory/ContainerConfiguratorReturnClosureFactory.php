...
use ConfigTransformerPrefix202605\Nette\Utils\Json;
use ConfigTransformerPrefix202605\PhpParser\Node\Arg;
use ConfigTransformerPrefix202605\PhpParser\Node\ArrayItem;
use ConfigTransformerPrefix202605\PhpParser\Node\Expr;
use ConfigTransformerPrefix202605\PhpParser\Node\Expr\Array_;
use ConfigTransformerPrefix202605\PhpParser\Node\Expr\Assign;
use ConfigTransformerPrefix202605\PhpParser\Node\Expr\BinaryOp\Identical;
use ConfigTransformerPrefix202605\PhpParser\Node\Expr\MethodCall;
use ConfigTransformerPrefix202605\PhpParser\Node\Expr\Variable;
use ConfigTransformerPrefix202605\PhpParser\Node\Scalar\String_;
use ConfigTransformerPrefix202605\PhpParser\Node\Stmt;
use ConfigTransformerPrefix202605\PhpParser\Node\Stmt\Expression;
use ConfigTransformerPrefix202605\PhpParser\Node\Stmt\If_;
use ConfigTransformerPrefix202605\PhpParser\Node\Stmt\Return_;
