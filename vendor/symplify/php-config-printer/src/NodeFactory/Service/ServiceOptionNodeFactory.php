...
use ConfigTransformer202111067\Symplify\PhpConfigPrinter\ServiceOptionAnalyzer\ServiceOptionAnalyzer;
...
final class ServiceOptionNodeFactory
{
     ...
     */
    public function __construct(\ConfigTransformer202111067\Symplify\PhpConfigPrinter\ServiceOptionAnalyzer\ServiceOptionAnalyzer $serviceOptionAnalyzer, array $serviceOptionKeyYamlToPhpFactories)
    {
     ...
     */
    public function convertServiceOptionsToNodes(array $servicesValues, \ConfigTransformer202111067\PhpParser\Node\Expr\MethodCall $methodCall) : \ConfigTransformer202111067\PhpParser\Node\Expr\MethodCall
    {
    ...
    private function unNestArguments(array $servicesValues) : array
    {
        ...
        return [\ConfigTransformer202111067\Symplify\PhpConfigPrinter\ValueObject\YamlServiceKey::ARGUMENTS => $servicesValues];
    }
