...
use ConfigTransformer202107039\Symplify\PhpConfigPrinter\ServiceOptionAnalyzer\ServiceOptionAnalyzer;
...
final class ServiceOptionNodeFactory
{
     ...
     */
    public function __construct(\ConfigTransformer202107039\Symplify\PhpConfigPrinter\ServiceOptionAnalyzer\ServiceOptionAnalyzer $serviceOptionAnalyzer, array $serviceOptionKeyYamlToPhpFactories)
    {
     ...
     */
    public function convertServiceOptionsToNodes(array $servicesValues, \ConfigTransformer202107039\PhpParser\Node\Expr\MethodCall $methodCall) : \ConfigTransformer202107039\PhpParser\Node\Expr\MethodCall
    {
    ...
    private function unNestArguments(array $servicesValues) : array
    {
        ...
        return [\ConfigTransformer202107039\Symplify\PhpConfigPrinter\ValueObject\YamlServiceKey::ARGUMENTS => $servicesValues];
    }
