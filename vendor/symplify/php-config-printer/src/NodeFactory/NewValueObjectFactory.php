...
use ConfigTransformer20220610\MyCLabs\Enum\Enum;
...
use ConfigTransformer20220610\PhpParser\Node\Expr\New_;
use ConfigTransformer20220610\PhpParser\Node\Expr\StaticCall;
