...
use ConfigTransformer20220613\MyCLabs\Enum\Enum;
...
use ConfigTransformer20220613\PhpParser\Node\Expr\New_;
use ConfigTransformer20220613\PhpParser\Node\Expr\StaticCall;
