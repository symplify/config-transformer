...
use ConfigTransformer20220609\MyCLabs\Enum\Enum;
...
use ConfigTransformer20220609\PhpParser\Node\Expr\New_;
use ConfigTransformer20220609\PhpParser\Node\Expr\StaticCall;
