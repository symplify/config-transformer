...
final class ServiceReferenceExprResolver
{
    ...
    public function __construct(\ConfigTransformer202206079\Symplify\PhpConfigPrinter\ExprResolver\StringExprResolver $stringExprResolver)
    {
     ...
     */
    public function resolveServiceReferenceExpr(string $value, bool $skipServiceReference, string $functionName) : \ConfigTransformer202206079\PhpParser\Node\Expr
    {
        $value = \ltrim($value, '@');
