...
final class ServiceReferenceExprResolver
{
    ...
    public function __construct(\ConfigTransformer202203034\Symplify\PhpConfigPrinter\ExprResolver\StringExprResolver $stringExprResolver)
    {
        $this->stringExprResolver = $stringExprResolver;
    }
    public function resolveServiceReferenceExpr(string $value, bool $skipServiceReference, string $functionName) : \ConfigTransformer202203034\PhpParser\Node\Expr
    {
        $value = \ltrim($value, '@');
