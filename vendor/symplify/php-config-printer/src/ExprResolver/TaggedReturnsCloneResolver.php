...
final class TaggedReturnsCloneResolver
{
    ...
    public function resolve(\ConfigTransformer202206079\Symfony\Component\Yaml\Tag\TaggedValue $taggedValue) : \ConfigTransformer202206079\PhpParser\Node\Expr\Array_
    {
        $serviceName = $taggedValue->getValue()[0];
        $funcCall = $this->serviceReferenceExprResolver->resolveServiceReferenceExpr($serviceName, \false, \ConfigTransformer202206079\Symplify\PhpConfigPrinter\ValueObject\FunctionName::SERVICE);
        return new \ConfigTransformer202206079\PhpParser\Node\Expr\Array_([new \ConfigTransformer202206079\PhpParser\Node\Expr\ArrayItem($funcCall)]);
    }
}
