...
final class TaggedServiceResolver
{
    ...
    public function resolve(\ConfigTransformer202206046\Symfony\Component\Yaml\Tag\TaggedValue $taggedValue) : \ConfigTransformer202206046\PhpParser\Node\Expr
    {
        $serviceName = $taggedValue->getValue()['class'];
        return $this->serviceReferenceExprResolver->resolveServiceReferenceExpr($serviceName, \false, \ConfigTransformer202206046\Symplify\PhpConfigPrinter\ValueObject\FunctionName::INLINE_SERVICE);
    }
}
