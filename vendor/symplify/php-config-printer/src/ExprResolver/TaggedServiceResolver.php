...
final class TaggedServiceResolver
{
    ...
    public function resolve(\ConfigTransformer202108301\Symfony\Component\Yaml\Tag\TaggedValue $taggedValue) : \ConfigTransformer202108301\PhpParser\Node\Expr
    {
        $serviceName = $taggedValue->getValue()['class'];
        $functionName = \ConfigTransformer202108301\Symplify\PhpConfigPrinter\ValueObject\FunctionName::INLINE_SERVICE;
