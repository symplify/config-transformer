...
use ConfigTransformerPrefix202301\PhpParser\BuilderHelpers;
use ConfigTransformerPrefix202301\PhpParser\Node\Arg;
use ConfigTransformerPrefix202301\PhpParser\Node\Expr;
use ConfigTransformerPrefix202301\PhpParser\Node\Expr\ClassConstFetch;
use ConfigTransformerPrefix202301\PhpParser\Node\Expr\FuncCall;
