...
final class ExtensionConverter implements \ConfigTransformer202112237\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
     * @var string|null
     */
    ...
    public function convertToMethodCall($key, $values) : \ConfigTransformer202112237\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \ConfigTransformer202112237\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, \ConfigTransformer202112237\Symplify\PhpConfigPrinter\ValueObject\MethodName::EXTENSION, $args);
    ...
    public function match(string $rootKey, $key, $values) : bool
    {
        ...
        return !\in_array($rootKey, \ConfigTransformer202112237\Symplify\PhpConfigPrinter\ValueObject\YamlKey::provideRootKeys(), \true);
    }
}
