...
final class ExtensionConverter implements \ConfigTransformer202202204\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
     * @var string|null
     */
    ...
    public function convertToMethodCall($key, $values) : \ConfigTransformer202202204\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \ConfigTransformer202202204\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, \ConfigTransformer202202204\Symplify\PhpConfigPrinter\ValueObject\MethodName::EXTENSION, $args);
    ...
    public function match(string $rootKey, $key, $values) : bool
    {
        ...
        return !\in_array($rootKey, \ConfigTransformer202202204\Symplify\PhpConfigPrinter\ValueObject\YamlKey::provideRootKeys(), \true);
    }
}
