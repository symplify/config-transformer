...
final class ExtensionConverter implements \ConfigTransformer202206046\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
     * @var string|null
     */
    ...
    public function convertToMethodCall($key, $values) : \ConfigTransformer202206046\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \ConfigTransformer202206046\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, \ConfigTransformer202206046\Symplify\PhpConfigPrinter\ValueObject\MethodName::EXTENSION, $args);
    ...
    public function match(string $rootKey, $key, $values) : bool
    {
        ...
        return !\in_array($rootKey, \ConfigTransformer202206046\Symplify\PhpConfigPrinter\ValueObject\YamlKey::provideRootKeys(), \true);
    }
}
