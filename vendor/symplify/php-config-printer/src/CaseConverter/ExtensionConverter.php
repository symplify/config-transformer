...
final class ExtensionConverter implements \ConfigTransformer2022052210\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
     * @var string|null
     */
    ...
    public function convertToMethodCall($key, $values) : \ConfigTransformer2022052210\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \ConfigTransformer2022052210\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, \ConfigTransformer2022052210\Symplify\PhpConfigPrinter\ValueObject\MethodName::EXTENSION, $args);
    ...
    public function match(string $rootKey, $key, $values) : bool
    {
        ...
        return !\in_array($rootKey, \ConfigTransformer2022052210\Symplify\PhpConfigPrinter\ValueObject\YamlKey::provideRootKeys(), \true);
    }
}
