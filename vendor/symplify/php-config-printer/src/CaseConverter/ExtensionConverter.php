...
final class ExtensionConverter implements \ConfigTransformer2021113010\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
     * @var string|null
     */
    ...
    public function convertToMethodCall($key, $values) : \ConfigTransformer2021113010\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \ConfigTransformer2021113010\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, \ConfigTransformer2021113010\Symplify\PhpConfigPrinter\ValueObject\MethodName::EXTENSION, $args);
    ...
    public function match($rootKey, $key, $values) : bool
    {
        ...
        return !\in_array($rootKey, \ConfigTransformer2021113010\Symplify\PhpConfigPrinter\ValueObject\YamlKey::provideRootKeys(), \true);
    }
}
