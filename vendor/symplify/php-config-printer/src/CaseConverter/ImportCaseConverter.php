...
use ConfigTransformer2022051310\Symplify\PhpConfigPrinter\Sorter\YamlArgumentSorter;
 ...
 * imports: <---
 */
final class ImportCaseConverter implements \ConfigTransformer2022051310\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
    ...
    public function __construct(\ConfigTransformer2022051310\Symplify\PhpConfigPrinter\Sorter\YamlArgumentSorter $yamlArgumentSorter, \ConfigTransformer2022051310\Symplify\PhpConfigPrinter\NodeFactory\CommonNodeFactory $commonNodeFactory)
    {
    ...
    {
        return $rootKey === \ConfigTransformer2022051310\Symplify\PhpConfigPrinter\ValueObject\YamlKey::IMPORTS;
    }
    /**
     * @param mixed $key
     * @param mixed $values
    ...
    {
        if (\is_array($values)) {
            $arguments = $this->yamlArgumentSorter->sortArgumentsByKeyIfExists($values, [\ConfigTransformer2022051310\Symplify\PhpConfigPrinter\ValueObject\YamlKey::RESOURCE => '', 'type' => null, \ConfigTransformer2022051310\Symplify\PhpConfigPrinter\ValueObject\YamlKey::IGNORE_ERRORS => \false]);
     ...
     */
    private function createImportMethodCall(array $arguments) : \ConfigTransformer2022051310\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \ConfigTransformer2022051310\PhpParser\Node\Expr\MethodCall($containerConfiguratorVariable, 'import', $args);
    ...
    private function shouldSkipDefaultValue(string $name, $value, array $arguments) : bool
    {
        ...
        if ($name === \ConfigTransformer2022051310\Symplify\PhpConfigPrinter\ValueObject\YamlKey::IGNORE_ERRORS && $value === \false) {
            return \true;
        }
        ...
        if (!isset($arguments[\ConfigTransformer2022051310\Symplify\PhpConfigPrinter\ValueObject\YamlKey::IGNORE_ERRORS])) {
            return \false;
        }
        return $arguments[\ConfigTransformer2022051310\Symplify\PhpConfigPrinter\ValueObject\YamlKey::IGNORE_ERRORS] === \false;
    }
    /**
     * @param mixed $value
     * @return mixed
    ...
    private function replaceImportedFileSuffix($value)
    {
        ...
        return \ConfigTransformer2022051310\Nette\Utils\Strings::replace($value, self::INPUT_SUFFIX_REGEX, '.php');
    }
    /**
     * @param mixed $value
     */
    private function resolveExpr($value) : \ConfigTransformer2022051310\PhpParser\Node\Expr
    {
        if (\is_bool($value)) {
        ...
        if ($value === 'not_found') {
            return new \ConfigTransformer2022051310\PhpParser\Node\Scalar\String_('not_found');
        }
