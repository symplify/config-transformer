...
final class NameOnlyServiceCaseConverter implements \ConfigTransformer202106117\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
    ...
    public function convertToMethodCall($key, $values) : \ConfigTransformer202106117\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \ConfigTransformer202106117\PhpParser\Node\Expr\MethodCall(new \ConfigTransformer202106117\PhpParser\Node\Expr\Variable(\ConfigTransformer202106117\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \ConfigTransformer202106117\PhpParser\Node\Arg($classConstFetch)]);
