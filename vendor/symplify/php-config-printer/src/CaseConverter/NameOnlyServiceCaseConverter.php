...
final class NameOnlyServiceCaseConverter implements \ConfigTransformer202107130\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
    ...
    public function convertToMethodCall($key, $values) : \ConfigTransformer202107130\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \ConfigTransformer202107130\PhpParser\Node\Expr\MethodCall(new \ConfigTransformer202107130\PhpParser\Node\Expr\Variable(\ConfigTransformer202107130\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \ConfigTransformer202107130\PhpParser\Node\Arg($classConstFetch)]);
