...
final class NameOnlyServiceCaseConverter implements \ConfigTransformer202106120\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
    ...
    public function convertToMethodCall($key, $values) : \ConfigTransformer202106120\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \ConfigTransformer202106120\PhpParser\Node\Expr\MethodCall(new \ConfigTransformer202106120\PhpParser\Node\Expr\Variable(\ConfigTransformer202106120\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \ConfigTransformer202106120\PhpParser\Node\Arg($classConstFetch)]);
