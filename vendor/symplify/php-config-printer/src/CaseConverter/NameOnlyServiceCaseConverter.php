...
final class NameOnlyServiceCaseConverter implements \ConfigTransformer2021070510\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
    ...
    public function convertToMethodCall($key, $values) : \ConfigTransformer2021070510\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \ConfigTransformer2021070510\PhpParser\Node\Expr\MethodCall(new \ConfigTransformer2021070510\PhpParser\Node\Expr\Variable(\ConfigTransformer2021070510\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \ConfigTransformer2021070510\PhpParser\Node\Arg($classConstFetch)]);
