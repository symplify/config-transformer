...
final class NameOnlyServiceCaseConverter implements \ConfigTransformer202106282\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
     * @var \Symplify\PhpConfigPrinter\NodeFactory\CommonNodeFactory
     */
    private $commonNodeFactory;
    public function __construct(\ConfigTransformer202106282\Symplify\PhpConfigPrinter\NodeFactory\CommonNodeFactory $commonNodeFactory)
    {
    ...
    public function convertToMethodCall($key, $values) : \ConfigTransformer202106282\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \ConfigTransformer202106282\PhpParser\Node\Expr\MethodCall(new \ConfigTransformer202106282\PhpParser\Node\Expr\Variable(\ConfigTransformer202106282\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \ConfigTransformer202106282\PhpParser\Node\Arg($classConstFetch)]);
