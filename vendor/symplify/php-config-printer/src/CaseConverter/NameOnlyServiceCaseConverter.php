...
final class NameOnlyServiceCaseConverter implements \ConfigTransformer202106115\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
    ...
    public function convertToMethodCall($key, $values) : \ConfigTransformer202106115\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \ConfigTransformer202106115\PhpParser\Node\Expr\MethodCall(new \ConfigTransformer202106115\PhpParser\Node\Expr\Variable(\ConfigTransformer202106115\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \ConfigTransformer202106115\PhpParser\Node\Arg($classConstFetch)]);
