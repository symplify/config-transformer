...
final class NameOnlyServiceCaseConverter implements \ConfigTransformer2021061810\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
    ...
    public function convertToMethodCall($key, $values) : \ConfigTransformer2021061810\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \ConfigTransformer2021061810\PhpParser\Node\Expr\MethodCall(new \ConfigTransformer2021061810\PhpParser\Node\Expr\Variable(\ConfigTransformer2021061810\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \ConfigTransformer2021061810\PhpParser\Node\Arg($classConstFetch)]);
