...
final class NameOnlyServiceCaseConverter implements \ConfigTransformer202107233\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
    ...
    public function convertToMethodCall($key, $values) : \ConfigTransformer202107233\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \ConfigTransformer202107233\PhpParser\Node\Expr\MethodCall(new \ConfigTransformer202107233\PhpParser\Node\Expr\Variable(\ConfigTransformer202107233\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \ConfigTransformer202107233\PhpParser\Node\Arg($classConstFetch)]);
