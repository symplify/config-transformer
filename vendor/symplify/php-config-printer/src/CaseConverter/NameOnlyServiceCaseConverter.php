...
final class NameOnlyServiceCaseConverter implements \ConfigTransformer202110315\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
    ...
    public function convertToMethodCall($key, $values) : \ConfigTransformer202110315\PhpParser\Node\Stmt\Expression
    {
        ...
        $setMethodCall = new \ConfigTransformer202110315\PhpParser\Node\Expr\MethodCall(new \ConfigTransformer202110315\PhpParser\Node\Expr\Variable(\ConfigTransformer202110315\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), 'set', [new \ConfigTransformer202110315\PhpParser\Node\Arg($classConstFetch)]);
        return new \ConfigTransformer202110315\PhpParser\Node\Stmt\Expression($setMethodCall);
    }
    /**
     * @param mixed $key
     * @param mixed $values
