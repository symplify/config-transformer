 ...
 * parameters: <---
 */
final class ParameterCaseConverter implements \ConfigTransformer202108202\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
    ...
    {
        return $rootKey === \ConfigTransformer202108202\Symplify\PhpConfigPrinter\ValueObject\YamlKey::PARAMETERS;
    }
    public function convertToMethodCall($key, $values) : \ConfigTransformer202108202\PhpParser\Node\Stmt\Expression
    {
        ...
        $parametersVariable = new \ConfigTransformer202108202\PhpParser\Node\Expr\Variable(\ConfigTransformer202108202\Symplify\PhpConfigPrinter\ValueObject\VariableName::PARAMETERS);
        $methodCall = new \ConfigTransformer202108202\PhpParser\Node\Expr\MethodCall($parametersVariable, \ConfigTransformer202108202\Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
