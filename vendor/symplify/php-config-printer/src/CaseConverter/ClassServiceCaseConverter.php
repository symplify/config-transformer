...
final class ClassServiceCaseConverter implements \ConfigTransformer202107067\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
    ...
    {
        $args = $this->argsNodeFactory->createFromValues([$key, $values[\ConfigTransformer202107067\Symplify\PhpConfigPrinter\ValueObject\YamlKey::CLASS_KEY]]);
        $setMethodCall = new \ConfigTransformer202107067\PhpParser\Node\Expr\MethodCall(new \ConfigTransformer202107067\PhpParser\Node\Expr\Variable(\ConfigTransformer202107067\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \ConfigTransformer202107067\Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
        unset($values[\ConfigTransformer202107067\Symplify\PhpConfigPrinter\ValueObject\YamlKey::CLASS_KEY]);
        $setMethodCall = $this->serviceOptionNodeFactory->convertServiceOptionsToNodes($values, $setMethodCall);
        return new \ConfigTransformer202107067\PhpParser\Node\Stmt\Expression($setMethodCall);
    }
    public function match(string $rootKey, $key, $values) : bool
    {
        ...
        return !isset($values[\ConfigTransformer202107067\Symplify\PhpConfigPrinter\ValueObject\YamlKey::ALIAS]);
    }
}
