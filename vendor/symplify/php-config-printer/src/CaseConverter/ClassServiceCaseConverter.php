...
final class ClassServiceCaseConverter implements \ConfigTransformer2022052210\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
    ...
    {
        $args = $this->argsNodeFactory->createFromValues([$key, $values[\ConfigTransformer2022052210\Symplify\PhpConfigPrinter\ValueObject\YamlKey::CLASS_KEY]]);
        ...
        unset($values[\ConfigTransformer2022052210\Symplify\PhpConfigPrinter\ValueObject\YamlKey::CLASS_KEY]);
    ...
    public function match(string $rootKey, $key, $values) : bool
    {
        ...
        return !isset($values[\ConfigTransformer2022052210\Symplify\PhpConfigPrinter\ValueObject\YamlKey::ALIAS]);
    }
}
