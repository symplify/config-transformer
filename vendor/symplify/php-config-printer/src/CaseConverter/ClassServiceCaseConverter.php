...
final class ClassServiceCaseConverter implements \ConfigTransformer202111231\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
    ...
    {
        $args = $this->argsNodeFactory->createFromValues([$key, $values[\ConfigTransformer202111231\Symplify\PhpConfigPrinter\ValueObject\YamlKey::CLASS_KEY]]);
        ...
        unset($values[\ConfigTransformer202111231\Symplify\PhpConfigPrinter\ValueObject\YamlKey::CLASS_KEY]);
    ...
    public function match($rootKey, $key, $values) : bool
    {
        ...
        return !isset($values[\ConfigTransformer202111231\Symplify\PhpConfigPrinter\ValueObject\YamlKey::ALIAS]);
    }
}
