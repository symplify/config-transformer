...
final class ClassServiceCaseConverter implements \ConfigTransformer2021061210\Symplify\PhpConfigPrinter\Contract\CaseConverterInterface
{
    /**
    ...
    {
        $args = $this->argsNodeFactory->createFromValues([$key, $values[\ConfigTransformer2021061210\Symplify\PhpConfigPrinter\ValueObject\YamlKey::CLASS_KEY]]);
        $setMethodCall = new \ConfigTransformer2021061210\PhpParser\Node\Expr\MethodCall(new \ConfigTransformer2021061210\PhpParser\Node\Expr\Variable(\ConfigTransformer2021061210\Symplify\PhpConfigPrinter\ValueObject\VariableName::SERVICES), \ConfigTransformer2021061210\Symplify\PhpConfigPrinter\ValueObject\MethodName::SET, $args);
        unset($values[\ConfigTransformer2021061210\Symplify\PhpConfigPrinter\ValueObject\YamlKey::CLASS_KEY]);
    ...
    public function match(string $rootKey, $key, $values) : bool
    {
        ...
        return !isset($values[\ConfigTransformer2021061210\Symplify\PhpConfigPrinter\ValueObject\YamlKey::ALIAS]);
    }
}
