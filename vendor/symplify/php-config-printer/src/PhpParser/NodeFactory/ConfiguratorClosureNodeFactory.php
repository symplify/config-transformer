...
use ConfigTransformer20220607\PhpParser\Node\Expr\Array_;
use ConfigTransformer20220607\PhpParser\Node\Expr\ArrayItem;
use ConfigTransformer20220607\PhpParser\Node\Expr\Closure;
...
final class ConfiguratorClosureNodeFactory
{
    ...
    private function createRoutingConfiguratorParam() : Param
    {
        ...
        $classNameFullyQualified = new FullyQualified('ConfigTransformer20220607\\Symfony\\Component\\Routing\\Loader\\Configurator\\RoutingConfigurator');
