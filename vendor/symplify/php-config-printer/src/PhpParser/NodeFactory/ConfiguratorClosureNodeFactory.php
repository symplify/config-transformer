...
use ConfigTransformerPrefix202301\PhpParser\Node\Expr\Closure;
...
use ConfigTransformerPrefix202301\PhpParser\Node\Identifier;
use ConfigTransformerPrefix202301\PhpParser\Node\Name\FullyQualified;
