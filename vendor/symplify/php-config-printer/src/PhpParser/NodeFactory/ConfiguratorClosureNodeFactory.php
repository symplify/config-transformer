...
use ConfigTransformer20220610\PhpParser\Node\Expr\Array_;
use ConfigTransformer20220610\PhpParser\Node\Expr\ArrayItem;
...
use ConfigTransformer20220610\PhpParser\Node\Identifier;
...
final class ConfiguratorClosureNodeFactory
{
    ...
    private function createRoutingConfiguratorParam() : Param
    {
        ...
        $classNameFullyQualified = new FullyQualified('ConfigTransformer20220610\\Symfony\\Component\\Routing\\Loader\\Configurator\\RoutingConfigurator');
