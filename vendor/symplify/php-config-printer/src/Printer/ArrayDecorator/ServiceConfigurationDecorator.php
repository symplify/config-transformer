...
namespace ConfigTransformer202203076\Symplify\PhpConfigPrinter\Printer\ArrayDecorator;

use ConfigTransformer202203076\Symplify\PhpConfigPrinter\Reflection\ConstantNameFromValueResolver;
final class ServiceConfigurationDecorator
{
    ...
    public function __construct(\ConfigTransformer202203076\Symplify\PhpConfigPrinter\Reflection\ConstantNameFromValueResolver $constantNameFromValueResolver)
    {
