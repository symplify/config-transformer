...
use ConfigTransformerPrefix202312\PhpParser\Node\Stmt\Declare_;
use ConfigTransformerPrefix202312\PhpParser\Node\Stmt\DeclareDeclare;
use ConfigTransformerPrefix202312\PhpParser\Node\Stmt\Nop;
use ConfigTransformerPrefix202312\PhpParser\NodeTraverser;
use ConfigTransformerPrefix202312\PhpParser\PrettyPrinter\Standard;
