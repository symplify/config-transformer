...
use ConfigTransformerPrefix202501\PhpParser\Node\Scalar\LNumber;
use ConfigTransformerPrefix202501\PhpParser\Node\Stmt;
use ConfigTransformerPrefix202501\PhpParser\Node\Stmt\Declare_;
use ConfigTransformerPrefix202501\PhpParser\Node\Stmt\DeclareDeclare;
use ConfigTransformerPrefix202501\PhpParser\Node\Stmt\Nop;
use ConfigTransformerPrefix202501\PhpParser\NodeTraverser;
use ConfigTransformerPrefix202501\PhpParser\PrettyPrinter\Standard;
