...
use ConfigTransformerPrefix202401\PhpParser\Node\Stmt\Declare_;
use ConfigTransformerPrefix202401\PhpParser\Node\Stmt\DeclareDeclare;
use ConfigTransformerPrefix202401\PhpParser\Node\Stmt\Nop;
use ConfigTransformerPrefix202401\PhpParser\NodeTraverser;
use ConfigTransformerPrefix202401\PhpParser\PrettyPrinter\Standard;
