...
use ConfigTransformerPrefix202605\PhpParser\Node\Scalar\LNumber;
use ConfigTransformerPrefix202605\PhpParser\Node\Stmt;
use ConfigTransformerPrefix202605\PhpParser\Node\Stmt\Declare_;
use ConfigTransformerPrefix202605\PhpParser\Node\Stmt\DeclareDeclare;
use ConfigTransformerPrefix202605\PhpParser\Node\Stmt\Nop;
use ConfigTransformerPrefix202605\PhpParser\NodeTraverser;
use ConfigTransformerPrefix202605\PhpParser\PrettyPrinter\Standard;
