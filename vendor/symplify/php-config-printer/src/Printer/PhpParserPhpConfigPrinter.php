...
use ConfigTransformer202212\PhpParser\Node\Stmt\Declare_;
use ConfigTransformer202212\PhpParser\Node\Stmt\DeclareDeclare;
use ConfigTransformer202212\PhpParser\Node\Stmt\Nop;
use ConfigTransformer202212\PhpParser\NodeTraverser;
use ConfigTransformer202212\PhpParser\PrettyPrinter\Standard;
