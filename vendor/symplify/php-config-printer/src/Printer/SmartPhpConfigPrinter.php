...
use ConfigTransformer202111113\Symplify\PhpConfigPrinter\Printer\ArrayDecorator\ServiceConfigurationDecorator;
...
final class SmartPhpConfigPrinter
{
    ...
    public function __construct(\ConfigTransformer202111113\Symplify\PhpConfigPrinter\NodeFactory\ContainerConfiguratorReturnClosureFactory $configuratorReturnClosureFactory, \ConfigTransformer202111113\Symplify\PhpConfigPrinter\Printer\PhpParserPhpConfigPrinter $phpParserPhpConfigPrinter, \ConfigTransformer202111113\Symplify\PhpConfigPrinter\Printer\ArrayDecorator\ServiceConfigurationDecorator $serviceConfigurationDecorator)
    {
    ...
    public function printConfiguredServices(array $configuredServices) : string
    {
        ...
        $return = $this->configuratorReturnClosureFactory->createFromYamlArray([\ConfigTransformer202111113\Symplify\PhpConfigPrinter\ValueObject\YamlKey::SERVICES => $servicesWithConfigureCalls]);
