...
use ConfigTransformer202201175\Symplify\PhpConfigPrinter\Printer\ArrayDecorator\ServiceConfigurationDecorator;
...
final class SmartPhpConfigPrinter
{
    ...
    public function __construct(\ConfigTransformer202201175\Symplify\PhpConfigPrinter\NodeFactory\ContainerConfiguratorReturnClosureFactory $configuratorReturnClosureFactory, \ConfigTransformer202201175\Symplify\PhpConfigPrinter\Printer\PhpParserPhpConfigPrinter $phpParserPhpConfigPrinter, \ConfigTransformer202201175\Symplify\PhpConfigPrinter\Printer\ArrayDecorator\ServiceConfigurationDecorator $serviceConfigurationDecorator)
    {
    ...
    public function printConfiguredServices(array $configuredServices, bool $shouldUseConfigureMethod) : string
    {
        ...
        $return = $this->configuratorReturnClosureFactory->createFromYamlArray([\ConfigTransformer202201175\Symplify\PhpConfigPrinter\ValueObject\YamlKey::SERVICES => $servicesWithConfigureCalls]);
