...
use ConfigTransformer202206048\Symplify\PhpConfigPrinter\Printer\ArrayDecorator\ServiceConfigurationDecorator;
...
final class SmartPhpConfigPrinter
{
    ...
    public function __construct(\ConfigTransformer202206048\Symplify\PhpConfigPrinter\NodeFactory\ContainerConfiguratorReturnClosureFactory $configuratorReturnClosureFactory, \ConfigTransformer202206048\Symplify\PhpConfigPrinter\Printer\PhpParserPhpConfigPrinter $phpParserPhpConfigPrinter, \ConfigTransformer202206048\Symplify\PhpConfigPrinter\Printer\ArrayDecorator\ServiceConfigurationDecorator $serviceConfigurationDecorator)
    {
    ...
    public function printConfiguredServices(array $configuredServices) : string
    {
        ...
        $return = $this->configuratorReturnClosureFactory->createFromYamlArray([\ConfigTransformer202206048\Symplify\PhpConfigPrinter\ValueObject\YamlKey::SERVICES => $servicesWithConfigureCalls]);
