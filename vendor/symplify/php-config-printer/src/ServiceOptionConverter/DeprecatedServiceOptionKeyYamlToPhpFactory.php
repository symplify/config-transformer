...
final class DeprecatedServiceOptionKeyYamlToPhpFactory implements \ConfigTransformer202203257\Symplify\PhpConfigPrinter\Contract\Converter\ServiceOptionsKeyYamlToPhpFactoryInterface
{
    /**
    ...
    public function decorateServiceMethodCall($key, $yaml, $values, \ConfigTransformer202203257\PhpParser\Node\Expr\MethodCall $methodCall) : \ConfigTransformer202203257\PhpParser\Node\Expr\MethodCall
    {
        ...
        return new \ConfigTransformer202203257\PhpParser\Node\Expr\MethodCall($methodCall, 'deprecate', $args);
    }
    /**
     * @param mixed $key
     * @param mixed $values
    ...
    {
        return $key === \ConfigTransformer202203257\Symplify\PhpConfigPrinter\ValueObject\YamlServiceKey::DEPRECATED;
    }
}
