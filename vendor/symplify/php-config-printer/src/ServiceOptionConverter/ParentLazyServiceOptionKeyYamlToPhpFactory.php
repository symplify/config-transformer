...
final class ParentLazyServiceOptionKeyYamlToPhpFactory implements \ConfigTransformer202203034\Symplify\PhpConfigPrinter\Contract\Converter\ServiceOptionsKeyYamlToPhpFactoryInterface
{
    /**
     * @param mixed $key
    ...
    {
        $method = $key;
        $methodCall = new \ConfigTransformer202203034\PhpParser\Node\Expr\MethodCall($methodCall, $method);
        $methodCall->args[] = new \ConfigTransformer202203034\PhpParser\Node\Arg(\ConfigTransformer202203034\PhpParser\BuilderHelpers::normalizeValue($values[$key]));
        return $methodCall;
    }
    /**
     * @param mixed $key
    ...
    {
        return \in_array($key, [\ConfigTransformer202203034\Symplify\PhpConfigPrinter\ValueObject\YamlKey::PARENT, \ConfigTransformer202203034\Symplify\PhpConfigPrinter\ValueObject\YamlKey::LAZY], \true);
    }
}
