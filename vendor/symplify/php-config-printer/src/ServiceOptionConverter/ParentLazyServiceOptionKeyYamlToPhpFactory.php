...
final class ParentLazyServiceOptionKeyYamlToPhpFactory implements \ConfigTransformer202112120\Symplify\PhpConfigPrinter\Contract\Converter\ServiceOptionsKeyYamlToPhpFactoryInterface
{
    public function decorateServiceMethodCall($key, $yaml, $values, \ConfigTransformer202112120\PhpParser\Node\Expr\MethodCall $methodCall) : \ConfigTransformer202112120\PhpParser\Node\Expr\MethodCall
    {
        ...
        $methodCall->args[] = new \ConfigTransformer202112120\PhpParser\Node\Arg(\ConfigTransformer202112120\PhpParser\BuilderHelpers::normalizeValue($values[$key]));
        return $methodCall;
    }
    /**
     * @param mixed $key
    ...
    {
        return \in_array($key, [\ConfigTransformer202112120\Symplify\PhpConfigPrinter\ValueObject\YamlKey::PARENT, \ConfigTransformer202112120\Symplify\PhpConfigPrinter\ValueObject\YamlKey::LAZY], \true);
    }
}
