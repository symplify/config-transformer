...
final class ParentLazyServiceOptionKeyYamlToPhpFactory implements \ConfigTransformer202111301\Symplify\PhpConfigPrinter\Contract\Converter\ServiceOptionsKeyYamlToPhpFactoryInterface
{
    /**
    ...
    public function decorateServiceMethodCall($key, $yaml, $values, $methodCall) : \ConfigTransformer202111301\PhpParser\Node\Expr\MethodCall
    {
        ...
        $methodCall->args[] = new \ConfigTransformer202111301\PhpParser\Node\Arg(\ConfigTransformer202111301\PhpParser\BuilderHelpers::normalizeValue($values[$key]));
        return $methodCall;
    }
    /**
     * @param mixed $key
    ...
    {
        return \in_array($key, [\ConfigTransformer202111301\Symplify\PhpConfigPrinter\ValueObject\YamlKey::PARENT, \ConfigTransformer202111301\Symplify\PhpConfigPrinter\ValueObject\YamlKey::LAZY], \true);
    }
}
