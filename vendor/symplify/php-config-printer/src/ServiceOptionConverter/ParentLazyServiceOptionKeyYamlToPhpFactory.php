...
final class ParentLazyServiceOptionKeyYamlToPhpFactory implements \ConfigTransformer202107154\Symplify\PhpConfigPrinter\Contract\Converter\ServiceOptionsKeyYamlToPhpFactoryInterface
{
    /**
    ...
    public function decorateServiceMethodCall($key, $yaml, $values, $methodCall) : \ConfigTransformer202107154\PhpParser\Node\Expr\MethodCall
    {
        ...
        $methodCall->args[] = new \ConfigTransformer202107154\PhpParser\Node\Arg(\ConfigTransformer202107154\PhpParser\BuilderHelpers::normalizeValue($values[$key]));
        return $methodCall;
    }
    public function isMatch($key, $values) : bool
    {
        return \in_array($key, [\ConfigTransformer202107154\Symplify\PhpConfigPrinter\ValueObject\YamlKey::PARENT, \ConfigTransformer202107154\Symplify\PhpConfigPrinter\ValueObject\YamlKey::LAZY], \true);
    }
}
