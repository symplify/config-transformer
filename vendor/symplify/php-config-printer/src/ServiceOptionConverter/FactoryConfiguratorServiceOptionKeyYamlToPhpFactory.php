...
final class FactoryConfiguratorServiceOptionKeyYamlToPhpFactory implements \ConfigTransformer202203029\Symplify\PhpConfigPrinter\Contract\Converter\ServiceOptionsKeyYamlToPhpFactoryInterface
{
    /**
    ...
    public function decorateServiceMethodCall($key, $yaml, $values, \ConfigTransformer202203029\PhpParser\Node\Expr\MethodCall $methodCall) : \ConfigTransformer202203029\PhpParser\Node\Expr\MethodCall
    {
        ...
        return new \ConfigTransformer202203029\PhpParser\Node\Expr\MethodCall($methodCall, 'factory', $args);
    }
    /**
     * @param mixed $key
     * @param mixed $values
    ...
    {
        return \in_array($key, [\ConfigTransformer202203029\Symplify\PhpConfigPrinter\ValueObject\YamlKey::FACTORY, \ConfigTransformer202203029\Symplify\PhpConfigPrinter\ValueObject\YamlKey::CONFIGURATOR], \true);
    }
}
