...
final class FactoryConfiguratorServiceOptionKeyYamlToPhpFactory implements \ConfigTransformer2022051710\Symplify\PhpConfigPrinter\Contract\Converter\ServiceOptionsKeyYamlToPhpFactoryInterface
{
    /**
    ...
    public function decorateServiceMethodCall($key, $yaml, $values, \ConfigTransformer2022051710\PhpParser\Node\Expr\MethodCall $methodCall) : \ConfigTransformer2022051710\PhpParser\Node\Expr\MethodCall
    {
        ...
        return new \ConfigTransformer2022051710\PhpParser\Node\Expr\MethodCall($methodCall, 'factory', $args);
    }
    /**
     * @param mixed $key
     * @param mixed $values
    ...
    {
        return \in_array($key, [\ConfigTransformer2022051710\Symplify\PhpConfigPrinter\ValueObject\YamlKey::FACTORY, \ConfigTransformer2022051710\Symplify\PhpConfigPrinter\ValueObject\YamlKey::CONFIGURATOR], \true);
    }
}
