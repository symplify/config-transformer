...
final class CallsServiceOptionKeyYamlToPhpFactory implements \ConfigTransformer2021123110\Symplify\PhpConfigPrinter\Contract\Converter\ServiceOptionsKeyYamlToPhpFactoryInterface
{
    /**
    ...
    {
        return $key === \ConfigTransformer2021123110\Symplify\PhpConfigPrinter\ValueObject\YamlServiceKey::CALLS;
    }
}
