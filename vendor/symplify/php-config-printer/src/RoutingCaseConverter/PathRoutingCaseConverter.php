...
final class PathRoutingCaseConverter implements \ConfigTransformer202109228\Symplify\PhpConfigPrinter\Contract\RoutingCaseConverterInterface
{
    /**
     * @var string[]
     */
    ...
    public function convertToMethodCall($key, $values) : \ConfigTransformer202109228\PhpParser\Node\Stmt\Expression
    {
        ...
        $methodCall = new \ConfigTransformer202109228\PhpParser\Node\Expr\MethodCall($variable, 'add', $args);
        foreach (self::NESTED_KEYS as $nestedKey) {
            ...
            $methodCall = new \ConfigTransformer202109228\PhpParser\Node\Expr\MethodCall($methodCall, $nestedKey, $args);
        }
