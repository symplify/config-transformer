...
use ConfigTransformer202203054\Symplify\Astral\StaticFactory\SimpleNameResolverStaticFactory;
...
return static function (\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('ConfigTransformer202203054\Symplify\PhpConfigPrinter\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/ValueObject']);
    ...
    $services->set(\ConfigTransformer202203054\PhpParser\NodeVisitor\ParentConnectingVisitor::class);
    $services->set(\ConfigTransformer202203054\Symplify\Astral\NodeFinder\SimpleNodeFinder::class);
    $services->set(\ConfigTransformer202203054\Symplify\PackageBuilder\Php\TypeChecker::class);
    $services->set(\ConfigTransformer202203054\Symplify\Astral\NodeValue\NodeValueResolver::class);
    $services->set(\ConfigTransformer202203054\Symplify\Astral\Naming\SimpleNameResolver::class)->factory(\ConfigTransformer202203054\Symplify\Astral\StaticFactory\SimpleNameResolverStaticFactory::class . '::create');
