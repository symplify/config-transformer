...
return static function (\ConfigTransformer202106115\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    // filesystem
    $services->set(\ConfigTransformer202106115\Symplify\SmartFileSystem\Finder\FinderSanitizer::class);
    $services->set(\ConfigTransformer202106115\Symplify\SmartFileSystem\SmartFileSystem::class);
    $services->set(\ConfigTransformer202106115\Symplify\SmartFileSystem\Finder\SmartFinder::class);
    $services->set(\ConfigTransformer202106115\Symplify\SmartFileSystem\FileSystemGuard::class);
    ...
    $services->set(\ConfigTransformer202106115\Symplify\PackageBuilder\Reflection\PrivatesAccessor::class);
};
