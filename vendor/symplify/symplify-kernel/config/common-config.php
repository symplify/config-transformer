...
return static function (\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    // filesystem
    $services->set(\ConfigTransformer2021110110\Symplify\SmartFileSystem\Finder\FinderSanitizer::class);
    $services->set(\ConfigTransformer2021110110\Symplify\SmartFileSystem\SmartFileSystem::class);
    $services->set(\ConfigTransformer2021110110\Symplify\SmartFileSystem\Finder\SmartFinder::class);
    $services->set(\ConfigTransformer2021110110\Symplify\SmartFileSystem\FileSystemGuard::class);
    ...
    $services->set(\ConfigTransformer2021110110\Symplify\PackageBuilder\Reflection\PrivatesAccessor::class);
};
