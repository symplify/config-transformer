...
namespace ConfigTransformer202205313\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202205313\Psr\Container\ContainerInterface;
}
