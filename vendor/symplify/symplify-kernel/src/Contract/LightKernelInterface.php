...
namespace ConfigTransformer202203075\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202203075\Psr\Container\ContainerInterface;
}
