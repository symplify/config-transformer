...
namespace ConfigTransformer202201153\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202201153\Psr\Container\ContainerInterface;
}
