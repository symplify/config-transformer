...
namespace ConfigTransformer202112085\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202112085\Psr\Container\ContainerInterface;
}
