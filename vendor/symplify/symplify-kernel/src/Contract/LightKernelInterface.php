...
namespace ConfigTransformer2022011110\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer2022011110\Psr\Container\ContainerInterface;
}
