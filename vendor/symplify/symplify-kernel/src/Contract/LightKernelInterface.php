...
namespace ConfigTransformer202202249\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202202249\Psr\Container\ContainerInterface;
}
