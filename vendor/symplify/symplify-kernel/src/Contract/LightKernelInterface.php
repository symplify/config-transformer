...
namespace ConfigTransformer202201166\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202201166\Psr\Container\ContainerInterface;
}
