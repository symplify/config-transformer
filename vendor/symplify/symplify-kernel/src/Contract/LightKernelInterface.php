...
namespace ConfigTransformer202205038\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202205038\Psr\Container\ContainerInterface;
}
