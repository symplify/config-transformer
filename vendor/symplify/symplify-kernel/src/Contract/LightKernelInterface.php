...
namespace ConfigTransformer202202193\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202202193\Psr\Container\ContainerInterface;
}
