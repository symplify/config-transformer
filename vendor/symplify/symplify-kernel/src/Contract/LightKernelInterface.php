...
namespace ConfigTransformer202203163\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202203163\Psr\Container\ContainerInterface;
}
