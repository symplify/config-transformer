...
namespace ConfigTransformer202201208\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202201208\Psr\Container\ContainerInterface;
}
