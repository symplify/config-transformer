...
namespace ConfigTransformer202205122\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202205122\Psr\Container\ContainerInterface;
}
