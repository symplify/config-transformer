...
namespace ConfigTransformer202111235\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202111235\Psr\Container\ContainerInterface;
}
