...
namespace ConfigTransformer202205317\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202205317\Psr\Container\ContainerInterface;
}
