...
namespace ConfigTransformer202112193\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202112193\Psr\Container\ContainerInterface;
}
