...
namespace ConfigTransformer202111064\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202111064\Psr\Container\ContainerInterface;
}
