...
namespace ConfigTransformer202205309\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202205309\Psr\Container\ContainerInterface;
}
