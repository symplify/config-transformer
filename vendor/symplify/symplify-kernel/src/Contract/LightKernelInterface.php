...
namespace ConfigTransformer202112023\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202112023\Psr\Container\ContainerInterface;
}
