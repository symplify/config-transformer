...
namespace ConfigTransformer202201155\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202201155\Psr\Container\ContainerInterface;
}
