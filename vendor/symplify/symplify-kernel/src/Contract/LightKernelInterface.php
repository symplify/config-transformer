...
namespace ConfigTransformer202202022\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202202022\Psr\Container\ContainerInterface;
}
