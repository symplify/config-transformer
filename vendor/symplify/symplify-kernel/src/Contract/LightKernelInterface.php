...
namespace ConfigTransformer202201210\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202201210\Psr\Container\ContainerInterface;
}
