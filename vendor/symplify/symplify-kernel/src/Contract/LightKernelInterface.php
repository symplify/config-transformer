...
namespace ConfigTransformer2022020510\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer2022020510\Psr\Container\ContainerInterface;
}
