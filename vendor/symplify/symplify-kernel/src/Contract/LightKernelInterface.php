...
namespace ConfigTransformer202205128\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202205128\Psr\Container\ContainerInterface;
}
