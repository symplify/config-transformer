...
namespace ConfigTransformer202201151\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202201151\Psr\Container\ContainerInterface;
}
