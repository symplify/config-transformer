...
namespace ConfigTransformer202204142\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202204142\Psr\Container\ContainerInterface;
}
