...
namespace ConfigTransformer202201163\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202201163\Psr\Container\ContainerInterface;
}
