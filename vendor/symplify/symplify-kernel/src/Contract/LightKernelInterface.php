...
namespace ConfigTransformer202205134\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202205134\Psr\Container\ContainerInterface;
}
