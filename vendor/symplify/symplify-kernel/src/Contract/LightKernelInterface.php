...
namespace ConfigTransformer202205256\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202205256\Psr\Container\ContainerInterface;
}
