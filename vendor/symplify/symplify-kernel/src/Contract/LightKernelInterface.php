...
namespace ConfigTransformer202203032\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202203032\Psr\Container\ContainerInterface;
}
