...
namespace ConfigTransformer202111023\Symplify\SymplifyKernel\Contract;
...
interface LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformer202111023\Psr\Container\ContainerInterface;
}
