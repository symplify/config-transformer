...
namespace ConfigTransformerPrefix202302\Symplify\SymplifyKernel\ValueObject;
...
use ConfigTransformerPrefix202302\Symfony\Component\HttpKernel\KernelInterface;
use ConfigTransformerPrefix202302\Symplify\PackageBuilder\Console\Input\StaticInputDetector;
use ConfigTransformerPrefix202302\Symplify\PackageBuilder\Console\Style\SymfonyStyleFactory;
use ConfigTransformerPrefix202302\Symplify\SymplifyKernel\Contract\LightKernelInterface;
use ConfigTransformerPrefix202302\Symplify\SymplifyKernel\Exception\BootException;
use Throwable;
/**
 * @api
 */
