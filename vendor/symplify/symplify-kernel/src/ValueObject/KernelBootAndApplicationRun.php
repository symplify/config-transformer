...
final class KernelBootAndApplicationRun
{
    ...
    private function createKernel() : \ConfigTransformer202110318\Symfony\Component\HttpKernel\KernelInterface
    {
    ...
    private function validateKernelClass(string $kernelClass) : void
    {
        ...
        $errorMessage = \sprintf('Class "%s" must by type of "%s"', $kernelClass, \ConfigTransformer202110318\Symfony\Component\HttpKernel\KernelInterface::class);
