...
namespace ConfigTransformer202111013\Symplify\SymplifyKernel;
...
use ConfigTransformer202111013\Symplify\SymplifyKernel\DependencyInjection\LoadExtensionConfigsCompilerPass;
...
final class ContainerBuilderFactory
{
    ...
    public function __construct(\ConfigTransformer202111013\Symplify\SymplifyKernel\Contract\Config\LoaderFactoryInterface $loaderFactory)
    {
    ...
    public function create(array $extensions, array $compilerPasses, array $configFiles) : \ConfigTransformer202111013\Symfony\Component\DependencyInjection\ContainerBuilder
    {
        ...
        $compilerPassConfig->setMergePass(new \ConfigTransformer202111013\Symplify\SymplifyKernel\DependencyInjection\LoadExtensionConfigsCompilerPass());
