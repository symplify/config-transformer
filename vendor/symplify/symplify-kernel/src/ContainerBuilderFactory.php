...
namespace ConfigTransformer202111016\Symplify\SymplifyKernel;
...
use ConfigTransformer202111016\Symplify\SymplifyKernel\DependencyInjection\LoadExtensionConfigsCompilerPass;
...
final class ContainerBuilderFactory
{
    ...
    public function __construct(\ConfigTransformer202111016\Symplify\SymplifyKernel\Contract\Config\LoaderFactoryInterface $loaderFactory)
    {
    ...
    public function create(array $extensions, array $compilerPasses, array $configFiles) : \ConfigTransformer202111016\Symfony\Component\DependencyInjection\ContainerBuilder
    {
        ...
        $compilerPassConfig->setMergePass(new \ConfigTransformer202111016\Symplify\SymplifyKernel\DependencyInjection\LoadExtensionConfigsCompilerPass());
