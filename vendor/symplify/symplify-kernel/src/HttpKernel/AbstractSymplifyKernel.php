...
namespace ConfigTransformer202106122\Symplify\SymplifyKernel\HttpKernel;
...
use ConfigTransformer202106122\Symplify\SymplifyKernel\Strings\KernelUniqueHasher;
abstract class AbstractSymplifyKernel extends \ConfigTransformer202106122\Symfony\Component\HttpKernel\Kernel implements \ConfigTransformer202106122\Symplify\PackageBuilder\Contract\HttpKernel\ExtraConfigAwareKernelInterface
{
    /**
     * @var string[]
     */
    ...
    {
        return [new \ConfigTransformer202106122\Symplify\SymplifyKernel\Bundle\SymplifyKernelBundle()];
    }
    /**
    ...
    public function setConfigs(array $configs) : void
    {
        foreach ($configs as $config) {
            if ($config instanceof \ConfigTransformer202106122\Symplify\SmartFileSystem\SmartFileInfo) {
    ...
    {
        $kernelUniqueHasher = new \ConfigTransformer202106122\Symplify\SymplifyKernel\Strings\KernelUniqueHasher();
