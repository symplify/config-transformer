...
namespace ConfigTransformerPrefix202302\Symplify\SymplifyKernel\HttpKernel;
...
use ConfigTransformerPrefix202302\Symplify\SymplifyKernel\ValueObject\SymplifyKernelConfig;
/**
 * @api
 */
abstract class AbstractSymplifyKernel implements LightKernelInterface
{
    ...
    public function getContainer() : \ConfigTransformerPrefix202302\Psr\Container\ContainerInterface
    {
