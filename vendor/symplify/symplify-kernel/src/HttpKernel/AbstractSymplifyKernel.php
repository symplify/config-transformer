...
use ConfigTransformer202111011\Symplify\SymplifyKernel\Config\Loader\ParameterMergingLoaderFactory;
use ConfigTransformer202111011\Symplify\SymplifyKernel\ContainerBuilderFactory;
...
use ConfigTransformer202111011\Symplify\SymplifyKernel\ValueObject\SymplifyKernelConfig;
/**
 * @api
 */
abstract class AbstractSymplifyKernel implements \ConfigTransformer202111011\Symplify\SymplifyKernel\Contract\LightKernelInterface
{
    ...
    {
        $containerBuilderFactory = new \ConfigTransformer202111011\Symplify\SymplifyKernel\ContainerBuilderFactory(new \ConfigTransformer202111011\Symplify\SymplifyKernel\Config\Loader\ParameterMergingLoaderFactory());
        ...
        $configFiles[] = \ConfigTransformer202111011\Symplify\SymplifyKernel\ValueObject\SymplifyKernelConfig::FILE_PATH;
