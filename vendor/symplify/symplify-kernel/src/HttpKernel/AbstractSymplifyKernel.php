...
namespace ConfigTransformer20210610\Symplify\SymplifyKernel\HttpKernel;
...
use ConfigTransformer20210610\Symplify\SymplifyKernel\Strings\KernelUniqueHasher;
abstract class AbstractSymplifyKernel extends \ConfigTransformer20210610\Symfony\Component\HttpKernel\Kernel implements \ConfigTransformer20210610\Symplify\PackageBuilder\Contract\HttpKernel\ExtraConfigAwareKernelInterface
{
    /**
     * @var string[]
     */
    ...
    {
        return [new \ConfigTransformer20210610\Symplify\SymplifyKernel\Bundle\SymplifyKernelBundle()];
    }
    /**
    ...
    public function setConfigs(array $configs) : void
    {
        foreach ($configs as $config) {
            if ($config instanceof \ConfigTransformer20210610\Symplify\SmartFileSystem\SmartFileInfo) {
    ...
    {
        $kernelUniqueHasher = new \ConfigTransformer20210610\Symplify\SymplifyKernel\Strings\KernelUniqueHasher();
