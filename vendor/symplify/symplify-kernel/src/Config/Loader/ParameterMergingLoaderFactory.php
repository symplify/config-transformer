...
namespace ConfigTransformer202111019\Symplify\SymplifyKernel\Config\Loader;
...
use ConfigTransformer202111019\Symplify\SymplifyKernel\Contract\Config\LoaderFactoryInterface;
final class ParameterMergingLoaderFactory implements \ConfigTransformer202111019\Symplify\SymplifyKernel\Contract\Config\LoaderFactoryInterface
{
    /**
     * @param \Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder
     * @param string $currentWorkingDirectory
     */
    public function create($containerBuilder, $currentWorkingDirectory) : \ConfigTransformer202111019\Symfony\Component\Config\Loader\LoaderInterface
    {
