...
abstract class AbstractKernelTestCase extends \ConfigTransformer202110318\PHPUnit\Framework\TestCase
{
    ...
    protected function getService($type)
    {
        if (self::$container === null) {
            throw new \ConfigTransformer202110318\Symplify\SymplifyKernel\Exception\ShouldNotHappenException('First, create container with booKernel(KernelClass::class)');
        }
    ...
    {
        if (static::$kernel !== null && static::$kernel instanceof \ConfigTransformer202110318\Symfony\Component\HttpKernel\KernelInterface) {
