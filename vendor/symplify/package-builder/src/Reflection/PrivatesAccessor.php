...
use ConfigTransformer202208\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException;
use ConfigTransformer202208\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException;
/**
 * @api
