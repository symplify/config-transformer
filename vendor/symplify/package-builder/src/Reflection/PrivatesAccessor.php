...
use ConfigTransformerPrefix202302\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException;
use ConfigTransformerPrefix202302\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException;
/**
 * @api
