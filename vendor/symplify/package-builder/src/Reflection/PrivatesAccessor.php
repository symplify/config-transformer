...
use ConfigTransformer202205316\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException;
use ConfigTransformer202205316\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException;
/**
 * @api
...
final class PrivatesAccessor
{
    ...
    public function getPrivatePropertyOfClass(object $object, string $propertyName, string $valueClassName) : object
    {
        ...
        throw new \ConfigTransformer202205316\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException($errorMessage);
    }
    /**
     * @return mixed
     */
    ...
    private function resolvePropertyReflection(object $object, string $propertyName) : \ReflectionProperty
    {
        ...
        throw new \ConfigTransformer202205316\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException($errorMessage);
    }
}
