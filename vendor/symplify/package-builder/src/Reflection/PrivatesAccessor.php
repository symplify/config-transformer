...
use ConfigTransformer202212\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException;
use ConfigTransformer202212\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException;
/**
 * @api
