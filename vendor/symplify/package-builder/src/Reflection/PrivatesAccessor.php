...
use ConfigTransformerPrefix202310\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException;
use ConfigTransformerPrefix202310\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException;
/**
 * @api
