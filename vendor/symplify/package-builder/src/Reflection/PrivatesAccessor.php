...
use ConfigTransformer202211\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException;
use ConfigTransformer202211\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException;
/**
 * @api
