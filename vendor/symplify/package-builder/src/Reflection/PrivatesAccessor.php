...
use ConfigTransformer2021113010\Symplify\PHPStanRules\Exception\ShouldNotHappenException;
/**
 * @api
...
final class PrivatesAccessor
{
    ...
    private function resolvePropertyReflection($object, string $propertyName) : \ReflectionProperty
    {
        ...
        if ($parentClass === \false) {
            throw new \ConfigTransformer2021113010\Symplify\PHPStanRules\Exception\ShouldNotHappenException();
        }
