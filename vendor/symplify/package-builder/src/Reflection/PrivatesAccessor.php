...
use ConfigTransformerPrefix202301\Symplify\PackageBuilder\Exception\InvalidPrivatePropertyTypeException;
use ConfigTransformerPrefix202301\Symplify\PackageBuilder\Exception\MissingPrivatePropertyException;
/**
 * @api
