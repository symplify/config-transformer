...
abstract class AbstractSymplifyCommand extends \ConfigTransformer202206075\Symfony\Component\Console\Command\Command
{
    /**
    ...
    {
        parent::__construct();
        $this->addOption(\ConfigTransformer202206075\Symplify\PackageBuilder\ValueObject\Option::CONFIG, 'c', \ConfigTransformer202206075\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'Path to config file');
    }
    /**
     * @required
     */
    public function autowire(\ConfigTransformer202206075\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \ConfigTransformer202206075\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem, \ConfigTransformer202206075\Symplify\SmartFileSystem\Finder\SmartFinder $smartFinder, \ConfigTransformer202206075\Symplify\SmartFileSystem\FileSystemGuard $fileSystemGuard) : void
    {
