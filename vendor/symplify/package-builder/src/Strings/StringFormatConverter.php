...
namespace ConfigTransformer202205313\Symplify\PackageBuilder\Strings;
...
final class StringFormatConverter
{
    ...
    {
        $matches = \ConfigTransformer202205313\Nette\Utils\Strings::matchAll($input, self::BIG_LETTER_REGEX);
        $parts = [];
