...
namespace ConfigTransformer202203158\Symplify\PackageBuilder\Neon;

use ConfigTransformer202203158\Nette\Neon\Encoder;
use ConfigTransformer202203158\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \ConfigTransformer202203158\Nette\Neon\Neon::encode($phpStanNeon, \ConfigTransformer202203158\Nette\Neon\Encoder::BLOCK, '    ');
    ...
    {
        return \ConfigTransformer202203158\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \ConfigTransformer202203158\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
