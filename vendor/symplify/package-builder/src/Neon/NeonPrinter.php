...
namespace ConfigTransformer202201152\Symplify\PackageBuilder\Neon;

use ConfigTransformer202201152\Nette\Neon\Encoder;
use ConfigTransformer202201152\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \ConfigTransformer202201152\Nette\Neon\Neon::encode($phpStanNeon, \ConfigTransformer202201152\Nette\Neon\Encoder::BLOCK, '    ');
    ...
    {
        return \ConfigTransformer202201152\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \ConfigTransformer202201152\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
