...
namespace ConfigTransformer202112193\Symplify\PackageBuilder\Neon;

use ConfigTransformer202112193\Nette\Neon\Encoder;
use ConfigTransformer202112193\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \ConfigTransformer202112193\Nette\Neon\Neon::encode($phpStanNeon, \ConfigTransformer202112193\Nette\Neon\Encoder::BLOCK, '    ');
    ...
    {
        return \ConfigTransformer202112193\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \ConfigTransformer202112193\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
