...
namespace ConfigTransformer202111210\Symplify\PackageBuilder\Neon;

use ConfigTransformer202111210\Nette\Neon\Encoder;
use ConfigTransformer202111210\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \ConfigTransformer202111210\Nette\Neon\Neon::encode($phpStanNeon, \ConfigTransformer202111210\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \ConfigTransformer202111210\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \ConfigTransformer202111210\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \ConfigTransformer202111210\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
