...
namespace ConfigTransformer202112120\Symplify\PackageBuilder\Neon;

use ConfigTransformer202112120\Nette\Neon\Encoder;
use ConfigTransformer202112120\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \ConfigTransformer202112120\Nette\Neon\Neon::encode($phpStanNeon, \ConfigTransformer202112120\Nette\Neon\Encoder::BLOCK, '    ');
    ...
    {
        return \ConfigTransformer202112120\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \ConfigTransformer202112120\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
