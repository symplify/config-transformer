...
namespace ConfigTransformer2021083010\Symplify\PackageBuilder\Neon;

use ConfigTransformer2021083010\Nette\Neon\Encoder;
use ConfigTransformer2021083010\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \ConfigTransformer2021083010\Nette\Neon\Neon::encode($phpStanNeon, \ConfigTransformer2021083010\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \ConfigTransformer2021083010\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \ConfigTransformer2021083010\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \ConfigTransformer2021083010\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
