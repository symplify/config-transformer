...
namespace ConfigTransformer2022041410\Symplify\PackageBuilder\Neon;

use ConfigTransformer2022041410\Nette\Neon\Encoder;
use ConfigTransformer2022041410\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \ConfigTransformer2022041410\Nette\Neon\Neon::encode($phpStanNeon, \ConfigTransformer2022041410\Nette\Neon\Encoder::BLOCK, '    ');
    ...
    {
        return \ConfigTransformer2022041410\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \ConfigTransformer2022041410\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
