...
namespace ConfigTransformer20210606\Symplify\PackageBuilder\Neon;

use ConfigTransformer20210606\Nette\Neon\Encoder;
use ConfigTransformer20210606\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \ConfigTransformer20210606\Nette\Neon\Neon::encode($phpStanNeon, \ConfigTransformer20210606\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \ConfigTransformer20210606\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \ConfigTransformer20210606\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \ConfigTransformer20210606\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
