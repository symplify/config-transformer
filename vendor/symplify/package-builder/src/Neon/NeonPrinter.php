...
namespace ConfigTransformer202109285\Symplify\PackageBuilder\Neon;

use ConfigTransformer202109285\Nette\Neon\Encoder;
use ConfigTransformer202109285\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \ConfigTransformer202109285\Nette\Neon\Neon::encode($phpStanNeon, \ConfigTransformer202109285\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \ConfigTransformer202109285\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \ConfigTransformer202109285\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \ConfigTransformer202109285\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
