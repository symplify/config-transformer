...
namespace ConfigTransformer202107149\Symplify\PackageBuilder\Neon;

use ConfigTransformer202107149\Nette\Neon\Encoder;
use ConfigTransformer202107149\Nette\Neon\Neon;
...
final class NeonPrinter
{
    ...
    {
        $neonContent = \ConfigTransformer202107149\Nette\Neon\Neon::encode($phpStanNeon, \ConfigTransformer202107149\Nette\Neon\Encoder::BLOCK);
    ...
    {
        return \ConfigTransformer202107149\Nette\Utils\Strings::replace($neonContent, '#\\t#', '    ');
    }
    private function inlineSingleTags(string $neonContent) : string
    {
        return \ConfigTransformer202107149\Nette\Utils\Strings::replace($neonContent, self::TAGS_REGEX, 'tags: [$1]');
    }
    private function fixDoubleSpaceInArguments(string $neonContent) : string
    {
        return \ConfigTransformer202107149\Nette\Utils\Strings::replace($neonContent, self::ARGUMENTS_DOUBLE_SPACE_REGEX, '$1');
    }
}
