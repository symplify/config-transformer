...
final class SmartFinder
{
    ...
    public function __construct(\ConfigTransformer202205290\Symplify\SmartFileSystem\Finder\FinderSanitizer $finderSanitizer, \ConfigTransformer202205290\Symplify\SmartFileSystem\FileSystemFilter $fileSystemFilter)
    {
    ...
    public function find(array $directoriesOrFiles, string $name, array $excludedDirectories = []) : array
    {
        ...
        foreach ($files as $file) {
            $fileInfos[] = new \ConfigTransformer202205290\Symplify\SmartFileSystem\SmartFileInfo($file);
        }
        return $fileInfos;
    }
}
