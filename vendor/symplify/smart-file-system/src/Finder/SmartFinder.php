...
final class SmartFinder
{
    ...
    public function __construct(\ConfigTransformer202107112\Symplify\SmartFileSystem\Finder\FinderSanitizer $finderSanitizer, \ConfigTransformer202107112\Symplify\SmartFileSystem\FileSystemFilter $fileSystemFilter)
    {
    ...
    public function find(array $directoriesOrFiles, string $name, array $excludedDirectories = []) : array
    {
        ...
        foreach ($files as $file) {
            $fileInfos[] = new \ConfigTransformer202107112\Symplify\SmartFileSystem\SmartFileInfo($file);
        }
        return $fileInfos;
    }
}
