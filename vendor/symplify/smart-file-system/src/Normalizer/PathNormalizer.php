...
namespace ConfigTransformer202203163\Symplify\SmartFileSystem\Normalizer;
...
final class PathNormalizer
{
    ...
    public function normalizePath(string $originalPath) : string
    {
        ...
        $matches = \ConfigTransformer202203163\Nette\Utils\Strings::match($originalPath, self::SCHEME_PATH_REGEX);
        if ($matches !== null) {
            [, $scheme, $path] = $matches;
        } else {
        ...
        $path = \ConfigTransformer202203163\Nette\Utils\Strings::replace($normalizedPath, self::TWO_AND_MORE_SLASHES_REGEX, '/');
