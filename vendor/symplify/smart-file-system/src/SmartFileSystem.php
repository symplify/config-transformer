 ...
 */
final class SmartFileSystem extends \ConfigTransformer202111233\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile($filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \ConfigTransformer202111233\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    /**
     * @param string $filename
     */
    public function readFileToSmartFileInfo($filename) : \ConfigTransformer202111233\Symplify\SmartFileSystem\SmartFileInfo
    {
        return new \ConfigTransformer202111233\Symplify\SmartFileSystem\SmartFileInfo($filename);
    }
    /**
    ...
    private function getLastError() : string
    {
        ...
        return \ConfigTransformer202111233\Nette\Utils\Strings::replace($htmlMessage, self::BEFORE_COLLON_REGEX, '');
    }
}
