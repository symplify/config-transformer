 ...
 */
final class SmartFileSystem extends \ConfigTransformer2021062210\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile(string $filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \ConfigTransformer2021062210\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    public function readFileToSmartFileInfo(string $filename) : \ConfigTransformer2021062210\Symplify\SmartFileSystem\SmartFileInfo
    {
        return new \ConfigTransformer2021062210\Symplify\SmartFileSystem\SmartFileInfo($filename);
    }
    /**
    ...
    private function getLastError() : string
    {
        ...
        return \ConfigTransformer2021062210\Nette\Utils\Strings::replace($message, self::BEFORE_COLLON_REGEX, '');
    }
}
