 ...
 */
final class SmartFileSystem extends \ConfigTransformer202108222\Symfony\Component\Filesystem\Filesystem
{
    /**
     * @var string
    ...
    public function readFile($filename) : string
    {
        ...
        if (!$source) {
            ...
            throw new \ConfigTransformer202108222\Symfony\Component\Filesystem\Exception\IOException($message, 0, null, $filename);
        }
        return $source;
    }
    /**
     * @param string $filename
     */
    public function readFileToSmartFileInfo($filename) : \ConfigTransformer202108222\Symplify\SmartFileSystem\SmartFileInfo
    {
        return new \ConfigTransformer202108222\Symplify\SmartFileSystem\SmartFileInfo($filename);
    }
    /**
    ...
    private function getLastError() : string
    {
        ...
        return \ConfigTransformer202108222\Nette\Utils\Strings::replace($htmlMessage, self::BEFORE_COLLON_REGEX, '');
    }
}
