...
namespace ConfigTransformer202205120\Symplify\ComposerJsonManipulator\Printer;
...
final class ComposerJsonPrinter
{
    ...
    public function printToString(\ConfigTransformer202205120\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : string
    {
     ...
     */
    public function print(\ConfigTransformer202205120\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, $targetFile) : string
    {
