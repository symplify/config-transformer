...
namespace ConfigTransformer202112060\Symplify\ComposerJsonManipulator\Printer;
...
final class ComposerJsonPrinter
{
    ...
    public function printToString(\ConfigTransformer202112060\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : string
    {
     ...
     */
    public function print(\ConfigTransformer202112060\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, $targetFile) : string
    {
