...
namespace ConfigTransformer202111019\Symplify\ComposerJsonManipulator\Printer;
...
final class ComposerJsonPrinter
{
    ...
    public function printToString(\ConfigTransformer202111019\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson) : string
    {
     ...
     */
    public function print(\ConfigTransformer202111019\Symplify\ComposerJsonManipulator\ValueObject\ComposerJson $composerJson, $targetFile) : string
    {
