...
use ConfigTransformer202106115\Symplify\EasyTesting\Console\EasyTestingConsoleApplication;
...
return static function (\ConfigTransformer202106115\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('ConfigTransformer202106115\Symplify\EasyTesting\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/DataProvider', __DIR__ . '/../src/HttpKernel', __DIR__ . '/../src/ValueObject']);
    // console
    $services->set(\ConfigTransformer202106115\Symplify\EasyTesting\Console\EasyTestingConsoleApplication::class);
    $services->alias(\ConfigTransformer202106115\Symfony\Component\Console\Application::class, \ConfigTransformer202106115\Symplify\EasyTesting\Console\EasyTestingConsoleApplication::class);
