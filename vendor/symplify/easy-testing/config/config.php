...
use ConfigTransformer202107038\Symplify\EasyTesting\Console\EasyTestingConsoleApplication;
...
return static function (\ConfigTransformer202107038\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('ConfigTransformer202107038\Symplify\EasyTesting\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/DataProvider', __DIR__ . '/../src/HttpKernel', __DIR__ . '/../src/ValueObject']);
    // console
    $services->set(\ConfigTransformer202107038\Symplify\EasyTesting\Console\EasyTestingConsoleApplication::class);
    $services->alias(\ConfigTransformer202107038\Symfony\Component\Console\Application::class, \ConfigTransformer202107038\Symplify\EasyTesting\Console\EasyTestingConsoleApplication::class);
