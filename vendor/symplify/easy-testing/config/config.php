...
use ConfigTransformer202106114\Symplify\EasyTesting\Console\EasyTestingConsoleApplication;
...
return static function (\ConfigTransformer202106114\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('ConfigTransformer202106114\Symplify\EasyTesting\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/DataProvider', __DIR__ . '/../src/HttpKernel', __DIR__ . '/../src/ValueObject']);
    // console
    $services->set(\ConfigTransformer202106114\Symplify\EasyTesting\Console\EasyTestingConsoleApplication::class);
    $services->alias(\ConfigTransformer202106114\Symfony\Component\Console\Application::class, \ConfigTransformer202106114\Symplify\EasyTesting\Console\EasyTestingConsoleApplication::class);
