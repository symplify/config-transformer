...
use ConfigTransformer2021062210\Symplify\EasyTesting\Console\EasyTestingConsoleApplication;
...
return static function (\ConfigTransformer2021062210\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('ConfigTransformer2021062210\Symplify\EasyTesting\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/DataProvider', __DIR__ . '/../src/HttpKernel', __DIR__ . '/../src/ValueObject']);
    // console
    $services->set(\ConfigTransformer2021062210\Symplify\EasyTesting\Console\EasyTestingConsoleApplication::class);
    $services->alias(\ConfigTransformer2021062210\Symfony\Component\Console\Application::class, \ConfigTransformer2021062210\Symplify\EasyTesting\Console\EasyTestingConsoleApplication::class);
