...
namespace ConfigTransformer202205120\Symplify\EasyTesting\Command;
...
use ConfigTransformer202205120\Symplify\EasyTesting\Finder\FixtureFinder;
use ConfigTransformer202205120\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use ConfigTransformer202205120\Symplify\EasyTesting\ValueObject\Option;
use ConfigTransformer202205120\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
final class ValidateFixtureSkipNamingCommand extends \ConfigTransformer202205120\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\ConfigTransformer202205120\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \ConfigTransformer202205120\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\ConfigTransformer202205120\Symplify\EasyTesting\ValueObject\Option::SOURCE, \ConfigTransformer202205120\Symfony\Component\Console\Input\InputArgument::REQUIRED | \ConfigTransformer202205120\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\ConfigTransformer202205120\Symplify\EasyTesting\ValueObject\Option::SOURCE);
