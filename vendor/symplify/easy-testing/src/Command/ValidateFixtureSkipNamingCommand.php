...
namespace ConfigTransformer202106181\Symplify\EasyTesting\Command;
...
use ConfigTransformer202106181\Symplify\EasyTesting\Finder\FixtureFinder;
use ConfigTransformer202106181\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use ConfigTransformer202106181\Symplify\EasyTesting\ValueObject\Option;
...
final class ValidateFixtureSkipNamingCommand extends \ConfigTransformer202106181\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\ConfigTransformer202106181\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \ConfigTransformer202106181\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    {
        $this->addArgument(\ConfigTransformer202106181\Symplify\EasyTesting\ValueObject\Option::SOURCE, \ConfigTransformer202106181\Symfony\Component\Console\Input\InputArgument::REQUIRED | \ConfigTransformer202106181\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\ConfigTransformer202106181\Symplify\EasyTesting\ValueObject\Option::SOURCE);
        ...
        return \ConfigTransformer202106181\Symplify\PackageBuilder\Console\ShellCode::ERROR;
    }
}
