...
namespace ConfigTransformer202107276\Symplify\EasyTesting\Command;
...
use ConfigTransformer202107276\Symplify\EasyTesting\Finder\FixtureFinder;
use ConfigTransformer202107276\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use ConfigTransformer202107276\Symplify\EasyTesting\ValueObject\Option;
...
final class ValidateFixtureSkipNamingCommand extends \ConfigTransformer202107276\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\ConfigTransformer202107276\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \ConfigTransformer202107276\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    {
        $this->addArgument(\ConfigTransformer202107276\Symplify\EasyTesting\ValueObject\Option::SOURCE, \ConfigTransformer202107276\Symfony\Component\Console\Input\InputArgument::REQUIRED | \ConfigTransformer202107276\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\ConfigTransformer202107276\Symplify\EasyTesting\ValueObject\Option::SOURCE);
        ...
        return \ConfigTransformer202107276\Symplify\PackageBuilder\Console\ShellCode::ERROR;
    }
}
