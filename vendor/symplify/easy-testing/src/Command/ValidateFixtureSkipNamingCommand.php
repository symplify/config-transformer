...
namespace ConfigTransformer202201245\Symplify\EasyTesting\Command;
...
use ConfigTransformer202201245\Symplify\EasyTesting\Finder\FixtureFinder;
use ConfigTransformer202201245\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use ConfigTransformer202201245\Symplify\EasyTesting\ValueObject\Option;
use ConfigTransformer202201245\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
final class ValidateFixtureSkipNamingCommand extends \ConfigTransformer202201245\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\ConfigTransformer202201245\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \ConfigTransformer202201245\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\ConfigTransformer202201245\Symplify\EasyTesting\ValueObject\Option::SOURCE, \ConfigTransformer202201245\Symfony\Component\Console\Input\InputArgument::REQUIRED | \ConfigTransformer202201245\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\ConfigTransformer202201245\Symplify\EasyTesting\ValueObject\Option::SOURCE);
