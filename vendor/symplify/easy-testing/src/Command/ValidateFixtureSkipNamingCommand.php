...
namespace ConfigTransformer202108250\Symplify\EasyTesting\Command;
...
use ConfigTransformer202108250\Symplify\EasyTesting\Finder\FixtureFinder;
use ConfigTransformer202108250\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use ConfigTransformer202108250\Symplify\EasyTesting\ValueObject\Option;
use ConfigTransformer202108250\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
final class ValidateFixtureSkipNamingCommand extends \ConfigTransformer202108250\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\ConfigTransformer202108250\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \ConfigTransformer202108250\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    {
        $this->addArgument(\ConfigTransformer202108250\Symplify\EasyTesting\ValueObject\Option::SOURCE, \ConfigTransformer202108250\Symfony\Component\Console\Input\InputArgument::REQUIRED | \ConfigTransformer202108250\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\ConfigTransformer202108250\Symplify\EasyTesting\ValueObject\Option::SOURCE);
