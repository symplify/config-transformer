...
namespace ConfigTransformer202112105\Symplify\EasyTesting\Command;
...
use ConfigTransformer202112105\Symplify\EasyTesting\Finder\FixtureFinder;
use ConfigTransformer202112105\Symplify\EasyTesting\MissplacedSkipPrefixResolver;
use ConfigTransformer202112105\Symplify\EasyTesting\ValueObject\Option;
use ConfigTransformer202112105\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand;
final class ValidateFixtureSkipNamingCommand extends \ConfigTransformer202112105\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\ConfigTransformer202112105\Symplify\EasyTesting\MissplacedSkipPrefixResolver $missplacedSkipPrefixResolver, \ConfigTransformer202112105\Symplify\EasyTesting\Finder\FixtureFinder $fixtureFinder)
    {
    ...
    protected function configure() : void
    {
        ...
        $this->addArgument(\ConfigTransformer202112105\Symplify\EasyTesting\ValueObject\Option::SOURCE, \ConfigTransformer202112105\Symfony\Component\Console\Input\InputArgument::REQUIRED | \ConfigTransformer202112105\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Paths to analyse');
    ...
    {
        $source = (array) $input->getArgument(\ConfigTransformer202112105\Symplify\EasyTesting\ValueObject\Option::SOURCE);
