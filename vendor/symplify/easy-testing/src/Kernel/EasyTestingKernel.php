...
namespace ConfigTransformer202111019\Symplify\EasyTesting\Kernel;

use ConfigTransformer202111019\Psr\Container\ContainerInterface;
use ConfigTransformer202111019\Symplify\EasyTesting\ValueObject\EasyTestingConfig;
...
final class EasyTestingKernel extends \ConfigTransformer202111019\Symplify\SymplifyKernel\HttpKernel\AbstractSymplifyKernel
{
    ...
    {
        $configFiles[] = \ConfigTransformer202111019\Symplify\EasyTesting\ValueObject\EasyTestingConfig::FILE_PATH;
