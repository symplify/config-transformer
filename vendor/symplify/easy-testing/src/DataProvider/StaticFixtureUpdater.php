...
final class StaticFixtureUpdater
{
     ...
     */
    public static function updateFixtureContent($originalFileInfo, string $changedContent, \ConfigTransformer2021120210\Symplify\SmartFileSystem\SmartFileInfo $fixtureFileInfo) : void
    {
    ...
    public static function updateExpectedFixtureContent(string $newOriginalContent, \ConfigTransformer2021120210\Symplify\SmartFileSystem\SmartFileInfo $expectedFixtureFileInfo) : void
    {
        if (!\getenv('UPDATE_TESTS') && !\getenv('UT')) {
            return;
        }
    ...
    private static function getSmartFileSystem() : \ConfigTransformer2021120210\Symplify\SmartFileSystem\SmartFileSystem
    {
        return new \ConfigTransformer2021120210\Symplify\SmartFileSystem\SmartFileSystem();
    }
    /**
     * @param \Symplify\SmartFileSystem\SmartFileInfo|string $originalFileInfo
     */
    ...
    {
        if ($originalFileInfo instanceof \ConfigTransformer2021120210\Symplify\SmartFileSystem\SmartFileInfo) {
