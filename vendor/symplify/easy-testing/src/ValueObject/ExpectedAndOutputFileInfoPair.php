...
final class ExpectedAndOutputFileInfoPair
{
    ...
    public function __construct(\ConfigTransformer202202198\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, ?\ConfigTransformer202202198\Symplify\SmartFileSystem\SmartFileInfo $outputFileInfo)
    {
    ...
    {
        if (!$this->outputFileInfo instanceof \ConfigTransformer202202198\Symplify\SmartFileSystem\SmartFileInfo) {
