...
final class ExpectedAndOutputFileInfoPair
{
    ...
    public function __construct(\ConfigTransformer202109187\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, ?\ConfigTransformer202109187\Symplify\SmartFileSystem\SmartFileInfo $outputFileInfo)
    {
    ...
    {
        if (!$this->outputFileInfo instanceof \ConfigTransformer202109187\Symplify\SmartFileSystem\SmartFileInfo) {
