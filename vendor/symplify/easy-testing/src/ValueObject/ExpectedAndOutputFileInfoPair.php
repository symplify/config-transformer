...
final class ExpectedAndOutputFileInfoPair
{
    ...
    public function __construct(\ConfigTransformer202111268\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, ?\ConfigTransformer202111268\Symplify\SmartFileSystem\SmartFileInfo $outputFileInfo)
    {
    ...
    {
        if (!$this->outputFileInfo instanceof \ConfigTransformer202111268\Symplify\SmartFileSystem\SmartFileInfo) {
