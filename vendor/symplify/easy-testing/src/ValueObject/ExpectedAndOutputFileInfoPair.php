...
final class ExpectedAndOutputFileInfoPair
{
    ...
    public function __construct(\ConfigTransformer2021112210\Symplify\SmartFileSystem\SmartFileInfo $expectedFileInfo, ?\ConfigTransformer2021112210\Symplify\SmartFileSystem\SmartFileInfo $outputFileInfo)
    {
    ...
    {
        if (!$this->outputFileInfo instanceof \ConfigTransformer2021112210\Symplify\SmartFileSystem\SmartFileInfo) {
