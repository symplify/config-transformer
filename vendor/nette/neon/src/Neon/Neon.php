...
final class Neon
{
    public const BLOCK = \ConfigTransformer202110311\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \ConfigTransformer202110311\Nette\Neon\Encoder();
    ...
    public static function decode(string $input)
    {
        ...
        $decoder = new \ConfigTransformer202110311\Nette\Neon\Decoder();
