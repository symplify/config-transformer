...
final class Neon
{
    public const BLOCK = \ConfigTransformer2022010310\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \ConfigTransformer2022010310\Nette\Neon\Encoder();
    ...
    {
        $decoder = new \ConfigTransformer2022010310\Nette\Neon\Decoder();
    ...
    {
        if (!\is_file($file)) {
            throw new \ConfigTransformer2022010310\Nette\Neon\Exception("File '{$file}' does not exist.");
        }
