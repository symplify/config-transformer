...
final class Neon
{
    public const BLOCK = \ConfigTransformer202111047\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \ConfigTransformer202111047\Nette\Neon\Encoder();
    ...
    public static function decode(string $input)
    {
        ...
        $decoder = new \ConfigTransformer202111047\Nette\Neon\Decoder();
