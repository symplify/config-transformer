...
final class Neon
{
    public const BLOCK = \ConfigTransformer2021110310\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \ConfigTransformer2021110310\Nette\Neon\Encoder();
    ...
    public static function decode(string $input)
    {
        ...
        $decoder = new \ConfigTransformer2021110310\Nette\Neon\Decoder();
