...
final class Neon
{
    public const BLOCK = \ConfigTransformer202112303\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \ConfigTransformer202112303\Nette\Neon\Encoder();
    ...
    {
        $decoder = new \ConfigTransformer202112303\Nette\Neon\Decoder();
    ...
    {
        if (!\is_file($file)) {
            throw new \ConfigTransformer202112303\Nette\Neon\Exception("File '{$file}' does not exist.");
        }
