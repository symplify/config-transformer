...
final class Neon
{
    public const BLOCK = \ConfigTransformer202111267\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \ConfigTransformer202111267\Nette\Neon\Encoder();
    ...
    {
        $decoder = new \ConfigTransformer202111267\Nette\Neon\Decoder();
    ...
    {
        if (!\is_file($file)) {
            throw new \ConfigTransformer202111267\Nette\Neon\Exception("File '{$file}' does not exist.");
        }
