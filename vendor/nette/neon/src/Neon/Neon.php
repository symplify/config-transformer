...
final class Neon
{
    public const BLOCK = \ConfigTransformer202201075\Nette\Neon\Encoder::BLOCK;
    ...
    {
        $encoder = new \ConfigTransformer202201075\Nette\Neon\Encoder();
    ...
    {
        $decoder = new \ConfigTransformer202201075\Nette\Neon\Decoder();
    ...
    {
        if (!\is_file($file)) {
            throw new \ConfigTransformer202201075\Nette\Neon\Exception("File '{$file}' does not exist.");
        }
