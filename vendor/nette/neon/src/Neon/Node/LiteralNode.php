...
namespace ConfigTransformer202111015\Nette\Neon\Node;

use ConfigTransformer202111015\Nette\Neon\Node;
/** @internal */
final class LiteralNode extends \ConfigTransformer202111015\Nette\Neon\Node
{
    /** @var mixed */
    public $value;
