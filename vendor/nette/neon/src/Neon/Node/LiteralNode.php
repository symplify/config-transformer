...
namespace ConfigTransformer202110212\Nette\Neon\Node;

use ConfigTransformer202110212\Nette\Neon\Node;
/** @internal */
final class LiteralNode extends \ConfigTransformer202110212\Nette\Neon\Node
{
    /** @var mixed */
    public $value;
