...
namespace ConfigTransformer202111021\Nette\Neon\Node;

use ConfigTransformer202111021\Nette\Neon\Node;
/** @internal */
final class LiteralNode extends \ConfigTransformer202111021\Nette\Neon\Node
{
    /** @var mixed */
    public $value;
