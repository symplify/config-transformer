...
namespace ConfigTransformer202111047\Nette\Neon\Node;

use ConfigTransformer202111047\Nette\Neon\Node;
/** @internal */
final class LiteralNode extends \ConfigTransformer202111047\Nette\Neon\Node
{
    /** @var mixed */
    public $value;
