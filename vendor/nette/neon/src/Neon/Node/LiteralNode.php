...
namespace ConfigTransformer202111026\Nette\Neon\Node;

use ConfigTransformer202111026\Nette\Neon\Node;
/** @internal */
final class LiteralNode extends \ConfigTransformer202111026\Nette\Neon\Node
{
    /** @var mixed */
    public $value;
