...
namespace ConfigTransformer2021110410\Nette\Neon\Node;

use ConfigTransformer2021110410\Nette\Neon\Node;
/** @internal */
final class LiteralNode extends \ConfigTransformer2021110410\Nette\Neon\Node
{
    /** @var mixed */
    public $value;
