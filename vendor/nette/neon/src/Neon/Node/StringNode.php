...
/** @internal */
final class StringNode extends \ConfigTransformer202111029\Nette\Neon\Node
{
    /** @var string */
    public $value;
    ...
    public function toString() : string
    {
        ...
        if ($res === \false) {
            throw new \ConfigTransformer202111029\Nette\Neon\Exception('Invalid UTF-8 sequence: ' . $this->value);
        }
