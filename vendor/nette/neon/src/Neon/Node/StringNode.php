...
/** @internal */
final class StringNode extends \ConfigTransformer2021110310\Nette\Neon\Node
{
    /** @var string */
    public $value;
    ...
    public function toString() : string
    {
        ...
        if ($res === \false) {
            throw new \ConfigTransformer2021110310\Nette\Neon\Exception('Invalid UTF-8 sequence: ' . $this->value);
        }
