...
use ConfigTransformer202201167\Nette\Neon;
use ConfigTransformer202201167\Nette\Neon\Node;
/** @internal */
final class EntityChainNode extends \ConfigTransformer202201167\Nette\Neon\Node
{
    /** @var EntityNode[] */
    public $chain = [];
    ...
    public function toValue() : \ConfigTransformer202201167\Nette\Neon\Entity
    {
        ...
        return new \ConfigTransformer202201167\Nette\Neon\Entity(\ConfigTransformer202201167\Nette\Neon\Neon::CHAIN, $entities);
    }
