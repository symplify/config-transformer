...
use ConfigTransformer202110205\Nette\Neon;
use ConfigTransformer202110205\Nette\Neon\Node;
/** @internal */
final class EntityChainNode extends \ConfigTransformer202110205\Nette\Neon\Node
{
    /** @var EntityNode[] */
    public $chain = [];
    ...
    public function toValue() : \ConfigTransformer202110205\Nette\Neon\Entity
    {
        ...
        return new \ConfigTransformer202110205\Nette\Neon\Entity(\ConfigTransformer202110205\Nette\Neon\Neon::CHAIN, $entities);
    }
