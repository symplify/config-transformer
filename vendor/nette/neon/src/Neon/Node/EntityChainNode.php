...
use ConfigTransformer202111248\Nette\Neon;
use ConfigTransformer202111248\Nette\Neon\Node;
/** @internal */
final class EntityChainNode extends \ConfigTransformer202111248\Nette\Neon\Node
{
    /** @var EntityNode[] */
    public $chain = [];
    ...
    public function toValue() : \ConfigTransformer202111248\Nette\Neon\Entity
    {
        ...
        return new \ConfigTransformer202111248\Nette\Neon\Entity(\ConfigTransformer202111248\Nette\Neon\Neon::CHAIN, $entities);
    }
