...
class Helpers
{
    ...
    public static function getLastError() : string
    {
        ...
        $message = \ini_get('html_errors') ? \ConfigTransformer202203032\Nette\Utils\Html::htmlToText($message) : $message;
    ...
    {
        if ($min > $max) {
            throw new \ConfigTransformer202203032\Nette\InvalidArgumentException("Minimum ({$min}) is not less than maximum ({$max}).");
        }
