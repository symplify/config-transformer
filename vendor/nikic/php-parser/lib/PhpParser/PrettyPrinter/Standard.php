...
namespace ConfigTransformer202107102\PhpParser\PrettyPrinter;

use ConfigTransformer202107102\PhpParser\Node;
use ConfigTransformer202107102\PhpParser\Node\Expr;
...
use ConfigTransformer202107102\PhpParser\Node\Name;
use ConfigTransformer202107102\PhpParser\Node\Scalar;
use ConfigTransformer202107102\PhpParser\Node\Scalar\MagicConst;
use ConfigTransformer202107102\PhpParser\Node\Stmt;
use ConfigTransformer202107102\PhpParser\PrettyPrinterAbstract;
class Standard extends \ConfigTransformer202107102\PhpParser\PrettyPrinterAbstract
{
    // Special nodes
    /**
    ...
    {
        $kind = $node->getAttribute('kind', \ConfigTransformer202107102\PhpParser\Node\Scalar\String_::KIND_SINGLE_QUOTED);
        switch ($kind) {
            case \ConfigTransformer202107102\PhpParser\Node\Scalar\String_::KIND_NOWDOC:
            ...
            case \ConfigTransformer202107102\PhpParser\Node\Scalar\String_::KIND_SINGLE_QUOTED:
                return $this->pSingleQuotedString($node->value);
            case \ConfigTransformer202107102\PhpParser\Node\Scalar\String_::KIND_HEREDOC:
                $label = $node->getAttribute('docLabel');
                if ($label && !$this->containsEndLabel($node->value, $label)) {
                    if ($node->value === '') {
                        return "<<<{$label}\n{$label}" . $this->docStringEndToken;
            ...
            /* break missing intentionally */
            case \ConfigTransformer202107102\PhpParser\Node\Scalar\String_::KIND_DOUBLE_QUOTED:
    ...
    {
        if ($node->getAttribute('kind') === \ConfigTransformer202107102\PhpParser\Node\Scalar\String_::KIND_HEREDOC) {
            $label = $node->getAttribute('docLabel');
            if ($label && !$this->encapsedContainsEndLabel($node->parts, $label)) {
                if (\count($node->parts) === 1 && $node->parts[0] instanceof \ConfigTransformer202107102\PhpParser\Node\Scalar\EncapsedStringPart && $node->parts[0]->value === '') {
                    return "<<<{$label}\n{$label}" . $this->docStringEndToken;
                }
    ...
    protected function pScalar_LNumber($node)
    {
        ...
        $kind = $node->getAttribute('kind', \ConfigTransformer202107102\PhpParser\Node\Scalar\LNumber::KIND_DEC);
        if (\ConfigTransformer202107102\PhpParser\Node\Scalar\LNumber::KIND_DEC === $kind) {
        ...
        switch ($kind) {
            case \ConfigTransformer202107102\PhpParser\Node\Scalar\LNumber::KIND_BIN:
                return $sign . '0b' . \base_convert($str, 10, 2);
            case \ConfigTransformer202107102\PhpParser\Node\Scalar\LNumber::KIND_OCT:
                return $sign . '0' . \base_convert($str, 10, 8);
            case \ConfigTransformer202107102\PhpParser\Node\Scalar\LNumber::KIND_HEX:
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\Assign::class, $node->var, ' = ', $node->expr);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\AssignRef::class, $node->var, ' =& ', $node->expr);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\AssignOp\Plus::class, $node->var, ' += ', $node->expr);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\AssignOp\Minus::class, $node->var, ' -= ', $node->expr);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\AssignOp\Mul::class, $node->var, ' *= ', $node->expr);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\AssignOp\Div::class, $node->var, ' /= ', $node->expr);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\AssignOp\Concat::class, $node->var, ' .= ', $node->expr);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\AssignOp\Mod::class, $node->var, ' %= ', $node->expr);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\AssignOp\BitwiseAnd::class, $node->var, ' &= ', $node->expr);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\AssignOp\BitwiseOr::class, $node->var, ' |= ', $node->expr);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\AssignOp\BitwiseXor::class, $node->var, ' ^= ', $node->expr);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\AssignOp\ShiftLeft::class, $node->var, ' <<= ', $node->expr);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\AssignOp\ShiftRight::class, $node->var, ' >>= ', $node->expr);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\AssignOp\Pow::class, $node->var, ' **= ', $node->expr);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\AssignOp\Coalesce::class, $node->var, ' ??= ', $node->expr);
    }
    // Binary expressions
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\Plus::class, $node->left, ' + ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\Minus::class, $node->left, ' - ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\Mul::class, $node->left, ' * ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\Div::class, $node->left, ' / ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\Concat::class, $node->left, ' . ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\Mod::class, $node->left, ' % ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\BooleanAnd::class, $node->left, ' && ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\BooleanOr::class, $node->left, ' || ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\BitwiseAnd::class, $node->left, ' & ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\BitwiseOr::class, $node->left, ' | ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\BitwiseXor::class, $node->left, ' ^ ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\ShiftLeft::class, $node->left, ' << ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\ShiftRight::class, $node->left, ' >> ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\Pow::class, $node->left, ' ** ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\LogicalAnd::class, $node->left, ' and ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\LogicalOr::class, $node->left, ' or ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\LogicalXor::class, $node->left, ' xor ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\Equal::class, $node->left, ' == ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\NotEqual::class, $node->left, ' != ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\Identical::class, $node->left, ' === ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\NotIdentical::class, $node->left, ' !== ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\Spaceship::class, $node->left, ' <=> ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\Greater::class, $node->left, ' > ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\GreaterOrEqual::class, $node->left, ' >= ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\Smaller::class, $node->left, ' < ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\SmallerOrEqual::class, $node->left, ' <= ', $node->right);
    }
    /**
    ...
    {
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BinaryOp\Coalesce::class, $node->left, ' ?? ', $node->right);
    }
    /**
    ...
    {
        list($precedence, $associativity) = $this->precedenceMap[\ConfigTransformer202107102\PhpParser\Node\Expr\Instanceof_::class];
    ...
    {
        return $this->pPrefixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BooleanNot::class, '!', $node->expr);
    }
    /**
    ...
    {
        return $this->pPrefixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\BitwiseNot::class, '~', $node->expr);
    }
    /**
    ...
    {
        if ($node->expr instanceof \ConfigTransformer202107102\PhpParser\Node\Expr\UnaryMinus || $node->expr instanceof \ConfigTransformer202107102\PhpParser\Node\Expr\PreDec) {
            // Enforce -(-$expr) instead of --$expr
            return '-(' . $this->p($node->expr) . ')';
        }
        return $this->pPrefixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\UnaryMinus::class, '-', $node->expr);
    }
    /**
    ...
    {
        if ($node->expr instanceof \ConfigTransformer202107102\PhpParser\Node\Expr\UnaryPlus || $node->expr instanceof \ConfigTransformer202107102\PhpParser\Node\Expr\PreInc) {
            // Enforce +(+$expr) instead of ++$expr
            return '+(' . $this->p($node->expr) . ')';
        }
        return $this->pPrefixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\UnaryPlus::class, '+', $node->expr);
    }
    /**
    ...
    {
        return $this->pPrefixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\PreInc::class, '++', $node->var);
    }
    /**
    ...
    {
        return $this->pPrefixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\PreDec::class, '--', $node->var);
    }
    /**
    ...
    {
        return $this->pPostfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\PostInc::class, $node->var, '++');
    }
    /**
    ...
    {
        return $this->pPostfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\PostDec::class, $node->var, '--');
    }
    /**
    ...
    {
        return $this->pPrefixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\ErrorSuppress::class, '@', $node->expr);
    }
    /**
    ...
    {
        return $this->pPrefixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\YieldFrom::class, 'yield from ', $node->expr);
    }
    /**
    ...
    {
        return $this->pPrefixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\Print_::class, 'print ', $node->expr);
    }
    // Casts
    /**
    ...
    {
        return $this->pPrefixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\Cast\Int_::class, '(int) ', $node->expr);
    }
    /**
    ...
    {
        $kind = $node->getAttribute('kind', \ConfigTransformer202107102\PhpParser\Node\Expr\Cast\Double::KIND_DOUBLE);
        if ($kind === \ConfigTransformer202107102\PhpParser\Node\Expr\Cast\Double::KIND_DOUBLE) {
            $cast = '(double)';
        } elseif ($kind === \ConfigTransformer202107102\PhpParser\Node\Expr\Cast\Double::KIND_FLOAT) {
            $cast = '(float)';
        } elseif ($kind === \ConfigTransformer202107102\PhpParser\Node\Expr\Cast\Double::KIND_REAL) {
            $cast = '(real)';
        }
        return $this->pPrefixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\Cast\Double::class, $cast . ' ', $node->expr);
    }
    /**
    ...
    {
        return $this->pPrefixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\Cast\String_::class, '(string) ', $node->expr);
    }
    /**
    ...
    {
        return $this->pPrefixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\Cast\Array_::class, '(array) ', $node->expr);
    }
    /**
    ...
    {
        return $this->pPrefixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\Cast\Object_::class, '(object) ', $node->expr);
    }
    /**
    ...
    {
        return $this->pPrefixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\Cast\Bool_::class, '(bool) ', $node->expr);
    }
    /**
    ...
    {
        return $this->pPrefixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\Cast\Unset_::class, '(unset) ', $node->expr);
    }
    ...
    {
        return $this->pDereferenceLhs($node->class) . '::' . ($node->name instanceof \ConfigTransformer202107102\PhpParser\Node\Expr ? $node->name instanceof \ConfigTransformer202107102\PhpParser\Node\Expr\Variable ? $this->p($node->name) : '{' . $this->p($node->name) . '}' : $node->name) . '(' . $this->pMaybeMultiline($node->args) . ')';
    }
    /**
    ...
    {
        static $map = [\ConfigTransformer202107102\PhpParser\Node\Expr\Include_::TYPE_INCLUDE => 'include', \ConfigTransformer202107102\PhpParser\Node\Expr\Include_::TYPE_INCLUDE_ONCE => 'include_once', \ConfigTransformer202107102\PhpParser\Node\Expr\Include_::TYPE_REQUIRE => 'require', \ConfigTransformer202107102\PhpParser\Node\Expr\Include_::TYPE_REQUIRE_ONCE => 'require_once'];
    ...
    {
        if ($node->name instanceof \ConfigTransformer202107102\PhpParser\Node\Expr) {
    ...
    {
        $syntax = $node->getAttribute('kind', $this->options['shortArraySyntax'] ? \ConfigTransformer202107102\PhpParser\Node\Expr\Array_::KIND_SHORT : \ConfigTransformer202107102\PhpParser\Node\Expr\Array_::KIND_LONG);
        if ($syntax === \ConfigTransformer202107102\PhpParser\Node\Expr\Array_::KIND_SHORT) {
    ...
    {
        if ($node->class instanceof \ConfigTransformer202107102\PhpParser\Node\Stmt\Class_) {
    ...
    protected function pExpr_Ternary($node)
    {
        ...
        return $this->pInfixOp(\ConfigTransformer202107102\PhpParser\Node\Expr\Ternary::class, $node->cond, ' ?' . (null !== $node->if ? ' ' . $this->p($node->if) . ' ' : '') . ': ', $node->else);
    }
    /**
    ...
    {
        $kind = $node->getAttribute('kind', \ConfigTransformer202107102\PhpParser\Node\Expr\Exit_::KIND_DIE);
        return ($kind === \ConfigTransformer202107102\PhpParser\Node\Expr\Exit_::KIND_EXIT ? 'exit' : 'die') . (null !== $node->expr ? '(' . $this->p($node->expr) . ')' : '');
    }
    /**
    ...
    {
        return $type === \ConfigTransformer202107102\PhpParser\Node\Stmt\Use_::TYPE_FUNCTION ? 'function ' : ($type === \ConfigTransformer202107102\PhpParser\Node\Stmt\Use_::TYPE_CONSTANT ? 'const ' : '');
    }
    /**
    ...
    {
        if ($node instanceof \ConfigTransformer202107102\PhpParser\Node\Expr) {
            return '{' . $this->p($node) . '}';
        } else {
            return $node;
        }
    ...
    protected function pEncapsList($encapsList, $quote)
    {
        ...
        foreach ($encapsList as $element) {
            if ($element instanceof \ConfigTransformer202107102\PhpParser\Node\Scalar\EncapsedStringPart) {
    ...
    protected function encapsedContainsEndLabel($parts, $label)
    {
        foreach ($parts as $i => $part) {
            ...
            if ($part instanceof \ConfigTransformer202107102\PhpParser\Node\Scalar\EncapsedStringPart && $this->containsEndLabel($part->value, $label, $atStart, $atEnd)) {
                return \true;
            }
        }
        return \false;
