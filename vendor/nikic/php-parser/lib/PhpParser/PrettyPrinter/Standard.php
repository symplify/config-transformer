...
namespace ConfigTransformerPrefix202606\PhpParser\PrettyPrinter;

use ConfigTransformerPrefix202606\PhpParser\Node;
use ConfigTransformerPrefix202606\PhpParser\Node\Expr;
use ConfigTransformerPrefix202606\PhpParser\Node\Expr\AssignOp;
use ConfigTransformerPrefix202606\PhpParser\Node\Expr\BinaryOp;
use ConfigTransformerPrefix202606\PhpParser\Node\Expr\Cast;
use ConfigTransformerPrefix202606\PhpParser\Node\Name;
use ConfigTransformerPrefix202606\PhpParser\Node\Scalar;
use ConfigTransformerPrefix202606\PhpParser\Node\Scalar\MagicConst;
use ConfigTransformerPrefix202606\PhpParser\Node\Stmt;
use ConfigTransformerPrefix202606\PhpParser\PrettyPrinterAbstract;
class Standard extends PrettyPrinterAbstract
{
    ...
    {
        if ($node->getAttribute('shouldPrintRawValue') === \true) {
