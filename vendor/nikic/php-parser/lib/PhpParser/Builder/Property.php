...
class Property implements \ConfigTransformer202202249\PhpParser\Builder
{
    protected $name;
    protected $flags = 0;
    ...
    {
        $this->flags = \ConfigTransformer202202249\PhpParser\BuilderHelpers::addModifier($this->flags, \ConfigTransformer202202249\PhpParser\Node\Stmt\Class_::MODIFIER_READONLY);
        return $this;
    }
    /**
    ...
    {
        return new \ConfigTransformer202202249\PhpParser\Node\Stmt\Property($this->flags !== 0 ? $this->flags : \ConfigTransformer202202249\PhpParser\Node\Stmt\Class_::MODIFIER_PUBLIC, [new \ConfigTransformer202202249\PhpParser\Node\Stmt\PropertyProperty($this->name, $this->default)], $this->attributes, $this->type, $this->attributeGroups);
    }
}
