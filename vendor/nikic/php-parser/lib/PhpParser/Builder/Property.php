...
class Property implements \ConfigTransformer2021070710\PhpParser\Builder
{
    protected $name;
    protected $flags = 0;
    ...
    {
        $this->flags = \ConfigTransformer2021070710\PhpParser\BuilderHelpers::addModifier($this->flags, \ConfigTransformer2021070710\PhpParser\Node\Stmt\Class_::MODIFIER_STATIC);
        return $this;
    }
    /**
    ...
    {
        return new \ConfigTransformer2021070710\PhpParser\Node\Stmt\Property($this->flags !== 0 ? $this->flags : \ConfigTransformer2021070710\PhpParser\Node\Stmt\Class_::MODIFIER_PUBLIC, [new \ConfigTransformer2021070710\PhpParser\Node\Stmt\PropertyProperty($this->name, $this->default)], $this->attributes, $this->type);
    }
}
