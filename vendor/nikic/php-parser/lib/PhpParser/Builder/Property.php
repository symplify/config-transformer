...
class Property implements \ConfigTransformer202107130\PhpParser\Builder
{
    protected $name;
    protected $flags = 0;
    ...
    {
        $this->flags = \ConfigTransformer202107130\PhpParser\BuilderHelpers::addModifier($this->flags, \ConfigTransformer202107130\PhpParser\Node\Stmt\Class_::MODIFIER_STATIC);
        return $this;
    }
    /**
    ...
    {
        return new \ConfigTransformer202107130\PhpParser\Node\Stmt\Property($this->flags !== 0 ? $this->flags : \ConfigTransformer202107130\PhpParser\Node\Stmt\Class_::MODIFIER_PUBLIC, [new \ConfigTransformer202107130\PhpParser\Node\Stmt\PropertyProperty($this->name, $this->default)], $this->attributes, $this->type, $this->attributeGroups);
    }
}
