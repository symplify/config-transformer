...
class Property implements \ConfigTransformer2022051710\PhpParser\Builder
{
    protected $name;
    protected $flags = 0;
    ...
    {
        $this->flags = \ConfigTransformer2022051710\PhpParser\BuilderHelpers::addModifier($this->flags, \ConfigTransformer2022051710\PhpParser\Node\Stmt\Class_::MODIFIER_READONLY);
        return $this;
    }
    /**
