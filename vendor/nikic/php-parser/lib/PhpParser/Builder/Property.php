...
class Property implements \ConfigTransformer202107069\PhpParser\Builder
{
    protected $name;
    protected $flags = 0;
    ...
    {
        return new \ConfigTransformer202107069\PhpParser\Node\Stmt\Property($this->flags !== 0 ? $this->flags : \ConfigTransformer202107069\PhpParser\Node\Stmt\Class_::MODIFIER_PUBLIC, [new \ConfigTransformer202107069\PhpParser\Node\Stmt\PropertyProperty($this->name, $this->default)], $this->attributes, $this->type);
    }
}
