...
class EnumCase implements \ConfigTransformer2021120410\PhpParser\Builder
{
    protected $name;
    ...
    {
        $this->value = \ConfigTransformer2021120410\PhpParser\BuilderHelpers::normalizeValue($value);
        return $this;
    }
    /**
    ...
    {
        $this->attributes = ['comments' => [\ConfigTransformer2021120410\PhpParser\BuilderHelpers::normalizeDocComment($docComment)]];
        return $this;
    }
    /**
    ...
    {
        return new \ConfigTransformer2021120410\PhpParser\Node\Stmt\EnumCase($this->name, $this->value, $this->attributes, $this->attributeGroups);
    }
}
