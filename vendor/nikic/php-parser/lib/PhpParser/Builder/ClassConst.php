...
use ConfigTransformer202106279\PhpParser\Node\Const_;
use ConfigTransformer202106279\PhpParser\Node\Identifier;
use ConfigTransformer202106279\PhpParser\Node\Stmt;
class ClassConst implements \ConfigTransformer202106279\PhpParser\Builder
{
    protected $flags = 0;
    ...
    {
        $this->constants = [new \ConfigTransformer202106279\PhpParser\Node\Const_($name, \ConfigTransformer202106279\PhpParser\BuilderHelpers::normalizeValue($value))];
    }
    /**
    ...
    {
        return new \ConfigTransformer202106279\PhpParser\Node\Stmt\ClassConst($this->constants, $this->flags, $this->attributes);
    }
}
