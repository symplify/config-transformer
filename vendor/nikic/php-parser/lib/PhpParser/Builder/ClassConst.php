...
use ConfigTransformer202205168\PhpParser\Node\Const_;
use ConfigTransformer202205168\PhpParser\Node\Identifier;
use ConfigTransformer202205168\PhpParser\Node\Stmt;
class ClassConst implements \ConfigTransformer202205168\PhpParser\Builder
{
    protected $flags = 0;
    ...
    {
        $this->constants = [new \ConfigTransformer202205168\PhpParser\Node\Const_($name, \ConfigTransformer202205168\PhpParser\BuilderHelpers::normalizeValue($value))];
    }
    /**
    ...
    {
        return new \ConfigTransformer202205168\PhpParser\Node\Stmt\ClassConst($this->constants, $this->flags, $this->attributes, $this->attributeGroups);
    }
}
