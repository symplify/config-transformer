...
use ConfigTransformer202107154\PhpParser\Node\Const_;
use ConfigTransformer202107154\PhpParser\Node\Identifier;
use ConfigTransformer202107154\PhpParser\Node\Stmt;
class ClassConst implements \ConfigTransformer202107154\PhpParser\Builder
{
    protected $flags = 0;
    ...
    {
        $this->constants = [new \ConfigTransformer202107154\PhpParser\Node\Const_($name, \ConfigTransformer202107154\PhpParser\BuilderHelpers::normalizeValue($value))];
    }
    /**
    ...
    {
        return new \ConfigTransformer202107154\PhpParser\Node\Stmt\ClassConst($this->constants, $this->flags, $this->attributes, $this->attributeGroups);
    }
}
