...
use ConfigTransformer202202249\PhpParser\Node\Const_;
use ConfigTransformer202202249\PhpParser\Node\Identifier;
use ConfigTransformer202202249\PhpParser\Node\Stmt;
class ClassConst implements \ConfigTransformer202202249\PhpParser\Builder
{
    protected $flags = 0;
    ...
    {
        $this->constants = [new \ConfigTransformer202202249\PhpParser\Node\Const_($name, \ConfigTransformer202202249\PhpParser\BuilderHelpers::normalizeValue($value))];
    }
    /**
    ...
    {
        return new \ConfigTransformer202202249\PhpParser\Node\Stmt\ClassConst($this->constants, $this->flags, $this->attributes, $this->attributeGroups);
    }
}
