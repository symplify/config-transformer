...
use ConfigTransformer2021091710\PhpParser\Node\Const_;
use ConfigTransformer2021091710\PhpParser\Node\Identifier;
use ConfigTransformer2021091710\PhpParser\Node\Stmt;
class ClassConst implements \ConfigTransformer2021091710\PhpParser\Builder
{
    protected $flags = 0;
    ...
    {
        $this->constants = [new \ConfigTransformer2021091710\PhpParser\Node\Const_($name, \ConfigTransformer2021091710\PhpParser\BuilderHelpers::normalizeValue($value))];
    }
    /**
    ...
    {
        return new \ConfigTransformer2021091710\PhpParser\Node\Stmt\ClassConst($this->constants, $this->flags, $this->attributes, $this->attributeGroups);
    }
}
