...
use ConfigTransformer2022051710\PhpParser\Node\Const_;
use ConfigTransformer2022051710\PhpParser\Node\Identifier;
use ConfigTransformer2022051710\PhpParser\Node\Stmt;
class ClassConst implements \ConfigTransformer2022051710\PhpParser\Builder
{
    protected $flags = 0;
    ...
    {
        $this->constants = [new \ConfigTransformer2022051710\PhpParser\Node\Const_($name, \ConfigTransformer2022051710\PhpParser\BuilderHelpers::normalizeValue($value))];
    }
    /**
    ...
    {
        return new \ConfigTransformer2022051710\PhpParser\Node\Stmt\ClassConst($this->constants, $this->flags, $this->attributes, $this->attributeGroups);
    }
}
