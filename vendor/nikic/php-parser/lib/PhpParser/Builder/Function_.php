...
class Function_ extends \ConfigTransformer2021091710\PhpParser\Builder\FunctionLike
{
    protected $name;
    protected $stmts = [];
    ...
    {
        $this->stmts[] = \ConfigTransformer2021091710\PhpParser\BuilderHelpers::normalizeStmt($stmt);
        return $this;
    }
    /**
    ...
    {
        return new \ConfigTransformer2021091710\PhpParser\Node\Stmt\Function_($this->name, ['byRef' => $this->returnByRef, 'params' => $this->params, 'returnType' => $this->returnType, 'stmts' => $this->stmts, 'attrGroups' => $this->attributeGroups], $this->attributes);
    }
}
