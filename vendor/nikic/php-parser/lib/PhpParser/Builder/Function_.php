...
class Function_ extends \ConfigTransformer202108234\PhpParser\Builder\FunctionLike
{
    protected $name;
    protected $stmts = [];
    ...
    {
        $this->stmts[] = \ConfigTransformer202108234\PhpParser\BuilderHelpers::normalizeStmt($stmt);
        return $this;
    }
    /**
    ...
    {
        return new \ConfigTransformer202108234\PhpParser\Node\Stmt\Function_($this->name, ['byRef' => $this->returnByRef, 'params' => $this->params, 'returnType' => $this->returnType, 'stmts' => $this->stmts, 'attrGroups' => $this->attributeGroups], $this->attributes);
    }
}
