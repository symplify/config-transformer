...
class Function_ extends \ConfigTransformer2021110310\PhpParser\Builder\FunctionLike
{
    protected $name;
    protected $stmts = [];
    ...
    {
        $this->stmts[] = \ConfigTransformer2021110310\PhpParser\BuilderHelpers::normalizeStmt($stmt);
        return $this;
    }
    /**
    ...
    {
        return new \ConfigTransformer2021110310\PhpParser\Node\Stmt\Function_($this->name, ['byRef' => $this->returnByRef, 'params' => $this->params, 'returnType' => $this->returnType, 'stmts' => $this->stmts, 'attrGroups' => $this->attributeGroups], $this->attributes);
    }
}
