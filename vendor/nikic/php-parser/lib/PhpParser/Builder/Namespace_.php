...
class Namespace_ extends \ConfigTransformer202205256\PhpParser\Builder\Declaration
{
    private $name;
    private $stmts = [];
    /**
    ...
    {
        $this->name = null !== $name ? \ConfigTransformer202205256\PhpParser\BuilderHelpers::normalizeName($name) : null;
    }
    /**
     * Adds a statement.
     *
    ...
    {
        return new \ConfigTransformer202205256\PhpParser\Node\Stmt\Namespace_($this->name, $this->stmts, $this->attributes);
    }
}
