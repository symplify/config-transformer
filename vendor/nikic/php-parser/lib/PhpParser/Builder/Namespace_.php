...
class Namespace_ extends \ConfigTransformer202107063\PhpParser\Builder\Declaration
{
    private $name;
    private $stmts = [];
    /**
    ...
    {
        $this->name = null !== $name ? \ConfigTransformer202107063\PhpParser\BuilderHelpers::normalizeName($name) : null;
    }
    /**
     * Adds a statement.
     *
    ...
    {
        return new \ConfigTransformer202107063\PhpParser\Node\Stmt\Namespace_($this->name, $this->stmts, $this->attributes);
    }
}
