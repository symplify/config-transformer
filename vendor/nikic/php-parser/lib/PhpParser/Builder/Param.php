...
class Param implements \ConfigTransformer202107105\PhpParser\Builder
{
    protected $name;
    ...
    {
        $this->default = \ConfigTransformer202107105\PhpParser\BuilderHelpers::normalizeValue($value);
        return $this;
    }
    /**
    ...
    {
        $this->type = \ConfigTransformer202107105\PhpParser\BuilderHelpers::normalizeType($type);
        if ($this->type == 'void') {
    ...
    {
        return new \ConfigTransformer202107105\PhpParser\Node\Param(new \ConfigTransformer202107105\PhpParser\Node\Expr\Variable($this->name), $this->default, $this->type, $this->byRef, $this->variadic, [], 0, $this->attributeGroups);
    }
}
