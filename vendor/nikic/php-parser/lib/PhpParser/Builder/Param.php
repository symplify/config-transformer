...
class Param implements \ConfigTransformer202108234\PhpParser\Builder
{
    protected $name;
    ...
    {
        $this->default = \ConfigTransformer202108234\PhpParser\BuilderHelpers::normalizeValue($value);
        return $this;
    }
    /**
    ...
    {
        $this->type = \ConfigTransformer202108234\PhpParser\BuilderHelpers::normalizeType($type);
        if ($this->type == 'void') {
    ...
    {
        return new \ConfigTransformer202108234\PhpParser\Node\Param(new \ConfigTransformer202108234\PhpParser\Node\Expr\Variable($this->name), $this->default, $this->type, $this->byRef, $this->variadic, [], 0, $this->attributeGroups);
    }
}
