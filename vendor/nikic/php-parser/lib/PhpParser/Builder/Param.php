...
class Param implements \ConfigTransformer2021091710\PhpParser\Builder
{
    protected $name;
    ...
    {
        return new \ConfigTransformer2021091710\PhpParser\Node\Param(new \ConfigTransformer2021091710\PhpParser\Node\Expr\Variable($this->name), $this->default, $this->type, $this->byRef, $this->variadic, [], 0, $this->attributeGroups);
    }
}
