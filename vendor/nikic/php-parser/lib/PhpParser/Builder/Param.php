...
class Param implements \ConfigTransformer202107080\PhpParser\Builder
{
    protected $name;
    ...
    {
        return new \ConfigTransformer202107080\PhpParser\Node\Param(new \ConfigTransformer202107080\PhpParser\Node\Expr\Variable($this->name), $this->default, $this->type, $this->byRef, $this->variadic, [], 0, $this->attributeGroups);
    }
}
