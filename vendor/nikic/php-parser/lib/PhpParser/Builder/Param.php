...
class Param implements \ConfigTransformer202106279\PhpParser\Builder
{
    protected $name;
    ...
    {
        return new \ConfigTransformer202106279\PhpParser\Node\Param(new \ConfigTransformer202106279\PhpParser\Node\Expr\Variable($this->name), $this->default, $this->type, $this->byRef, $this->variadic);
    }
}
