...
class Param implements \ConfigTransformer202107130\PhpParser\Builder
{
    protected $name;
    ...
    {
        $this->default = \ConfigTransformer202107130\PhpParser\BuilderHelpers::normalizeValue($value);
        return $this;
    }
    /**
    ...
    {
        $this->type = \ConfigTransformer202107130\PhpParser\BuilderHelpers::normalizeType($type);
        if ($this->type == 'void') {
    ...
    {
        return new \ConfigTransformer202107130\PhpParser\Node\Param(new \ConfigTransformer202107130\PhpParser\Node\Expr\Variable($this->name), $this->default, $this->type, $this->byRef, $this->variadic, [], 0, $this->attributeGroups);
    }
}
