...
class Use_ implements \ConfigTransformer2022051710\PhpParser\Builder
{
    protected $name;
    protected $type;
    ...
    {
        $this->name = \ConfigTransformer2022051710\PhpParser\BuilderHelpers::normalizeName($name);
        $this->type = $type;
    }
    /**
    ...
    {
        return new \ConfigTransformer2022051710\PhpParser\Node\Stmt\Use_([new \ConfigTransformer2022051710\PhpParser\Node\Stmt\UseUse($this->name, $this->alias)], $this->type);
    }
}
