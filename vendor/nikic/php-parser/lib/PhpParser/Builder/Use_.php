...
class Use_ implements \ConfigTransformer202106187\PhpParser\Builder
{
    protected $name;
    protected $type;
    ...
    {
        $this->name = \ConfigTransformer202106187\PhpParser\BuilderHelpers::normalizeName($name);
        $this->type = $type;
    }
    /**
    ...
    {
        return new \ConfigTransformer202106187\PhpParser\Node\Stmt\Use_([new \ConfigTransformer202106187\PhpParser\Node\Stmt\UseUse($this->name, $this->alias)], $this->type);
    }
}
