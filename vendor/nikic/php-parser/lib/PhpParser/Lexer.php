...
use ConfigTransformerPrefix202312\PhpParser\Parser\Tokens;
class Lexer
{
    protected $code;
    protected $tokens;
    ...
    protected function createTokenMap() : array
    {
        ...
        if (\defined('ConfigTransformerPrefix202312\\T_ONUMBER')) {
            $tokenMap[\ConfigTransformerPrefix202312\T_ONUMBER] = Tokens::T_DNUMBER;
        }
        // HHVM also has a separate token for the __COMPILER_HALT_OFFSET__ constant
        if (\defined('ConfigTransformerPrefix202312\\T_COMPILER_HALT_OFFSET')) {
            $tokenMap[\ConfigTransformerPrefix202312\T_COMPILER_HALT_OFFSET] = Tokens::T_STRING;
        }
