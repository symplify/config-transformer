...
class NodeTraverser implements \ConfigTransformer202112195\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    protected function traverseNode(\ConfigTransformer202112195\PhpParser\Node $node) : \ConfigTransformer202112195\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \ConfigTransformer202112195\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \ConfigTransformer202112195\PhpParser\Node) {
    ...
    {
        if ($old instanceof \ConfigTransformer202112195\PhpParser\Node\Stmt && $new instanceof \ConfigTransformer202112195\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \ConfigTransformer202112195\PhpParser\Node\Expr && $new instanceof \ConfigTransformer202112195\PhpParser\Node\Stmt) {
