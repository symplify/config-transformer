...
class NodeTraverser implements \ConfigTransformer202111142\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    protected function traverseNode($node) : \ConfigTransformer202111142\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \ConfigTransformer202111142\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \ConfigTransformer202111142\PhpParser\Node) {
    ...
    {
        if ($old instanceof \ConfigTransformer202111142\PhpParser\Node\Stmt && $new instanceof \ConfigTransformer202111142\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \ConfigTransformer202111142\PhpParser\Node\Expr && $new instanceof \ConfigTransformer202111142\PhpParser\Node\Stmt) {
