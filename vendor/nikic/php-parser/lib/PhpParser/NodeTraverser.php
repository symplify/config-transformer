...
class NodeTraverser implements \ConfigTransformer20210610\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    protected function traverseNode(\ConfigTransformer20210610\PhpParser\Node $node) : \ConfigTransformer20210610\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \ConfigTransformer20210610\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \ConfigTransformer20210610\PhpParser\Node) {
    ...
    {
        if ($old instanceof \ConfigTransformer20210610\PhpParser\Node\Stmt && $new instanceof \ConfigTransformer20210610\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \ConfigTransformer20210610\PhpParser\Node\Expr && $new instanceof \ConfigTransformer20210610\PhpParser\Node\Stmt) {
