...
class NodeTraverser implements \ConfigTransformer2021122310\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    protected function traverseNode(\ConfigTransformer2021122310\PhpParser\Node $node) : \ConfigTransformer2021122310\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \ConfigTransformer2021122310\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \ConfigTransformer2021122310\PhpParser\Node) {
    ...
    {
        if ($old instanceof \ConfigTransformer2021122310\PhpParser\Node\Stmt && $new instanceof \ConfigTransformer2021122310\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \ConfigTransformer2021122310\PhpParser\Node\Expr && $new instanceof \ConfigTransformer2021122310\PhpParser\Node\Stmt) {
