...
class NodeTraverser implements \ConfigTransformer2022051710\PhpParser\NodeTraverserInterface
{
    /**
     ...
     */
    protected function traverseNode(\ConfigTransformer2022051710\PhpParser\Node $node) : \ConfigTransformer2022051710\PhpParser\Node
    {
        foreach ($node->getSubNodeNames() as $name) {
            ...
            } elseif ($subNode instanceof \ConfigTransformer2022051710\PhpParser\Node) {
                $traverseChildren = \true;
                $breakVisitorIndex = null;
                foreach ($this->visitors as $visitorIndex => $visitor) {
                    $return = $visitor->enterNode($subNode);
                    if (null !== $return) {
                        if ($return instanceof \ConfigTransformer2022051710\PhpParser\Node) {
    ...
    {
        if ($old instanceof \ConfigTransformer2022051710\PhpParser\Node\Stmt && $new instanceof \ConfigTransformer2022051710\PhpParser\Node\Expr) {
        ...
        if ($old instanceof \ConfigTransformer2022051710\PhpParser\Node\Expr && $new instanceof \ConfigTransformer2022051710\PhpParser\Node\Stmt) {
