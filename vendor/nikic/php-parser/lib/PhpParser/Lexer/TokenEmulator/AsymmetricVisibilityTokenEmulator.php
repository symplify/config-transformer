...
final class AsymmetricVisibilityTokenEmulator extends TokenEmulator
{
    ...
    {
        $map = [\T_PUBLIC => \ConfigTransformerPrefix202501\T_PUBLIC_SET, \T_PROTECTED => \ConfigTransformerPrefix202501\T_PROTECTED_SET, \T_PRIVATE => \ConfigTransformerPrefix202501\T_PRIVATE_SET];
    ...
    {
        $reverseMap = [\ConfigTransformerPrefix202501\T_PUBLIC_SET => \T_PUBLIC, \ConfigTransformerPrefix202501\T_PROTECTED_SET => \T_PROTECTED, \ConfigTransformerPrefix202501\T_PRIVATE_SET => \T_PRIVATE];
        for ($i = 0, $c = \count($tokens); $i < $c; ++$i) {
            $token = $tokens[$i];
