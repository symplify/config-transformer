...
namespace ConfigTransformerPrefix202501\PhpParser\Lexer;

use ConfigTransformerPrefix202501\PhpParser\Error;
use ConfigTransformerPrefix202501\PhpParser\ErrorHandler;
use ConfigTransformerPrefix202501\PhpParser\Lexer;
use ConfigTransformerPrefix202501\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use ConfigTransformerPrefix202501\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use ConfigTransformerPrefix202501\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use ConfigTransformerPrefix202501\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use ConfigTransformerPrefix202501\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use ConfigTransformerPrefix202501\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use ConfigTransformerPrefix202501\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use ConfigTransformerPrefix202501\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use ConfigTransformerPrefix202501\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use ConfigTransformerPrefix202501\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use ConfigTransformerPrefix202501\PhpParser\Lexer\TokenEmulator\TokenEmulator;
