...
namespace ConfigTransformer202210\PhpParser\Lexer;

use ConfigTransformer202210\PhpParser\Error;
use ConfigTransformer202210\PhpParser\ErrorHandler;
use ConfigTransformer202210\PhpParser\Lexer;
use ConfigTransformer202210\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use ConfigTransformer202210\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use ConfigTransformer202210\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use ConfigTransformer202210\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use ConfigTransformer202210\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use ConfigTransformer202210\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use ConfigTransformer202210\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use ConfigTransformer202210\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use ConfigTransformer202210\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use ConfigTransformer202210\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use ConfigTransformer202210\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use ConfigTransformer202210\PhpParser\Lexer\TokenEmulator\TokenEmulator;
