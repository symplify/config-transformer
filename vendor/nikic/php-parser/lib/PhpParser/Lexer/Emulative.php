...
namespace ConfigTransformerPrefix202507\PhpParser\Lexer;

use ConfigTransformerPrefix202507\PhpParser\Error;
use ConfigTransformerPrefix202507\PhpParser\ErrorHandler;
use ConfigTransformerPrefix202507\PhpParser\Lexer;
use ConfigTransformerPrefix202507\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use ConfigTransformerPrefix202507\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use ConfigTransformerPrefix202507\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use ConfigTransformerPrefix202507\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use ConfigTransformerPrefix202507\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use ConfigTransformerPrefix202507\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use ConfigTransformerPrefix202507\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use ConfigTransformerPrefix202507\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use ConfigTransformerPrefix202507\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use ConfigTransformerPrefix202507\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use ConfigTransformerPrefix202507\PhpParser\Lexer\TokenEmulator\TokenEmulator;
