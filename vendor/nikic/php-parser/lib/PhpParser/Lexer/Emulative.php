...
namespace ConfigTransformerPrefix202605\PhpParser\Lexer;

use ConfigTransformerPrefix202605\PhpParser\Error;
use ConfigTransformerPrefix202605\PhpParser\ErrorHandler;
use ConfigTransformerPrefix202605\PhpParser\Lexer;
use ConfigTransformerPrefix202605\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use ConfigTransformerPrefix202605\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use ConfigTransformerPrefix202605\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use ConfigTransformerPrefix202605\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use ConfigTransformerPrefix202605\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use ConfigTransformerPrefix202605\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use ConfigTransformerPrefix202605\PhpParser\Lexer\TokenEmulator\PipeOperatorEmulator;
use ConfigTransformerPrefix202605\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use ConfigTransformerPrefix202605\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use ConfigTransformerPrefix202605\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use ConfigTransformerPrefix202605\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use ConfigTransformerPrefix202605\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use ConfigTransformerPrefix202605\PhpParser\Lexer\TokenEmulator\VoidCastEmulator;
