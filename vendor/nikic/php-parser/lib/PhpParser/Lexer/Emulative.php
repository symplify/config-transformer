...
namespace ConfigTransformer20220607\PhpParser\Lexer;

use ConfigTransformer20220607\PhpParser\Error;
use ConfigTransformer20220607\PhpParser\ErrorHandler;
use ConfigTransformer20220607\PhpParser\Lexer;
use ConfigTransformer20220607\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use ConfigTransformer20220607\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use ConfigTransformer20220607\PhpParser\Lexer\TokenEmulator\CoaleseEqualTokenEmulator;
use ConfigTransformer20220607\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use ConfigTransformer20220607\PhpParser\Lexer\TokenEmulator\FlexibleDocStringEmulator;
use ConfigTransformer20220607\PhpParser\Lexer\TokenEmulator\FnTokenEmulator;
use ConfigTransformer20220607\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use ConfigTransformer20220607\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use ConfigTransformer20220607\PhpParser\Lexer\TokenEmulator\NumericLiteralSeparatorEmulator;
use ConfigTransformer20220607\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use ConfigTransformer20220607\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use ConfigTransformer20220607\PhpParser\Lexer\TokenEmulator\TokenEmulator;
