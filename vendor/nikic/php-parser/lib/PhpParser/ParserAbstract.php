...
use ConfigTransformerPrefix202507\PhpParser\Node\Expr\Cast\Double;
use ConfigTransformerPrefix202507\PhpParser\Node\Identifier;
use ConfigTransformerPrefix202507\PhpParser\Node\InterpolatedStringPart;
use ConfigTransformerPrefix202507\PhpParser\Node\Name;
use ConfigTransformerPrefix202507\PhpParser\Node\Param;
use ConfigTransformerPrefix202507\PhpParser\Node\PropertyHook;
use ConfigTransformerPrefix202507\PhpParser\Node\Scalar\InterpolatedString;
use ConfigTransformerPrefix202507\PhpParser\Node\Scalar\Int_;
use ConfigTransformerPrefix202507\PhpParser\Node\Scalar\String_;
use ConfigTransformerPrefix202507\PhpParser\Node\Stmt;
use ConfigTransformerPrefix202507\PhpParser\Node\Stmt\Class_;
use ConfigTransformerPrefix202507\PhpParser\Node\Stmt\ClassConst;
use ConfigTransformerPrefix202507\PhpParser\Node\Stmt\ClassMethod;
use ConfigTransformerPrefix202507\PhpParser\Node\Stmt\Const_;
use ConfigTransformerPrefix202507\PhpParser\Node\Stmt\Else_;
use ConfigTransformerPrefix202507\PhpParser\Node\Stmt\ElseIf_;
use ConfigTransformerPrefix202507\PhpParser\Node\Stmt\Enum_;
use ConfigTransformerPrefix202507\PhpParser\Node\Stmt\Interface_;
use ConfigTransformerPrefix202507\PhpParser\Node\Stmt\Namespace_;
use ConfigTransformerPrefix202507\PhpParser\Node\Stmt\Nop;
use ConfigTransformerPrefix202507\PhpParser\Node\Stmt\Property;
use ConfigTransformerPrefix202507\PhpParser\Node\Stmt\TryCatch;
use ConfigTransformerPrefix202507\PhpParser\Node\UseItem;
use ConfigTransformerPrefix202507\PhpParser\Node\VarLikeIdentifier;
use ConfigTransformerPrefix202507\PhpParser\NodeVisitor\CommentAnnotatingVisitor;
