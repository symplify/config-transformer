...
namespace ConfigTransformerPrefix202606\PhpParser;

/*
 * This parser is based on a skeleton written by Moriyoshi Koizumi, which in
 * turn is based on work by Masato Bito.
 */
use ConfigTransformerPrefix202606\PhpParser\Node\Arg;
use ConfigTransformerPrefix202606\PhpParser\Node\Expr;
use ConfigTransformerPrefix202606\PhpParser\Node\Expr\Array_;
use ConfigTransformerPrefix202606\PhpParser\Node\Expr\Cast\Double;
use ConfigTransformerPrefix202606\PhpParser\Node\Identifier;
use ConfigTransformerPrefix202606\PhpParser\Node\InterpolatedStringPart;
use ConfigTransformerPrefix202606\PhpParser\Node\Name;
use ConfigTransformerPrefix202606\PhpParser\Node\Param;
use ConfigTransformerPrefix202606\PhpParser\Node\PropertyHook;
use ConfigTransformerPrefix202606\PhpParser\Node\Scalar\InterpolatedString;
use ConfigTransformerPrefix202606\PhpParser\Node\Scalar\Int_;
use ConfigTransformerPrefix202606\PhpParser\Node\Scalar\String_;
use ConfigTransformerPrefix202606\PhpParser\Node\Stmt;
use ConfigTransformerPrefix202606\PhpParser\Node\Stmt\Class_;
use ConfigTransformerPrefix202606\PhpParser\Node\Stmt\ClassConst;
use ConfigTransformerPrefix202606\PhpParser\Node\Stmt\ClassMethod;
use ConfigTransformerPrefix202606\PhpParser\Node\Stmt\Const_;
use ConfigTransformerPrefix202606\PhpParser\Node\Stmt\Else_;
use ConfigTransformerPrefix202606\PhpParser\Node\Stmt\ElseIf_;
use ConfigTransformerPrefix202606\PhpParser\Node\Stmt\Enum_;
use ConfigTransformerPrefix202606\PhpParser\Node\Stmt\Interface_;
use ConfigTransformerPrefix202606\PhpParser\Node\Stmt\Namespace_;
use ConfigTransformerPrefix202606\PhpParser\Node\Stmt\Nop;
use ConfigTransformerPrefix202606\PhpParser\Node\Stmt\Property;
use ConfigTransformerPrefix202606\PhpParser\Node\Stmt\TryCatch;
use ConfigTransformerPrefix202606\PhpParser\Node\UseItem;
use ConfigTransformerPrefix202606\PhpParser\Node\VarLikeIdentifier;
use ConfigTransformerPrefix202606\PhpParser\NodeVisitor\CommentAnnotatingVisitor;
