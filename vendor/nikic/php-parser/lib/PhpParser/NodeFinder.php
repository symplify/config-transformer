...
class NodeFinder
{
    ...
    public function find($nodes, callable $filter) : array
    {
        ...
        $visitor = new \ConfigTransformer202206079\PhpParser\NodeVisitor\FindingVisitor($filter);
        $traverser = new \ConfigTransformer202206079\PhpParser\NodeTraverser();
    ...
    public function findFirst($nodes, callable $filter)
    {
        ...
        $visitor = new \ConfigTransformer202206079\PhpParser\NodeVisitor\FirstFindingVisitor($filter);
        $traverser = new \ConfigTransformer202206079\PhpParser\NodeTraverser();
        $traverser->addVisitor($visitor);
        $traverser->traverse($nodes);
