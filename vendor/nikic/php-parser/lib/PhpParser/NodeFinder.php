...
use ConfigTransformer202107154\PhpParser\NodeVisitor\FindingVisitor;
use ConfigTransformer202107154\PhpParser\NodeVisitor\FirstFindingVisitor;
class NodeFinder
{
    /**
    ...
    public function find($nodes, $filter) : array
    {
        ...
        $visitor = new \ConfigTransformer202107154\PhpParser\NodeVisitor\FindingVisitor($filter);
    ...
    public function findFirst($nodes, $filter)
    {
        ...
        $visitor = new \ConfigTransformer202107154\PhpParser\NodeVisitor\FirstFindingVisitor($filter);
        $traverser = new \ConfigTransformer202107154\PhpParser\NodeTraverser();
        $traverser->addVisitor($visitor);
        $traverser->traverse($nodes);
