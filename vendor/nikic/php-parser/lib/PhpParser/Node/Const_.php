...
class Const_ extends \ConfigTransformer202205211\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \ConfigTransformer202205211\PhpParser\Node\Expr $value, array $attributes = [])
    {
