...
class Const_ extends \ConfigTransformer2022022110\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \ConfigTransformer2022022110\PhpParser\Node\Expr $value, array $attributes = [])
    {
