...
class Const_ extends \ConfigTransformer202112194\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \ConfigTransformer202112194\PhpParser\Node\Expr $value, array $attributes = [])
    {
