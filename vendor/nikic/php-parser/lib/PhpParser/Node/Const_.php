 ...
 */
class Const_ extends \ConfigTransformer202109204\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \ConfigTransformer202109204\PhpParser\Node\Expr $value, array $attributes = [])
    {
