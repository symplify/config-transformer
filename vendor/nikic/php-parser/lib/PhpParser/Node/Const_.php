 ...
 */
class Const_ extends \ConfigTransformer2021113010\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \ConfigTransformer2021113010\PhpParser\Node\Expr $value, array $attributes = [])
    {
