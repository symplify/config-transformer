...
class Const_ extends \ConfigTransformer2021120810\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \ConfigTransformer2021120810\PhpParser\Node\Expr $value, array $attributes = [])
    {
