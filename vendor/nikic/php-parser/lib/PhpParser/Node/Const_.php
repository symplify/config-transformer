 ...
 */
class Const_ extends \ConfigTransformer202107154\PhpParser\NodeAbstract
{
    /** @var Identifier Name */
    public $name;
    /** @var Expr Value */
     ...
     */
    public function __construct($name, \ConfigTransformer202107154\PhpParser\Node\Expr $value, array $attributes = [])
    {
