...
class Alias extends \ConfigTransformer202111216\PhpParser\Node\Stmt\TraitUseAdaptation
{
    ...
    public function __construct($trait, $method, $newModifier, $newName, array $attributes = [])
    {
        ...
        $this->newName = \is_string($newName) ? new \ConfigTransformer202111216\PhpParser\Node\Identifier($newName) : $newName;
    }
