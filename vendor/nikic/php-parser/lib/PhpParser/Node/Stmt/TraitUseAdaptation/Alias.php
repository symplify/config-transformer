...
class Alias extends \ConfigTransformer2021112210\PhpParser\Node\Stmt\TraitUseAdaptation
{
    ...
    public function __construct($trait, $method, $newModifier, $newName, array $attributes = [])
    {
        ...
        $this->newName = \is_string($newName) ? new \ConfigTransformer2021112210\PhpParser\Node\Identifier($newName) : $newName;
    }
