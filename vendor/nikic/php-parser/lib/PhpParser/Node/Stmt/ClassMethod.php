...
use ConfigTransformer202109073\PhpParser\Node\FunctionLike;
class ClassMethod extends \ConfigTransformer202109073\PhpParser\Node\Stmt implements \ConfigTransformer202109073\PhpParser\Node\FunctionLike
{
    /** @var int Flags */
    public $flags;
    ...
    public function __construct($name, array $subNodes = [], array $attributes = [])
    {
        ...
        $this->returnType = \is_string($returnType) ? new \ConfigTransformer202109073\PhpParser\Node\Identifier($returnType) : $returnType;
    ...
    {
        return (bool) ($this->flags & \ConfigTransformer202109073\PhpParser\Node\Stmt\Class_::MODIFIER_ABSTRACT);
    }
    /**
