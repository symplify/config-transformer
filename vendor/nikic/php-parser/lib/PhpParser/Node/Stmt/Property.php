...
use ConfigTransformer202111018\PhpParser\Node\ComplexType;
use ConfigTransformer202111018\PhpParser\Node\Identifier;
use ConfigTransformer202111018\PhpParser\Node\Name;
class Property extends \ConfigTransformer202111018\PhpParser\Node\Stmt
{
    /** @var int Modifiers */
    public $flags;
    ...
    public function __construct(int $flags, array $props, array $attributes = [], $type = null, array $attrGroups = [])
    {
        ...
        $this->flags = $flags;
        $this->props = $props;
        $this->type = \is_string($type) ? new \ConfigTransformer202111018\PhpParser\Node\Identifier($type) : $type;
    ...
    {
        return (bool) ($this->flags & \ConfigTransformer202111018\PhpParser\Node\Stmt\Class_::MODIFIER_READONLY);
    }
