...
namespace ConfigTransformer20210610\PhpParser\Node\Scalar;

use ConfigTransformer20210610\PhpParser\Error;
use ConfigTransformer20210610\PhpParser\Node\Scalar;
class String_ extends \ConfigTransformer20210610\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \ConfigTransformer20210610\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
