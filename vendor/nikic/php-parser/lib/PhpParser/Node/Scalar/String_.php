...
class String_ extends \ConfigTransformer202205300\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \ConfigTransformer202205300\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
