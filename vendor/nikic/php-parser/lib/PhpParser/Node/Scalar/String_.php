...
namespace ConfigTransformer202205211\PhpParser\Node\Scalar;

use ConfigTransformer202205211\PhpParser\Error;
use ConfigTransformer202205211\PhpParser\Node\Scalar;
class String_ extends \ConfigTransformer202205211\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \ConfigTransformer202205211\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
