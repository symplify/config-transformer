...
namespace ConfigTransformer2022051110\PhpParser\Node\Scalar;

use ConfigTransformer2022051110\PhpParser\Error;
use ConfigTransformer2022051110\PhpParser\Node\Scalar;
class String_ extends \ConfigTransformer2022051110\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \ConfigTransformer2022051110\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
