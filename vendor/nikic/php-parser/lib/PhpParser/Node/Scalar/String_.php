...
namespace ConfigTransformer202206076\PhpParser\Node\Scalar;

use ConfigTransformer202206076\PhpParser\Error;
use ConfigTransformer202206076\PhpParser\Node\Scalar;
class String_ extends \ConfigTransformer202206076\PhpParser\Node\Scalar
{
    ...
    {
        $attributes['kind'] = $str[0] === "'" || $str[1] === "'" && ($str[0] === 'b' || $str[0] === 'B') ? \ConfigTransformer202206076\PhpParser\Node\Scalar\String_::KIND_SINGLE_QUOTED : \ConfigTransformer202206076\PhpParser\Node\Scalar\String_::KIND_DOUBLE_QUOTED;
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \ConfigTransformer202206076\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
