...
namespace ConfigTransformer202106187\PhpParser\Node\Scalar;

use ConfigTransformer202106187\PhpParser\Error;
use ConfigTransformer202106187\PhpParser\Node\Scalar;
class String_ extends \ConfigTransformer202106187\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \ConfigTransformer202106187\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
