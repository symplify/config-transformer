...
namespace ConfigTransformer2021090310\PhpParser\Node\Scalar;

use ConfigTransformer2021090310\PhpParser\Error;
use ConfigTransformer2021090310\PhpParser\Node\Scalar;
class String_ extends \ConfigTransformer2021090310\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \ConfigTransformer2021090310\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
