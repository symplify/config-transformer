...
namespace ConfigTransformer202109062\PhpParser\Node\Scalar;

use ConfigTransformer202109062\PhpParser\Error;
use ConfigTransformer202109062\PhpParser\Node\Scalar;
class String_ extends \ConfigTransformer202109062\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \ConfigTransformer202109062\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
