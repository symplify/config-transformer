...
namespace ConfigTransformer2021113010\PhpParser\Node\Scalar;

use ConfigTransformer2021113010\PhpParser\Error;
use ConfigTransformer2021113010\PhpParser\Node\Scalar;
class String_ extends \ConfigTransformer2021113010\PhpParser\Node\Scalar
{
    ...
    private static function codePointToUtf8(int $num) : string
    {
        ...
        throw new \ConfigTransformer2021113010\PhpParser\Error('Invalid UTF-8 codepoint escape sequence: Codepoint too large');
    }
