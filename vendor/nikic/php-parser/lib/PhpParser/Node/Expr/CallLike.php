...
abstract class CallLike extends \ConfigTransformer2021122310\PhpParser\Node\Expr
{
    /**
    ...
    public function isFirstClassCallable() : bool
    {
        foreach ($this->getRawArgs() as $arg) {
            if ($arg instanceof \ConfigTransformer2021122310\PhpParser\Node\VariadicPlaceholder) {
                return \true;
            }
        }
        return \false;
