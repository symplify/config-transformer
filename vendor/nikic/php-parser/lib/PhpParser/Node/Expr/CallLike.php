...
abstract class CallLike extends \ConfigTransformer202204146\PhpParser\Node\Expr
{
    /**
    ...
    public function isFirstClassCallable() : bool
    {
        foreach ($this->getRawArgs() as $arg) {
            if ($arg instanceof \ConfigTransformer202204146\PhpParser\Node\VariadicPlaceholder) {
                return \true;
            }
        }
        return \false;
