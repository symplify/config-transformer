...
abstract class CallLike extends \ConfigTransformer202202204\PhpParser\Node\Expr
{
    /**
    ...
    public function isFirstClassCallable() : bool
    {
        foreach ($this->getRawArgs() as $arg) {
            if ($arg instanceof \ConfigTransformer202202204\PhpParser\Node\VariadicPlaceholder) {
                return \true;
            }
        }
        return \false;
