...
abstract class CallLike extends \ConfigTransformer202205038\PhpParser\Node\Expr
{
    /**
    ...
    public function isFirstClassCallable() : bool
    {
        foreach ($this->getRawArgs() as $arg) {
            if ($arg instanceof \ConfigTransformer202205038\PhpParser\Node\VariadicPlaceholder) {
                return \true;
            }
        }
        return \false;
