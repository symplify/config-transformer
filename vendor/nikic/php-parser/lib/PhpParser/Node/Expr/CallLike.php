...
abstract class CallLike extends \ConfigTransformer202110315\PhpParser\Node\Expr
{
    /**
    ...
    public function isFirstClassCallable() : bool
    {
        foreach ($this->getRawArgs() as $arg) {
            if ($arg instanceof \ConfigTransformer202110315\PhpParser\Node\VariadicPlaceholder) {
                return \true;
            }
        }
        return \false;
