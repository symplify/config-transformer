...
abstract class CallLike extends \ConfigTransformer202205123\PhpParser\Node\Expr
{
    /**
    ...
    public function isFirstClassCallable() : bool
    {
        foreach ($this->getRawArgs() as $arg) {
            if ($arg instanceof \ConfigTransformer202205123\PhpParser\Node\VariadicPlaceholder) {
                return \true;
            }
        }
        return \false;
