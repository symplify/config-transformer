...
abstract class CallLike extends \ConfigTransformer202203051\PhpParser\Node\Expr
{
    /**
    ...
    public function isFirstClassCallable() : bool
    {
        foreach ($this->getRawArgs() as $arg) {
            if ($arg instanceof \ConfigTransformer202203051\PhpParser\Node\VariadicPlaceholder) {
                return \true;
            }
        }
        return \false;
