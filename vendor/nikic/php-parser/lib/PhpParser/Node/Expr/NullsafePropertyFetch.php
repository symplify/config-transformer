...
class NullsafePropertyFetch extends \ConfigTransformer202112107\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\ConfigTransformer202112107\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
