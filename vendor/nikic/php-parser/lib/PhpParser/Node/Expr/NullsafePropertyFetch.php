...
class NullsafePropertyFetch extends \ConfigTransformer202108248\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\ConfigTransformer202108248\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
