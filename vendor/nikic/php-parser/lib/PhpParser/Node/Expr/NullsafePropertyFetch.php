...
class NullsafePropertyFetch extends \ConfigTransformer2022051710\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\ConfigTransformer2022051710\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
