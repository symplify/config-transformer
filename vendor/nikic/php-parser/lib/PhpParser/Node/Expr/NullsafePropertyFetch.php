...
class NullsafePropertyFetch extends \ConfigTransformer202205038\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\ConfigTransformer202205038\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
