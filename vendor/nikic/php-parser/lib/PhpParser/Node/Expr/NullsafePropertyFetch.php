...
class NullsafePropertyFetch extends \ConfigTransformer202112079\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\ConfigTransformer202112079\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
