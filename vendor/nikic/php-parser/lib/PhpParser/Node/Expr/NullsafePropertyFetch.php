...
class NullsafePropertyFetch extends \ConfigTransformer2022022110\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\ConfigTransformer2022022110\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
