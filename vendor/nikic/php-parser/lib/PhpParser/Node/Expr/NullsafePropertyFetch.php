...
class NullsafePropertyFetch extends \ConfigTransformer202204146\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\ConfigTransformer202204146\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
