...
class NullsafePropertyFetch extends \ConfigTransformer202204174\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\ConfigTransformer202204174\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
