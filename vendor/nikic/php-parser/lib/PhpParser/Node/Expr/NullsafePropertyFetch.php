...
class NullsafePropertyFetch extends \ConfigTransformer202109049\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\ConfigTransformer202109049\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
