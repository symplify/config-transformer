...
class NullsafePropertyFetch extends \ConfigTransformer202205170\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\ConfigTransformer202205170\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
