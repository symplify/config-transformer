...
class NullsafePropertyFetch extends \ConfigTransformer202202202\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\ConfigTransformer202202202\PhpParser\Node\Expr $var, $name, array $attributes = [])
    {
