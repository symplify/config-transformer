...
class NullsafeMethodCall extends \ConfigTransformer202205038\PhpParser\Node\Expr\CallLike
{
     ...
     */
    public function __construct(\ConfigTransformer202205038\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
