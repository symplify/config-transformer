...
class NullsafeMethodCall extends \ConfigTransformer202206052\PhpParser\Node\Expr\CallLike
{
     ...
     */
    public function __construct(\ConfigTransformer202206052\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
