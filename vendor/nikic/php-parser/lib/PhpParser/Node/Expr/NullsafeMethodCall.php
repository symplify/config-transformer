...
class NullsafeMethodCall extends \ConfigTransformer202202215\PhpParser\Node\Expr\CallLike
{
     ...
     */
    public function __construct(\ConfigTransformer202202215\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
