...
class NullsafeMethodCall extends \ConfigTransformer202204174\PhpParser\Node\Expr\CallLike
{
     ...
     */
    public function __construct(\ConfigTransformer202204174\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
