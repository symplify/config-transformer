...
class NullsafeMethodCall extends \ConfigTransformer202107154\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\ConfigTransformer202107154\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
