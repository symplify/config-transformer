...
class NullsafeMethodCall extends \ConfigTransformer2021082410\PhpParser\Node\Expr
{
     ...
     */
    public function __construct(\ConfigTransformer2021082410\PhpParser\Node\Expr $var, $name, array $args = [], array $attributes = [])
    {
