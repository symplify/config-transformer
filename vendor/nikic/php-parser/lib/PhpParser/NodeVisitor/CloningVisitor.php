 ...
 */
class CloningVisitor extends \ConfigTransformer202205205\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202205205\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
