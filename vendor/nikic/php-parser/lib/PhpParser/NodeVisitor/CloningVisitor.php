 ...
 */
class CloningVisitor extends \ConfigTransformer202202183\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202202183\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
