 ...
 */
class CloningVisitor extends \ConfigTransformer2021061910\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer2021061910\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
