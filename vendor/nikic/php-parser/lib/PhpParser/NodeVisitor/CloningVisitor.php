 ...
 */
class CloningVisitor extends \ConfigTransformer202204145\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202204145\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
