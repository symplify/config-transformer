 ...
 */
class CloningVisitor extends \ConfigTransformer202201260\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202201260\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
