 ...
 */
class CloningVisitor extends \ConfigTransformer202205123\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202205123\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
