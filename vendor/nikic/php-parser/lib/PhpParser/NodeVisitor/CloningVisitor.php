 ...
 */
class CloningVisitor extends \ConfigTransformer202206079\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202206079\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
