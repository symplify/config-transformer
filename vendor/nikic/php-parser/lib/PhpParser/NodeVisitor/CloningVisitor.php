 ...
 */
class CloningVisitor extends \ConfigTransformer202202043\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202202043\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
