 ...
 */
class CloningVisitor extends \ConfigTransformer202107061\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202107061\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
