 ...
 */
class CloningVisitor extends \ConfigTransformer202204146\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202204146\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
