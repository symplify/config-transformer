 ...
 */
class CloningVisitor extends \ConfigTransformer202107080\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202107080\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
