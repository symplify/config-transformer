 ...
 */
class CloningVisitor extends \ConfigTransformer202205015\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202205015\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
