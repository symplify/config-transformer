 ...
 */
class CloningVisitor extends \ConfigTransformer202206052\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202206052\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
