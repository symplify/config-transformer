 ...
 */
class CloningVisitor extends \ConfigTransformer202106282\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202106282\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
