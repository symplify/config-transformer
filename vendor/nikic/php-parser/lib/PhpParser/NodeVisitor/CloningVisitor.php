 ...
 */
class CloningVisitor extends \ConfigTransformer202203157\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202203157\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
