 ...
 */
class CloningVisitor extends \ConfigTransformer202205120\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202205120\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
