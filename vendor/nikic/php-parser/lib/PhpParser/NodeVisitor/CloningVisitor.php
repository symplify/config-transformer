 ...
 */
class CloningVisitor extends \ConfigTransformer202205033\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202205033\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
