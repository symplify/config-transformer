 ...
 */
class CloningVisitor extends \ConfigTransformer202205131\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202205131\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
