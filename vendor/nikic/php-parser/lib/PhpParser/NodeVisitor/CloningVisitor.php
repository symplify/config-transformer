 ...
 */
class CloningVisitor extends \ConfigTransformer202112194\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202112194\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
