 ...
 */
class CloningVisitor extends \ConfigTransformer202206041\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202206041\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
