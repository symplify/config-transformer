 ...
 */
class CloningVisitor extends \ConfigTransformer202201258\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202201258\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
