 ...
 */
class CloningVisitor extends \ConfigTransformer2022051710\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer2022051710\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
