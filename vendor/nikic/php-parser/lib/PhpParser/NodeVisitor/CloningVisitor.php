 ...
 */
class CloningVisitor extends \ConfigTransformer202112108\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202112108\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
