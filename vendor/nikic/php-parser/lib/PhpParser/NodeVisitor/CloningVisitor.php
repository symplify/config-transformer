 ...
 */
class CloningVisitor extends \ConfigTransformer2022041410\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer2022041410\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
