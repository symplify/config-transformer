 ...
 */
class CloningVisitor extends \ConfigTransformer202206063\PhpParser\NodeVisitorAbstract
{
    public function enterNode(\ConfigTransformer202206063\PhpParser\Node $origNode)
    {
        $node = clone $origNode;
