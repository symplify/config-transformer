 ...
 */
namespace ConfigTransformer20220607\Composer;

use ConfigTransformer20220607\Composer\Autoload\ClassLoader;
use ConfigTransformer20220607\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ConfigTransformer20220607\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
