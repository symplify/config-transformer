 ...
 */
namespace ConfigTransformer202209\Composer;

use ConfigTransformer202209\Composer\Autoload\ClassLoader;
use ConfigTransformer202209\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ConfigTransformer202209\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
