 ...
 */
namespace ConfigTransformerPrefix202605\Composer;

use ConfigTransformerPrefix202605\Composer\Autoload\ClassLoader;
use ConfigTransformerPrefix202605\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ConfigTransformerPrefix202605\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
