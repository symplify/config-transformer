 ...
 */
namespace ConfigTransformerPrefix202507\Composer;

use ConfigTransformerPrefix202507\Composer\Autoload\ClassLoader;
use ConfigTransformerPrefix202507\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ConfigTransformerPrefix202507\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
