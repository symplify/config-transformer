 ...
 */
namespace ConfigTransformer202207\Composer;

use ConfigTransformer202207\Composer\Autoload\ClassLoader;
use ConfigTransformer202207\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ConfigTransformer202207\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
