 ...
 */
namespace ConfigTransformer202211\Composer;

use ConfigTransformer202211\Composer\Autoload\ClassLoader;
use ConfigTransformer202211\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ConfigTransformer202211\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
