 ...
 */
namespace ConfigTransformer20220608\Composer;

use ConfigTransformer20220608\Composer\Autoload\ClassLoader;
use ConfigTransformer20220608\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ConfigTransformer20220608\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
