 ...
 */
namespace ConfigTransformer202210\Composer;

use ConfigTransformer202210\Composer\Autoload\ClassLoader;
use ConfigTransformer202210\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ConfigTransformer202210\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
