 ...
 */
namespace ConfigTransformer20220609\Composer;

use ConfigTransformer20220609\Composer\Autoload\ClassLoader;
use ConfigTransformer20220609\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ConfigTransformer20220609\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
