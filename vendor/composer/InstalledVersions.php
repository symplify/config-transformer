 ...
 */
namespace ConfigTransformer20220613\Composer;

use ConfigTransformer20220613\Composer\Autoload\ClassLoader;
use ConfigTransformer20220613\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ConfigTransformer20220613\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
