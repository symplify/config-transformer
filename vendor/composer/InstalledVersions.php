 ...
 */
namespace ConfigTransformer202107129\Composer;

use ConfigTransformer202107129\Composer\Autoload\ClassLoader;
use ConfigTransformer202107129\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ConfigTransformer202107129\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\ConfigTransformer202107129\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
