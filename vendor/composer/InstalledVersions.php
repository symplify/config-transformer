 ...
 */
namespace ConfigTransformer202208\Composer;

use ConfigTransformer202208\Composer\Autoload\ClassLoader;
use ConfigTransformer202208\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ConfigTransformer202208\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
