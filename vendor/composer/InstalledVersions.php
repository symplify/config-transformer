 ...
 */
namespace ConfigTransformerPrefix202501\Composer;

use ConfigTransformerPrefix202501\Composer\Autoload\ClassLoader;
use ConfigTransformerPrefix202501\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('ConfigTransformerPrefix202501\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
