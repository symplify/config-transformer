...
use function trim;
class AssertTagValueNode implements \ConfigTransformer2022052210\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocTagValueNode
{
    use NodeAttributes;
    /** @var TypeNode */
    public $type;
    ...
    public $description;
    public function __construct(\ConfigTransformer2022052210\PHPStan\PhpDocParser\Ast\Type\TypeNode $type, string $parameter, bool $isNegated, string $description)
    {
        $this->type = $type;
