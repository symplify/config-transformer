...
use function trim;
class AssertTagValueNode implements \ConfigTransformer202205135\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocTagValueNode
{
    use NodeAttributes;
    /** @var TypeNode */
    public $type;
    ...
    public $description;
    public function __construct(\ConfigTransformer202205135\PHPStan\PhpDocParser\Ast\Type\TypeNode $type, string $parameter, bool $isNegated, string $description)
    {
        $this->type = $type;
