...
use ConfigTransformer2022053010\PHPStan\PhpDocParser\Parser\ParserException;
 ...
 */
class InvalidTagValueNode implements \ConfigTransformer2022053010\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocTagValueNode
{
    use NodeAttributes;
    ...
    public function __construct(string $value, \ConfigTransformer2022053010\PHPStan\PhpDocParser\Parser\ParserException $exception)
    {
        $this->value = $value;
    ...
    public function __get(string $name)
    {
        ...
        return new \ConfigTransformer2022053010\PHPStan\PhpDocParser\Parser\ParserException(...$this->exceptionArgs);
    }
