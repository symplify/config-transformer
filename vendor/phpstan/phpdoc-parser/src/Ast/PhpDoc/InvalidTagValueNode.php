...
use ConfigTransformer202206021\PHPStan\PhpDocParser\Parser\ParserException;
 ...
 */
class InvalidTagValueNode implements \ConfigTransformer202206021\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocTagValueNode
{
    use NodeAttributes;
    ...
    public function __construct(string $value, \ConfigTransformer202206021\PHPStan\PhpDocParser\Parser\ParserException $exception)
    {
        $this->value = $value;
    ...
    public function __get(string $name)
    {
        ...
        return new \ConfigTransformer202206021\PHPStan\PhpDocParser\Parser\ParserException(...$this->exceptionArgs);
    }
