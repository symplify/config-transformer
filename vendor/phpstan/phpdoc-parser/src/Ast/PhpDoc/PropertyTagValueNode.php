...
class PropertyTagValueNode implements \ConfigTransformer202203177\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocTagValueNode
{
    use NodeAttributes;
    /** @var TypeNode */
    public $type;
    ...
    public $description;
    public function __construct(\ConfigTransformer202203177\PHPStan\PhpDocParser\Ast\Type\TypeNode $type, string $propertyName, string $description)
    {
        $this->type = $type;
