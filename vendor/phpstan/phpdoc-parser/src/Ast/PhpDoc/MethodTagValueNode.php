...
class MethodTagValueNode implements \ConfigTransformer202205275\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocTagValueNode
{
    use NodeAttributes;
    /** @var bool */
    public $isStatic;
    ...
    public $description;
    public function __construct(bool $isStatic, ?\ConfigTransformer202205275\PHPStan\PhpDocParser\Ast\Type\TypeNode $returnType, string $methodName, array $parameters, string $description)
    {
