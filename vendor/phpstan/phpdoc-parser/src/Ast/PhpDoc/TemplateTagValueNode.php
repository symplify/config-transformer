...
use function trim;
class TemplateTagValueNode implements \ConfigTransformer202205148\PHPStan\PhpDocParser\Ast\PhpDoc\PhpDocTagValueNode
{
    use NodeAttributes;
    /** @var string */
    public $name;
    ...
    public $description;
    public function __construct(string $name, ?\ConfigTransformer202205148\PHPStan\PhpDocParser\Ast\Type\TypeNode $bound, string $description)
    {
        $this->name = $name;
        $this->bound = $bound;
