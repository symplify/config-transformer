...
class ConstTypeNode implements \ConfigTransformer202205124\PHPStan\PhpDocParser\Ast\Type\TypeNode
{
    use NodeAttributes;
    /** @var ConstExprNode */
    public $constExpr;
    public function __construct(\ConfigTransformer202205124\PHPStan\PhpDocParser\Ast\ConstExpr\ConstExprNode $constExpr)
    {
