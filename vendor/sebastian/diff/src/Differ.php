...
use function substr;
use ConfigTransformerPrefix202302\SebastianBergmann\Diff\Output\DiffOutputBuilderInterface;
use ConfigTransformerPrefix202302\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder;
final class Differ
{
    public const OLD = 0;
