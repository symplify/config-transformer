...
use function substr;
use ConfigTransformer20220608\SebastianBergmann\Diff\Output\DiffOutputBuilderInterface;
use ConfigTransformer20220608\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder;
final class Differ
{
    public const OLD = 0;
