...
use function substr;
use ConfigTransformer202212\SebastianBergmann\Diff\Output\DiffOutputBuilderInterface;
use ConfigTransformer202212\SebastianBergmann\Diff\Output\UnifiedDiffOutputBuilder;
final class Differ
{
    public const OLD = 0;
