 ...
 */
namespace ConfigTransformer2022060710\Symfony\Polyfill\Intl\Grapheme;

\define('ConfigTransformer2022060710\\SYMFONY_GRAPHEME_CLUSTER_RX', ((float) \PCRE_VERSION < 10 ? (float) \PCRE_VERSION >= 8.32 : (float) \PCRE_VERSION >= 10.39) ? '\\X' : Grapheme::GRAPHEME_CLUSTER_RX);
/**
