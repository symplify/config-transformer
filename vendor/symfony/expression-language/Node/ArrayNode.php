 ...
 * @internal
 */
class ArrayNode extends \ConfigTransformer202110315\Symfony\Component\ExpressionLanguage\Node\Node
{
    protected $index;
    ...
    public function toArray()
    {
        ...
        if ($this->isHash($value)) {
            foreach ($value as $k => $v) {
                $array[] = ', ';
                $array[] = new \ConfigTransformer202110315\Symfony\Component\ExpressionLanguage\Node\ConstantNode($k);
                $array[] = ': ';
                $array[] = $v;
            }
            $array[0] = '{';
