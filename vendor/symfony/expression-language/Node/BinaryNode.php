 ...
 * @internal
 */
class BinaryNode extends \ConfigTransformer202110259\Symfony\Component\ExpressionLanguage\Node\Node
{
    private const OPERATORS = ['~' => '.', 'and' => '&&', 'or' => '||'];
    private const FUNCTIONS = ['**' => 'pow', '..' => 'range', 'in' => 'in_array', 'not in' => '!in_array'];
    public function __construct(string $operator, \ConfigTransformer202110259\Symfony\Component\ExpressionLanguage\Node\Node $left, \ConfigTransformer202110259\Symfony\Component\ExpressionLanguage\Node\Node $right)
    {
