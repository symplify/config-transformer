 ...
 * @internal
 */
class BinaryNode extends \ConfigTransformer2021080410\Symfony\Component\ExpressionLanguage\Node\Node
{
    private const OPERATORS = ['~' => '.', 'and' => '&&', 'or' => '||'];
    private const FUNCTIONS = ['**' => 'pow', '..' => 'range', 'in' => 'in_array', 'not in' => '!in_array'];
    public function __construct(string $operator, \ConfigTransformer2021080410\Symfony\Component\ExpressionLanguage\Node\Node $left, \ConfigTransformer2021080410\Symfony\Component\ExpressionLanguage\Node\Node $right)
    {
