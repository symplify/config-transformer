 ...
 * @internal
 */
class GetAttrNode extends \ConfigTransformer202112085\Symfony\Component\ExpressionLanguage\Node\Node
{
    public const PROPERTY_CALL = 1;
    public const METHOD_CALL = 2;
    public const ARRAY_CALL = 3;
    public function __construct(\ConfigTransformer202112085\Symfony\Component\ExpressionLanguage\Node\Node $node, \ConfigTransformer202112085\Symfony\Component\ExpressionLanguage\Node\Node $attribute, \ConfigTransformer202112085\Symfony\Component\ExpressionLanguage\Node\ArrayNode $arguments, int $type)
    {
