 ...
 * @internal
 */
class UnaryNode extends \ConfigTransformer20210606\Symfony\Component\ExpressionLanguage\Node\Node
{
    private const OPERATORS = ['!' => '!', 'not' => '!', '+' => '+', '-' => '-'];
    public function __construct(string $operator, \ConfigTransformer20210606\Symfony\Component\ExpressionLanguage\Node\Node $node)
    {
