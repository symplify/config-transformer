 ...
 * @internal
 */
class UnaryNode extends \ConfigTransformer202108207\Symfony\Component\ExpressionLanguage\Node\Node
{
    private const OPERATORS = ['!' => '!', 'not' => '!', '+' => '+', '-' => '-'];
    public function __construct(string $operator, \ConfigTransformer202108207\Symfony\Component\ExpressionLanguage\Node\Node $node)
    {
