 ...
 * @internal
 */
class UnaryNode extends \ConfigTransformer2021101110\Symfony\Component\ExpressionLanguage\Node\Node
{
    private const OPERATORS = ['!' => '!', 'not' => '!', '+' => '+', '-' => '-'];
    public function __construct(string $operator, \ConfigTransformer2021101110\Symfony\Component\ExpressionLanguage\Node\Node $node)
    {
