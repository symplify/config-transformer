 ...
 * @internal
 */
class UnaryNode extends \ConfigTransformer202111218\Symfony\Component\ExpressionLanguage\Node\Node
{
    private const OPERATORS = ['!' => '!', 'not' => '!', '+' => '+', '-' => '-'];
    public function __construct(string $operator, \ConfigTransformer202111218\Symfony\Component\ExpressionLanguage\Node\Node $node)
    {
