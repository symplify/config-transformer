 ...
 * @internal
 */
class UnaryNode extends \ConfigTransformer2021061810\Symfony\Component\ExpressionLanguage\Node\Node
{
    private const OPERATORS = ['!' => '!', 'not' => '!', '+' => '+', '-' => '-'];
    public function __construct(string $operator, \ConfigTransformer2021061810\Symfony\Component\ExpressionLanguage\Node\Node $node)
    {
