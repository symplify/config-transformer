 ...
 */
class ClassStub extends \ConfigTransformer2021072110\Symfony\Component\VarDumper\Caster\ConstStub
{
    /**
    ...
    public function __construct(string $identifier, $callable = null)
    {
        ...
        try {
            ...
            if (null !== $callable && $r instanceof \ReflectionFunctionAbstract) {
                $s = \ConfigTransformer2021072110\Symfony\Component\VarDumper\Caster\ReflectionCaster::castFunctionAbstract($r, [], new \ConfigTransformer2021072110\Symfony\Component\VarDumper\Cloner\Stub(), \true, \ConfigTransformer2021072110\Symfony\Component\VarDumper\Caster\Caster::EXCLUDE_VERBOSE);
                $s = \ConfigTransformer2021072110\Symfony\Component\VarDumper\Caster\ReflectionCaster::getSignature($s);
