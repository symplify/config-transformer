 ...
 */
class HtmlDumper extends \ConfigTransformer202106187\Symfony\Component\VarDumper\Dumper\CliDumper
{
    ...
    {
        \ConfigTransformer202106187\Symfony\Component\VarDumper\Dumper\AbstractDumper::__construct($output, $charset, $flags);
     ...
     */
    public function dump(\ConfigTransformer202106187\Symfony\Component\VarDumper\Cloner\Data $data, $output = null, $extraDisplayOptions = [])
    {
...
EOHTML
    ...
    public function enterHash(\ConfigTransformer202106187\Symfony\Component\VarDumper\Cloner\Cursor $cursor, int $type, $class, bool $hasChild)
    {
        ...
        if ($hasChild) {
            ...
            if ($cursor->refIndex) {
                $r = \ConfigTransformer202106187\Symfony\Component\VarDumper\Cloner\Cursor::HASH_OBJECT !== $type ? 1 - (\ConfigTransformer202106187\Symfony\Component\VarDumper\Cloner\Cursor::HASH_RESOURCE !== $type) : 2;
    ...
    protected function dumpLine(int $depth, $endOfValue = \false)
    {
        ...
        if (-1 === $depth) {
            \ConfigTransformer202106187\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine(0);
        }
        \ConfigTransformer202106187\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine($depth);
    }
