 ...
 */
class HtmlDumper extends \ConfigTransformer202107139\Symfony\Component\VarDumper\Dumper\CliDumper
{
    ...
    {
        \ConfigTransformer202107139\Symfony\Component\VarDumper\Dumper\AbstractDumper::__construct($output, $charset, $flags);
...
EOHTML
    ...
    public function enterHash($cursor, $type, $class, $hasChild)
    {
        ...
        if ($hasChild) {
            ...
            if ($cursor->refIndex) {
                $r = \ConfigTransformer202107139\Symfony\Component\VarDumper\Cloner\Cursor::HASH_OBJECT !== $type ? 1 - (\ConfigTransformer202107139\Symfony\Component\VarDumper\Cloner\Cursor::HASH_RESOURCE !== $type) : 2;
    ...
    protected function dumpLine($depth, $endOfValue = \false)
    {
        ...
        if (-1 === $depth) {
            \ConfigTransformer202107139\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine(0);
        }
        \ConfigTransformer202107139\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine($depth);
    }
