 ...
 */
namespace ConfigTransformerPrefix202401\Symfony\Component\String;

use ConfigTransformerPrefix202401\Symfony\Component\String\Exception\ExceptionInterface;
use ConfigTransformerPrefix202401\Symfony\Component\String\Exception\InvalidArgumentException;
use ConfigTransformerPrefix202401\Symfony\Component\String\Exception\RuntimeException;
/**
...
class ByteString extends AbstractString
{
    ...
    {
        $str = $this->camel();
        $str->string = \strtolower(\preg_replace(['/([A-Z]+)([A-Z][a-z])/', '/([a-z\\d])([A-Z])/'], 'ConfigTransformerPrefix202401\\1_\\2', $str->string));
        return $str;
    }
    /**
     * @return static
