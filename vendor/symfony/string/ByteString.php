 ...
 */
namespace ConfigTransformerPrefix202501\Symfony\Component\String;

use ConfigTransformerPrefix202501\Random\Randomizer;
use ConfigTransformerPrefix202501\Symfony\Component\String\Exception\ExceptionInterface;
use ConfigTransformerPrefix202501\Symfony\Component\String\Exception\InvalidArgumentException;
use ConfigTransformerPrefix202501\Symfony\Component\String\Exception\RuntimeException;
/**
...
class ByteString extends AbstractString
{
    ...
    {
        $str = $this->camel();
        $str->string = \strtolower(\preg_replace(['/([A-Z]+)([A-Z][a-z])/', '/([a-z\\d])([A-Z])/'], 'ConfigTransformerPrefix202501\\1_\\2', $str->string));
        return $str;
    }
    /**
     * @return static
