 ...
 */
namespace ConfigTransformer202211\Symfony\Component\String;

use ConfigTransformer202211\Symfony\Component\String\Exception\ExceptionInterface;
use ConfigTransformer202211\Symfony\Component\String\Exception\InvalidArgumentException;
use ConfigTransformer202211\Symfony\Component\String\Exception\RuntimeException;
/**
...
class ByteString extends AbstractString
{
    ...
    {
        $str = $this->camel();
        $str->string = \strtolower(\preg_replace(['/([A-Z]+)([A-Z][a-z])/', '/([a-z\\d])([A-Z])/'], 'ConfigTransformer202211\\1_\\2', $str->string));
        return $str;
    }
    /**
     * @return $this
