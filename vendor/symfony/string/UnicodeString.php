 ...
 */
class UnicodeString extends \ConfigTransformer202108183\Symfony\Component\String\AbstractUnicodeString
{
    public function __construct(string $string = '')
    {
        $this->string = \normalizer_is_normalized($string) ? $string : \normalizer_normalize($string);
        if (\false === $this->string) {
            throw new \ConfigTransformer202108183\Symfony\Component\String\Exception\InvalidArgumentException('Invalid UTF-8 string.');
        }
    }
    /**
     * @param string ...$suffix
     */
    public function append(...$suffix) : \ConfigTransformer202108183\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
    ...
    {
        if ($suffix instanceof \ConfigTransformer202108183\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($string instanceof \ConfigTransformer202108183\Symfony\Component\String\AbstractString) {
    ...
    {
        if ($needle instanceof \ConfigTransformer202108183\Symfony\Component\String\AbstractString) {
     ...
     */
    public function join($strings, $lastGlue = null) : \ConfigTransformer202108183\Symfony\Component\String\AbstractString
    {
    ...
    public function normalize($form = self::NFC)
    {
        ...
        if (\in_array($form, [self::NFC, self::NFKC], \true)) {
            ...
            throw new \ConfigTransformer202108183\Symfony\Component\String\Exception\InvalidArgumentException('Unsupported normalization form.');
     ...
     * @param string ...$prefix
     */
    public function prepend(...$prefix) : \ConfigTransformer202108183\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
     ...
     * @param string $to
     */
    public function replace($from, $to) : \ConfigTransformer202108183\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
     ...
     */
    public function replaceMatches($fromRegexp, $to) : \ConfigTransformer202108183\Symfony\Component\String\AbstractString
    {
     ...
     */
    public function slice($start = 0, $length = null) : \ConfigTransformer202108183\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
     ...
     * @param int|null $length
     */
    public function splice($replacement, $start = 0, $length = null) : \ConfigTransformer202108183\Symfony\Component\String\AbstractString
    {
        $str = clone $this;
        if (\PHP_VERSION_ID < 80000 && 0 > $start && \grapheme_strlen($this->string) < -$start) {
            $start = 0;
    ...
    public function split($delimiter, $limit = null, $flags = null) : array
    {
        ...
        if (\false === $delimiter) {
            throw new \ConfigTransformer202108183\Symfony\Component\String\Exception\InvalidArgumentException('Split delimiter is not a valid UTF-8 string.');
        }
        $str = clone $this;
        $tail = $this->string;
        $chunks = [];
    ...
    {
        if ($prefix instanceof \ConfigTransformer202108183\Symfony\Component\String\AbstractString) {
