 ...
 */
namespace ConfigTransformer2021093010\Symfony\Component\String\Slugger;

use ConfigTransformer2021093010\Symfony\Component\String\AbstractUnicodeString;
...
if (!\interface_exists(\ConfigTransformer2021093010\Symfony\Contracts\Translation\LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "Symfony\\Component\\String\\Slugger\\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
/**
 * @author Titouan Galopin <galopintitouan@gmail.com>
 */
class AsciiSlugger implements \ConfigTransformer2021093010\Symfony\Component\String\Slugger\SluggerInterface, \ConfigTransformer2021093010\Symfony\Contracts\Translation\LocaleAwareInterface
{
     ...
     */
    public function slug($string, $separator = '-', $locale = null) : \ConfigTransformer2021093010\Symfony\Component\String\AbstractUnicodeString
    {
        ...
        $unicodeString = (new \ConfigTransformer2021093010\Symfony\Component\String\UnicodeString($string))->ascii($transliterator);
