...
use ConfigTransformer202201243\Symfony\Component\Finder\Gitignore;
final class VcsIgnoredFilterIterator extends \FilterIterator
{
    ...
    private function readGitignoreFile(string $path) : ?array
    {
        ...
        return $this->gitignoreFilesCache[$path] = [\ConfigTransformer202201243\Symfony\Component\Finder\Gitignore::toRegex($gitignoreFileContent), \ConfigTransformer202201243\Symfony\Component\Finder\Gitignore::toRegexMatchingNegatedPatterns($gitignoreFileContent)];
    }
