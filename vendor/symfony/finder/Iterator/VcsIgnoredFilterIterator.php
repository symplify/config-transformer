...
use ConfigTransformer202203078\Symfony\Component\Finder\Gitignore;
final class VcsIgnoredFilterIterator extends \FilterIterator
{
    ...
    private function readGitignoreFile(string $path) : ?array
    {
        ...
        return $this->gitignoreFilesCache[$path] = [\ConfigTransformer202203078\Symfony\Component\Finder\Gitignore::toRegex($gitignoreFileContent), \ConfigTransformer202203078\Symfony\Component\Finder\Gitignore::toRegexMatchingNegatedPatterns($gitignoreFileContent)];
    }
