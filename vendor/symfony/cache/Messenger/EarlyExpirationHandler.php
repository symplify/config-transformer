...
use ConfigTransformerPrefix202605\Symfony\Component\Messenger\Attribute\AsMessageHandler;
/**
...
class EarlyExpirationHandler
{
    ...
    public function __invoke(EarlyExpirationMessage $message)
    {
        ...
        static $setMetadata;
        $setMetadata = $setMetadata ?? \Closure::bind(static function (CacheItem $item, float $startTime) {
