...
final class EarlyExpirationMessage
{
    ...
    public static function create(\ConfigTransformer202206079\Symfony\Component\DependencyInjection\ReverseContainer $reverseContainer, callable $callback, \ConfigTransformer202206079\Symfony\Component\Cache\CacheItem $item, \ConfigTransformer202206079\Symfony\Component\Cache\Adapter\AdapterInterface $pool) : ?self
    {
        try {
            $item = clone $item;
            $item->set(null);
    ...
    public function getItem() : \ConfigTransformer202206079\Symfony\Component\Cache\CacheItem
    {
        return $this->item;
    }
    ...
    public function findPool(\ConfigTransformer202206079\Symfony\Component\DependencyInjection\ReverseContainer $reverseContainer) : \ConfigTransformer202206079\Symfony\Component\Cache\Adapter\AdapterInterface
    {
        return $reverseContainer->getService($this->pool);
    }
    public function findCallback(\ConfigTransformer202206079\Symfony\Component\DependencyInjection\ReverseContainer $reverseContainer) : callable
    {
    ...
    private function __construct(\ConfigTransformer202206079\Symfony\Component\Cache\CacheItem $item, string $pool, string|array $callback)
    {
        $this->item = $item;
        $this->pool = $pool;
