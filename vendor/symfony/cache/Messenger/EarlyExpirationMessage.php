...
final class EarlyExpirationMessage
{
    ...
    public static function create(\ConfigTransformer202203032\Symfony\Component\DependencyInjection\ReverseContainer $reverseContainer, callable $callback, \ConfigTransformer202203032\Symfony\Component\Cache\CacheItem $item, \ConfigTransformer202203032\Symfony\Component\Cache\Adapter\AdapterInterface $pool) : ?self
    {
        try {
            $item = clone $item;
            $item->set(null);
    ...
    public function getItem() : \ConfigTransformer202203032\Symfony\Component\Cache\CacheItem
    {
        return $this->item;
    }
    ...
    public function findPool(\ConfigTransformer202203032\Symfony\Component\DependencyInjection\ReverseContainer $reverseContainer) : \ConfigTransformer202203032\Symfony\Component\Cache\Adapter\AdapterInterface
    {
        return $reverseContainer->getService($this->pool);
    }
    public function findCallback(\ConfigTransformer202203032\Symfony\Component\DependencyInjection\ReverseContainer $reverseContainer) : callable
    {
    ...
    private function __construct(\ConfigTransformer202203032\Symfony\Component\Cache\CacheItem $item, string $pool, string|array $callback)
    {
        $this->item = $item;
        $this->pool = $pool;
