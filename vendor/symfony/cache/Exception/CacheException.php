...
if (\interface_exists(\ConfigTransformer202106129\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer202106129\Psr\Cache\CacheException, \ConfigTransformer202106129\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer202106129\Psr\Cache\CacheException
    {
    }
}
