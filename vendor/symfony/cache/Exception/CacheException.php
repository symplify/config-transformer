...
if (\interface_exists(\ConfigTransformer202112190\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer202112190\Psr\Cache\CacheException, \ConfigTransformer202112190\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer202112190\Psr\Cache\CacheException
    {
    }
}
