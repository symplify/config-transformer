...
if (\interface_exists(\ConfigTransformer202111019\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer202111019\Psr\Cache\CacheException, \ConfigTransformer202111019\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer202111019\Psr\Cache\CacheException
    {
    }
}
