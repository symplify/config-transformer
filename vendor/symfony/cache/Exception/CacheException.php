...
if (\interface_exists(\ConfigTransformer202108312\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer202108312\Psr\Cache\CacheException, \ConfigTransformer202108312\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer202108312\Psr\Cache\CacheException
    {
    }
}
