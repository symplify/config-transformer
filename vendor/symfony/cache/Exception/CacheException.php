...
if (\interface_exists(\ConfigTransformer202110017\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer202110017\Psr\Cache\CacheException, \ConfigTransformer202110017\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer202110017\Psr\Cache\CacheException
    {
    }
}
