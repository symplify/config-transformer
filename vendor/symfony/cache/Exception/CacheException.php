...
if (\interface_exists(\ConfigTransformer202111114\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer202111114\Psr\Cache\CacheException, \ConfigTransformer202111114\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer202111114\Psr\Cache\CacheException
    {
    }
}
