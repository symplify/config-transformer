...
if (\interface_exists(\ConfigTransformer2022052410\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer2022052410\Psr\Cache\CacheException, \ConfigTransformer2022052410\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer2022052410\Psr\Cache\CacheException
    {
    }
}
