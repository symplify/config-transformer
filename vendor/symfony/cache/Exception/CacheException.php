...
if (\interface_exists(\ConfigTransformer202205305\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer202205305\Psr\Cache\CacheException, \ConfigTransformer202205305\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer202205305\Psr\Cache\CacheException
    {
    }
}
