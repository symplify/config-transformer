...
if (\interface_exists(\ConfigTransformer202203163\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer202203163\Psr\Cache\CacheException, \ConfigTransformer202203163\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer202203163\Psr\Cache\CacheException
    {
    }
}
