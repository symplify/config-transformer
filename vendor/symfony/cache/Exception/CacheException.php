...
if (\interface_exists(\ConfigTransformer202107130\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer202107130\Psr\Cache\CacheException, \ConfigTransformer202107130\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer202107130\Psr\Cache\CacheException
    {
    }
}
