...
if (\interface_exists(\ConfigTransformer2021061210\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer2021061210\Psr\Cache\CacheException, \ConfigTransformer2021061210\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer2021061210\Psr\Cache\CacheException
    {
    }
}
