...
if (\interface_exists(\ConfigTransformer2021101110\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer2021101110\Psr\Cache\CacheException, \ConfigTransformer2021101110\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer2021101110\Psr\Cache\CacheException
    {
    }
}
