...
if (\interface_exists(\ConfigTransformer202201160\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer202201160\Psr\Cache\CacheException, \ConfigTransformer202201160\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer202201160\Psr\Cache\CacheException
    {
    }
}
