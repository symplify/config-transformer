...
if (\interface_exists(\ConfigTransformer202112197\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer202112197\Psr\Cache\CacheException, \ConfigTransformer202112197\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer202112197\Psr\Cache\CacheException
    {
    }
}
