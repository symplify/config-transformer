...
if (\interface_exists(\ConfigTransformer2022053010\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer2022053010\Psr\Cache\CacheException, \ConfigTransformer2022053010\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer2022053010\Psr\Cache\CacheException
    {
    }
}
