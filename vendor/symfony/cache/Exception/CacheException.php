...
if (\interface_exists(\ConfigTransformer202110111\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer202110111\Psr\Cache\CacheException, \ConfigTransformer202110111\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer202110111\Psr\Cache\CacheException
    {
    }
}
