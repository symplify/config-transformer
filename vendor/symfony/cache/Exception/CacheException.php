...
if (\interface_exists(\ConfigTransformer202110259\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer202110259\Psr\Cache\CacheException, \ConfigTransformer202110259\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer202110259\Psr\Cache\CacheException
    {
    }
}
