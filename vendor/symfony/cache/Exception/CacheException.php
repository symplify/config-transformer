...
if (\interface_exists(\ConfigTransformer2021120610\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer2021120610\Psr\Cache\CacheException, \ConfigTransformer2021120610\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer2021120610\Psr\Cache\CacheException
    {
    }
}
