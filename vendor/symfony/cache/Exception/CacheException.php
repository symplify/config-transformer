...
if (\interface_exists(\ConfigTransformer202112141\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer202112141\Psr\Cache\CacheException, \ConfigTransformer202112141\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer202112141\Psr\Cache\CacheException
    {
    }
}
