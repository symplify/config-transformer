...
if (\interface_exists(\ConfigTransformer202107112\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer202107112\Psr\Cache\CacheException, \ConfigTransformer202107112\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer202107112\Psr\Cache\CacheException
    {
    }
}
