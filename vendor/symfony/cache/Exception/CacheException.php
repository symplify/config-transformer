...
if (\interface_exists(\ConfigTransformer202107039\Psr\SimpleCache\CacheException::class)) {
    class CacheException extends \Exception implements \ConfigTransformer202107039\Psr\Cache\CacheException, \ConfigTransformer202107039\Psr\SimpleCache\CacheException
    {
    }
} else {
    class CacheException extends \Exception implements \ConfigTransformer202107039\Psr\Cache\CacheException
    {
    }
}
