...
if (\interface_exists(\ConfigTransformer202203082\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \ConfigTransformer202203082\Psr\Cache\CacheException, \ConfigTransformer202203082\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \ConfigTransformer202203082\Psr\Cache\CacheException
    {
    }
}
