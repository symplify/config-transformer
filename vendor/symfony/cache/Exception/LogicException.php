...
if (\interface_exists(\ConfigTransformer202110315\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \ConfigTransformer202110315\Psr\Cache\CacheException, \ConfigTransformer202110315\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \ConfigTransformer202110315\Psr\Cache\CacheException
    {
    }
}
