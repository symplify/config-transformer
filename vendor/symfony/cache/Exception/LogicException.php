...
if (\interface_exists(\ConfigTransformer202108211\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \ConfigTransformer202108211\Psr\Cache\CacheException, \ConfigTransformer202108211\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \ConfigTransformer202108211\Psr\Cache\CacheException
    {
    }
}
