...
if (\interface_exists(\ConfigTransformer202201257\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \ConfigTransformer202201257\Psr\Cache\CacheException, \ConfigTransformer202201257\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \ConfigTransformer202201257\Psr\Cache\CacheException
    {
    }
}
