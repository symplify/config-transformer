...
if (\interface_exists(\ConfigTransformer202205134\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \ConfigTransformer202205134\Psr\Cache\CacheException, \ConfigTransformer202205134\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \ConfigTransformer202205134\Psr\Cache\CacheException
    {
    }
}
