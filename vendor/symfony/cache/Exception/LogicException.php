...
if (\interface_exists(\ConfigTransformer202112121\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \ConfigTransformer202112121\Psr\Cache\CacheException, \ConfigTransformer202112121\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \ConfigTransformer202112121\Psr\Cache\CacheException
    {
    }
}
