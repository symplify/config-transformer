...
if (\interface_exists(\ConfigTransformer202108226\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \ConfigTransformer202108226\Psr\Cache\CacheException, \ConfigTransformer202108226\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \ConfigTransformer202108226\Psr\Cache\CacheException
    {
    }
}
