...
if (\interface_exists(\ConfigTransformer202202064\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \ConfigTransformer202202064\Psr\Cache\CacheException, \ConfigTransformer202202064\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \ConfigTransformer202202064\Psr\Cache\CacheException
    {
    }
}
