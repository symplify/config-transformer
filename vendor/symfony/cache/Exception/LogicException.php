...
if (\interface_exists(\ConfigTransformer202106265\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \ConfigTransformer202106265\Psr\Cache\CacheException, \ConfigTransformer202106265\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \ConfigTransformer202106265\Psr\Cache\CacheException
    {
    }
}
