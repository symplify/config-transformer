...
if (\interface_exists(\ConfigTransformer202111179\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \ConfigTransformer202111179\Psr\Cache\CacheException, \ConfigTransformer202111179\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \ConfigTransformer202111179\Psr\Cache\CacheException
    {
    }
}
