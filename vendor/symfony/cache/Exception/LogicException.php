...
if (\interface_exists(\ConfigTransformer2022012510\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \ConfigTransformer2022012510\Psr\Cache\CacheException, \ConfigTransformer2022012510\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \ConfigTransformer2022012510\Psr\Cache\CacheException
    {
    }
}
