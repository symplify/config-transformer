...
if (\interface_exists(\ConfigTransformer202109098\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \ConfigTransformer202109098\Psr\Cache\CacheException, \ConfigTransformer202109098\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \ConfigTransformer202109098\Psr\Cache\CacheException
    {
    }
}
