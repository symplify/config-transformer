...
if (\interface_exists(\ConfigTransformer202202215\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \ConfigTransformer202202215\Psr\Cache\CacheException, \ConfigTransformer202202215\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \ConfigTransformer202202215\Psr\Cache\CacheException
    {
    }
}
