...
if (\interface_exists(\ConfigTransformer202107149\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \ConfigTransformer202107149\Psr\Cache\CacheException, \ConfigTransformer202107149\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \ConfigTransformer202107149\Psr\Cache\CacheException
    {
    }
}
