...
if (\interface_exists(\ConfigTransformer2021093010\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \ConfigTransformer2021093010\Psr\Cache\CacheException, \ConfigTransformer2021093010\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \ConfigTransformer2021093010\Psr\Cache\CacheException
    {
    }
}
