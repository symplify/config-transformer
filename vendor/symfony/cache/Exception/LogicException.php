...
if (\interface_exists(\ConfigTransformer202205016\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \ConfigTransformer202205016\Psr\Cache\CacheException, \ConfigTransformer202205016\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \ConfigTransformer202205016\Psr\Cache\CacheException
    {
    }
}
