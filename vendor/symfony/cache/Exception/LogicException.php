...
if (\interface_exists(\ConfigTransformer2021122310\Psr\SimpleCache\CacheException::class)) {
    class LogicException extends \LogicException implements \ConfigTransformer2021122310\Psr\Cache\CacheException, \ConfigTransformer2021122310\Psr\SimpleCache\CacheException
    {
    }
} else {
    class LogicException extends \LogicException implements \ConfigTransformer2021122310\Psr\Cache\CacheException
    {
    }
}
