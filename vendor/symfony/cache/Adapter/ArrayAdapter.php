...
use ConfigTransformerPrefix202606\Psr\Cache\CacheItemInterface;
use ConfigTransformerPrefix202606\Psr\Log\LoggerAwareInterface;
use ConfigTransformerPrefix202606\Psr\Log\LoggerAwareTrait;
...
class ArrayAdapter implements AdapterInterface, CacheInterface, LoggerAwareInterface, ResettableInterface
{
    ...
    public function __construct(int $defaultLifetime = 0, bool $storeSerialized = \true, float $maxLifetime = 0, int $maxItems = 0)
    {
        ...
        self::$createCacheItem = self::$createCacheItem ?? \Closure::bind(static function ($key, $value, $isHit, $tags, $expiry = null) {
            $item = new CacheItem();
            $item->key = $key;
            $item->value = $value;
            $item->isHit = $isHit;
     ...
     * @param mixed $key
     */
    public function getItem($key) : \ConfigTransformerPrefix202606\Psr\Cache\CacheItemInterface
    {
