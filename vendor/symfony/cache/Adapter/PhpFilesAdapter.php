...
use ConfigTransformerPrefix202605\Symfony\Component\Cache\Traits\CachedValueInterface;
use ConfigTransformerPrefix202605\Symfony\Component\Cache\Traits\FilesystemCommonTrait;
use ConfigTransformerPrefix202605\Symfony\Component\VarExporter\VarExporter;
/**
...
class PhpFilesAdapter extends AbstractAdapter implements PruneableInterface
{
    ...
    private function getFileKey(string $file) : string
    {
        ...
        $encodedKey = (string) \substr(\fgets($h), 8);
        \fclose($h);
