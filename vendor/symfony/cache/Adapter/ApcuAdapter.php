 ...
 */
class ApcuAdapter extends \ConfigTransformer202108303\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    private $marshaller;
    /**
     * @throws CacheException if APCu is not enabled
     */
    public function __construct(string $namespace = '', int $defaultLifetime = 0, string $version = null, \ConfigTransformer202108303\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
        if (!static::isSupported()) {
            throw new \ConfigTransformer202108303\Symfony\Component\Cache\Exception\CacheException('APCu is not enabled.');
        }
        if ('cli' === \PHP_SAPI) {
        ...
        if (null !== $version) {
            \ConfigTransformer202108303\Symfony\Component\Cache\CacheItem::validateKey($version);
