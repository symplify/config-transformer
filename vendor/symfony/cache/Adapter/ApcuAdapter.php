 ...
 */
class ApcuAdapter extends \ConfigTransformer202112063\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    private ?\ConfigTransformer202112063\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller;
    /**
     * @throws CacheException if APCu is not enabled
     */
    public function __construct(string $namespace = '', int $defaultLifetime = 0, string $version = null, \ConfigTransformer202112063\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
        if (!static::isSupported()) {
            throw new \ConfigTransformer202112063\Symfony\Component\Cache\Exception\CacheException('APCu is not enabled.');
        }
        if ('cli' === \PHP_SAPI) {
        ...
        if (null !== $version) {
            \ConfigTransformer202112063\Symfony\Component\Cache\CacheItem::validateKey($version);
