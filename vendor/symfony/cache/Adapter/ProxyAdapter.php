...
class ProxyAdapter implements \ConfigTransformer2021120210\Symfony\Component\Cache\Adapter\AdapterInterface, \ConfigTransformer2021120210\Symfony\Contracts\Cache\CacheInterface, \ConfigTransformer2021120210\Symfony\Component\Cache\PruneableInterface, \ConfigTransformer2021120210\Symfony\Component\Cache\ResettableInterface
{
    ...
    public function __construct(\ConfigTransformer2021120210\Psr\Cache\CacheItemPoolInterface $pool, string $namespace = '', int $defaultLifetime = 0)
    {
        $this->pool = $pool;
        $this->poolHash = \spl_object_hash($pool);
        if ('' !== $namespace) {
            \assert('' !== \ConfigTransformer2021120210\Symfony\Component\Cache\CacheItem::validateKey($namespace));
        ...
        self::$createCacheItem ?? (self::$createCacheItem = \Closure::bind(static function ($key, $innerItem, $poolHash) {
            ...
            } elseif ($innerItem instanceof \ConfigTransformer2021120210\Symfony\Component\Cache\CacheItem) {
        ...
        self::$setInnerItem ?? (self::$setInnerItem = \Closure::bind(
             ...
             */
            static function (\ConfigTransformer2021120210\Psr\Cache\CacheItemInterface $innerItem, array $item) {
                // Tags are stored separately, no need to account for them when considering this item's newly set metadata
                if (isset(($metadata = $item["\0*\0newMetadata"])[\ConfigTransformer2021120210\Symfony\Component\Cache\CacheItem::METADATA_TAGS])) {
            ...
            null,
            \ConfigTransformer2021120210\Symfony\Component\Cache\CacheItem::class
        ));
    }
    /**
     * {@inheritdoc}
    ...
    private function doSave(\ConfigTransformer2021120210\Psr\Cache\CacheItemInterface $item, string $method) : bool
    {
        ...
        } elseif ($this->pool instanceof \ConfigTransformer2021120210\Symfony\Component\Cache\Adapter\AdapterInterface) {
