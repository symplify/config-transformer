...
class ProxyAdapter implements \ConfigTransformer202108303\Symfony\Component\Cache\Adapter\AdapterInterface, \ConfigTransformer202108303\Symfony\Contracts\Cache\CacheInterface, \ConfigTransformer202108303\Symfony\Component\Cache\PruneableInterface, \ConfigTransformer202108303\Symfony\Component\Cache\ResettableInterface
{
    ...
    public function __construct(\ConfigTransformer202108303\Psr\Cache\CacheItemPoolInterface $pool, string $namespace = '', int $defaultLifetime = 0)
    {
        $this->pool = $pool;
        $this->poolHash = $poolHash = \spl_object_hash($pool);
        if ('' !== $namespace) {
            \assert('' !== \ConfigTransformer202108303\Symfony\Component\Cache\CacheItem::validateKey($namespace));
        ...
        self::$createCacheItem ?? (self::$createCacheItem = \Closure::bind(static function ($key, $innerItem, $poolHash) {
            ...
            } elseif ($innerItem instanceof \ConfigTransformer202108303\Symfony\Component\Cache\CacheItem) {
        ...
        self::$setInnerItem ?? (self::$setInnerItem = \Closure::bind(
             ...
             */
            static function (\ConfigTransformer202108303\Psr\Cache\CacheItemInterface $innerItem, array $item) {
                // Tags are stored separately, no need to account for them when considering this item's newly set metadata
                if (isset(($metadata = $item["\0*\0newMetadata"])[\ConfigTransformer202108303\Symfony\Component\Cache\CacheItem::METADATA_TAGS])) {
            ...
            null,
            \ConfigTransformer202108303\Symfony\Component\Cache\CacheItem::class
        ));
    }
    /**
     * {@inheritdoc}
    ...
    private function doSave(\ConfigTransformer202108303\Psr\Cache\CacheItemInterface $item, string $method)
    {
        ...
        } elseif ($this->pool instanceof \ConfigTransformer202108303\Symfony\Component\Cache\Adapter\AdapterInterface) {
