...
use ConfigTransformerPrefix202606\Psr\Log\LoggerAwareInterface;
use ConfigTransformerPrefix202606\Psr\Log\LoggerInterface;
...
use ConfigTransformerPrefix202606\Symfony\Component\Cache\ResettableInterface;
use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\AbstractAdapterTrait;
use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\ContractsTrait;
use ConfigTransformerPrefix202606\Symfony\Contracts\Cache\CacheInterface;
/**
        ...
        foreach ($byLifetime as $lifetime => $values) {
            ...
            if (\is_array($e) || 1 === \count($values)) {
                foreach (\is_array($e) ? $e : \array_keys($values) as $id) {
                    ...
                    CacheItem::log($this->logger, $message, ['key' => (string) \substr($id, \strlen($this->namespace)), 'exception' => $e instanceof \Exception ? $e : null, 'cache-adapter' => \get_debug_type($this)]);
                }
            } else {
