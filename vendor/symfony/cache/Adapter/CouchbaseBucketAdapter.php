...
class CouchbaseBucketAdapter extends AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\ConfigTransformer20220612\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
    ...
    public static function createConnection(array|string $servers, array $options = []) : \ConfigTransformer20220612\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \ConfigTransformer20220612\CouchbaseCluster($connectionString);
