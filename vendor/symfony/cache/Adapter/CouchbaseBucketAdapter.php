...
class CouchbaseBucketAdapter extends AbstractAdapter
{
     ...
     */
    private $marshaller;
    public function __construct(\ConfigTransformerPrefix202605\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, ?MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \ConfigTransformerPrefix202605\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \ConfigTransformerPrefix202605\CouchbaseCluster($connectionString);
