...
class CouchbaseBucketAdapter extends AbstractAdapter
{
     ...
     */
    private $marshaller;
    public function __construct(\ConfigTransformerPrefix202606\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, ?MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \ConfigTransformerPrefix202606\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \ConfigTransformerPrefix202606\CouchbaseCluster($connectionString);
