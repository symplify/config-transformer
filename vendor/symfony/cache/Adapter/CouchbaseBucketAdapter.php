 ...
 */
class CouchbaseBucketAdapter extends \ConfigTransformer202107252\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\ConfigTransformer202107252\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, \ConfigTransformer202107252\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
        if (!static::isSupported()) {
            throw new \ConfigTransformer202107252\Symfony\Component\Cache\Exception\CacheException('Couchbase >= 2.6.0 < 3.0.0 is required.');
        }
     ...
     * @param mixed[] $options
     */
    public static function createConnection($servers, $options = []) : \ConfigTransformer202107252\CouchbaseBucket
    {
        ...
        try {
            ...
            foreach ($servers as $dsn) {
                if (0 !== \strpos($dsn, 'couchbase:')) {
                    throw new \ConfigTransformer202107252\Symfony\Component\Cache\Exception\InvalidArgumentException(\sprintf('Invalid Couchbase DSN: "%s" does not start with "couchbase:".', $dsn));
                }
            ...
            $client = new \ConfigTransformer202107252\CouchbaseCluster($connectionString);
