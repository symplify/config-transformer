...
class CouchbaseBucketAdapter extends AbstractAdapter
{
    ...
    private \ConfigTransformer202301\CouchbaseBucket $bucket;
    private MarshallerInterface $marshaller;
    public function __construct(\ConfigTransformer202301\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
    ...
    public static function createConnection(array|string $servers, array $options = []) : \ConfigTransformer202301\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \ConfigTransformer202301\CouchbaseCluster($connectionString);
