 ...
 */
class CouchbaseBucketAdapter extends \ConfigTransformer202202194\Symfony\Component\Cache\Adapter\AbstractAdapter
{
    ...
    private $bucket;
    private $marshaller;
    public function __construct(\ConfigTransformer202202194\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, \ConfigTransformer202202194\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
        if (!static::isSupported()) {
            throw new \ConfigTransformer202202194\Symfony\Component\Cache\Exception\CacheException('Couchbase >= 2.6.0 < 3.0.0 is required.');
        }
    ...
    public static function createConnection(array|string $servers, array $options = []) : \ConfigTransformer202202194\CouchbaseBucket
    {
        ...
        try {
            ...
            foreach ($servers as $dsn) {
                if (0 !== \strpos($dsn, 'couchbase:')) {
                    throw new \ConfigTransformer202202194\Symfony\Component\Cache\Exception\InvalidArgumentException(\sprintf('Invalid Couchbase DSN: "%s" does not start with "couchbase:".', $dsn));
                }
            ...
            $client = new \ConfigTransformer202202194\CouchbaseCluster($connectionString);
