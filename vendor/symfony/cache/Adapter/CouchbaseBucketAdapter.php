...
class CouchbaseBucketAdapter extends AbstractAdapter
{
     ...
     */
    private $marshaller;
    public function __construct(\ConfigTransformerPrefix202310\CouchbaseBucket $bucket, string $namespace = '', int $defaultLifetime = 0, MarshallerInterface $marshaller = null)
    {
     ...
     */
    public static function createConnection($servers, array $options = []) : \ConfigTransformerPrefix202310\CouchbaseBucket
    {
        ...
        try {
            ...
            $client = new \ConfigTransformerPrefix202310\CouchbaseCluster($connectionString);
