...
use ConfigTransformer202208\Doctrine\DBAL\Connection;
use ConfigTransformer202208\Doctrine\DBAL\Driver\ServerInfoAwareConnection;
use ConfigTransformer202208\Doctrine\DBAL\DriverManager;
use ConfigTransformer202208\Doctrine\DBAL\Exception as DBALException;
use ConfigTransformer202208\Doctrine\DBAL\Exception\TableNotFoundException;
use ConfigTransformer202208\Doctrine\DBAL\ParameterType;
use ConfigTransformer202208\Doctrine\DBAL\Schema\Schema;
use ConfigTransformer202208\Symfony\Component\Cache\Exception\InvalidArgumentException;
use ConfigTransformer202208\Symfony\Component\Cache\Marshaller\DefaultMarshaller;
use ConfigTransformer202208\Symfony\Component\Cache\Marshaller\MarshallerInterface;
use ConfigTransformer202208\Symfony\Component\Cache\PruneableInterface;
class DoctrineDbalAdapter extends AbstractAdapter implements PruneableInterface
{
    ...
    private function getPlatformName() : string
    {
        ...
        switch (\true) {
            case $platform instanceof \ConfigTransformer202208\Doctrine\DBAL\Platforms\MySQLPlatform:
            case $platform instanceof \ConfigTransformer202208\Doctrine\DBAL\Platforms\MySQL57Platform:
                return $this->platformName = 'mysql';
            case $platform instanceof \ConfigTransformer202208\Doctrine\DBAL\Platforms\SqlitePlatform:
                return $this->platformName = 'sqlite';
            case $platform instanceof \ConfigTransformer202208\Doctrine\DBAL\Platforms\PostgreSQLPlatform:
            case $platform instanceof \ConfigTransformer202208\Doctrine\DBAL\Platforms\PostgreSQL94Platform:
                return $this->platformName = 'pgsql';
            case $platform instanceof \ConfigTransformer202208\Doctrine\DBAL\Platforms\OraclePlatform:
                return $this->platformName = 'oci';
            case $platform instanceof \ConfigTransformer202208\Doctrine\DBAL\Platforms\SQLServerPlatform:
            case $platform instanceof \ConfigTransformer202208\Doctrine\DBAL\Platforms\SQLServer2012Platform:
