 ...
 */
namespace ConfigTransformerPrefix202310\Symfony\Component\Cache\Adapter;

use ConfigTransformerPrefix202310\Doctrine\DBAL\ArrayParameterType;
use ConfigTransformerPrefix202310\Doctrine\DBAL\Configuration;
use ConfigTransformerPrefix202310\Doctrine\DBAL\Connection;
use ConfigTransformerPrefix202310\Doctrine\DBAL\Driver\ServerInfoAwareConnection;
use ConfigTransformerPrefix202310\Doctrine\DBAL\DriverManager;
use ConfigTransformerPrefix202310\Doctrine\DBAL\Exception as DBALException;
use ConfigTransformerPrefix202310\Doctrine\DBAL\Exception\TableNotFoundException;
use ConfigTransformerPrefix202310\Doctrine\DBAL\ParameterType;
use ConfigTransformerPrefix202310\Doctrine\DBAL\Schema\DefaultSchemaManagerFactory;
use ConfigTransformerPrefix202310\Doctrine\DBAL\Schema\Schema;
use ConfigTransformerPrefix202310\Doctrine\DBAL\Tools\DsnParser;
use ConfigTransformerPrefix202310\Symfony\Component\Cache\Exception\InvalidArgumentException;
use ConfigTransformerPrefix202310\Symfony\Component\Cache\Marshaller\DefaultMarshaller;
use ConfigTransformerPrefix202310\Symfony\Component\Cache\Marshaller\MarshallerInterface;
use ConfigTransformerPrefix202310\Symfony\Component\Cache\PruneableInterface;
class DoctrineDbalAdapter extends AbstractAdapter implements PruneableInterface
{
    ...
    private function getPlatformName() : string
    {
        ...
        switch (\true) {
            case $platform instanceof \ConfigTransformerPrefix202310\Doctrine\DBAL\Platforms\MySQLPlatform:
            case $platform instanceof \ConfigTransformerPrefix202310\Doctrine\DBAL\Platforms\MySQL57Platform:
                return 'mysql';
            case $platform instanceof \ConfigTransformerPrefix202310\Doctrine\DBAL\Platforms\SqlitePlatform:
                return 'sqlite';
            case $platform instanceof \ConfigTransformerPrefix202310\Doctrine\DBAL\Platforms\PostgreSQLPlatform:
            case $platform instanceof \ConfigTransformerPrefix202310\Doctrine\DBAL\Platforms\PostgreSQL94Platform:
                return 'pgsql';
            case $platform instanceof \ConfigTransformerPrefix202310\Doctrine\DBAL\Platforms\OraclePlatform:
                return 'oci';
            case $platform instanceof \ConfigTransformerPrefix202310\Doctrine\DBAL\Platforms\SQLServerPlatform:
            case $platform instanceof \ConfigTransformerPrefix202310\Doctrine\DBAL\Platforms\SQLServer2012Platform:
                return 'sqlsrv';
            default:
