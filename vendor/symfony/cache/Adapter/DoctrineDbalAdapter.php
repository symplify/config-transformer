 ...
 */
namespace ConfigTransformerPrefix202302\Symfony\Component\Cache\Adapter;

use ConfigTransformerPrefix202302\Doctrine\DBAL\Connection;
use ConfigTransformerPrefix202302\Doctrine\DBAL\Driver\ServerInfoAwareConnection;
use ConfigTransformerPrefix202302\Doctrine\DBAL\DriverManager;
use ConfigTransformerPrefix202302\Doctrine\DBAL\Exception as DBALException;
use ConfigTransformerPrefix202302\Doctrine\DBAL\Exception\TableNotFoundException;
use ConfigTransformerPrefix202302\Doctrine\DBAL\ParameterType;
use ConfigTransformerPrefix202302\Doctrine\DBAL\Schema\Schema;
use ConfigTransformerPrefix202302\Symfony\Component\Cache\Exception\InvalidArgumentException;
use ConfigTransformerPrefix202302\Symfony\Component\Cache\Marshaller\DefaultMarshaller;
use ConfigTransformerPrefix202302\Symfony\Component\Cache\Marshaller\MarshallerInterface;
...
class DoctrineDbalAdapter extends AbstractAdapter implements PruneableInterface
{
    ...
    protected function doFetch(array $ids) : iterable
    {
        ...
        $result = $this->conn->executeQuery($sql, [$now, $ids], [ParameterType::INTEGER, Connection::PARAM_STR_ARRAY])->iterateNumeric();
        ...
        if ($expired) {
            ...
            $this->conn->executeStatement($sql, [$now, $expired], [ParameterType::INTEGER, Connection::PARAM_STR_ARRAY]);
        }
    }
    ...
    private function getPlatformName() : string
    {
        ...
        switch (\true) {
            case $platform instanceof \ConfigTransformerPrefix202302\Doctrine\DBAL\Platforms\MySQLPlatform:
            case $platform instanceof \ConfigTransformerPrefix202302\Doctrine\DBAL\Platforms\MySQL57Platform:
                return $this->platformName = 'mysql';
            case $platform instanceof \ConfigTransformerPrefix202302\Doctrine\DBAL\Platforms\SqlitePlatform:
                return $this->platformName = 'sqlite';
            case $platform instanceof \ConfigTransformerPrefix202302\Doctrine\DBAL\Platforms\PostgreSQLPlatform:
            case $platform instanceof \ConfigTransformerPrefix202302\Doctrine\DBAL\Platforms\PostgreSQL94Platform:
                return $this->platformName = 'pgsql';
            case $platform instanceof \ConfigTransformerPrefix202302\Doctrine\DBAL\Platforms\OraclePlatform:
                return $this->platformName = 'oci';
            case $platform instanceof \ConfigTransformerPrefix202302\Doctrine\DBAL\Platforms\SQLServerPlatform:
            case $platform instanceof \ConfigTransformerPrefix202302\Doctrine\DBAL\Platforms\SQLServer2012Platform:
