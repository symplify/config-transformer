...
use ConfigTransformerPrefix202301\Doctrine\DBAL\Connection;
use ConfigTransformerPrefix202301\Doctrine\DBAL\Driver\ServerInfoAwareConnection;
use ConfigTransformerPrefix202301\Doctrine\DBAL\DriverManager;
use ConfigTransformerPrefix202301\Doctrine\DBAL\Exception as DBALException;
use ConfigTransformerPrefix202301\Doctrine\DBAL\Exception\TableNotFoundException;
use ConfigTransformerPrefix202301\Doctrine\DBAL\ParameterType;
use ConfigTransformerPrefix202301\Doctrine\DBAL\Schema\Schema;
use ConfigTransformerPrefix202301\Symfony\Component\Cache\Exception\InvalidArgumentException;
use ConfigTransformerPrefix202301\Symfony\Component\Cache\Marshaller\DefaultMarshaller;
use ConfigTransformerPrefix202301\Symfony\Component\Cache\Marshaller\MarshallerInterface;
...
class DoctrineDbalAdapter extends AbstractAdapter implements PruneableInterface
{
    ...
    private function getPlatformName() : string
    {
        ...
        switch (\true) {
            case $platform instanceof \ConfigTransformerPrefix202301\Doctrine\DBAL\Platforms\MySQLPlatform:
            case $platform instanceof \ConfigTransformerPrefix202301\Doctrine\DBAL\Platforms\MySQL57Platform:
                return $this->platformName = 'mysql';
            case $platform instanceof \ConfigTransformerPrefix202301\Doctrine\DBAL\Platforms\SqlitePlatform:
                return $this->platformName = 'sqlite';
            case $platform instanceof \ConfigTransformerPrefix202301\Doctrine\DBAL\Platforms\PostgreSQLPlatform:
            case $platform instanceof \ConfigTransformerPrefix202301\Doctrine\DBAL\Platforms\PostgreSQL94Platform:
                return $this->platformName = 'pgsql';
            case $platform instanceof \ConfigTransformerPrefix202301\Doctrine\DBAL\Platforms\OraclePlatform:
                return $this->platformName = 'oci';
            case $platform instanceof \ConfigTransformerPrefix202301\Doctrine\DBAL\Platforms\SQLServerPlatform:
            case $platform instanceof \ConfigTransformerPrefix202301\Doctrine\DBAL\Platforms\SQLServer2012Platform:
