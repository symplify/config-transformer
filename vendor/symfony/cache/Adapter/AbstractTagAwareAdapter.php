 ...
 * @internal
 */
abstract class AbstractTagAwareAdapter implements \ConfigTransformer202111267\Symfony\Component\Cache\Adapter\TagAwareAdapterInterface, \ConfigTransformer202111267\Symfony\Contracts\Cache\TagAwareCacheInterface, \ConfigTransformer202111267\Psr\Log\LoggerAwareInterface, \ConfigTransformer202111267\Symfony\Component\Cache\ResettableInterface
{
    ...
    {
        $this->namespace = '' === $namespace ? '' : \ConfigTransformer202111267\Symfony\Component\Cache\CacheItem::validateKey($namespace) . ':';
        ...
        self::$createCacheItem ?? (self::$createCacheItem = \Closure::bind(static function ($key, $value, $isHit) {
            ...
            $item->metadata[\ConfigTransformer202111267\Symfony\Component\Cache\CacheItem::METADATA_TAGS] = $value['tags'] ?? [];
            if (isset($value['meta'])) {
        ...
        self::$mergeByLifetime ?? (self::$mergeByLifetime = \Closure::bind(static function ($deferred, &$expiredIds, $getId, $tagPrefix, $defaultLifetime) {
            ...
            foreach ($deferred as $key => $item) {
                ...
                if (isset(($metadata = $item->newMetadata)[\ConfigTransformer202111267\Symfony\Component\Cache\CacheItem::METADATA_TAGS])) {
                    $value = ['value' => $item->value, 'tags' => $metadata[\ConfigTransformer202111267\Symfony\Component\Cache\CacheItem::METADATA_TAGS]];
                ...
                $oldTags = $item->metadata[\ConfigTransformer202111267\Symfony\Component\Cache\CacheItem::METADATA_TAGS] ?? [];
