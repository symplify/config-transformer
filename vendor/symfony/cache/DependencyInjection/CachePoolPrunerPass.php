 ...
 */
class CachePoolPrunerPass implements \ConfigTransformer202107154\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    ...
    public function process($container)
    {
        ...
        foreach ($container->findTaggedServiceIds($this->cachePoolTag) as $id => $tags) {
            ...
            if ($reflection->implementsInterface(\ConfigTransformer202107154\Symfony\Component\Cache\PruneableInterface::class)) {
                $services[$id] = new \ConfigTransformer202107154\Symfony\Component\DependencyInjection\Reference($id);
            }
        }
        $container->getDefinition($this->cacheCommandServiceId)->replaceArgument(0, new \ConfigTransformer202107154\Symfony\Component\DependencyInjection\Argument\IteratorArgument($services));
    }
}
