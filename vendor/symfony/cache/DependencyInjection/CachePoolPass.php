...
use ConfigTransformerPrefix202605\Symfony\Component\Cache\Adapter\AbstractAdapter;
use ConfigTransformerPrefix202605\Symfony\Component\Cache\Adapter\ArrayAdapter;
use ConfigTransformerPrefix202605\Symfony\Component\Cache\Adapter\ChainAdapter;
use ConfigTransformerPrefix202605\Symfony\Component\Cache\Adapter\NullAdapter;
use ConfigTransformerPrefix202605\Symfony\Component\Cache\Adapter\ParameterNormalizer;
use ConfigTransformerPrefix202605\Symfony\Component\Cache\Adapter\TagAwareAdapter;
use ConfigTransformerPrefix202605\Symfony\Component\Cache\Messenger\EarlyExpirationDispatcher;
...
class CachePoolPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        foreach ($container->findTaggedServiceIds('cache.pool') as $id => $tags) {
            ...
            $pruneable = $tags[0]['pruneable'] ?? (($nullsafeVariable1 = $container->getReflectionClass($class, \false)) ? $nullsafeVariable1->implementsInterface(PruneableInterface::class) : null) ?? \false;
            ...
            $poolTags['cache.pool'][0]['pruneable'] = $poolTags['cache.pool'][0]['pruneable'] ?? $pruneable;
