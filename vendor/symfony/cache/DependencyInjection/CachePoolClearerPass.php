 ...
 */
class CachePoolClearerPass implements \ConfigTransformer202112191\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    /**
     * {@inheritdoc}
     */
        ...
        foreach ($container->findTaggedServiceIds('cache.pool.clearer') as $id => $attr) {
            ...
            foreach ($clearer->getArgument(0) as $name => $ref) {
                if ($container->hasDefinition($ref)) {
                    $pools[$name] = new \ConfigTransformer202112191\Symfony\Component\DependencyInjection\Reference($ref);
                }
            }
