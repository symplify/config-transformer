...
class RedisCluster6Proxy extends \RedisCluster implements ResetInterface, LazyObjectInterface
{
    ...
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->decrbyfloat(...\func_get_args());
    }
    /**
     * @return \RedisCluster|false|int
     */
    ...
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->hscan($key, $iterator, $pattern, $count, ...\array_slice(\func_get_args(), 4));
    }
    /**
    ...
    {
        ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->psubscribe(...\func_get_args());
    }
    /**
     * @return \RedisCluster|false|int
     */
    ...
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->scan($iterator, $key_or_address, $pattern, $count, ...\array_slice(\func_get_args(), 4));
    }
    /**
     * @return \RedisCluster|false|int
     */
    ...
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->sscan($key, $iterator, $pattern, $count, ...\array_slice(\func_get_args(), 4));
    }
    /**
     * @return \RedisCluster|false|int
     */
    ...
    {
        ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->subscribe(...\func_get_args());
    }
    /**
    ...
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->zscan($key, $iterator, $pattern, $count, ...\array_slice(\func_get_args(), 4));
    }
    /**
     * @return \RedisCluster|false|float
     */
