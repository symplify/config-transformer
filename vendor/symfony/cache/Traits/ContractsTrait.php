...
use ConfigTransformerPrefix202606\Symfony\Component\Cache\LockRegistry;
use ConfigTransformerPrefix202606\Symfony\Contracts\Cache\CacheInterface;
use ConfigTransformerPrefix202606\Symfony\Contracts\Cache\CacheTrait;
use ConfigTransformerPrefix202606\Symfony\Contracts\Cache\ItemInterface;
/**
...
trait ContractsTrait
{
    ...
    public function setCallbackWrapper(?callable $callbackWrapper) : callable
    {
        ...
        $this->callbackWrapper = $callbackWrapper ?? static function (callable $callback, ItemInterface $item, bool &$save, CacheInterface $pool, \Closure $setMetadata, ?LoggerInterface $logger, ?float $beta = null) {
