...
class Redis6Proxy extends \Redis implements ResetInterface, LazyObjectInterface
{
    ...
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->scan($iterator, $pattern, $count, $type, ...\array_slice(\func_get_args(), 4));
    }
    /**
     * @return \Redis|false|int
     */
