...
class Redis6Proxy extends \Redis implements ResetInterface, LazyObjectInterface
{
     ...
     * @return \Redis|bool
     */
    public function auth(#[\SensitiveParameter] $credentials)
    {
     ...
     * @return \Redis|bool
     */
    public function migrate($host, $port, $key, $dstdb, $timeout, $copy = \false, $replace = \false, #[\SensitiveParameter] $credentials = null)
    {
