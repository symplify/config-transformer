...
use ConfigTransformerPrefix202312\Predis\Command\Redis\UNLINK;
use ConfigTransformerPrefix202312\Predis\Connection\Aggregate\ClusterInterface;
use ConfigTransformerPrefix202312\Predis\Connection\Aggregate\RedisCluster;
use ConfigTransformerPrefix202312\Predis\Connection\Aggregate\ReplicationInterface;
use ConfigTransformerPrefix202312\Predis\Connection\Cluster\ClusterInterface as Predis2ClusterInterface;
use ConfigTransformerPrefix202312\Predis\Connection\Cluster\RedisCluster as Predis2RedisCluster;
...
use ConfigTransformerPrefix202312\Relay\Sentinel;
use ConfigTransformerPrefix202312\Symfony\Component\Cache\Exception\CacheException;
...
trait RedisTrait
{
    ...
    private function init($redis, string $namespace, int $defaultLifetime, ?MarshallerInterface $marshaller) : void
    {
        ...
        if ($redis instanceof \ConfigTransformerPrefix202312\Predis\ClientInterface && $redis->getOptions()->exceptions) {
    ...
    public static function createConnection(string $dsn, array $options = [])
    {
        ...
        if (!\extension_loaded('redis') && !\class_exists(\ConfigTransformerPrefix202312\Predis\Client::class)) {
        ...
        if (isset($params['redis_sentinel']) && !\class_exists(\ConfigTransformerPrefix202312\Predis\Client::class) && !\class_exists(\RedisSentinel::class) && !\class_exists(Sentinel::class)) {
        ...
        switch (\true) {
            case $params['redis_cluster']:
                $class = \extension_loaded('redis') ? \RedisCluster::class : \ConfigTransformerPrefix202312\Predis\Client::class;
                break;
            case isset($params['redis_sentinel']):
                switch (\true) {
                    ...
                    case \extension_loaded('relay'):
                        ...
                        break;
                    default:
                        $class = \ConfigTransformerPrefix202312\Predis\Client::class;
                        break;
                }
                break;
        ...
        if (isset($params['redis_sentinel']) && !\is_a($class, \ConfigTransformerPrefix202312\Predis\Client::class, \true) && !\class_exists(\RedisSentinel::class) && !\class_exists(Sentinel::class)) {
        ...
        if ($isRedisExt || $isRelayExt) {
            ...
            $initializer = static function () use($class, $isRedisExt, $connect, $params, $auth, $hosts, $tls) {
                ...
                do {
                    ...
                    } catch (\RedisException|\ConfigTransformerPrefix202312\Relay\Exception $redisException) {
                    }
                ...
                } catch (\RedisException|\ConfigTransformerPrefix202312\Relay\Exception $e) {
        ...
        } elseif (\is_a($class, \ConfigTransformerPrefix202312\Predis\ClientInterface::class, \true)) {
    ...
    protected function doFetch(array $ids) : iterable
    {
        ...
        $result = [];
        if ($this->redis instanceof \ConfigTransformerPrefix202312\Predis\ClientInterface && ($this->redis->getConnection() instanceof ClusterInterface || $this->redis->getConnection() instanceof Predis2ClusterInterface)) {
    ...
    protected function doClear(string $namespace) : bool
    {
        ...
        foreach ($hosts as $host) {
            ...
            } elseif (!$host instanceof \ConfigTransformerPrefix202312\Predis\ClientInterface) {
            ...
            if (!\version_compare($info['redis_version'], '2.8', '>=')) {
                ...
                $args = $this->redis instanceof \ConfigTransformerPrefix202312\Predis\ClientInterface ? [0, $pattern] : [[$pattern], 0];
            ...
            $cursor = null;
            do {
                $keys = $host instanceof \ConfigTransformerPrefix202312\Predis\ClientInterface ? $host->scan($cursor, 'MATCH', $pattern, 'COUNT', 1000) : $host->scan($cursor, $pattern, 1000);
    ...
    private function pipeline(\Closure $generator, object $redis = null) : \Generator
    {
        ...
        if ($redis instanceof \RedisCluster || $redis instanceof \ConfigTransformerPrefix202312\Predis\ClientInterface && ($redis->getConnection() instanceof RedisCluster || $redis->getConnection() instanceof Predis2RedisCluster)) {
            ...
            foreach ($generator() as $command => $args) {
                ...
                $ids[] = 'eval' === $command ? $redis instanceof \ConfigTransformerPrefix202312\Predis\ClientInterface ? $args[2] : $args[1][0] : $args[0];
            }
        } elseif ($redis instanceof \ConfigTransformerPrefix202312\Predis\ClientInterface) {
        ...
        if (!$redis instanceof \ConfigTransformerPrefix202312\Predis\ClientInterface && 'eval' === $command && $redis->getLastError()) {
            $e = $redis instanceof Relay ? new \ConfigTransformerPrefix202312\Relay\Exception($redis->getLastError()) : new \RedisException($redis->getLastError());
        ...
        if ($this->redis instanceof \ConfigTransformerPrefix202312\Predis\ClientInterface) {
            ...
            if (($connection instanceof ClusterInterface || $connection instanceof Predis2ClusterInterface) && $connection instanceof \Traversable) {
                ...
                foreach ($connection as $c) {
                    $hosts[] = new \ConfigTransformerPrefix202312\Predis\Client($c);
                }
            }
