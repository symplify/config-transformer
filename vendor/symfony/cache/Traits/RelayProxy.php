 ...
 */
namespace ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits;

use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\Relay\BgsaveTrait;
use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\Relay\CopyTrait;
use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\Relay\FtTrait;
use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\Relay\GeosearchTrait;
use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\Relay\GetrangeTrait;
use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\Relay\GetWithMetaTrait;
use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\Relay\HsetTrait;
use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\Relay\IsTrackedTrait;
use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\Relay\MoveTrait;
use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\Relay\NullableReturnTrait;
use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\Relay\PfcountTrait;
use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\Relay\Relay11Trait;
use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\Relay\Relay121Trait;
use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\Relay\Relay12Trait;
use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\Relay\Relay20Trait;
use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\Relay\Relay21Trait;
use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\Relay\Relay22Trait;
use ConfigTransformerPrefix202606\Symfony\Component\Cache\Traits\Relay\SwapdbTrait;
use ConfigTransformerPrefix202606\Symfony\Component\VarExporter\LazyObjectInterface;
use ConfigTransformerPrefix202606\Symfony\Component\VarExporter\LazyProxyTrait;
use ConfigTransformerPrefix202606\Symfony\Contracts\Service\ResetInterface;
// Help opcache.preload discover always-needed symbols
\class_exists(\ConfigTransformerPrefix202606\Symfony\Component\VarExporter\Internal\Hydrator::class);
\class_exists(\ConfigTransformerPrefix202606\Symfony\Component\VarExporter\Internal\LazyObjectRegistry::class);
\class_exists(\ConfigTransformerPrefix202606\Symfony\Component\VarExporter\Internal\LazyObjectState::class);
/**
 * @internal
 */
class RelayProxy extends \ConfigTransformerPrefix202606\Relay\Relay implements ResetInterface, LazyObjectInterface
{
    use BgsaveTrait;
    use CopyTrait;
    use FtTrait;
