 ...
 */
namespace ConfigTransformerPrefix202310\Symfony\Component\Cache\Traits;

use ConfigTransformerPrefix202310\Relay\Relay;
use ConfigTransformerPrefix202310\Symfony\Component\VarExporter\LazyObjectInterface;
use ConfigTransformerPrefix202310\Symfony\Component\VarExporter\LazyProxyTrait;
use ConfigTransformerPrefix202310\Symfony\Contracts\Service\ResetInterface;
// Help opcache.preload discover always-needed symbols
\class_exists(\ConfigTransformerPrefix202310\Symfony\Component\VarExporter\Internal\Hydrator::class);
\class_exists(\ConfigTransformerPrefix202310\Symfony\Component\VarExporter\Internal\LazyObjectRegistry::class);
\class_exists(\ConfigTransformerPrefix202310\Symfony\Component\VarExporter\Internal\LazyObjectState::class);
/**
 * @internal
 */
class RelayProxy extends Relay implements ResetInterface, LazyObjectInterface
{
    ...
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->scan($iterator, $match, $count, $type, ...\array_slice(\func_get_args(), 4));
    }
    /**
     * @return mixed[]|false
     */
    ...
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->hscan($key, $iterator, $match, $count, ...\array_slice(\func_get_args(), 4));
    }
    /**
     * @return mixed[]|false
     */
    ...
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->sscan($key, $iterator, $match, $count, ...\array_slice(\func_get_args(), 4));
    }
    /**
     * @return mixed[]|false
     */
    ...
    {
        return ($this->lazyObjectState->realInstance = $this->lazyObjectState->realInstance ?? ($this->lazyObjectState->initializer)())->zscan($key, $iterator, $match, $count, ...\array_slice(\func_get_args(), 4));
    }
    /**
     * @return \Relay\Relay|mixed[]|false
     */
