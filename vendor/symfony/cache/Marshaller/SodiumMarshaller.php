 ...
 */
class SodiumMarshaller implements \ConfigTransformer2021120810\Symfony\Component\Cache\Marshaller\MarshallerInterface
{
     ...
     */
    public function __construct(array $decryptionKeys, \ConfigTransformer2021120810\Symfony\Component\Cache\Marshaller\MarshallerInterface $marshaller = null)
    {
        if (!self::isSupported()) {
            throw new \ConfigTransformer2021120810\Symfony\Component\Cache\Exception\CacheException('The "sodium" PHP extension is not loaded.');
        }
        if (!isset($decryptionKeys[0])) {
            throw new \ConfigTransformer2021120810\Symfony\Component\Cache\Exception\InvalidArgumentException('At least one decryption key must be provided at index "0".');
        }
