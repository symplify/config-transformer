 ...
 */
class DefaultMarshaller implements \ConfigTransformer202202245\Symfony\Component\Cache\Marshaller\MarshallerInterface
{
    ...
    public function __construct(bool $useIgbinarySerialize = null, bool $throwOnSerializationFailure = \false)
    {
        if (null === $useIgbinarySerialize) {
            ...
            throw new \ConfigTransformer202202245\Symfony\Component\Cache\Exception\CacheException(\extension_loaded('igbinary') ? 'Please upgrade the "igbinary" PHP extension to v3.1.6 or higher.' : 'The "igbinary" PHP extension is not loaded.');
        }
