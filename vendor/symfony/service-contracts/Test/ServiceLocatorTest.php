 ...
 */
namespace ConfigTransformer20220610\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\ConfigTransformer20220610\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\ConfigTransformer20220610\Psr\Container\ContainerExceptionInterface::class);
