 ...
 */
namespace ConfigTransformer2022060710\Symfony\Contracts\Service\Test;
...
use ConfigTransformer2022060710\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\ConfigTransformer2022060710\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\ConfigTransformer2022060710\Psr\Container\ContainerExceptionInterface::class);
