 ...
 */
namespace ConfigTransformerPrefix202302\Symfony\Contracts\Service\Test;
...
use ConfigTransformerPrefix202302\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\ConfigTransformerPrefix202302\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\ConfigTransformerPrefix202302\Psr\Container\ContainerExceptionInterface::class);
