 ...
 */
namespace ConfigTransformer20220612\Symfony\Contracts\Service\Test;

use ConfigTransformer20220612\PHPUnit\Framework\TestCase;
use ConfigTransformer20220612\Psr\Container\ContainerInterface;
use ConfigTransformer20220612\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\ConfigTransformer20220612\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\ConfigTransformer20220612\Psr\Container\ContainerExceptionInterface::class);
