 ...
 */
namespace ConfigTransformer202301\Symfony\Contracts\Service\Test;

use ConfigTransformer202301\PHPUnit\Framework\TestCase;
use ConfigTransformer202301\Psr\Container\ContainerInterface;
use ConfigTransformer202301\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\ConfigTransformer202301\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\ConfigTransformer202301\Psr\Container\ContainerExceptionInterface::class);
