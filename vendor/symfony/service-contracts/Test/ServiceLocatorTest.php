 ...
 */
namespace ConfigTransformer20220611\Symfony\Contracts\Service\Test;
...
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\ConfigTransformer20220611\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\ConfigTransformer20220611\Psr\Container\ContainerExceptionInterface::class);
