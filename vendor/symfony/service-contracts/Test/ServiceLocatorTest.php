 ...
 */
namespace ConfigTransformerPrefix202301\Symfony\Contracts\Service\Test;
...
use ConfigTransformerPrefix202301\Symfony\Contracts\Service\ServiceLocatorTrait;
abstract class ServiceLocatorTest extends TestCase
{
    ...
    public function testThrowsOnUndefinedInternalService()
    {
        if (!$this->getExpectedException()) {
            $this->expectException(\ConfigTransformerPrefix202301\Psr\Container\NotFoundExceptionInterface::class);
    ...
    {
        $this->expectException(\ConfigTransformerPrefix202301\Psr\Container\ContainerExceptionInterface::class);
