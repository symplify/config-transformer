...
class Response
{
    ...
    {
        $this->headers = new \ConfigTransformer20210606\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\ConfigTransformer20210606\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\ConfigTransformer20210606\Symfony\Component\HttpFoundation\Request $request) : void
    {
