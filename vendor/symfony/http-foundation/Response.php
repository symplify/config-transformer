...
class Response
{
    ...
    {
        $this->headers = new \ConfigTransformer202106265\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final
     */
    public function isNotModified(\ConfigTransformer202106265\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     * @final
     */
    protected function ensureIEOverSSLCompatibility(\ConfigTransformer202106265\Symfony\Component\HttpFoundation\Request $request) : void
    {
