 ...
 */
class MockArraySessionStorage implements \ConfigTransformer202107252\Symfony\Component\HttpFoundation\Session\Storage\SessionStorageInterface
{
    /**
     * @var string
     */
     ...
     */
    protected $bags = [];
    public function __construct(string $name = 'MOCKSESSID', \ConfigTransformer202107252\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag $metaBag = null)
    {
        $this->name = $name;
    ...
    {
        if (null === $bag) {
            $bag = new \ConfigTransformer202107252\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag();
        }
