 ...
 */
class MockArraySessionStorage implements \ConfigTransformer202108042\Symfony\Component\HttpFoundation\Session\Storage\SessionStorageInterface
{
    /**
     * @var string
     */
     ...
     */
    protected $bags = [];
    public function __construct(string $name = 'MOCKSESSID', \ConfigTransformer202108042\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag $metaBag = null)
    {
        $this->name = $name;
    ...
    {
        if (null === $bag) {
            $bag = new \ConfigTransformer202108042\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag();
        }
