 ...
 */
class MockArraySessionStorage implements \ConfigTransformer202110010\Symfony\Component\HttpFoundation\Session\Storage\SessionStorageInterface
{
    /**
     * @var string
     */
     ...
     */
    protected $bags = [];
    public function __construct(string $name = 'MOCKSESSID', \ConfigTransformer202110010\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag $metaBag = null)
    {
        $this->name = $name;
    ...
    {
        if (null === $bag) {
            $bag = new \ConfigTransformer202110010\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag();
        }
