 ...
 */
class MockArraySessionStorage implements \ConfigTransformer2021082910\Symfony\Component\HttpFoundation\Session\Storage\SessionStorageInterface
{
    /**
     * @var string
     */
     ...
     */
    protected $bags = [];
    public function __construct(string $name = 'MOCKSESSID', \ConfigTransformer2021082910\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag $metaBag = null)
    {
        $this->name = $name;
    ...
    {
        if (null === $bag) {
            $bag = new \ConfigTransformer2021082910\Symfony\Component\HttpFoundation\Session\Storage\MetadataBag();
        }
