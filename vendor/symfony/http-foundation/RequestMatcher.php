 ...
 */
class RequestMatcher implements \ConfigTransformer202107081\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
    ...
    public function matches(\ConfigTransformer202107081\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (\ConfigTransformer202107081\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
