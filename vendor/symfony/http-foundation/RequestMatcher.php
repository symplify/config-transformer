 ...
 */
class RequestMatcher implements \ConfigTransformer2021061210\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
     ...
     * {@inheritdoc}
     */
    public function matches(\ConfigTransformer2021061210\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (\ConfigTransformer2021061210\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
