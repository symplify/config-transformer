 ...
 */
class RequestMatcher implements \ConfigTransformer202108296\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
    ...
    public function matches($request)
    {
        ...
        if (\ConfigTransformer202108296\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
