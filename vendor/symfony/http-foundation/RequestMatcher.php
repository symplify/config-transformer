 ...
 */
class RequestMatcher implements \ConfigTransformer202106120\Symfony\Component\HttpFoundation\RequestMatcherInterface
{
    /**
     * @var string|null
     */
     ...
     * {@inheritdoc}
     */
    public function matches(\ConfigTransformer202106120\Symfony\Component\HttpFoundation\Request $request)
    {
        ...
        if (\ConfigTransformer202106120\Symfony\Component\HttpFoundation\IpUtils::checkIp($request->getClientIp(), $this->ips)) {
            return \true;
        }
