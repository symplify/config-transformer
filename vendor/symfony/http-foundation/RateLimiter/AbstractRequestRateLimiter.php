...
use ConfigTransformer202110248\Symfony\Component\RateLimiter\LimiterInterface;
use ConfigTransformer202110248\Symfony\Component\RateLimiter\Policy\NoLimiter;
 ...
 * @experimental in 5.3
 */
abstract class AbstractRequestRateLimiter implements \ConfigTransformer202110248\Symfony\Component\HttpFoundation\RateLimiter\RequestRateLimiterInterface
{
    /**
    ...
    public function consume($request) : \ConfigTransformer202110248\Symfony\Component\RateLimiter\RateLimit
    {
        ...
        if (0 === \count($limiters)) {
            $limiters = [new \ConfigTransformer202110248\Symfony\Component\RateLimiter\Policy\NoLimiter()];
        }
