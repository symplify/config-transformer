 ...
 */
final class ResponseFormatSame extends \ConfigTransformer202109073\PHPUnit\Framework\Constraint\Constraint
{
    private $request;
    private $format;
    public function __construct(\ConfigTransformer202109073\Symfony\Component\HttpFoundation\Request $request, ?string $format)
    {
