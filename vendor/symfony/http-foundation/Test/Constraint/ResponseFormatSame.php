 ...
 */
final class ResponseFormatSame extends \ConfigTransformer2021072110\PHPUnit\Framework\Constraint\Constraint
{
    private $request;
    private $format;
    public function __construct(\ConfigTransformer2021072110\Symfony\Component\HttpFoundation\Request $request, ?string $format)
    {
