...
final class ResponseCookieValueSame extends \ConfigTransformer202108240\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
     ...
     */
    protected function getCookie($response) : ?\ConfigTransformer202108240\Symfony\Component\HttpFoundation\Cookie
    {
