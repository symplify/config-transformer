...
final class ResponseCookieValueSame extends \ConfigTransformer2021072110\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
     ...
     */
    protected function getCookie($response) : ?\ConfigTransformer2021072110\Symfony\Component\HttpFoundation\Cookie
    {
