...
final class ResponseCookieValueSame extends \ConfigTransformer202108229\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
     ...
     */
    protected function getCookie($response) : ?\ConfigTransformer202108229\Symfony\Component\HttpFoundation\Cookie
    {
