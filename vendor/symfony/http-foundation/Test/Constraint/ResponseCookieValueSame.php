...
final class ResponseCookieValueSame extends \ConfigTransformer202108182\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
     ...
     */
    protected function getCookie($response) : ?\ConfigTransformer202108182\Symfony\Component\HttpFoundation\Cookie
    {
