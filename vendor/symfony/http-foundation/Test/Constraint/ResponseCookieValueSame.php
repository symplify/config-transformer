...
final class ResponseCookieValueSame extends \ConfigTransformer202107211\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
     ...
     */
    protected function getCookie($response) : ?\ConfigTransformer202107211\Symfony\Component\HttpFoundation\Cookie
    {
