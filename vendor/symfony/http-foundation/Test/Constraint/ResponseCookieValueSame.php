...
final class ResponseCookieValueSame extends \ConfigTransformer202108187\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
     ...
     */
    protected function getCookie($response) : ?\ConfigTransformer202108187\Symfony\Component\HttpFoundation\Cookie
    {
