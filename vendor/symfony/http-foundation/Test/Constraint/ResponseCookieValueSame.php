...
final class ResponseCookieValueSame extends \ConfigTransformer2021101110\PHPUnit\Framework\Constraint\Constraint
{
    private $name;
    private $value;
    private $path;
     ...
     */
    protected function getCookie($response) : ?\ConfigTransformer2021101110\Symfony\Component\HttpFoundation\Cookie
    {
