...
use ConfigTransformer2021120710\Symfony\Component\Yaml\Exception\ParseException;
/**
...
class Unescaper
{
    ...
    private function unescapeCharacter(string $value) : string
    {
        switch ($value[1]) {
            ...
            default:
                throw new \ConfigTransformer2021120710\Symfony\Component\Yaml\Exception\ParseException(\sprintf('Found unknown escape character "%s".', $value));
        }
    }
    /**
