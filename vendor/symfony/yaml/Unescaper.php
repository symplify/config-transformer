...
use ConfigTransformer202112107\Symfony\Component\Yaml\Exception\ParseException;
/**
...
class Unescaper
{
    ...
    private function unescapeCharacter(string $value) : string
    {
        switch ($value[1]) {
            ...
            default:
                throw new \ConfigTransformer202112107\Symfony\Component\Yaml\Exception\ParseException(\sprintf('Found unknown escape character "%s".', $value));
        }
    }
    /**
