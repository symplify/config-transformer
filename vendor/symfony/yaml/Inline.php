...
use ConfigTransformerPrefix202605\Symfony\Component\Yaml\Exception\DumpException;
            ...
            case \in_array($scalar[0], ['+', '-', '.'], \true) || \is_numeric($scalar[0]):
                ...
                switch (\true) {
                    ...
                    case Parser::preg_match(self::getTimestampRegex(), $scalar):
                        ...
                        } catch (\ConfigTransformerPrefix202605\DateRangeError|\ValueError $exception) {
                            // no-op
                        }
