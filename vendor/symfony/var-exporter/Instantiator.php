 ...
 */
namespace ConfigTransformer202111307\Symfony\Component\VarExporter;

use ConfigTransformer202111307\Symfony\Component\VarExporter\Exception\ExceptionInterface;
use ConfigTransformer202111307\Symfony\Component\VarExporter\Exception\NotInstantiableTypeException;
use ConfigTransformer202111307\Symfony\Component\VarExporter\Internal\Hydrator;
use ConfigTransformer202111307\Symfony\Component\VarExporter\Internal\Registry;
/**
...
final class Instantiator
{
    ...
    public static function instantiate(string $class, array $properties = [], array $privateProperties = []) : object
    {
        ...
        if (\ConfigTransformer202111307\Symfony\Component\VarExporter\Internal\Registry::$cloneable[$class]) {
            $wrappedInstance = [clone \ConfigTransformer202111307\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]];
        } elseif (\ConfigTransformer202111307\Symfony\Component\VarExporter\Internal\Registry::$instantiableWithoutConstructor[$class]) {
            $wrappedInstance = [$reflector->newInstanceWithoutConstructor()];
        } elseif (null === \ConfigTransformer202111307\Symfony\Component\VarExporter\Internal\Registry::$prototypes[$class]) {
        ...
        foreach ($privateProperties as $class => $properties) {
            ...
            (\ConfigTransformer202111307\Symfony\Component\VarExporter\Internal\Hydrator::$hydrators[$class] ?? \ConfigTransformer202111307\Symfony\Component\VarExporter\Internal\Hydrator::getHydrator($class))($properties, $wrappedInstance);
        }
