...
use ConfigTransformer202201309\Symfony\Component\VarExporter\Internal\Exporter;
...
use ConfigTransformer202201309\Symfony\Component\VarExporter\Internal\Values;
/**
...
final class VarExporter
{
    ...
    {
        $isStaticValue = \true;
        if (!\is_object($value) && !(\is_array($value) && $value) && !\is_resource($value) || $value instanceof \ConfigTransformer202201309\UnitEnum) {
            return \ConfigTransformer202201309\Symfony\Component\VarExporter\Internal\Exporter::export($value);
        }
        $objectsPool = new \SplObjectStorage();
        $refsPool = [];
        $objectsCount = 0;
        try {
            $value = \ConfigTransformer202201309\Symfony\Component\VarExporter\Internal\Exporter::prepare([$value], $objectsPool, $refsPool, $objectsCount, $isStaticValue)[0];
        } finally {
            $references = [];
        ...
        if ($classes || $references) {
            $value = new \ConfigTransformer202201309\Symfony\Component\VarExporter\Internal\Hydrator(new \ConfigTransformer202201309\Symfony\Component\VarExporter\Internal\Registry($classes), $references ? new \ConfigTransformer202201309\Symfony\Component\VarExporter\Internal\Values($references) : null, $properties, $value, $wakeups);
        } else {
            $isStaticValue = \true;
        }
        return \ConfigTransformer202201309\Symfony\Component\VarExporter\Internal\Exporter::export($value);
