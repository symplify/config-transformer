 ...
 */
namespace ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection;

use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\Argument\RewindableGenerator;
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\Argument\ServiceLocator as ArgumentServiceLocator;
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\Exception\EnvNotFoundException;
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException;
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\Exception\ParameterCircularReferenceException;
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\Exception\RuntimeException;
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException;
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException;
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\ParameterBag\EnvPlaceholderParameterBag;
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\ParameterBag\FrozenParameterBag;
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\ParameterBag\ParameterBagInterface;
...
class Container implements ContainerInterface, ResetInterface
{
    ...
    protected function getEnv(string $name)
    {
        ...
        if (\false !== ($i = \strpos($name, ':'))) {
            $prefix = (string) \substr($name, 0, $i);
            $localName = (string) \substr($name, 1 + $i);
        } else {
            $prefix = 'string';
            $localName = $name;
        }
