 ...
 */
namespace ConfigTransformer2022031610\Symfony\Component\DependencyInjection\LazyProxy;
...
class ProxyHelper
{
    ...
    public static function getTypeHint(\ReflectionFunctionAbstract $r, \ReflectionParameter $p = null, bool $noBuiltin = \false) : ?string
    {
        ...
        } elseif ($type instanceof \ConfigTransformer2022031610\ReflectionIntersectionType) {
            $reflectionTypes = $type->getTypes();
            $glue = '&';
