 ...
 */
namespace ConfigTransformer202107232\Symfony\Component\DependencyInjection\LazyProxy;
...
class ProxyHelper
{
    ...
    public static function getTypeHint($r, $p = null, $noBuiltin = \false) : ?string
    {
        ...
        } elseif ($type instanceof \ConfigTransformer202107232\ReflectionIntersectionType) {
            $reflectionTypes = $type->getTypes();
            $glue = '&';
