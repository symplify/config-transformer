 ...
 */
namespace ConfigTransformer202110111\Symfony\Component\DependencyInjection\LazyProxy;
...
class ProxyHelper
{
    ...
    public static function getTypeHint($r, $p = null, $noBuiltin = \false) : ?string
    {
        ...
        } elseif ($type instanceof \ConfigTransformer202110111\ReflectionIntersectionType) {
            $reflectionTypes = $type->getTypes();
            $glue = '&';
