 ...
 */
namespace ConfigTransformer202201258\Symfony\Component\DependencyInjection\LazyProxy;
...
class ProxyHelper
{
    ...
    public static function getTypeHint(\ReflectionFunctionAbstract $r, \ReflectionParameter $p = null, bool $noBuiltin = \false) : ?string
    {
        ...
        } elseif ($type instanceof \ConfigTransformer202201258\ReflectionIntersectionType) {
            $reflectionTypes = $type->getTypes();
            $glue = '&';
