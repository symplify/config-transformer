 ...
 */
namespace ConfigTransformer202111015\Symfony\Component\DependencyInjection\LazyProxy;
...
class ProxyHelper
{
    ...
    public static function getTypeHint($r, $p = null, $noBuiltin = \false) : ?string
    {
        ...
        } elseif ($type instanceof \ConfigTransformer202111015\ReflectionIntersectionType) {
            $reflectionTypes = $type->getTypes();
            $glue = '&';
