 ...
 */
namespace ConfigTransformer2021081610\Symfony\Component\DependencyInjection\LazyProxy;
...
class ProxyHelper
{
    ...
    public static function getTypeHint($r, $p = null, $noBuiltin = \false) : ?string
    {
        ...
        } elseif ($type instanceof \ConfigTransformer2021081610\ReflectionIntersectionType) {
            $reflectionTypes = $type->getTypes();
            $glue = '&';
