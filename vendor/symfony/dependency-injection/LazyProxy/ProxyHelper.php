 ...
 */
namespace ConfigTransformer202108193\Symfony\Component\DependencyInjection\LazyProxy;
...
class ProxyHelper
{
    ...
    public static function getTypeHint($r, $p = null, $noBuiltin = \false) : ?string
    {
        ...
        } elseif ($type instanceof \ConfigTransformer202108193\ReflectionIntersectionType) {
            $reflectionTypes = $type->getTypes();
            $glue = '&';
