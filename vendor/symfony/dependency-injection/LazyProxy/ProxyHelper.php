 ...
 */
namespace ConfigTransformer202111141\Symfony\Component\DependencyInjection\LazyProxy;
...
class ProxyHelper
{
    ...
    public static function getTypeHint($r, $p = null, $noBuiltin = \false) : ?string
    {
        ...
        } elseif ($type instanceof \ConfigTransformer202111141\ReflectionIntersectionType) {
            $reflectionTypes = $type->getTypes();
            $glue = '&';
