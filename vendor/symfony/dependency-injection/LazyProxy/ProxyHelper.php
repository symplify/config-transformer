 ...
 */
namespace ConfigTransformer202108242\Symfony\Component\DependencyInjection\LazyProxy;
...
class ProxyHelper
{
    ...
    public static function getTypeHint($r, $p = null, $noBuiltin = \false) : ?string
    {
        ...
        } elseif ($type instanceof \ConfigTransformer202108242\ReflectionIntersectionType) {
            $reflectionTypes = $type->getTypes();
            $glue = '&';
