 ...
 */
namespace ConfigTransformer202108258\Symfony\Component\DependencyInjection\LazyProxy;
...
class ProxyHelper
{
    ...
    public static function getTypeHint($r, $p = null, $noBuiltin = \false) : ?string
    {
        ...
        } elseif ($type instanceof \ConfigTransformer202108258\ReflectionIntersectionType) {
            $reflectionTypes = $type->getTypes();
            $glue = '&';
