...
interface InstantiatorInterface
{
     ...
     * @return object
     */
    public function instantiateProxy(\ConfigTransformer202206079\Symfony\Component\DependencyInjection\ContainerInterface $container, \ConfigTransformer202206079\Symfony\Component\DependencyInjection\Definition $definition, string $id, callable $realInstantiator);
}
