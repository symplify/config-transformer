...
use ConfigTransformerPrefix202605\Composer\InstalledVersions;
use ConfigTransformerPrefix202605\Symfony\Component\Config\Resource\ClassExistenceResource;
use ConfigTransformerPrefix202605\Symfony\Component\Config\Resource\ComposerResource;
use ConfigTransformerPrefix202605\Symfony\Component\Config\Resource\DirectoryResource;
use ConfigTransformerPrefix202605\Symfony\Component\Config\Resource\FileExistenceResource;
use ConfigTransformerPrefix202605\Symfony\Component\Config\Resource\FileResource;
use ConfigTransformerPrefix202605\Symfony\Component\Config\Resource\GlobResource;
use ConfigTransformerPrefix202605\Symfony\Component\Config\Resource\ReflectionClassResource;
...
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\Compiler\Compiler;
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface;
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\Compiler\PassConfig;
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
...
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface;
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
...
class ContainerBuilder extends Container implements TaggedContainerInterface
{
        ...
        if (null !== ($factory = $definition->getFactory())) {
            if (\is_array($factory)) {
                ...
                $factory = function (ServiceLocator $arguments) use($factory) {
                    return $this->getExpressionLanguage()->evaluate((string) \substr($factory, 2), ['container' => $this, 'args' => $arguments]);
                };
    ...
    private function inVendors(string $path) : bool
    {
        ...
        foreach ($this->vendors as $vendor) {
            if (\strncmp($path, $vendor, \strlen($vendor)) === 0 && \false !== \strpbrk((string) \substr($path, \strlen($vendor), 1), '/' . \DIRECTORY_SEPARATOR)) {
