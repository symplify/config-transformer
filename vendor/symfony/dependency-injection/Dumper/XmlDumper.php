 ...
 */
class XmlDumper extends \ConfigTransformer202202194\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    /**
     * @var \DOMDocument
     */
    ...
    private function addService(\ConfigTransformer202202194\Symfony\Component\DependencyInjection\Definition $definition, ?string $id, \DOMElement $parent)
    {
        ...
        if (null !== ($decoratedService = $definition->getDecoratedService())) {
            ...
            if (\in_array($decorationOnInvalid, [\ConfigTransformer202202194\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_INVALID_REFERENCE, \ConfigTransformer202202194\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE], \true)) {
        ...
        if ($callable = $definition->getFactory()) {
            ...
            if (\is_array($callable) && $callable[0] instanceof \ConfigTransformer202202194\Symfony\Component\DependencyInjection\Definition) {
                $this->addService($callable[0], null, $factory);
                $factory->setAttribute('method', $callable[1]);
            } elseif (\is_array($callable)) {
                if (null !== $callable[0]) {
                    $factory->setAttribute($callable[0] instanceof \ConfigTransformer202202194\Symfony\Component\DependencyInjection\Reference ? 'service' : 'class', $callable[0]);
                }
                $factory->setAttribute('method', $callable[1]);
            } else {
        ...
        if ($callable = $definition->getConfigurator()) {
            ...
            if (\is_array($callable) && $callable[0] instanceof \ConfigTransformer202202194\Symfony\Component\DependencyInjection\Definition) {
                ...
                $configurator->setAttribute($callable[0] instanceof \ConfigTransformer202202194\Symfony\Component\DependencyInjection\Reference ? 'service' : 'class', $callable[0]);
                $configurator->setAttribute('method', $callable[1]);
            } else {
    ...
    private function addServiceAlias(string $alias, \ConfigTransformer202202194\Symfony\Component\DependencyInjection\Alias $id, \DOMElement $parent)
    {
        $service = $this->document->createElement('service');
    ...
    private function convertParameters(array $parameters, string $type, \DOMElement $parent, string $keyAttribute = 'key')
    {
        ...
        foreach ($parameters as $key => $value) {
            ...
            if (\is_array($tag = $value)) {
            ...
            } elseif ($value instanceof \ConfigTransformer202202194\Symfony\Component\DependencyInjection\Argument\TaggedIteratorArgument || $value instanceof \ConfigTransformer202202194\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument && ($tag = $value->getTaggedIteratorArgument())) {
                $element->setAttribute('type', $value instanceof \ConfigTransformer202202194\Symfony\Component\DependencyInjection\Argument\TaggedIteratorArgument ? 'tagged_iterator' : 'tagged_locator');
            ...
            } elseif ($value instanceof \ConfigTransformer202202194\Symfony\Component\DependencyInjection\Argument\IteratorArgument) {
                ...
                $this->convertParameters($value->getValues(), $type, $element, 'key');
            } elseif ($value instanceof \ConfigTransformer202202194\Symfony\Component\DependencyInjection\Reference || $value instanceof \ConfigTransformer202202194\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument) {
                ...
                if (\ConfigTransformer202202194\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE == $behavior) {
                    $element->setAttribute('on-invalid', 'null');
                } elseif (\ConfigTransformer202202194\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_INVALID_REFERENCE == $behavior) {
                    $element->setAttribute('on-invalid', 'ignore');
                } elseif (\ConfigTransformer202202194\Symfony\Component\DependencyInjection\ContainerInterface::IGNORE_ON_UNINITIALIZED_REFERENCE == $behavior) {
    ...
    public static function phpToXml($value) : string
    {
        switch (\true) {
            ...
            case \false === $value:
                return 'false';
            case $value instanceof \ConfigTransformer202202194\Symfony\Component\DependencyInjection\Parameter:
                return '%' . $value . '%';
            case $value instanceof \ConfigTransformer202202194\UnitEnum:
