 ...
 */
class GraphvizDumper extends \ConfigTransformer202206045\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    /**
     * @var mixed[]
     */
    ...
    private function findEdges(string $id, array $arguments, bool $required, string $name, bool $lazy = \false) : array
    {
        ...
        foreach ($arguments as $argument) {
            if ($argument instanceof \ConfigTransformer202206045\Symfony\Component\DependencyInjection\Parameter) {
            ...
            } elseif ($argument instanceof \ConfigTransformer202206045\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
                $edges[] = $this->findEdges($id, $argument->getValues(), $required, $name, \true);
            } elseif ($argument instanceof \ConfigTransformer202206045\Symfony\Component\DependencyInjection\Definition) {
    ...
    private function findNodes() : array
    {
        ...
        foreach ($container->getDefinitions() as $id => $definition) {
            ...
            $container->setDefinition($id, new \ConfigTransformer202206045\Symfony\Component\DependencyInjection\Definition('stdClass'));
        }
    ...
    private function cloneContainer() : \ConfigTransformer202206045\Symfony\Component\DependencyInjection\ContainerBuilder
    {
        $parameterBag = new \ConfigTransformer202206045\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->container->getParameterBag()->all());
        $container = new \ConfigTransformer202206045\Symfony\Component\DependencyInjection\ContainerBuilder($parameterBag);
