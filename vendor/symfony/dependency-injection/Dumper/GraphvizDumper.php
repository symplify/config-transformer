 ...
 */
class GraphvizDumper extends \ConfigTransformer202111010\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    private $nodes;
    private $edges;
    ...
    private function findEdges(string $id, array $arguments, bool $required, string $name, bool $lazy = \false) : array
    {
        ...
        foreach ($arguments as $argument) {
            if ($argument instanceof \ConfigTransformer202111010\Symfony\Component\DependencyInjection\Parameter) {
            ...
            } elseif ($argument instanceof \ConfigTransformer202111010\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
                $edges = \array_merge($edges, $this->findEdges($id, $argument->getValues(), $required, $name, \true));
            } elseif ($argument instanceof \ConfigTransformer202111010\Symfony\Component\DependencyInjection\Definition) {
    ...
    private function findNodes() : array
    {
        ...
        foreach ($container->getDefinitions() as $id => $definition) {
            ...
            $container->setDefinition($id, new \ConfigTransformer202111010\Symfony\Component\DependencyInjection\Definition('stdClass'));
        }
    ...
    private function cloneContainer() : \ConfigTransformer202111010\Symfony\Component\DependencyInjection\ContainerBuilder
    {
        $parameterBag = new \ConfigTransformer202111010\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->container->getParameterBag()->all());
        $container = new \ConfigTransformer202111010\Symfony\Component\DependencyInjection\ContainerBuilder($parameterBag);
