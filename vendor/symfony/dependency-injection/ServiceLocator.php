...
use ConfigTransformer202107108\Symfony\Contracts\Service\ServiceLocatorTrait;
 ...
 */
class ServiceLocator implements \ConfigTransformer202107108\Symfony\Contracts\Service\ServiceProviderInterface
{
    ...
    private function createNotFoundException(string $id) : \ConfigTransformer202107108\Psr\Container\NotFoundExceptionInterface
    {
        if ($this->loading) {
            ...
            return new \ConfigTransformer202107108\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, \end($this->loading) ?: null, null, [], $msg);
        }
        ...
        if (!$class) {
            // no-op
        } elseif (\is_subclass_of($class, \ConfigTransformer202107108\Symfony\Contracts\Service\ServiceSubscriberInterface::class)) {
            $msg[] = \sprintf('Unless you need extra laziness, try using dependency injection instead. Otherwise, you need to declare it using "%s::getSubscribedServices()".', \preg_replace('/([^\\\\]++\\\\)++/', '', $class));
        } else {
            $msg[] = 'Try using dependency injection instead.';
        }
        return new \ConfigTransformer202107108\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, \end($this->loading) ?: null, null, [], \implode(' ', $msg));
    }
    ...
    {
        return new \ConfigTransformer202107108\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, $path);
    }
