 ...
 */
namespace ConfigTransformerPrefix202606\Symfony\Component\DependencyInjection\Loader;

use ConfigTransformerPrefix202606\Symfony\Component\Config\Exception\FileLocatorFileNotFoundException;
use ConfigTransformerPrefix202606\Symfony\Component\Config\Exception\LoaderLoadException;
use ConfigTransformerPrefix202606\Symfony\Component\Config\FileLocatorInterface;
use ConfigTransformerPrefix202606\Symfony\Component\Config\Loader\FileLoader as BaseFileLoader;
use ConfigTransformerPrefix202606\Symfony\Component\Config\Loader\Loader;
use ConfigTransformerPrefix202606\Symfony\Component\Config\Resource\GlobResource;
use ConfigTransformerPrefix202606\Symfony\Component\DependencyInjection\Attribute\When;
use ConfigTransformerPrefix202606\Symfony\Component\DependencyInjection\ChildDefinition;
use ConfigTransformerPrefix202606\Symfony\Component\DependencyInjection\Compiler\RegisterAutoconfigureAttributesPass;
use ConfigTransformerPrefix202606\Symfony\Component\DependencyInjection\ContainerBuilder;
use ConfigTransformerPrefix202606\Symfony\Component\DependencyInjection\Definition;
...
abstract class FileLoader extends BaseFileLoader
{
    ...
    private function findClasses(string $namespace, string $pattern, array $excludePatterns, ?RegisterAutoconfigureAttributesPass $autoconfigureAttributes) : array
    {
        ...
        foreach ($this->glob($pattern, \true, $resource, \false, \false, $excludePaths) as $path => $info) {
            ...
            $class = $namespace . \ltrim(\str_replace('/', '\\', (string) \substr($path, $prefixLen, -\strlen($m[0]))), '\\');
