...
use ConfigTransformerPrefix202605\Symfony\Component\Config\Builder\ConfigBuilderGeneratorInterface;
use ConfigTransformerPrefix202605\Symfony\Component\Config\Builder\ConfigBuilderInterface;
...
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\Extension\ConfigurationExtensionInterface;
...
class PhpFileLoader extends FileLoader
{
    ...
    private function configBuilder(string $namespace) : ConfigBuilderInterface
    {
        ...
        $alias = Container::underscore((string) \substr($namespace, 15, -6));
