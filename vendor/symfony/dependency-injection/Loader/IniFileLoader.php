...
use ConfigTransformer202201160\Symfony\Component\Config\Util\XmlUtils;
 ...
 */
class IniFileLoader extends \ConfigTransformer202201160\Symfony\Component\DependencyInjection\Loader\FileLoader
{
    /**
     * {@inheritdoc}
    ...
    public function load($resource, $type = null)
    {
        ...
        if (\false === $result || [] === $result) {
            throw new \ConfigTransformer202201160\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('The "%s" file is not valid.', $resource));
        }
        // real raw parsing
    ...
    private function phpize(string $value)
    {
        ...
        switch (\true) {
            ...
            default:
                return \ConfigTransformer202201160\Symfony\Component\Config\Util\XmlUtils::phpize($value);
        }
    }
}
