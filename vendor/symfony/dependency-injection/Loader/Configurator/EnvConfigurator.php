...
class EnvConfigurator extends \ConfigTransformer202109186\Symfony\Component\Config\Loader\ParamConfigurator
{
    /**
     * @var string[]
     */
    ...
    {
        $processor = \strtolower(\preg_replace(['/([A-Z]+)([A-Z][a-z])/', '/([a-z\\d])([A-Z])/'], 'ConfigTransformer202109186\\1_\\2', $name));
