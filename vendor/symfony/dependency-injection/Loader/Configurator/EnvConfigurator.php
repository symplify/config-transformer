...
class EnvConfigurator extends \ConfigTransformer202108188\Symfony\Component\Config\Loader\ParamConfigurator
{
    /**
     * @var string[]
     */
    ...
    {
        $processor = \strtolower(\preg_replace(['/([A-Z]+)([A-Z][a-z])/', '/([a-z\\d])([A-Z])/'], 'ConfigTransformer202108188\\1_\\2', $name));
