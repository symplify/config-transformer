 ...
 */
class CheckArgumentsValidityPass extends \ConfigTransformer202205235\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * @var bool
     */
            ...
            if ($k !== $i++) {
                if (!\is_int($k)) {
                    ...
                    if ($this->throwExceptions) {
                        throw new \ConfigTransformer202205235\Symfony\Component\DependencyInjection\Exception\RuntimeException($msg);
                    }
                    break;
                }
