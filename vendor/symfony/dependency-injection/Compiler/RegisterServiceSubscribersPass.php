 ...
 */
namespace ConfigTransformerPrefix202606\Symfony\Component\DependencyInjection\Compiler;

use ConfigTransformerPrefix202606\Psr\Container\ContainerInterface as PsrContainerInterface;
use ConfigTransformerPrefix202606\Symfony\Bundle\FrameworkBundle\Controller\AbstractController;
use ConfigTransformerPrefix202606\Symfony\Component\DependencyInjection\Argument\BoundArgument;
...
use ConfigTransformerPrefix202606\Symfony\Component\DependencyInjection\TypedReference;
use ConfigTransformerPrefix202606\Symfony\Component\HttpFoundation\Session\SessionInterface;
use ConfigTransformerPrefix202606\Symfony\Contracts\Service\ServiceProviderInterface;
use ConfigTransformerPrefix202606\Symfony\Contracts\Service\ServiceSubscriberInterface;
/**
        ...
        foreach ($class::getSubscribedServices() as $key => $type) {
            ...
            if ($name) {
                if (\false !== ($i = \strpos($name, '::get'))) {
                    $name = \lcfirst((string) \substr($name, 5 + $i));
