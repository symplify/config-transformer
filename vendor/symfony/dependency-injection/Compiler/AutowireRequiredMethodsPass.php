 ...
 */
class AutowireRequiredMethodsPass extends \ConfigTransformer202106193\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     */
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        if (!$value instanceof \ConfigTransformer202106193\Symfony\Component\DependencyInjection\Definition || !$value->isAutowired() || $value->isAbstract() || !$value->getClass()) {
            return $value;
        }
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\PHP_VERSION_ID >= 80000 && $r->getAttributes(\ConfigTransformer202106193\Symfony\Contracts\Service\Attribute\Required::class)) {
