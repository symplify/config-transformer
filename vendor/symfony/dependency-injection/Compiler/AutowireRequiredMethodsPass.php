 ...
 */
class AutowireRequiredMethodsPass extends \ConfigTransformer202206044\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     * @param mixed $value
    ...
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        if (!$value instanceof \ConfigTransformer202206044\Symfony\Component\DependencyInjection\Definition || !$value->isAutowired() || $value->isAbstract() || !$value->getClass()) {
            return $value;
        }
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\method_exists($r, 'getAttributes') ? $r->getAttributes(\ConfigTransformer202206044\Symfony\Contracts\Service\Attribute\Required::class) : []) {
