 ...
 */
class AutowireRequiredMethodsPass extends \ConfigTransformer202112087\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     * @param mixed $value
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        if (!$value instanceof \ConfigTransformer202112087\Symfony\Component\DependencyInjection\Definition || !$value->isAutowired() || $value->isAbstract() || !$value->getClass()) {
            return $value;
        }
