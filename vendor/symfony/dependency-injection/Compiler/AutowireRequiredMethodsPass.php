 ...
 */
class AutowireRequiredMethodsPass extends \ConfigTransformer202201175\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
     * @param mixed $value
    ...
    protected function processValue($value, bool $isRoot = \false)
    {
        ...
        foreach ($reflectionClass->getMethods() as $reflectionMethod) {
            ...
            while (\true) {
                if (\method_exists($r, 'getAttributes') ? $r->getAttributes(\ConfigTransformer202201175\Symfony\Contracts\Service\Attribute\Required::class) : []) {
