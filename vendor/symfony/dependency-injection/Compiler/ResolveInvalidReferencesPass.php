 ...
 */
class ResolveInvalidReferencesPass implements \ConfigTransformer202111287\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $container;
    ...
    public function process($container)
    {
        ...
        $this->signalingException = new \ConfigTransformer202111287\Symfony\Component\DependencyInjection\Exception\RuntimeException('Invalid reference.');
        try {
    ...
    private function processValue($value, int $rootLevel = 0, int $level = 0)
    {
        if ($value instanceof \ConfigTransformer202111287\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument) {
        ...
        } elseif ($value instanceof \ConfigTransformer202111287\Symfony\Component\DependencyInjection\Argument\ArgumentInterface) {
            ...
            foreach ($value as $k => $v) {
                ...
                } catch (\ConfigTransformer202111287\Symfony\Component\DependencyInjection\Exception\RuntimeException $e) {
        ...
        } elseif ($value instanceof \ConfigTransformer202111287\Symfony\Component\DependencyInjection\Reference) {
            ...
            if ($currentDefinition->innerServiceId === $id && \ConfigTransformer202111287\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE === $currentDefinition->decorationOnInvalid) {
                return null;
            }
            $invalidBehavior = $value->getInvalidBehavior();
            if (\ConfigTransformer202111287\Symfony\Component\DependencyInjection\ContainerInterface::RUNTIME_EXCEPTION_ON_INVALID_REFERENCE === $invalidBehavior && $value instanceof \ConfigTransformer202111287\Symfony\Component\DependencyInjection\TypedReference && !$this->container->has($id)) {
                $e = new \ConfigTransformer202111287\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException($id, $this->currentId);
                ...
                return new \ConfigTransformer202111287\Symfony\Component\DependencyInjection\TypedReference($id, $value->getType(), $value->getInvalidBehavior());
            }
            // resolve invalid behavior
            if (\ConfigTransformer202111287\Symfony\Component\DependencyInjection\ContainerInterface::NULL_ON_INVALID_REFERENCE === $invalidBehavior) {
                $value = null;
