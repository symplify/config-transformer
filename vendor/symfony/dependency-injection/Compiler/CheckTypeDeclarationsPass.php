...
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\Exception\InvalidParameterTypeException;
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\Exception\RuntimeException;
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\ExpressionLanguage;
...
use ConfigTransformerPrefix202605\Symfony\Component\DependencyInjection\ServiceLocator;
    ...
    private function checkType(Definition $checkedDefinition, $value, \ReflectionParameter $parameter, ?string $envPlaceholderUniquePrefix, \ReflectionType $reflectionType = null) : void
    {
        ...
        if ($value instanceof Definition) {
            ...
            if ('%' === ($value[0] ?? '') && \preg_match('/^%([^%]+)%$/', $value, $match)) {
                $value = $this->container->getParameter((string) \substr($value, 1, -1));
            }
