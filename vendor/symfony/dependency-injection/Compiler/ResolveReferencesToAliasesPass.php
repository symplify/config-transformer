 ...
 */
class ResolveReferencesToAliasesPass extends \ConfigTransformer202107211\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    /**
     * {@inheritdoc}
    ...
    protected function processValue($value, $isRoot = \false)
    {
        ...
        return $defId !== $id ? new \ConfigTransformer202107211\Symfony\Component\DependencyInjection\Reference($defId, $value->getInvalidBehavior()) : $value;
    }
    private function getDefinitionId(string $id, \ConfigTransformer202107211\Symfony\Component\DependencyInjection\ContainerBuilder $container) : string
    {
        ...
        do {
            if (isset($seen[$id])) {
                throw new \ConfigTransformer202107211\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException($id, \array_merge(\array_keys($seen), [$id]));
            }
            $seen[$id] = \true;
