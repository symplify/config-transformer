 ...
 */
class SingleCommandApplication extends \ConfigTransformer202112090\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    public function run($input = null, $output = null) : int
    {
        ...
        $application = new \ConfigTransformer202112090\Symfony\Component\Console\Application($this->getName() ?: 'UNKNOWN', $this->version);
