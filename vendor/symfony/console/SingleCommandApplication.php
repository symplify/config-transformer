 ...
 */
class SingleCommandApplication extends \ConfigTransformer2021120710\Symfony\Component\Console\Command\Command
{
    /**
     * @var string
     */
    ...
    public function run($input = null, $output = null) : int
    {
        ...
        $application = new \ConfigTransformer2021120710\Symfony\Component\Console\Application($this->getName() ?: 'UNKNOWN', $this->version);
