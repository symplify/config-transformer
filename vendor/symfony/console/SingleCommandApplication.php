 ...
 */
class SingleCommandApplication extends \ConfigTransformer2021080410\Symfony\Component\Console\Command\Command
{
    ...
    public function run($input = null, $output = null) : int
    {
        ...
        $application = new \ConfigTransformer2021080410\Symfony\Component\Console\Application($this->getName() ?: 'UNKNOWN', $this->version);
