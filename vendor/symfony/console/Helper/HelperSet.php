...
class HelperSet implements \IteratorAggregate
{
     ...
     * @param string $name
     */
    public function get($name) : \ConfigTransformer202112016\Symfony\Component\Console\Helper\HelperInterface
    {
        if (!$this->has($name)) {
            throw new \ConfigTransformer202112016\Symfony\Component\Console\Exception\InvalidArgumentException(\sprintf('The helper "%s" is not defined.', $name));
        }
