 ...
 */
namespace ConfigTransformerPrefix202605\Symfony\Component\Console\Helper;

use ConfigTransformerPrefix202605\Symfony\Component\Console\Cursor;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Exception\MissingInputException;
...
use ConfigTransformerPrefix202605\Symfony\Component\Console\Formatter\OutputFormatterStyle;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Input\InputInterface;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Input\StreamableInputInterface;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Output\ConsoleOutputInterface;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Output\ConsoleSectionOutput;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Output\OutputInterface;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Question\ChoiceQuestion;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Question\Question;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Terminal;
use function ConfigTransformerPrefix202605\Symfony\Component\String\s;
/**
...
class QuestionHelper extends Helper
{
            ...
            if (\false === $c || '' === $ret && '' === $c && null === $question->getDefault()) {
                ...
                if ("\t" === $c || "\n" === $c) {
                    if ($numMatches > 0 && -1 !== $ofs) {
                        ...
                        $matches = \array_filter($autocomplete($ret), static function ($match) use($ret) {
    ...
    {
        $ret = '';
        $helper = $helper ?? new TerminalInputHelper($inputStream, \false);
        while (!\feof($inputStream)) {
            $helper->waitForInput();
