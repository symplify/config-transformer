 ...
 */
class FormatterHelper extends \ConfigTransformer2021070510\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \ConfigTransformer2021070510\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
