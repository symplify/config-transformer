 ...
 */
class FormatterHelper extends \ConfigTransformer202112026\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, $style, $large = \false) : string
    {
        ...
        foreach ($messages as $message) {
            $message = \ConfigTransformer202112026\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
