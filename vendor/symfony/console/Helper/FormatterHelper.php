 ...
 */
class FormatterHelper extends \ConfigTransformer2021120210\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, $style, $large = \false) : string
    {
        ...
        foreach ($messages as $message) {
            $message = \ConfigTransformer2021120210\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
