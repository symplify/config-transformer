 ...
 */
class FormatterHelper extends \ConfigTransformer2021113010\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, $style, $large = \false) : string
    {
        ...
        foreach ($messages as $message) {
            $message = \ConfigTransformer2021113010\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
