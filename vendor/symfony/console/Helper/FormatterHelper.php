 ...
 */
class FormatterHelper extends \ConfigTransformer202107055\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false)
    {
        ...
        foreach ($messages as $message) {
            $message = \ConfigTransformer202107055\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
