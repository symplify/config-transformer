 ...
 */
class FormatterHelper extends \ConfigTransformer202203075\Symfony\Component\Console\Helper\Helper
{
    /**
    ...
    public function formatBlock($messages, string $style, bool $large = \false) : string
    {
        ...
        foreach ($messages as $message) {
            $message = \ConfigTransformer202203075\Symfony\Component\Console\Formatter\OutputFormatter::escape($message);
