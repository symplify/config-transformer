...
use ConfigTransformer202111133\Symfony\Component\String\UnicodeString;
/**
 * Helper is the base class for all helper classes.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
abstract class Helper implements \ConfigTransformer202111133\Symfony\Component\Console\Helper\HelperInterface
{
    ...
    public static function width($string) : int
    {
        ...
        if (\preg_match('//u', $string)) {
            return (new \ConfigTransformer202111133\Symfony\Component\String\UnicodeString($string))->width(\false);
        }
    ...
    public static function length($string) : int
    {
        $string ?? ($string = '');
        if (\preg_match('//u', $string)) {
            return (new \ConfigTransformer202111133\Symfony\Component\String\UnicodeString($string))->length();
        }
        if (\false === ($encoding = \mb_detect_encoding($string, null, \true))) {
            return \strlen($string);
        }
