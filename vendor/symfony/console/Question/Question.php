 ...
 */
namespace ConfigTransformer2021120410\Symfony\Component\Console\Question;
...
class Question
{
    ...
    public function setHidden($hidden)
    {
        if ($this->autocompleterCallback) {
            throw new \ConfigTransformer2021120410\Symfony\Component\Console\Exception\LogicException('A hidden question cannot use the autocompleter.');
        }
        $this->hidden = $hidden;
        return $this;
    }
    ...
    public function setMaxAttempts($attempts)
    {
        if (null !== $attempts && $attempts < 1) {
            throw new \ConfigTransformer2021120410\Symfony\Component\Console\Exception\InvalidArgumentException('Maximum number of attempts must be a positive value.');
        }
