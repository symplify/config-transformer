 ...
 * @internal
 */
class XmlDescriptor extends \ConfigTransformer202205211\Symfony\Component\Console\Descriptor\Descriptor
{
    public function getInputDefinitionDocument(\ConfigTransformer202205211\Symfony\Component\Console\Input\InputDefinition $definition) : \DOMDocument
    {
    ...
    public function getCommandDocument(\ConfigTransformer202205211\Symfony\Component\Console\Command\Command $command, bool $short = \false) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    public function getApplicationDocument(\ConfigTransformer202205211\Symfony\Component\Console\Application $application, string $namespace = null, bool $short = \false) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
        ...
        $description = new \ConfigTransformer202205211\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
    ...
    private function getInputArgumentDocument(\ConfigTransformer202205211\Symfony\Component\Console\Input\InputArgument $argument) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    private function getInputOptionDocument(\ConfigTransformer202205211\Symfony\Component\Console\Input\InputOption $option) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
