 ...
 * @internal
 */
class XmlDescriptor extends \ConfigTransformer2021120210\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
    ...
    public function getApplicationDocument($application, $namespace = null, $short = \false) : \DOMDocument
    {
        ...
        $description = new \ConfigTransformer2021120210\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
    ...
    private function getInputArgumentDocument(\ConfigTransformer2021120210\Symfony\Component\Console\Input\InputArgument $argument) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    private function getInputOptionDocument(\ConfigTransformer2021120210\Symfony\Component\Console\Input\InputOption $option) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
