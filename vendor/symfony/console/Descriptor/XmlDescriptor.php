 ...
 * @internal
 */
class XmlDescriptor extends \ConfigTransformer202111035\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
    ...
    public function getApplicationDocument($application, $namespace = null, $short = \false) : \DOMDocument
    {
        ...
        $description = new \ConfigTransformer202111035\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $namespace, \true);
        if ($namespace) {
    ...
    private function getInputArgumentDocument(\ConfigTransformer202111035\Symfony\Component\Console\Input\InputArgument $argument) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
    ...
    private function getInputOptionDocument(\ConfigTransformer202111035\Symfony\Component\Console\Input\InputOption $option) : \DOMDocument
    {
        $dom = new \DOMDocument('1.0', 'UTF-8');
