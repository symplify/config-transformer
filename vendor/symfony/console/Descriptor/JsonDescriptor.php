 ...
 */
namespace ConfigTransformer202109173\Symfony\Component\Console\Descriptor;
 ...
 * @internal
 */
class JsonDescriptor extends \ConfigTransformer202109173\Symfony\Component\Console\Descriptor\Descriptor
{
    /**
     * {@inheritdoc}
    ...
    protected function describeApplication($application, $options = [])
    {
        ...
        $description = new \ConfigTransformer202109173\Symfony\Component\Console\Descriptor\ApplicationDescription($application, $describedNamespace, \true);
        $commands = [];
    ...
    private function getInputArgumentData(\ConfigTransformer202109173\Symfony\Component\Console\Input\InputArgument $argument) : array
    {
    ...
    private function getInputOptionData(\ConfigTransformer202109173\Symfony\Component\Console\Input\InputOption $option, bool $negated = \false) : array
    {
    ...
    private function getInputDefinitionData(\ConfigTransformer202109173\Symfony\Component\Console\Input\InputDefinition $definition) : array
    {
        $inputArguments = [];
    ...
    private function getCommandData(\ConfigTransformer202109173\Symfony\Component\Console\Command\Command $command, bool $short = \false) : array
    {
