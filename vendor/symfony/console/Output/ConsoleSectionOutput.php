 ...
 */
class ConsoleSectionOutput extends \ConfigTransformer202107108\Symfony\Component\Console\Output\StreamOutput
{
    private $content = [];
    private $lines = 0;
    private $sections;
     ...
     */
    public function __construct($stream, array &$sections, int $verbosity, bool $decorated, \ConfigTransformer202107108\Symfony\Component\Console\Formatter\OutputFormatterInterface $formatter)
    {
    ...
    {
        return \ConfigTransformer202107108\Symfony\Component\Console\Helper\Helper::width(\ConfigTransformer202107108\Symfony\Component\Console\Helper\Helper::removeDecoration($this->getFormatter(), \str_replace("\t", '        ', $text)));
    }
}
