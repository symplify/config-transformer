 ...
 */
final class NullOutputFormatter implements \ConfigTransformer202112090\Symfony\Component\Console\Formatter\OutputFormatterInterface
{
    private $style;
    /**
     * {@inheritdoc}
    ...
    public function getStyle($name) : \ConfigTransformer202112090\Symfony\Component\Console\Formatter\OutputFormatterStyleInterface
    {
        ...
        return $this->style ?? ($this->style = new \ConfigTransformer202112090\Symfony\Component\Console\Formatter\NullOutputFormatterStyle());
    }
    /**
     * {@inheritdoc}
     * @param string $name
