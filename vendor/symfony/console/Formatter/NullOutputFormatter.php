 ...
 */
final class NullOutputFormatter implements \ConfigTransformer2021120810\Symfony\Component\Console\Formatter\OutputFormatterInterface
{
    /**
    ...
    public function getStyle($name) : \ConfigTransformer2021120810\Symfony\Component\Console\Formatter\OutputFormatterStyleInterface
    {
        ...
        return $this->style ?? ($this->style = new \ConfigTransformer2021120810\Symfony\Component\Console\Formatter\NullOutputFormatterStyle());
    }
    /**
     * {@inheritdoc}
     * @param string $name
