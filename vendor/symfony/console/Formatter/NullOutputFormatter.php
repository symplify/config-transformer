 ...
 */
final class NullOutputFormatter implements \ConfigTransformer202112079\Symfony\Component\Console\Formatter\OutputFormatterInterface
{
    /**
    ...
    public function getStyle($name) : \ConfigTransformer202112079\Symfony\Component\Console\Formatter\OutputFormatterStyleInterface
    {
        ...
        return $this->style ?? ($this->style = new \ConfigTransformer202112079\Symfony\Component\Console\Formatter\NullOutputFormatterStyle());
    }
    /**
     * {@inheritdoc}
     * @param string $name
