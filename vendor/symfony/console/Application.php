...
use ConfigTransformer202206\Symfony\Component\Console\Command\Command;
use ConfigTransformer202206\Symfony\Component\Console\Command\CompleteCommand;
use ConfigTransformer202206\Symfony\Component\Console\Command\DumpCompletionCommand;
use ConfigTransformer202206\Symfony\Component\Console\Command\HelpCommand;
use ConfigTransformer202206\Symfony\Component\Console\Command\LazyCommand;
use ConfigTransformer202206\Symfony\Component\Console\Command\ListCommand;
use ConfigTransformer202206\Symfony\Component\Console\Command\SignalableCommandInterface;
use ConfigTransformer202206\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
use ConfigTransformer202206\Symfony\Component\Console\Completion\CompletionInput;
use ConfigTransformer202206\Symfony\Component\Console\Completion\CompletionSuggestions;
use ConfigTransformer202206\Symfony\Component\Console\Event\ConsoleCommandEvent;
use ConfigTransformer202206\Symfony\Component\Console\Event\ConsoleErrorEvent;
use ConfigTransformer202206\Symfony\Component\Console\Event\ConsoleSignalEvent;
use ConfigTransformer202206\Symfony\Component\Console\Event\ConsoleTerminateEvent;
use ConfigTransformer202206\Symfony\Component\Console\Exception\CommandNotFoundException;
use ConfigTransformer202206\Symfony\Component\Console\Exception\ExceptionInterface;
use ConfigTransformer202206\Symfony\Component\Console\Exception\LogicException;
use ConfigTransformer202206\Symfony\Component\Console\Exception\NamespaceNotFoundException;
use ConfigTransformer202206\Symfony\Component\Console\Exception\RuntimeException;
use ConfigTransformer202206\Symfony\Component\Console\Formatter\OutputFormatter;
use ConfigTransformer202206\Symfony\Component\Console\Helper\DebugFormatterHelper;
use ConfigTransformer202206\Symfony\Component\Console\Helper\FormatterHelper;
use ConfigTransformer202206\Symfony\Component\Console\Helper\Helper;
use ConfigTransformer202206\Symfony\Component\Console\Helper\HelperSet;
use ConfigTransformer202206\Symfony\Component\Console\Helper\ProcessHelper;
use ConfigTransformer202206\Symfony\Component\Console\Helper\QuestionHelper;
use ConfigTransformer202206\Symfony\Component\Console\Input\ArgvInput;
use ConfigTransformer202206\Symfony\Component\Console\Input\ArrayInput;
use ConfigTransformer202206\Symfony\Component\Console\Input\InputArgument;
use ConfigTransformer202206\Symfony\Component\Console\Input\InputAwareInterface;
use ConfigTransformer202206\Symfony\Component\Console\Input\InputDefinition;
use ConfigTransformer202206\Symfony\Component\Console\Input\InputInterface;
use ConfigTransformer202206\Symfony\Component\Console\Input\InputOption;
use ConfigTransformer202206\Symfony\Component\Console\Output\ConsoleOutput;
use ConfigTransformer202206\Symfony\Component\Console\Output\ConsoleOutputInterface;
use ConfigTransformer202206\Symfony\Component\Console\Output\OutputInterface;
use ConfigTransformer202206\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use ConfigTransformer202206\Symfony\Component\Console\Style\SymfonyStyle;
use ConfigTransformer202206\Symfony\Component\ErrorHandler\ErrorHandler;
use ConfigTransformer202206\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
