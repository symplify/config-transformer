 ...
 */
namespace ConfigTransformerPrefix202605\Symfony\Component\Console;

use ConfigTransformerPrefix202605\Symfony\Component\Console\Command\Command;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Command\CompleteCommand;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Command\DumpCompletionCommand;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Command\HelpCommand;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Command\LazyCommand;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Command\ListCommand;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Command\SignalableCommandInterface;
use ConfigTransformerPrefix202605\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Completion\CompletionInput;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Completion\CompletionSuggestions;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Completion\Suggestion;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Event\ConsoleCommandEvent;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Event\ConsoleErrorEvent;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Event\ConsoleSignalEvent;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Event\ConsoleTerminateEvent;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Exception\CommandNotFoundException;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Exception\ExceptionInterface;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Exception\LogicException;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Exception\NamespaceNotFoundException;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Exception\RuntimeException;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Formatter\OutputFormatter;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Helper\DebugFormatterHelper;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Helper\DescriptorHelper;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Helper\FormatterHelper;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Helper\Helper;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Helper\HelperSet;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Helper\ProcessHelper;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Helper\QuestionHelper;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Input\ArgvInput;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Input\ArrayInput;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Input\InputArgument;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Input\InputAwareInterface;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Input\InputDefinition;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Input\InputInterface;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Input\InputOption;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Output\ConsoleOutput;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Output\ConsoleOutputInterface;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Output\OutputInterface;
use ConfigTransformerPrefix202605\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Style\SymfonyStyle;
use ConfigTransformerPrefix202605\Symfony\Component\ErrorHandler\ErrorHandler;
use ConfigTransformerPrefix202605\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
use ConfigTransformerPrefix202605\Symfony\Contracts\Service\ResetInterface;
/**
...
class Application implements ResetInterface
{
    ...
    public function find(string $name)
    {
        ...
        if (empty($commands) || \count(\preg_grep('{^' . $expr . '$}i', $commands)) < 1) {
            ...
            if ($alternatives = $this->findAlternatives($name, $allCommands)) {
                ...
                if ($alternatives = \array_filter($alternatives, function ($name) {
    ...
    private function findAlternatives(string $name, iterable $collection) : array
    {
        ...
        $alternatives = \array_filter($alternatives, static function ($lev) use($threshold) {
