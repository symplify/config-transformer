 ...
 */
namespace ConfigTransformerPrefix202310\Symfony\Component\Console;

use ConfigTransformerPrefix202310\Symfony\Component\Console\Command\Command;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Command\CompleteCommand;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Command\DumpCompletionCommand;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Command\HelpCommand;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Command\LazyCommand;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Command\ListCommand;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Command\SignalableCommandInterface;
use ConfigTransformerPrefix202310\Symfony\Component\Console\CommandLoader\CommandLoaderInterface;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Completion\CompletionInput;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Completion\CompletionSuggestions;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Completion\Suggestion;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Event\ConsoleCommandEvent;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Event\ConsoleErrorEvent;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Event\ConsoleSignalEvent;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Event\ConsoleTerminateEvent;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Exception\CommandNotFoundException;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Exception\ExceptionInterface;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Exception\LogicException;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Exception\NamespaceNotFoundException;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Exception\RuntimeException;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Formatter\OutputFormatter;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Helper\DebugFormatterHelper;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Helper\DescriptorHelper;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Helper\FormatterHelper;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Helper\Helper;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Helper\HelperSet;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Helper\ProcessHelper;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Helper\QuestionHelper;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Input\ArgvInput;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Input\ArrayInput;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Input\InputArgument;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Input\InputAwareInterface;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Input\InputDefinition;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Input\InputInterface;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Input\InputOption;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Output\ConsoleOutput;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Output\ConsoleOutputInterface;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Output\OutputInterface;
use ConfigTransformerPrefix202310\Symfony\Component\Console\SignalRegistry\SignalRegistry;
use ConfigTransformerPrefix202310\Symfony\Component\Console\Style\SymfonyStyle;
use ConfigTransformerPrefix202310\Symfony\Component\ErrorHandler\ErrorHandler;
use ConfigTransformerPrefix202310\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
use ConfigTransformerPrefix202310\Symfony\Contracts\Service\ResetInterface;
/**
