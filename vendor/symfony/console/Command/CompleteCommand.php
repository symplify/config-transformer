...
use ConfigTransformerPrefix202605\Symfony\Component\Console\Completion\Output\BashCompletionOutput;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Completion\Output\CompletionOutputInterface;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Completion\Output\FishCompletionOutput;
use ConfigTransformerPrefix202605\Symfony\Component\Console\Completion\Output\ZshCompletionOutput;
    ...
    protected function execute(InputInterface $input, OutputInterface $output) : int
    {
        try {
            ...
            if ($options = $suggestions->getOptionSuggestions()) {
                $this->log('  --' . \implode(' --', \array_map(static function ($o) {
                    return $o->getName();
                }, $options)));
