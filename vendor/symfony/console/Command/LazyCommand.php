 ...
 */
final class LazyCommand extends \ConfigTransformer202112309\Symfony\Component\Console\Command\Command
{
    private $command;
    /**
     * @var bool|null
    ...
    public function setApplication(\ConfigTransformer202112309\Symfony\Component\Console\Application $application = null) : void
    {
    ...
    public function setHelperSet(\ConfigTransformer202112309\Symfony\Component\Console\Helper\HelperSet $helperSet) : void
    {
        if ($this->command instanceof parent) {
