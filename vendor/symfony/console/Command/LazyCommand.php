 ...
 */
final class LazyCommand extends \ConfigTransformer202205120\Symfony\Component\Console\Command\Command
{
    private $command;
    /**
     * @var bool|null
    ...
    public function setApplication(\ConfigTransformer202205120\Symfony\Component\Console\Application $application = null) : void
    {
    ...
    public function setHelperSet(\ConfigTransformer202205120\Symfony\Component\Console\Helper\HelperSet $helperSet) : void
    {
        if ($this->command instanceof parent) {
