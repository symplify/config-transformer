 ...
 */
class HelpCommand extends \ConfigTransformer202112309\Symfony\Component\Console\Command\Command
{
    private $command;
    /**
     * {@inheritdoc}
    ...
    protected function configure()
    {
        ...
        $this->setName('help')->setDefinition([new \ConfigTransformer202112309\Symfony\Component\Console\Input\InputArgument('command_name', \ConfigTransformer202112309\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'The command name', 'help'), new \ConfigTransformer202112309\Symfony\Component\Console\Input\InputOption('format', null, \ConfigTransformer202112309\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'The output format (txt, xml, json, or md)', 'txt'), new \ConfigTransformer202112309\Symfony\Component\Console\Input\InputOption('raw', null, \ConfigTransformer202112309\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'To output raw command help')])->setDescription('Display help for a command')->setHelp(<<<'EOF'
...
EOF
    ...
    public function setCommand(\ConfigTransformer202112309\Symfony\Component\Console\Command\Command $command)
    {
