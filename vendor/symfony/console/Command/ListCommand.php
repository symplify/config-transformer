 ...
 */
class ListCommand extends \ConfigTransformer202106122\Symfony\Component\Console\Command\Command
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->setName('list')->setDefinition([new \ConfigTransformer202106122\Symfony\Component\Console\Input\InputArgument('namespace', \ConfigTransformer202106122\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'The namespace name'), new \ConfigTransformer202106122\Symfony\Component\Console\Input\InputOption('raw', null, \ConfigTransformer202106122\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'To output raw command list'), new \ConfigTransformer202106122\Symfony\Component\Console\Input\InputOption('format', null, \ConfigTransformer202106122\Symfony\Component\Console\Input\InputOption::VALUE_REQUIRED, 'The output format (txt, xml, json, or md)', 'txt'), new \ConfigTransformer202106122\Symfony\Component\Console\Input\InputOption('short', null, \ConfigTransformer202106122\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'To skip describing commands\' arguments')])->setDescription('List commands')->setHelp(<<<'EOF'
