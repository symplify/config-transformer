 ...
 */
namespace ConfigTransformer202206072\Symfony\Component\Console\Command;

use ConfigTransformer202206072\Symfony\Component\Console\Application;
use ConfigTransformer202206072\Symfony\Component\Console\Attribute\AsCommand;
...
class Command
{
    ...
    public function run(InputInterface $input, OutputInterface $output) : int
    {
        ...
        if (null !== $this->processTitle) {
            ...
            } elseif (\function_exists('ConfigTransformer202206072\\setproctitle')) {
