...
{
    private $command;
    public function __construct(\ConfigTransformer202112105\Symfony\Component\Console\Command\Command $command)
    {
    ...
    public function complete($input) : array
    {
        ...
        $completionInput = \ConfigTransformer202112105\Symfony\Component\Console\Completion\CompletionInput::fromTokens($input, $currentIndex);
