...
{
    private $command;
    public function __construct(\ConfigTransformer202112108\Symfony\Component\Console\Command\Command $command)
    {
    ...
    public function complete(array $input) : array
    {
        ...
        $completionInput = \ConfigTransformer202112108\Symfony\Component\Console\Completion\CompletionInput::fromTokens($input, $currentIndex);
