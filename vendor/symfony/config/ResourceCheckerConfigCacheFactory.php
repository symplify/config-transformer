 ...
 */
class ResourceCheckerConfigCacheFactory implements \ConfigTransformer202107031\Symfony\Component\Config\ConfigCacheFactoryInterface
{
    ...
    {
        $cache = new \ConfigTransformer202107031\Symfony\Component\Config\ResourceCheckerConfigCache($file, $this->resourceCheckers);
        if (!$cache->isFresh()) {
            $callable($cache);
        }
        return $cache;
