 ...
 */
namespace ConfigTransformerPrefix202605\Symfony\Component\Config\Definition\Dumper;

use ConfigTransformerPrefix202605\Symfony\Component\Config\Definition\ArrayNode;
use ConfigTransformerPrefix202605\Symfony\Component\Config\Definition\BaseNode;
use ConfigTransformerPrefix202605\Symfony\Component\Config\Definition\BooleanNode;
use ConfigTransformerPrefix202605\Symfony\Component\Config\Definition\ConfigurationInterface;
use ConfigTransformerPrefix202605\Symfony\Component\Config\Definition\EnumNode;
use ConfigTransformerPrefix202605\Symfony\Component\Config\Definition\FloatNode;
use ConfigTransformerPrefix202605\Symfony\Component\Config\Definition\IntegerNode;
use ConfigTransformerPrefix202605\Symfony\Component\Config\Definition\NodeInterface;
use ConfigTransformerPrefix202605\Symfony\Component\Config\Definition\PrototypedArrayNode;
use ConfigTransformerPrefix202605\Symfony\Component\Config\Definition\ScalarNode;
/**
...
class XmlReferenceDumper
{
    ...
    private function writeNode(NodeInterface $node, int $depth = 0, bool $root = \false, ?string $namespace = null) : void
    {
        ...
        // xml remapping
        if ($node->getParent()) {
            $remapping = \array_filter($node->getParent()->getXmlRemappings(), static function (array $mapping) use($rootName) {
