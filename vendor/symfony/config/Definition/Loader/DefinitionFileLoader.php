...
class DefinitionFileLoader extends FileLoader
{
    ...
    public function load($resource, string $type = null)
    {
        ...
        $load = \Closure::bind(static function ($file) use($loader) {
            return include $file;
        }, null, \Symfony\Component\Config\Definition\Loader\ProtectedDefinitionFileLoader::class);
        $callback = $load($path);
 ...
 * @internal
 */
final class ProtectedDefinitionFileLoader extends \Symfony\Component\Config\Definition\Loader\DefinitionFileLoader
{
}
