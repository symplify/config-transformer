...
class NormalizationBuilder
{
    ...
    public $before = [];
    public $remappings = [];
    public function __construct(\ConfigTransformer202205235\Symfony\Component\Config\Definition\Builder\NodeDefinition $node)
    {
        $this->node = $node;
    }
    /**
    ...
    public function before(\Closure $closure = null)
    {
        ...
        return $this->before[] = new \ConfigTransformer202205235\Symfony\Component\Config\Definition\Builder\ExprBuilder($this->node);
    }
}
