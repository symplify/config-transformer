...
class NormalizationBuilder
{
    ...
    public $before = [];
    public $remappings = [];
    public function __construct(\ConfigTransformer2022012510\Symfony\Component\Config\Definition\Builder\NodeDefinition $node)
    {
        $this->node = $node;
    }
    /**
    ...
    public function before(\Closure $closure = null)
    {
        ...
        return $this->before[] = new \ConfigTransformer2022012510\Symfony\Component\Config\Definition\Builder\ExprBuilder($this->node);
    }
}
