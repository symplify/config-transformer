...
use ConfigTransformerPrefix202605\Symfony\Component\Config\Definition\Exception\InvalidDefinitionException;
...
class ArrayNodeDefinition extends NodeDefinition implements ParentNodeDefinitionInterface
{
    ...
    {
        $firstPathSegment = \false === ($pathSeparatorPos = \strpos($nodePath, $this->pathSeparator)) ? $nodePath : (string) \substr($nodePath, 0, $pathSeparatorPos);
        ...
        return $node->find((string) \substr($nodePath, $pathSeparatorPos + \strlen($this->pathSeparator)));
    }
}
