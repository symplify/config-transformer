...
class PrototypedArrayNode extends \Symfony\Component\Config\Definition\ArrayNode
{
     ...
     */
    public function getPrototype() : \Symfony\Component\Config\Definition\PrototypeNodeInterface
    {
            ...
            if (null !== $this->keyAttribute && \is_array($v)) {
                if (!isset($v[$this->keyAttribute]) && \is_int($k) && $isList) {
                    ...
                    if (\array_keys($v) === ['value']) {
                        $v = $v['value'];
                        if ($this->prototype instanceof \Symfony\Component\Config\Definition\ArrayNode && ($children = $this->prototype->getChildren()) && \array_key_exists('value', $children)) {
