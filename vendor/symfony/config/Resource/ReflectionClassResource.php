 ...
 */
namespace ConfigTransformer202201166\Symfony\Component\Config\Resource;

use ConfigTransformer202201166\Symfony\Component\EventDispatcher\EventSubscriberInterface;
use ConfigTransformer202201166\Symfony\Component\Messenger\Handler\MessageSubscriberInterface;
 ...
 * @final
 */
class ReflectionClassResource implements \ConfigTransformer202201166\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    /**
     * @var mixed[]
     */
    ...
    private function generateSignature(\ReflectionClass $class) : iterable
    {
        ...
        if (\interface_exists(\ConfigTransformer202201166\Symfony\Component\EventDispatcher\EventSubscriberInterface::class, \false) && $class->isSubclassOf(\ConfigTransformer202201166\Symfony\Component\EventDispatcher\EventSubscriberInterface::class)) {
            (yield \ConfigTransformer202201166\Symfony\Component\EventDispatcher\EventSubscriberInterface::class);
            (yield \print_r($class->name::getSubscribedEvents(), \true));
        }
        if (\interface_exists(\ConfigTransformer202201166\Symfony\Component\Messenger\Handler\MessageSubscriberInterface::class, \false) && $class->isSubclassOf(\ConfigTransformer202201166\Symfony\Component\Messenger\Handler\MessageSubscriberInterface::class)) {
            (yield \ConfigTransformer202201166\Symfony\Component\Messenger\Handler\MessageSubscriberInterface::class);
            foreach ($class->name::getHandledMessages() as $key => $value) {
                (yield $key . \print_r($value, \true));
            }
        }
        if (\interface_exists(\ConfigTransformer202201166\Symfony\Contracts\Service\ServiceSubscriberInterface::class, \false) && $class->isSubclassOf(\ConfigTransformer202201166\Symfony\Contracts\Service\ServiceSubscriberInterface::class)) {
            (yield \ConfigTransformer202201166\Symfony\Contracts\Service\ServiceSubscriberInterface::class);
