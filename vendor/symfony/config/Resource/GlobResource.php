...
use ConfigTransformer202206052\Symfony\Component\Finder\Glob;
/**
 ...
 */
class GlobResource implements \IteratorAggregate, \ConfigTransformer202206052\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    /**
     * @var string
     */
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\ConfigTransformer202206052\Symfony\Component\Finder\Finder::class)) {
        ...
        $regex = \ConfigTransformer202206052\Symfony\Component\Finder\Glob::toRegex($pattern);
        if ($this->recursive) {
