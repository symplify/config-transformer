...
use ConfigTransformer202205307\Symfony\Component\Finder\Glob;
/**
 ...
 */
class GlobResource implements \IteratorAggregate, \ConfigTransformer202205307\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    /**
     * @var string
     */
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\ConfigTransformer202205307\Symfony\Component\Finder\Finder::class)) {
        ...
        $regex = \ConfigTransformer202205307\Symfony\Component\Finder\Glob::toRegex($pattern);
        if ($this->recursive) {
