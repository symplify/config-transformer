...
use ConfigTransformer202206014\Symfony\Component\Finder\Glob;
/**
 ...
 */
class GlobResource implements \IteratorAggregate, \ConfigTransformer202206014\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    /**
     * @var string
     */
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\ConfigTransformer202206014\Symfony\Component\Finder\Finder::class)) {
        ...
        $finder = new \ConfigTransformer202206014\Symfony\Component\Finder\Finder();
        $regex = \ConfigTransformer202206014\Symfony\Component\Finder\Glob::toRegex($pattern);
        if ($this->recursive) {
