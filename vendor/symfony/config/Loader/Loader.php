 ...
 */
abstract class Loader implements \ConfigTransformer202108242\Symfony\Component\Config\Loader\LoaderInterface
{
    protected $resolver;
    protected $env;
    ...
    public function resolve($resource, $type = null)
    {
        ...
        if (\false === $loader) {
            throw new \ConfigTransformer202108242\Symfony\Component\Config\Exception\LoaderLoadException($resource, null, 0, null, $type);
        }
        return $loader;
    }
}
