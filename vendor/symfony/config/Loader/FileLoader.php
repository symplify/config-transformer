 ...
 */
abstract class FileLoader extends \Symfony\Component\Config\Loader\Loader
{
    ...
    private function doImport($resource, string $type = null, bool $ignoreErrors = \false, string $sourceResource = null)
    {
        try {
            ...
            if ($loader instanceof \Symfony\Component\Config\Loader\DirectoryAwareLoaderInterface) {
