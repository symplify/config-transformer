 ...
 */
class ConfigBuilderGenerator implements \Symfony\Component\Config\Builder\ConfigBuilderGeneratorInterface
{
    /**
     * @var ClassBuilder[]
     */
    ...
    public function build(ConfigurationInterface $configuration) : \Closure
    {
        ...
        $rootClass = new \Symfony\Component\Config\Builder\ClassBuilder('ConfigTransformerPrefix202401\\Symfony\\Config', $rootNode->getName());
        ...
        if (!\is_file($path)) {
            ...
            $rootClass->addImplements(\Symfony\Component\Config\Builder\ConfigBuilderInterface::class);
...
public function NAME(): string
{
    ...
    private function getFullPath(\Symfony\Component\Config\Builder\ClassBuilder $class) : string
    {
    ...
    private function buildNode(NodeInterface $node, \Symfony\Component\Config\Builder\ClassBuilder $class, string $namespace) : void
    {
    ...
    private function handleArrayNode(ArrayNode $node, \Symfony\Component\Config\Builder\ClassBuilder $class, string $namespace) : void
    {
        $childClass = new \Symfony\Component\Config\Builder\ClassBuilder($namespace, $node->getName());
...
COMMENTpublic function NAME(array $value = []): CLASS
{
    ...
    private function handleVariableNode(VariableNode $node, \Symfony\Component\Config\Builder\ClassBuilder $class) : void
    {
        $comment = $this->getComment($node);
...
public function NAME(mixed $valueDEFAULT): static
{
    ...
    private function handlePrototypedArrayNode(PrototypedArrayNode $node, \Symfony\Component\Config\Builder\ClassBuilder $class, string $namespace) : void
    {
...
public function NAME(string $VAR, TYPE $VALUE): static
{
    ...
    return $this;
        ...
        $childClass = new \Symfony\Component\Config\Builder\ClassBuilder($namespace, $name);
...
COMMENTpublic function NAME(string $VAR, array $VALUE = []): CLASS
{
    ...
    private function handleScalarNode(ScalarNode $node, \Symfony\Component\Config\Builder\ClassBuilder $class) : void
    {
        $comment = $this->getComment($node);
        $property = $class->addProperty($node->getName());
        $class->addUse(ParamConfigurator::class);
...
public function NAME($value): static
{
    ...
    private function buildToArray(\Symfony\Component\Config\Builder\ClassBuilder $class) : void
    {
        $body = '$output = [];';
...
public function NAME(): array
{
    ...
    private function buildConstructor(\Symfony\Component\Config\Builder\ClassBuilder $class) : void
    {
        $body = '';
        foreach ($class->getProperties() as $p) {
            $code = '$value[\'ORG_NAME\']';
...
{' . $body . '
    ...
    private function buildSetExtraKey(\Symfony\Component\Config\Builder\ClassBuilder $class) : void
    {
        if (!$class->shouldAllowExtraKeys()) {
            return;
        }
...
public function NAME(string $key, mixed $value): static
{
    ...
    private function getSubNamespace(\Symfony\Component\Config\Builder\ClassBuilder $rootClass) : string
    {
