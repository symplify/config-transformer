 ...
 */
namespace ConfigTransformer202109227\Symfony\Component\Config;

use ConfigTransformer202109227\Symfony\Component\Config\Resource\ResourceInterface;
use ConfigTransformer202109227\Symfony\Component\Filesystem\Exception\IOException;
use ConfigTransformer202109227\Symfony\Component\Filesystem\Filesystem;
/**
 ...
 */
class ResourceCheckerConfigCache implements \ConfigTransformer202109227\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \ConfigTransformer202109227\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\ConfigTransformer202109227\Symfony\Component\Filesystem\Exception\IOException $e) {
