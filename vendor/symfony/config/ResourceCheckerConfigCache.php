 ...
 */
namespace ConfigTransformer202206079\Symfony\Component\Config;
 ...
 */
class ResourceCheckerConfigCache implements \ConfigTransformer202206079\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write(string $content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \ConfigTransformer202206079\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\ConfigTransformer202206079\Symfony\Component\Filesystem\Exception\IOException $e) {
