 ...
 */
namespace ConfigTransformer202107252\Symfony\Component\Config;
 ...
 */
class ResourceCheckerConfigCache implements \ConfigTransformer202107252\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \ConfigTransformer202107252\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\ConfigTransformer202107252\Symfony\Component\Filesystem\Exception\IOException $e) {
