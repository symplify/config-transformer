 ...
 * @final
 */
class ResponseListener implements \ConfigTransformer202106120\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $charset;
    ...
    {
        return [\ConfigTransformer202106120\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => 'onKernelResponse'];
    }
}
