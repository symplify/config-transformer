 ...
 * @final
 */
class ResponseListener implements \ConfigTransformer202110019\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $charset;
    ...
    {
        return [\ConfigTransformer202110019\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => 'onKernelResponse'];
    }
}
