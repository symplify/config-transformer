 ...
 * @final
 */
class ResponseListener implements \ConfigTransformer202106125\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $charset;
    ...
    {
        return [\ConfigTransformer202106125\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => 'onKernelResponse'];
    }
}
