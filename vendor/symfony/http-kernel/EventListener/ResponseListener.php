 ...
 * @final
 */
class ResponseListener implements \ConfigTransformer202108165\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    private $charset;
    ...
    {
        return [\ConfigTransformer202108165\Symfony\Component\HttpKernel\KernelEvents::RESPONSE => 'onKernelResponse'];
    }
}
