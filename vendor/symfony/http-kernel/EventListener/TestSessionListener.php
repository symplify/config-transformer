 ...
 * @final
 */
class TestSessionListener extends \ConfigTransformer202106199\Symfony\Component\HttpKernel\EventListener\AbstractTestSessionListener
{
    private $container;
    public function __construct(\ConfigTransformer202106199\Psr\Container\ContainerInterface $container, array $sessionOptions = [])
    {
