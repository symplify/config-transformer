 ...
 * @final
 */
class TestSessionListener extends \ConfigTransformer202109187\Symfony\Component\HttpKernel\EventListener\AbstractTestSessionListener
{
    private $container;
    public function __construct(\ConfigTransformer202109187\Psr\Container\ContainerInterface $container, array $sessionOptions = [])
    {
