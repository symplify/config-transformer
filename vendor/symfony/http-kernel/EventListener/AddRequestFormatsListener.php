 ...
 * @final
 */
class AddRequestFormatsListener implements \ConfigTransformer2021101110\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\ConfigTransformer2021101110\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}
