 ...
 * @final
 */
class AddRequestFormatsListener implements \ConfigTransformer202106199\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\ConfigTransformer202106199\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}
