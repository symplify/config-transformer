 ...
 * @final
 */
class AddRequestFormatsListener implements \ConfigTransformer202110111\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\ConfigTransformer202110111\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}
