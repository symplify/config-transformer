 ...
 * @final
 */
class AddRequestFormatsListener implements \ConfigTransformer202109298\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\ConfigTransformer202109298\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 100]];
    }
}
