 ...
 * @final
 */
class ValidateRequestListener implements \ConfigTransformer2021093010\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    /**
    ...
    {
        return [\ConfigTransformer2021093010\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 256]]];
    }
}
