 ...
 * @final
 */
class ValidateRequestListener implements \ConfigTransformer202106199\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    /**
    ...
    {
        return [\ConfigTransformer202106199\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 256]]];
    }
}
