 ...
 * @final
 */
class ValidateRequestListener implements \ConfigTransformer202106194\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    /**
    ...
    {
        return [\ConfigTransformer202106194\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 256]]];
    }
}
