 ...
 * @final
 */
class ValidateRequestListener implements \ConfigTransformer2021070710\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    /**
    ...
    {
        return [\ConfigTransformer2021070710\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 256]]];
    }
}
