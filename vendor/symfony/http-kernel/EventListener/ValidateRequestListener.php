 ...
 * @final
 */
class ValidateRequestListener implements \ConfigTransformer202109298\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    /**
    ...
    {
        return [\ConfigTransformer202109298\Symfony\Component\HttpKernel\KernelEvents::REQUEST => [['onKernelRequest', 256]]];
    }
}
