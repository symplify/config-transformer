...
use ConfigTransformer202110012\Symfony\Component\Debug\DebugClassLoader as LegacyDebugClassLoader;
...
use ConfigTransformer202110012\Symfony\Component\ErrorHandler\DebugClassLoader;
 ...
 */
class AddAnnotatedClassesToCachePass implements \ConfigTransformer202110012\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $kernel;
    public function __construct(\ConfigTransformer202110012\Symfony\Component\HttpKernel\Kernel $kernel)
    {
        $this->kernel = $kernel;
    }
    /**
    ...
    public function process($container)
    {
        ...
        foreach ($container->getExtensions() as $extension) {
            if ($extension instanceof \ConfigTransformer202110012\Symfony\Component\HttpKernel\DependencyInjection\Extension) {
    ...
    private function getClassesInComposerClassMaps() : array
    {
        ...
        foreach (\spl_autoload_functions() as $function) {
            ...
            if ($function[0] instanceof \ConfigTransformer202110012\Symfony\Component\ErrorHandler\DebugClassLoader || $function[0] instanceof \ConfigTransformer202110012\Symfony\Component\Debug\DebugClassLoader) {
                $function = $function[0]->getClassLoader();
            }
            if (\is_array($function) && $function[0] instanceof \ConfigTransformer202110012\Composer\Autoload\ClassLoader) {
