 ...
 */
namespace ConfigTransformer202107072\Symfony\Component\HttpKernel\Debug;
...
use ConfigTransformer202107072\Symfony\Component\Routing\Generator\UrlGeneratorInterface;
/**
...
class FileLinkFormatter
{
     ...
     */
    public function __construct($fileLinkFormat = null, \ConfigTransformer202107072\Symfony\Component\HttpFoundation\RequestStack $requestStack = null, string $baseDir = null, $urlFormat = null)
    {
     ...
     * @internal
     */
    public static function generateUrlFormat(\ConfigTransformer202107072\Symfony\Component\Routing\Generator\UrlGeneratorInterface $router, string $routeName, string $queryString) : ?string
    {
        try {
    ...
    private function getFileLinkFormat()
    {
        ...
        if ($this->requestStack && $this->baseDir && $this->urlFormat) {
            ...
            if ($request instanceof \ConfigTransformer202107072\Symfony\Component\HttpFoundation\Request && (!$this->urlFormat instanceof \Closure || ($this->urlFormat = ($this->urlFormat)()))) {
