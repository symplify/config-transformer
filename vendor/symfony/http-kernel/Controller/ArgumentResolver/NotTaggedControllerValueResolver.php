 ...
 */
final class NotTaggedControllerValueResolver implements \ConfigTransformer202106289\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    private $container;
    public function __construct(\ConfigTransformer202106289\Psr\Container\ContainerInterface $container)
    {
    ...
    public function resolve(\ConfigTransformer202106289\Symfony\Component\HttpFoundation\Request $request, \ConfigTransformer202106289\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata $argument) : iterable
    {
        ...
        throw new \ConfigTransformer202106289\Symfony\Component\DependencyInjection\Exception\RuntimeException($message);
    }
}
