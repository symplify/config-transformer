 ...
 */
final class SessionValueResolver implements \ConfigTransformer202107154\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
    ...
    public function supports($request, $argument) : bool
    {
        ...
        if (\ConfigTransformer202107154\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \ConfigTransformer202107154\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }
