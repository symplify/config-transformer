 ...
 */
final class SessionValueResolver implements \ConfigTransformer2021101110\Symfony\Component\HttpKernel\Controller\ArgumentValueResolverInterface
{
    /**
     * {@inheritdoc}
    ...
    public function supports($request, $argument) : bool
    {
        ...
        if (\ConfigTransformer2021101110\Symfony\Component\HttpFoundation\Session\SessionInterface::class !== $type && !\is_subclass_of($type, \ConfigTransformer2021101110\Symfony\Component\HttpFoundation\Session\SessionInterface::class)) {
            return \false;
        }
