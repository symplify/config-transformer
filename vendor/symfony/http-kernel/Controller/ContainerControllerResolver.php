 ...
 */
class ContainerControllerResolver extends \ConfigTransformer2021082310\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\ConfigTransformer2021082310\Psr\Container\ContainerInterface $container, \ConfigTransformer2021082310\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \ConfigTransformer2021082310\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
