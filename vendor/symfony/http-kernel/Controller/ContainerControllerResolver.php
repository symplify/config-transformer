 ...
 */
class ContainerControllerResolver extends \ConfigTransformer2021062210\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\ConfigTransformer2021062210\Psr\Container\ContainerInterface $container, \ConfigTransformer2021062210\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \ConfigTransformer2021062210\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
