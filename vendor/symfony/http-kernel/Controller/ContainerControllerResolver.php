 ...
 */
class ContainerControllerResolver extends \ConfigTransformer2021061110\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\ConfigTransformer2021061110\Psr\Container\ContainerInterface $container, \ConfigTransformer2021061110\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \ConfigTransformer2021061110\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
