 ...
 */
class ContainerControllerResolver extends \ConfigTransformer202106125\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\ConfigTransformer202106125\Psr\Container\ContainerInterface $container, \ConfigTransformer202106125\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \ConfigTransformer202106125\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
