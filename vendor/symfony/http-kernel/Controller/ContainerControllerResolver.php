 ...
 */
class ContainerControllerResolver extends \ConfigTransformer202110276\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\ConfigTransformer202110276\Psr\Container\ContainerInterface $container, \ConfigTransformer202110276\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \ConfigTransformer202110276\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
