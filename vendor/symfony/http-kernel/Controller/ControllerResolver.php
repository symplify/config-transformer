 ...
 */
class ControllerResolver implements \ConfigTransformer202109049\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109049\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
