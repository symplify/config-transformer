 ...
 */
class ControllerResolver implements \ConfigTransformer202106184\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106184\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
