 ...
 */
class ControllerResolver implements \ConfigTransformer202108222\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202108222\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
