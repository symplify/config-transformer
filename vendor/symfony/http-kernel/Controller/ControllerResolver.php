 ...
 */
class ControllerResolver implements \ConfigTransformer202106120\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106120\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
