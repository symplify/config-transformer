 ...
 */
class ControllerResolver implements \ConfigTransformer202106125\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106125\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
