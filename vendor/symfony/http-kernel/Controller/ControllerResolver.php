 ...
 */
class ControllerResolver implements \ConfigTransformer202110019\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202110019\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
