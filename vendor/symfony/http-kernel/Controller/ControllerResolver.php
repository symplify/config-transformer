 ...
 */
class ControllerResolver implements \ConfigTransformer202109184\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109184\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
