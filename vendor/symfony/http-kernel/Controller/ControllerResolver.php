 ...
 */
class ControllerResolver implements \ConfigTransformer202106266\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106266\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
