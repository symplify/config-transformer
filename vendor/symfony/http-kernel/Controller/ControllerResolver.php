 ...
 */
class ControllerResolver implements \ConfigTransformer20210610\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer20210610\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
