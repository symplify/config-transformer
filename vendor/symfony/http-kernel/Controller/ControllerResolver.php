 ...
 */
class ControllerResolver implements \ConfigTransformer202110106\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202110106\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
