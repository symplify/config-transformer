 ...
 */
class ControllerResolver implements \ConfigTransformer202108234\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202108234\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
