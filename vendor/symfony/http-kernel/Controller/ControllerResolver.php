 ...
 */
class ControllerResolver implements \ConfigTransformer202108301\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202108301\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
