 ...
 */
class ControllerResolver implements \ConfigTransformer202106202\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106202\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
