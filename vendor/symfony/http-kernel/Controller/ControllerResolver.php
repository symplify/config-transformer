 ...
 */
class ControllerResolver implements \ConfigTransformer202106287\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106287\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
