 ...
 */
class ControllerResolver implements \ConfigTransformer202110017\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202110017\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
