 ...
 */
class ControllerResolver implements \ConfigTransformer202108187\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202108187\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
