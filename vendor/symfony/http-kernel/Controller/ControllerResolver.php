 ...
 */
class ControllerResolver implements \ConfigTransformer202108302\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202108302\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
