 ...
 */
class ControllerResolver implements \ConfigTransformer202106265\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106265\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
