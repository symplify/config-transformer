 ...
 */
class ControllerResolver implements \ConfigTransformer202109182\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109182\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
