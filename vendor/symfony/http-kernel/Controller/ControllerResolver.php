 ...
 */
class ControllerResolver implements \ConfigTransformer202106281\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106281\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
