 ...
 */
class ControllerResolver implements \ConfigTransformer202110105\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202110105\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
