 ...
 */
class ControllerResolver implements \ConfigTransformer202109216\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109216\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
