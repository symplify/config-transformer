 ...
 */
class ControllerResolver implements \ConfigTransformer202109294\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109294\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
