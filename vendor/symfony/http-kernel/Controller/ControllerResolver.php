 ...
 */
class ControllerResolver implements \ConfigTransformer202109287\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109287\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
