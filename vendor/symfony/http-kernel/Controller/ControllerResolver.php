 ...
 */
class ControllerResolver implements \ConfigTransformer202106282\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106282\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
