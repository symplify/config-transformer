 ...
 */
class ControllerResolver implements \ConfigTransformer202109234\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109234\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
