 ...
 */
class ControllerResolver implements \ConfigTransformer202106299\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106299\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
