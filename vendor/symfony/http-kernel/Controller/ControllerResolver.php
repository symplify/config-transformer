 ...
 */
class ControllerResolver implements \ConfigTransformer202108022\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202108022\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
