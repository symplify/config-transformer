 ...
 */
class ControllerResolver implements \ConfigTransformer202106130\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106130\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
