 ...
 */
class ControllerResolver implements \ConfigTransformer202106196\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106196\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
