 ...
 */
class ControllerResolver implements \ConfigTransformer202106199\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106199\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
