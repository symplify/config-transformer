 ...
 */
class ControllerResolver implements \ConfigTransformer202106240\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106240\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
