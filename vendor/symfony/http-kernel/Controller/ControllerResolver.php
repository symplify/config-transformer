 ...
 */
class ControllerResolver implements \ConfigTransformer202109303\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109303\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
