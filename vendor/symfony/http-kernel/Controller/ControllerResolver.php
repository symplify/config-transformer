 ...
 */
class ControllerResolver implements \ConfigTransformer202109302\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109302\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
