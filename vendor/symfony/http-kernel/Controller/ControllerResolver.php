 ...
 */
class ControllerResolver implements \ConfigTransformer202106279\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106279\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
