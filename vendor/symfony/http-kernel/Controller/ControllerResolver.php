 ...
 */
class ControllerResolver implements \ConfigTransformer202109048\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109048\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
