 ...
 */
class ControllerResolver implements \ConfigTransformer202109187\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109187\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
