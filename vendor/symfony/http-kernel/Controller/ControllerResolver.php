 ...
 */
class ControllerResolver implements \ConfigTransformer202106185\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106185\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
