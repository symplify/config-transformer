 ...
 */
class ControllerResolver implements \ConfigTransformer202106188\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106188\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
