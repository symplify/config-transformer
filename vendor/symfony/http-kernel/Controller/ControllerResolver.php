 ...
 */
class ControllerResolver implements \ConfigTransformer202109238\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109238\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
