 ...
 */
class ControllerResolver implements \ConfigTransformer202109181\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109181\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
