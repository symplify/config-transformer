 ...
 */
class ControllerResolver implements \ConfigTransformer202109299\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109299\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
