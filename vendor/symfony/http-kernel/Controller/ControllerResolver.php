 ...
 */
class ControllerResolver implements \ConfigTransformer202108315\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202108315\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
