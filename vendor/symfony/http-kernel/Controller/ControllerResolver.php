 ...
 */
class ControllerResolver implements \ConfigTransformer202111016\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202111016\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
