 ...
 */
class ControllerResolver implements \ConfigTransformer202110248\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202110248\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
