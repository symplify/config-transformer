 ...
 */
class ControllerResolver implements \ConfigTransformer202109063\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109063\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
