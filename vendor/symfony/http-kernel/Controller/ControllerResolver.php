 ...
 */
class ControllerResolver implements \ConfigTransformer202106193\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106193\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
