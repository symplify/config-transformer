 ...
 */
class ControllerResolver implements \ConfigTransformer202109067\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109067\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
