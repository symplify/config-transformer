 ...
 */
class ControllerResolver implements \ConfigTransformer202109023\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109023\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
