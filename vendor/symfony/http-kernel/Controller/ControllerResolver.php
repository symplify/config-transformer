 ...
 */
class ControllerResolver implements \ConfigTransformer202110010\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202110010\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
