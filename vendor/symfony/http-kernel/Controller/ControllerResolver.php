 ...
 */
class ControllerResolver implements \ConfigTransformer202109298\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109298\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
