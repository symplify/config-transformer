 ...
 */
class ControllerResolver implements \ConfigTransformer202107076\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202107076\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
