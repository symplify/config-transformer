 ...
 */
class ControllerResolver implements \ConfigTransformer202108242\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202108242\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
