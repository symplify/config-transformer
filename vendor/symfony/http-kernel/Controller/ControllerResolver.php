 ...
 */
class ControllerResolver implements \ConfigTransformer202109301\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109301\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
