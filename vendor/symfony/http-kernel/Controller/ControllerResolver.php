 ...
 */
class ControllerResolver implements \ConfigTransformer202109285\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109285\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
