 ...
 */
class ControllerResolver implements \ConfigTransformer202110251\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202110251\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
