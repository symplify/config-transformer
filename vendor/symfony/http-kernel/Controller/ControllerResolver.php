 ...
 */
class ControllerResolver implements \ConfigTransformer202106249\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106249\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
