 ...
 */
class ControllerResolver implements \ConfigTransformer202106187\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106187\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
