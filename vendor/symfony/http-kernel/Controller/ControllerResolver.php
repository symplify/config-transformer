 ...
 */
class ControllerResolver implements \ConfigTransformer202106115\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106115\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
