 ...
 */
class ControllerResolver implements \ConfigTransformer202106121\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106121\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
