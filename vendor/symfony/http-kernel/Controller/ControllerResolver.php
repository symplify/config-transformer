 ...
 */
class ControllerResolver implements \ConfigTransformer202110312\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202110312\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
