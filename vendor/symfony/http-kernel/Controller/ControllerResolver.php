 ...
 */
class ControllerResolver implements \ConfigTransformer202107034\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202107034\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
