 ...
 */
class ControllerResolver implements \ConfigTransformer202109212\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109212\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
