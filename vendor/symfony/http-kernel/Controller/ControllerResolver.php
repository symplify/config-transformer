 ...
 */
class ControllerResolver implements \ConfigTransformer202110314\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202110314\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
