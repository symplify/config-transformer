 ...
 */
class ControllerResolver implements \ConfigTransformer2021061910\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer2021061910\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
