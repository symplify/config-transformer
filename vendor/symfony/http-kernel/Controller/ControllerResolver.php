 ...
 */
class ControllerResolver implements \ConfigTransformer202106114\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106114\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
