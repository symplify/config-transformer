 ...
 */
class ControllerResolver implements \ConfigTransformer202106205\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106205\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
