 ...
 */
class ControllerResolver implements \ConfigTransformer202109307\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109307\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
