 ...
 */
class ControllerResolver implements \ConfigTransformer20210606\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer20210606\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
