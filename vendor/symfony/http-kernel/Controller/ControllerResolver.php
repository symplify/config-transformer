 ...
 */
class ControllerResolver implements \ConfigTransformer202110015\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202110015\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
