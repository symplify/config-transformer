 ...
 */
class ControllerResolver implements \ConfigTransformer202110016\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202110016\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
