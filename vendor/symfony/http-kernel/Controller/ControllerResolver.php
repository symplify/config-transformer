 ...
 */
class ControllerResolver implements \ConfigTransformer202107242\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202107242\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
