 ...
 */
class ControllerResolver implements \ConfigTransformer202106280\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106280\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
