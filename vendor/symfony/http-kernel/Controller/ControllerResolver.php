 ...
 */
class ControllerResolver implements \ConfigTransformer202109036\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109036\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
