 ...
 */
class ControllerResolver implements \ConfigTransformer202106129\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106129\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
