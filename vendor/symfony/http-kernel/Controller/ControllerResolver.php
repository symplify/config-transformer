 ...
 */
class ControllerResolver implements \ConfigTransformer202106118\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106118\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
