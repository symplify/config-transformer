 ...
 */
class ControllerResolver implements \ConfigTransformer202109284\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109284\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
