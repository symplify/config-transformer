 ...
 */
class ControllerResolver implements \ConfigTransformer202108184\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202108184\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
