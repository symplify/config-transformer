 ...
 */
class ControllerResolver implements \ConfigTransformer202109046\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109046\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
