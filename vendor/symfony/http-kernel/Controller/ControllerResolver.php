 ...
 */
class ControllerResolver implements \ConfigTransformer202109151\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109151\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
