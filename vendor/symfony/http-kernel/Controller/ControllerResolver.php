 ...
 */
class ControllerResolver implements \ConfigTransformer202109186\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109186\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
