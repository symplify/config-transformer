 ...
 */
class ControllerResolver implements \ConfigTransformer202107056\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202107056\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
