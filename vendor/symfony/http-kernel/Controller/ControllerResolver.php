 ...
 */
class ControllerResolver implements \ConfigTransformer202108024\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202108024\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
