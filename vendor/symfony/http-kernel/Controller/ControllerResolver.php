 ...
 */
class ControllerResolver implements \ConfigTransformer202109202\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109202\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
