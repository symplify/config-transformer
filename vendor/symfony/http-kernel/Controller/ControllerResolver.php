 ...
 */
class ControllerResolver implements \ConfigTransformer202110125\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202110125\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
