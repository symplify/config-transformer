 ...
 */
class ControllerResolver implements \ConfigTransformer202108312\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202108312\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
