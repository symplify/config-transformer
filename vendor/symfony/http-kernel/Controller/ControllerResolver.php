 ...
 */
class ControllerResolver implements \ConfigTransformer202106124\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106124\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
