 ...
 */
class ControllerResolver implements \ConfigTransformer2021090310\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer2021090310\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
