 ...
 */
class ControllerResolver implements \ConfigTransformer202107158\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202107158\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
