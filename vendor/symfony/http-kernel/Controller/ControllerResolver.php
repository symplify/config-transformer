 ...
 */
class ControllerResolver implements \ConfigTransformer202106263\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106263\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
