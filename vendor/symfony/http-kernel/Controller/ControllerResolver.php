 ...
 */
class ControllerResolver implements \ConfigTransformer202106246\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106246\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
