 ...
 */
class ControllerResolver implements \ConfigTransformer202109297\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109297\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
