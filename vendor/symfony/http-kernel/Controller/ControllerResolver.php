 ...
 */
class ControllerResolver implements \ConfigTransformer202109278\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109278\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
