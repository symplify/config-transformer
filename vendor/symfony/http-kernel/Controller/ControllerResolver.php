 ...
 */
class ControllerResolver implements \ConfigTransformer202109305\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109305\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
