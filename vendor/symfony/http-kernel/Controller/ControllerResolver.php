 ...
 */
class ControllerResolver implements \ConfigTransformer202108304\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202108304\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
