 ...
 */
class ControllerResolver implements \ConfigTransformer202109292\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109292\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
