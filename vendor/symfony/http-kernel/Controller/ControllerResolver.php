 ...
 */
class ControllerResolver implements \ConfigTransformer202110146\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202110146\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
