 ...
 */
class ControllerResolver implements \ConfigTransformer202108047\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202108047\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
