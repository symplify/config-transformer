 ...
 */
class ControllerResolver implements \ConfigTransformer202106110\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106110\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
