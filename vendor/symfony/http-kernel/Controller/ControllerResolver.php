 ...
 */
class ControllerResolver implements \ConfigTransformer202106117\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106117\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
