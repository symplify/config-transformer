 ...
 */
class ControllerResolver implements \ConfigTransformer202109173\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109173\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
