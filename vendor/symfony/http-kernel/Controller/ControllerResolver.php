 ...
 */
class ControllerResolver implements \ConfigTransformer202106285\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106285\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
