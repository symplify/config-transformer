 ...
 */
class ControllerResolver implements \ConfigTransformer202110274\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202110274\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
