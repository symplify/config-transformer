 ...
 */
class ControllerResolver implements \ConfigTransformer202106111\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106111\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
