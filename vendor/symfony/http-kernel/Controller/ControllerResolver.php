 ...
 */
class ControllerResolver implements \ConfigTransformer2021081610\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer2021081610\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
