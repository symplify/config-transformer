 ...
 */
class ControllerResolver implements \ConfigTransformer202111019\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202111019\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
