 ...
 */
class ControllerResolver implements \ConfigTransformer202108296\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202108296\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
