 ...
 */
class ControllerResolver implements \ConfigTransformer202106289\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106289\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
