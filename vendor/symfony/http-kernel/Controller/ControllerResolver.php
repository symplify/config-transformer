 ...
 */
class ControllerResolver implements \ConfigTransformer202109282\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109282\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
