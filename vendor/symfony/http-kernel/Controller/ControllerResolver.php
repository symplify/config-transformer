 ...
 */
class ControllerResolver implements \ConfigTransformer202108294\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202108294\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
