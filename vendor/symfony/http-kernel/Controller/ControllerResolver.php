 ...
 */
class ControllerResolver implements \ConfigTransformer202106122\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106122\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
