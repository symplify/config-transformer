 ...
 */
class ControllerResolver implements \ConfigTransformer202109066\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202109066\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
