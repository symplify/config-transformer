 ...
 */
class ControllerResolver implements \ConfigTransformer202108303\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202108303\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
