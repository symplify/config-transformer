 ...
 */
class ControllerResolver implements \ConfigTransformer202106261\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106261\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
