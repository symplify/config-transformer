 ...
 */
class ControllerResolver implements \ConfigTransformer202106123\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106123\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
