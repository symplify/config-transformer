 ...
 */
class ControllerResolver implements \ConfigTransformer202106194\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202106194\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
