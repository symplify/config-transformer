 ...
 */
class ControllerResolver implements \ConfigTransformer202108203\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    public function __construct(\ConfigTransformer202108203\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    }
    /**
