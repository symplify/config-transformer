 ...
 */
class KernelEvent extends \ConfigTransformer2021070510\Symfony\Contracts\EventDispatcher\Event
{
    private $kernel;
    private $request;
    private $requestType;
     ...
     */
    public function __construct(\ConfigTransformer2021070510\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \ConfigTransformer2021070510\Symfony\Component\HttpFoundation\Request $request, ?int $requestType)
    {
        $this->kernel = $kernel;
    ...
    {
        return \ConfigTransformer2021070510\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST === $this->requestType;
    }
    /**
