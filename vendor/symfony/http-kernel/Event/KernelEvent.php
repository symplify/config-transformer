 ...
 */
class KernelEvent extends \ConfigTransformer202106120\Symfony\Contracts\EventDispatcher\Event
{
    private $kernel;
    private $request;
    private $requestType;
     ...
     */
    public function __construct(\ConfigTransformer202106120\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \ConfigTransformer202106120\Symfony\Component\HttpFoundation\Request $request, ?int $requestType)
    {
        $this->kernel = $kernel;
    ...
    {
        return \ConfigTransformer202106120\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST === $this->requestType;
    }
    /**
