 ...
 * @final
 */
class ExceptionDataCollector extends \ConfigTransformer202108202\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
    ...
    {
        if (null !== $exception) {
            $this->data = ['exception' => \ConfigTransformer202108202\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}
