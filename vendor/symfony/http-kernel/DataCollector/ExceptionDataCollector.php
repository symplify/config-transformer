 ...
 * @final
 */
class ExceptionDataCollector extends \ConfigTransformer202109074\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
    ...
    {
        if (null !== $exception) {
            $this->data = ['exception' => \ConfigTransformer202109074\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}
