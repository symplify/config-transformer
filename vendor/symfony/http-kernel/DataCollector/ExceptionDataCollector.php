 ...
 * @final
 */
class ExceptionDataCollector extends \ConfigTransformer202107154\Symfony\Component\HttpKernel\DataCollector\DataCollector
{
    /**
     * {@inheritdoc}
    ...
    {
        if (null !== $exception) {
            $this->data = ['exception' => \ConfigTransformer202107154\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception)];
        }
    }
    /**
     * {@inheritdoc}
