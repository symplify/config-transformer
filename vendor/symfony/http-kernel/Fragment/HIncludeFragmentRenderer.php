...
use ConfigTransformer202108251\Twig\Environment;
/**
 * Implements the Hinclude rendering strategy.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class HIncludeFragmentRenderer extends \ConfigTransformer202108251\Symfony\Component\HttpKernel\Fragment\RoutableFragmentRenderer
{
     ...
     */
    public function __construct(\ConfigTransformer202108251\Twig\Environment $twig = null, \ConfigTransformer202108251\Symfony\Component\HttpKernel\UriSigner $signer = null, string $globalDefaultTemplate = null, string $charset = 'utf-8')
    {
        $this->twig = $twig;
    ...
    {
        if ($uri instanceof \ConfigTransformer202108251\Symfony\Component\HttpKernel\Controller\ControllerReference) {
            $uri = (new \ConfigTransformer202108251\Symfony\Component\HttpKernel\Fragment\FragmentUriGenerator($this->fragmentPath, $this->signer))->generate($uri, $request);
        }
        ...
        return new \ConfigTransformer202108251\Symfony\Component\HttpFoundation\Response(\sprintf('<hx:include src="%s"%s>%s</hx:include>', $uri, $renderedAttributes, $content));
    }
    /**
     * {@inheritdoc}
     */
