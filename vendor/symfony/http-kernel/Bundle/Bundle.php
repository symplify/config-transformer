...
use ConfigTransformer202109095\Symfony\Component\DependencyInjection\ContainerAwareTrait;
 ...
 */
abstract class Bundle implements \ConfigTransformer202109095\Symfony\Component\HttpKernel\Bundle\BundleInterface
{
    ...
    public function getContainerExtension()
    {
        if (null === $this->extension) {
            ...
            if (null !== $extension) {
                if (!$extension instanceof \ConfigTransformer202109095\Symfony\Component\DependencyInjection\Extension\ExtensionInterface) {
                ...
                $expectedAlias = \ConfigTransformer202109095\Symfony\Component\DependencyInjection\Container::underscore($basename);
