 ...
 */
namespace ConfigTransformer202106263\Symfony\Component\HttpKernel\Profiler;
 ...
 */
class FileProfilerStorage implements \ConfigTransformer202106263\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * {@inheritdoc}
     */
    public function read(string $token) : ?\ConfigTransformer202106263\Symfony\Component\HttpKernel\Profiler\Profile
    {
     ...
     * @throws \RuntimeException
     */
    public function write(\ConfigTransformer202106263\Symfony\Component\HttpKernel\Profiler\Profile $profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\ConfigTransformer202106263\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    protected function createProfileFromData(string $token, array $data, \ConfigTransformer202106263\Symfony\Component\HttpKernel\Profiler\Profile $parent = null)
    {
        $profile = new \ConfigTransformer202106263\Symfony\Component\HttpKernel\Profiler\Profile($token);
