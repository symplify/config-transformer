 ...
 */
class FileProfilerStorage implements \ConfigTransformer2021071010\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
    ...
    public function write($profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\ConfigTransformer2021071010\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    {
        $profile = new \ConfigTransformer2021071010\Symfony\Component\HttpKernel\Profiler\Profile($token);
