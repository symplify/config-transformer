 ...
 */
namespace ConfigTransformer202109301\Symfony\Component\HttpKernel\Profiler;
 ...
 */
class FileProfilerStorage implements \ConfigTransformer202109301\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * @param string $token
     */
    public function read($token) : ?\ConfigTransformer202109301\Symfony\Component\HttpKernel\Profiler\Profile
    {
    ...
    public function write($profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\ConfigTransformer202109301\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    {
        $profile = new \ConfigTransformer202109301\Symfony\Component\HttpKernel\Profiler\Profile($token);
