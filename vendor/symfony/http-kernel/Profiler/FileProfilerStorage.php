 ...
 */
namespace ConfigTransformer202108212\Symfony\Component\HttpKernel\Profiler;
 ...
 */
class FileProfilerStorage implements \ConfigTransformer202108212\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * @param string $token
     */
    public function read($token) : ?\ConfigTransformer202108212\Symfony\Component\HttpKernel\Profiler\Profile
    {
    ...
    public function write($profile) : bool
    {
        ...
        $childrenToken = \array_filter(\array_map(function (\ConfigTransformer202108212\Symfony\Component\HttpKernel\Profiler\Profile $p) use($profileToken) {
    ...
    {
        $profile = new \ConfigTransformer202108212\Symfony\Component\HttpKernel\Profiler\Profile($token);
