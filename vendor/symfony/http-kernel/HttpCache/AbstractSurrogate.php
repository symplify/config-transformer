 ...
 */
abstract class AbstractSurrogate implements \ConfigTransformer202107130\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \ConfigTransformer202107130\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
    ...
    {
        $subRequest = \ConfigTransformer202107130\Symfony\Component\HttpFoundation\Request::create($uri, \ConfigTransformer202107130\Symfony\Component\HttpFoundation\Request::METHOD_GET, [], $cache->getRequest()->cookies->all(), [], $cache->getRequest()->server->all());
        try {
            $response = $cache->handle($subRequest, \ConfigTransformer202107130\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \true);
