...
use ConfigTransformer202106196\Symfony\Component\HttpKernel\HttpKernelInterface;
/**
 ...
 */
abstract class AbstractSurrogate implements \ConfigTransformer202106196\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \ConfigTransformer202106196\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
     */
    ...
    {
        $subRequest = \ConfigTransformer202106196\Symfony\Component\HttpFoundation\Request::create($uri, \ConfigTransformer202106196\Symfony\Component\HttpFoundation\Request::METHOD_GET, [], $cache->getRequest()->cookies->all(), [], $cache->getRequest()->server->all());
        try {
            $response = $cache->handle($subRequest, \ConfigTransformer202106196\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \true);
     ...
     */
    protected function removeFromControl(\ConfigTransformer202106196\Symfony\Component\HttpFoundation\Response $response)
    {
