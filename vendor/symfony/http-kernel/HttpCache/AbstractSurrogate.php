 ...
 */
abstract class AbstractSurrogate implements \ConfigTransformer2021083010\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \ConfigTransformer2021083010\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
    ...
    {
        $subRequest = \ConfigTransformer2021083010\Symfony\Component\HttpFoundation\Request::create($uri, \ConfigTransformer2021083010\Symfony\Component\HttpFoundation\Request::METHOD_GET, [], $cache->getRequest()->cookies->all(), [], $cache->getRequest()->server->all());
        try {
            $response = $cache->handle($subRequest, \ConfigTransformer2021083010\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, \true);
