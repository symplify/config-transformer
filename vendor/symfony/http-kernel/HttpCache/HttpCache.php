...
use ConfigTransformer202108112\Symfony\Component\HttpKernel\TerminableInterface;
/**
 * Cache provides HTTP caching.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class HttpCache implements \ConfigTransformer202108112\Symfony\Component\HttpKernel\HttpKernelInterface, \ConfigTransformer202108112\Symfony\Component\HttpKernel\TerminableInterface
{
    private $kernel;
    private $store;
    private $request;
     ...
     *                            (see RFC 5861).
     */
    public function __construct(\ConfigTransformer202108112\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \ConfigTransformer202108112\Symfony\Component\HttpKernel\HttpCache\StoreInterface $store, \ConfigTransformer202108112\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null, array $options = [])
    {
        $this->store = $store;
        $this->kernel = $kernel;
    ...
    private function addTraces(\ConfigTransformer202108112\Symfony\Component\HttpFoundation\Response $response)
    {
        $traceString = null;
    ...
    public function handle($request, $type = \ConfigTransformer202108112\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST, $catch = \true)
    {
        ...
        if (\ConfigTransformer202108112\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST === $type) {
            $this->traces = [];
    ...
    {
        if ($this->getKernel() instanceof \ConfigTransformer202108112\Symfony\Component\HttpKernel\TerminableInterface) {
            ...
            try {
                ...
                foreach (['Location', 'Content-Location'] as $header) {
                    if ($uri = $response->headers->get($header)) {
                        $subRequest = \ConfigTransformer202108112\Symfony\Component\HttpFoundation\Request::create($uri, 'get', [], [], [], $request->server->all());
    ...
    protected function forward($request, $catch = \false, $entry = null)
    {
        ...
        $response = \ConfigTransformer202108112\Symfony\Component\HttpKernel\HttpCache\SubRequestHandler::handle($this->kernel, $request, \ConfigTransformer202108112\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST, $catch);
        /*
     ...
     */
    private function restoreResponseBody(\ConfigTransformer202108112\Symfony\Component\HttpFoundation\Request $request, \ConfigTransformer202108112\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     */
    private function isPrivateRequest(\ConfigTransformer202108112\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     */
    private function record(\ConfigTransformer202108112\Symfony\Component\HttpFoundation\Request $request, string $event)
    {
     ...
     */
    private function getTraceKey(\ConfigTransformer202108112\Symfony\Component\HttpFoundation\Request $request) : string
    {
     ...
     */
    private function mayServeStaleWhileRevalidate(\ConfigTransformer202108112\Symfony\Component\HttpFoundation\Response $entry) : bool
    {
     ...
     */
    private function waitForLock(\ConfigTransformer202108112\Symfony\Component\HttpFoundation\Request $request) : bool
    {
        $wait = 0;
