...
use ConfigTransformer202107073\Symfony\Component\HttpKernel\TerminableInterface;
/**
 * Cache provides HTTP caching.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class HttpCache implements \ConfigTransformer202107073\Symfony\Component\HttpKernel\HttpKernelInterface, \ConfigTransformer202107073\Symfony\Component\HttpKernel\TerminableInterface
{
    private $kernel;
    private $store;
    private $request;
     ...
     *                            (see RFC 5861).
     */
    public function __construct(\ConfigTransformer202107073\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \ConfigTransformer202107073\Symfony\Component\HttpKernel\HttpCache\StoreInterface $store, \ConfigTransformer202107073\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null, array $options = [])
    {
        $this->store = $store;
        $this->kernel = $kernel;
    ...
    private function addTraces(\ConfigTransformer202107073\Symfony\Component\HttpFoundation\Response $response)
    {
        $traceString = null;
    ...
    public function handle(\ConfigTransformer202107073\Symfony\Component\HttpFoundation\Request $request, int $type = \ConfigTransformer202107073\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST, bool $catch = \true)
    {
        ...
        if (\ConfigTransformer202107073\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST === $type) {
            $this->traces = [];
    ...
    {
        if ($this->getKernel() instanceof \ConfigTransformer202107073\Symfony\Component\HttpKernel\TerminableInterface) {
     ...
     */
    protected function pass(\ConfigTransformer202107073\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
     ...
     * @see RFC2616 13.10
     */
    protected function invalidate(\ConfigTransformer202107073\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
        $response = $this->pass($request, $catch);
            ...
            try {
                ...
                foreach (['Location', 'Content-Location'] as $header) {
                    if ($uri = $response->headers->get($header)) {
                        $subRequest = \ConfigTransformer202107073\Symfony\Component\HttpFoundation\Request::create($uri, 'get', [], [], [], $request->server->all());
     ...
     * @throws \Exception
     */
    protected function lookup(\ConfigTransformer202107073\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
        try {
     ...
     * @return Response A Response instance
     */
    protected function validate(\ConfigTransformer202107073\Symfony\Component\HttpFoundation\Request $request, \ConfigTransformer202107073\Symfony\Component\HttpFoundation\Response $entry, bool $catch = \false)
    {
     ...
     * @return Response A Response instance
     */
    protected function fetch(\ConfigTransformer202107073\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false)
    {
        $subRequest = clone $request;
        // send no head requests because we want content
        if ('HEAD' === $request->getMethod()) {
     ...
     * @return Response A Response instance
     */
    protected function forward(\ConfigTransformer202107073\Symfony\Component\HttpFoundation\Request $request, bool $catch = \false, \ConfigTransformer202107073\Symfony\Component\HttpFoundation\Response $entry = null)
    {
        if ($this->surrogate) {
            $this->surrogate->addSurrogateCapability($request);
        }
        // always a "master" request (as the real master request can be in cache)
        $response = \ConfigTransformer202107073\Symfony\Component\HttpKernel\HttpCache\SubRequestHandler::handle($this->kernel, $request, \ConfigTransformer202107073\Symfony\Component\HttpKernel\HttpKernelInterface::MAIN_REQUEST, $catch);
        /*
     ...
     */
    protected function isFreshEnough(\ConfigTransformer202107073\Symfony\Component\HttpFoundation\Request $request, \ConfigTransformer202107073\Symfony\Component\HttpFoundation\Response $entry)
    {
        if (!$entry->isFresh()) {
     ...
     */
    protected function lock(\ConfigTransformer202107073\Symfony\Component\HttpFoundation\Request $request, \ConfigTransformer202107073\Symfony\Component\HttpFoundation\Response $entry)
    {
     ...
     * @throws \Exception
     */
    protected function store(\ConfigTransformer202107073\Symfony\Component\HttpFoundation\Request $request, \ConfigTransformer202107073\Symfony\Component\HttpFoundation\Response $response)
    {
        try {
     ...
     */
    private function restoreResponseBody(\ConfigTransformer202107073\Symfony\Component\HttpFoundation\Request $request, \ConfigTransformer202107073\Symfony\Component\HttpFoundation\Response $response)
    {
    ...
    protected function processResponseBody(\ConfigTransformer202107073\Symfony\Component\HttpFoundation\Request $request, \ConfigTransformer202107073\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     */
    private function isPrivateRequest(\ConfigTransformer202107073\Symfony\Component\HttpFoundation\Request $request) : bool
    {
     ...
     */
    private function record(\ConfigTransformer202107073\Symfony\Component\HttpFoundation\Request $request, string $event)
    {
     ...
     */
    private function getTraceKey(\ConfigTransformer202107073\Symfony\Component\HttpFoundation\Request $request) : string
    {
     ...
     */
    private function mayServeStaleWhileRevalidate(\ConfigTransformer202107073\Symfony\Component\HttpFoundation\Response $entry) : bool
    {
     ...
     */
    private function waitForLock(\ConfigTransformer202107073\Symfony\Component\HttpFoundation\Request $request) : bool
    {
        $wait = 0;
