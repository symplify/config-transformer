 ...
 */
namespace ConfigTransformer202108098\Symfony\Component\HttpKernel\HttpCache;
 ...
 */
class Store implements \ConfigTransformer202108098\Symfony\Component\HttpKernel\HttpCache\StoreInterface
{
    protected $root;
    private $keyCache;
    private $locks;
    ...
    {
        $key = $this->getCacheKey(\ConfigTransformer202108098\Symfony\Component\HttpFoundation\Request::create($url));
        if (isset($this->locks[$key])) {
            \flock($this->locks[$key], \LOCK_UN);
            \fclose($this->locks[$key]);
            unset($this->locks[$key]);
     ...
     */
    private function getCacheKey(\ConfigTransformer202108098\Symfony\Component\HttpFoundation\Request $request) : string
    {
     ...
     */
    private function persistRequest(\ConfigTransformer202108098\Symfony\Component\HttpFoundation\Request $request) : array
    {
     ...
     */
    private function persistResponse(\ConfigTransformer202108098\Symfony\Component\HttpFoundation\Response $response) : array
    {
     ...
     */
    private function restoreResponse(array $headers, string $path = null) : \ConfigTransformer202108098\Symfony\Component\HttpFoundation\Response
    {
        ...
        return new \ConfigTransformer202108098\Symfony\Component\HttpFoundation\Response($path, $status, $headers);
    }
}
