 ...
 */
class HtmlErrorRenderer implements \ConfigTransformer202107131\Symfony\Component\ErrorHandler\ErrorRenderer\ErrorRendererInterface
{
     ...
     */
    public function __construct($debug = \false, string $charset = null, $fileLinkFormat = null, string $projectDir = null, $outputBuffer = '', \ConfigTransformer202107131\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    public function render($exception) : \ConfigTransformer202107131\Symfony\Component\ErrorHandler\Exception\FlattenException
    {
        ...
        $exception = \ConfigTransformer202107131\Symfony\Component\ErrorHandler\Exception\FlattenException::createFromThrowable($exception, null, $headers);
    ...
    public static function getAndCleanOutputBuffer($requestStack) : \Closure
    {
        return static function () use($requestStack) : string {
            ...
            \ConfigTransformer202107131\Symfony\Component\HttpFoundation\Response::closeOutputBuffers($startObLevel + 1, \true);
            return \ob_get_clean();
        };
    }
    private function renderException(\ConfigTransformer202107131\Symfony\Component\ErrorHandler\Exception\FlattenException $exception, string $debugTemplate = 'views/exception_full.html.php') : string
    {
