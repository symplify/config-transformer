 ...
 */
namespace ConfigTransformer202106181\Symfony\Component\ErrorHandler\Exception;
...
class FlattenException
{
    ...
    public static function createFromThrowable(\Throwable $exception, int $statusCode = null, array $headers = [])
    {
        ...
        if ($exception instanceof \ConfigTransformer202106181\Symfony\Component\HttpKernel\Exception\HttpExceptionInterface) {
            $statusCode = $exception->getStatusCode();
            $headers = \array_merge($headers, $exception->getHeaders());
        } elseif ($exception instanceof \ConfigTransformer202106181\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface) {
            $statusCode = 400;
        }
        if (null === $statusCode) {
            $statusCode = 500;
        }
        if (\class_exists(\ConfigTransformer202106181\Symfony\Component\HttpFoundation\Response::class) && isset(\ConfigTransformer202106181\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode])) {
            $statusText = \ConfigTransformer202106181\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode];
        } else {
