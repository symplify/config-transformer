 ...
 */
namespace ConfigTransformer202110101\Symfony\Component\ErrorHandler\Exception;
...
class FlattenException
{
    ...
    public static function createFromThrowable($exception, $statusCode = null, $headers = []) : self
    {
        ...
        if ($exception instanceof \ConfigTransformer202110101\Symfony\Component\HttpKernel\Exception\HttpExceptionInterface) {
            $statusCode = $exception->getStatusCode();
            $headers = \array_merge($headers, $exception->getHeaders());
        } elseif ($exception instanceof \ConfigTransformer202110101\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface) {
            $statusCode = 400;
        }
        if (null === $statusCode) {
            $statusCode = 500;
        }
        if (\class_exists(\ConfigTransformer202110101\Symfony\Component\HttpFoundation\Response::class) && isset(\ConfigTransformer202110101\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode])) {
            $statusText = \ConfigTransformer202110101\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode];
        } else {
