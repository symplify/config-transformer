 ...
 */
namespace ConfigTransformer202109060\Symfony\Component\ErrorHandler\Exception;
...
class FlattenException
{
    ...
    public static function createFromThrowable($exception, $statusCode = null, $headers = [])
    {
        ...
        if ($exception instanceof \ConfigTransformer202109060\Symfony\Component\HttpKernel\Exception\HttpExceptionInterface) {
            $statusCode = $exception->getStatusCode();
            $headers = \array_merge($headers, $exception->getHeaders());
        } elseif ($exception instanceof \ConfigTransformer202109060\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface) {
            $statusCode = 400;
        }
        if (null === $statusCode) {
            $statusCode = 500;
        }
        if (\class_exists(\ConfigTransformer202109060\Symfony\Component\HttpFoundation\Response::class) && isset(\ConfigTransformer202109060\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode])) {
            $statusText = \ConfigTransformer202109060\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode];
        } else {
