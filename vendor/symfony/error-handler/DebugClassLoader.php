...
use ConfigTransformer202107071\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use ConfigTransformer202107071\Doctrine\Persistence\Proxy;
use ConfigTransformer202107071\Mockery\MockInterface;
use ConfigTransformer202107071\Phake\IMock;
use ConfigTransformer202107071\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use ConfigTransformer202107071\PHPUnit\Framework\MockObject\MockObject;
use ConfigTransformer202107071\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists(\ConfigTransformer202107071\Symfony\Component\ErrorHandler\ErrorHandler::class);
        \class_exists(\ConfigTransformer202107071\Psr\Log\LogLevel::class);
    ...
    public function checkAnnotations(\ReflectionClass $refl, string $class) : array
    {
        ...
        foreach ($parentAndOwnInterfaces + \class_uses($class, \false) as $use) {
            ...
            if (isset(self::$method[$use])) {
                if ($refl->isAbstract()) {
                    ...
                    if (!\strncmp($vendor, \str_replace('_', '\\', $use), $vendorLen) && 0 === \strpos($className, 'Symfony\\') && (!\class_exists(\ConfigTransformer202107071\Composer\InstalledVersions::class) || 'symfony/symfony' !== \ConfigTransformer202107071\Composer\InstalledVersions::getRootPackage()['name'])) {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \ConfigTransformer202107071\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
