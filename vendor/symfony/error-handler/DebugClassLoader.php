...
use ConfigTransformer202109182\Doctrine\Common\Persistence\Proxy as LegacyProxy;
use ConfigTransformer202109182\Doctrine\Persistence\Proxy;
use ConfigTransformer202109182\Mockery\MockInterface;
use ConfigTransformer202109182\Phake\IMock;
use ConfigTransformer202109182\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
use ConfigTransformer202109182\PHPUnit\Framework\MockObject\MockObject;
use ConfigTransformer202109182\Prophecy\Prophecy\ProphecySubjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable() : void
    {
        ...
        \class_exists(\ConfigTransformer202109182\Symfony\Component\ErrorHandler\ErrorHandler::class);
        \class_exists(\ConfigTransformer202109182\Psr\Log\LogLevel::class);
    ...
    public function checkAnnotations($refl, $class) : array
    {
        ...
        foreach ($parentAndOwnInterfaces + \class_uses($class, \false) as $use) {
            ...
            if (isset(self::$method[$use])) {
                if ($refl->isAbstract()) {
                    ...
                    if (!\strncmp($vendor, \str_replace('_', '\\', $use), $vendorLen) && 0 === \strpos($className, 'Symfony\\') && (!\class_exists(\ConfigTransformer202109182\Composer\InstalledVersions::class) || 'symfony/symfony' !== \ConfigTransformer202109182\Composer\InstalledVersions::getRootPackage()['name'])) {
        ...
        foreach ($refl->getMethods() as $method) {
            ...
            if ($finalOrInternal || $method->isConstructor() || \false === \strpos($doc, '@param') || \ConfigTransformer202109182\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation::class === $class) {
                continue;
            }
