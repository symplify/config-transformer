...
use ConfigTransformer202107107\Symplify\ConfigTransformer\Console\ConfigTransfomerConsoleApplication;
use ConfigTransformer202107107\Symplify\ConfigTransformer\Provider\YamlContentProvider;
...
return static function (\ConfigTransformer202107107\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('ConfigTransformer202107107\Symplify\ConfigTransformer\\', __DIR__ . '/../src')->exclude([
    ...
    // console
    $services->set(\ConfigTransformer202107107\Symplify\ConfigTransformer\Console\ConfigTransfomerConsoleApplication::class);
    $services->alias(\ConfigTransformer202107107\Symfony\Component\Console\Application::class, \ConfigTransformer202107107\Symplify\ConfigTransformer\Console\ConfigTransfomerConsoleApplication::class);
    ...
    $services->alias(\ConfigTransformer202107107\Symplify\PhpConfigPrinter\Contract\SymfonyVersionFeatureGuardInterface::class, \ConfigTransformer202107107\Symplify\ConfigTransformer\Configuration\Configuration::class);
    $services->alias(\ConfigTransformer202107107\Symplify\PhpConfigPrinter\Contract\YamlFileContentProviderInterface::class, \ConfigTransformer202107107\Symplify\ConfigTransformer\Provider\YamlContentProvider::class);
