...
use ConfigTransformer20210606\Symplify\ConfigTransformer\Console\ConfigTransfomerConsoleApplication;
use ConfigTransformer20210606\Symplify\ConfigTransformer\Provider\YamlContentProvider;
...
return static function (\ConfigTransformer20210606\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('ConfigTransformer20210606\Symplify\ConfigTransformer\\', __DIR__ . '/../src')->exclude([
    ...
    // console
    $services->set(\ConfigTransformer20210606\Symplify\ConfigTransformer\Console\ConfigTransfomerConsoleApplication::class);
    $services->alias(\ConfigTransformer20210606\Symfony\Component\Console\Application::class, \ConfigTransformer20210606\Symplify\ConfigTransformer\Console\ConfigTransfomerConsoleApplication::class);
    ...
    $services->alias(\ConfigTransformer20210606\Symplify\PhpConfigPrinter\Contract\SymfonyVersionFeatureGuardInterface::class, \ConfigTransformer20210606\Symplify\ConfigTransformer\Configuration\Configuration::class);
    $services->alias(\ConfigTransformer20210606\Symplify\PhpConfigPrinter\Contract\YamlFileContentProviderInterface::class, \ConfigTransformer20210606\Symplify\ConfigTransformer\Provider\YamlContentProvider::class);
