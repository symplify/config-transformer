...
use ConfigTransformer202106202\Symplify\ConfigTransformer\Console\ConfigTransfomerConsoleApplication;
use ConfigTransformer202106202\Symplify\ConfigTransformer\Provider\YamlContentProvider;
...
return static function (\ConfigTransformer202106202\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('ConfigTransformer202106202\Symplify\ConfigTransformer\\', __DIR__ . '/../src')->exclude([
    ...
    // console
    $services->set(\ConfigTransformer202106202\Symplify\ConfigTransformer\Console\ConfigTransfomerConsoleApplication::class);
    $services->alias(\ConfigTransformer202106202\Symfony\Component\Console\Application::class, \ConfigTransformer202106202\Symplify\ConfigTransformer\Console\ConfigTransfomerConsoleApplication::class);
    ...
    $services->alias(\ConfigTransformer202106202\Symplify\PhpConfigPrinter\Contract\SymfonyVersionFeatureGuardInterface::class, \ConfigTransformer202106202\Symplify\ConfigTransformer\Configuration\Configuration::class);
    $services->alias(\ConfigTransformer202106202\Symplify\PhpConfigPrinter\Contract\YamlFileContentProviderInterface::class, \ConfigTransformer202106202\Symplify\ConfigTransformer\Provider\YamlContentProvider::class);
