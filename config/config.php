...
use ConfigTransformer202206052\Symplify\ConfigTransformer\Command\SwitchFormatCommand;
...
return static function (\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('ConfigTransformer202206052\Symplify\ConfigTransformer\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/Kernel', __DIR__ . '/../src/DependencyInjection/Loader', __DIR__ . '/../src/Enum', __DIR__ . '/../src/ValueObject']);
    // console
    $services->set(\ConfigTransformer202206052\Symfony\Component\Console\Application::class)->call('add', [\ConfigTransformer202206052\Symfony\Component\DependencyInjection\Loader\Configurator\service(\ConfigTransformer202206052\Symplify\ConfigTransformer\Command\SwitchFormatCommand::class)]);
    ...
    $services->set(\ConfigTransformer202206052\Symplify\PackageBuilder\Yaml\ParametersMerger::class);
};
