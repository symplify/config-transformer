...
use ConfigTransformer202112108\Symplify\ConfigTransformer\Command\SwitchFormatCommand;
...
return static function (\Symfony\Component\DependencyInjection\Loader\Configurator\ContainerConfigurator $containerConfigurator) : void {
    ...
    $services->load('ConfigTransformer202112108\Symplify\ConfigTransformer\\', __DIR__ . '/../src')->exclude([__DIR__ . '/../src/Kernel', __DIR__ . '/../src/DependencyInjection/Loader', __DIR__ . '/../src/Enum', __DIR__ . '/../src/ValueObject']);
    // console
    $services->set(\ConfigTransformer202112108\Symfony\Component\Console\Application::class)->call('add', [\ConfigTransformer202112108\Symfony\Component\DependencyInjection\Loader\Configurator\service(\ConfigTransformer202112108\Symplify\ConfigTransformer\Command\SwitchFormatCommand::class)]);
    ...
    $services->set(\ConfigTransformer202112108\Symplify\PackageBuilder\Yaml\ParametersMerger::class);
};
