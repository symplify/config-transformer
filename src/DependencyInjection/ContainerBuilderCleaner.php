...
namespace ConfigTransformer202112108\Symplify\ConfigTransformer\DependencyInjection;
...
final class ContainerBuilderCleaner
{
    ...
    public function __construct(\ConfigTransformer202112108\Symplify\PackageBuilder\Reflection\PrivatesAccessor $privatesAccessor)
    {
        $this->privatesAccessor = $privatesAccessor;
    }
    public function cleanContainerBuilder(\ConfigTransformer202112108\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
    ...
    private function removeSymfonyInternalServices(\ConfigTransformer202112108\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        $containerBuilder->removeDefinition('service_container');
        $containerBuilder->removeAlias(\ConfigTransformer202112108\Psr\Container\ContainerInterface::class);
        $containerBuilder->removeAlias(\ConfigTransformer202112108\Symfony\Component\DependencyInjection\ContainerInterface::class);
    }
    private function removeTemporaryAnonymousIds(\ConfigTransformer202112108\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
    ...
    {
        return (bool) \ConfigTransformer202112108\Nette\Utils\Strings::match($name, self::ANONYMOUS_CLASS_REGEX);
    }
    private function resolvePolyfillForNameTag(\ConfigTransformer202112108\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
