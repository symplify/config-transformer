...
namespace ConfigTransformer2022051710\Symplify\ConfigTransformer\DependencyInjection;
...
final class ContainerBuilderCleaner
{
    ...
    public function cleanContainerBuilder(\ConfigTransformer2022051710\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
    ...
    private function removeSymfonyInternalServices(\ConfigTransformer2022051710\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
        $containerBuilder->removeDefinition('service_container');
        $containerBuilder->removeAlias(\ConfigTransformer2022051710\Psr\Container\ContainerInterface::class);
        $containerBuilder->removeAlias(\ConfigTransformer2022051710\Symfony\Component\DependencyInjection\ContainerInterface::class);
    }
    private function removeTemporaryAnonymousIds(\ConfigTransformer2022051710\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : void
    {
    ...
    {
        return (bool) \ConfigTransformer2022051710\Nette\Utils\Strings::match($name, self::ANONYMOUS_CLASS_REGEX);
    }
    private function resolvePolyfillForNameTag(\ConfigTransformer2022051710\Symfony\Component\DependencyInjection\Definition $definition) : void
    {
