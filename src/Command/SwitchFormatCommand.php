...
final class SwitchFormatCommand extends \ConfigTransformer202206075\Symplify\PackageBuilder\Console\Command\AbstractSymplifyCommand
{
    /**
    ...
    public function __construct(\ConfigTransformer202206075\Symplify\ConfigTransformer\Configuration\ConfigurationFactory $configurationFactory, \ConfigTransformer202206075\Symplify\ConfigTransformer\FileSystem\ConfigFileDumper $configFileDumper, \ConfigTransformer202206075\Symplify\ConfigTransformer\Converter\ConvertedContentFactory $convertedContentFactory)
    {
    ...
    {
        $this->setName(\ConfigTransformer202206075\Symplify\PackageBuilder\Console\Command\CommandNaming::classToName(self::class));
        $this->setDescription('Converts XML/YAML configs to PHP format');
        $this->addArgument(\ConfigTransformer202206075\Symplify\ConfigTransformer\ValueObject\Option::SOURCES, \ConfigTransformer202206075\Symfony\Component\Console\Input\InputArgument::REQUIRED | \ConfigTransformer202206075\Symfony\Component\Console\Input\InputArgument::IS_ARRAY, 'Path to directory with configs');
        $this->addOption(\ConfigTransformer202206075\Symplify\ConfigTransformer\ValueObject\Option::DRY_RUN, null, \ConfigTransformer202206075\Symfony\Component\Console\Input\InputOption::VALUE_NONE, 'Dry run - no removal or config change');
    }
     ...
     */
    private function removeFileInfos(\ConfigTransformer202206075\Symplify\ConfigTransformer\ValueObject\Configuration $configuration, array $fileInfos) : void
    {
