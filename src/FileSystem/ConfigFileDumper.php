...
namespace ConfigTransformer202106107\Symplify\ConfigTransformer\FileSystem;
...
use ConfigTransformer202106107\Symplify\SmartFileSystem\SmartFileSystem;
final class ConfigFileDumper
{
    ...
    public function __construct(\ConfigTransformer202106107\Symplify\ConfigTransformer\Configuration\Configuration $configuration, \ConfigTransformer202106107\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \ConfigTransformer202106107\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
        $this->configuration = $configuration;
        $this->symfonyStyle = $symfonyStyle;
        $this->smartFileSystem = $smartFileSystem;
    }
    public function dumpFile(\ConfigTransformer202106107\Symplify\ConfigTransformer\ValueObject\ConvertedContent $convertedContent) : void
    {
