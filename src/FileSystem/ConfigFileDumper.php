...
namespace ConfigTransformer202201167\Symplify\ConfigTransformer\FileSystem;
...
use ConfigTransformer202201167\Symplify\ConfigTransformer\ValueObject\ConvertedContent;
...
final class ConfigFileDumper
{
    ...
    public function __construct(\ConfigTransformer202201167\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \ConfigTransformer202201167\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
        $this->symfonyStyle = $symfonyStyle;
        $this->smartFileSystem = $smartFileSystem;
    }
    public function dumpFile(\ConfigTransformer202201167\Symplify\ConfigTransformer\ValueObject\ConvertedContent $convertedContent, \ConfigTransformer202201167\Symplify\ConfigTransformer\ValueObject\Configuration $configuration) : void
    {
