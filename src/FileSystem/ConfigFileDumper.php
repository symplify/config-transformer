...
namespace ConfigTransformer202112237\Symplify\ConfigTransformer\FileSystem;
...
final class ConfigFileDumper
{
    ...
    public function __construct(\ConfigTransformer202112237\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \ConfigTransformer202112237\Symplify\SmartFileSystem\SmartFileSystem $smartFileSystem)
    {
        $this->symfonyStyle = $symfonyStyle;
        $this->smartFileSystem = $smartFileSystem;
    }
    public function dumpFile(\ConfigTransformer202112237\Symplify\ConfigTransformer\ValueObject\ConvertedContent $convertedContent, \ConfigTransformer202112237\Symplify\ConfigTransformer\ValueObject\Configuration $configuration) : void
    {
