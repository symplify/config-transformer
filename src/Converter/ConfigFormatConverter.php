...
use ConfigTransformer2021110110\Symfony\Component\DependencyInjection\Dumper\YamlDumper;
use ConfigTransformer2021110110\Symfony\Component\Yaml\Yaml;
use ConfigTransformer2021110110\Symplify\ConfigTransformer\Collector\XmlImportCollector;
use ConfigTransformer2021110110\Symplify\ConfigTransformer\ConfigLoader;
use ConfigTransformer2021110110\Symplify\ConfigTransformer\DependencyInjection\ContainerBuilderCleaner;
use ConfigTransformer2021110110\Symplify\ConfigTransformer\Enum\Format;
use ConfigTransformer2021110110\Symplify\ConfigTransformer\Exception\NotImplementedYetException;
use ConfigTransformer2021110110\Symplify\PackageBuilder\Reflection\PrivatesAccessor;
use ConfigTransformer2021110110\Symplify\PackageBuilder\Yaml\ParametersMerger;
use ConfigTransformer2021110110\Symplify\PhpConfigPrinter\Provider\CurrentFilePathProvider;
...
final class ConfigFormatConverter
{
    ...
    public function __construct(\ConfigTransformer2021110110\Symplify\ConfigTransformer\ConfigLoader $configLoader, \ConfigTransformer2021110110\Symplify\ConfigTransformer\Converter\YamlToPhpConverter $yamlToPhpConverter, \ConfigTransformer2021110110\Symplify\PhpConfigPrinter\Provider\CurrentFilePathProvider $currentFilePathProvider, \ConfigTransformer2021110110\Symplify\ConfigTransformer\Collector\XmlImportCollector $xmlImportCollector, \ConfigTransformer2021110110\Symplify\ConfigTransformer\DependencyInjection\ContainerBuilderCleaner $containerBuilderCleaner, \ConfigTransformer2021110110\Symplify\PackageBuilder\Reflection\PrivatesAccessor $privatesAccessor, \ConfigTransformer2021110110\Symplify\PackageBuilder\Yaml\ParametersMerger $parametersMerger)
    {
    ...
    public function convert(\ConfigTransformer2021110110\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
        ...
        if ($smartFileInfo->getSuffix() === \ConfigTransformer2021110110\Symplify\ConfigTransformer\Enum\Format::YAML) {
        ...
        if ($smartFileInfo->getSuffix() === \ConfigTransformer2021110110\Symplify\ConfigTransformer\Enum\Format::XML) {
        ...
        throw new \ConfigTransformer2021110110\Symplify\ConfigTransformer\Exception\NotImplementedYetException($message);
    }
    private function dumpContainerBuilderToYaml(\ConfigTransformer2021110110\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : string
    {
        $yamlDumper = new \ConfigTransformer2021110110\Symfony\Component\DependencyInjection\Dumper\YamlDumper($containerBuilder);
    ...
    private function decorateWithCollectedXmlImports(string $dumpedYaml) : string
    {
        ...
        $yamlArray = \ConfigTransformer2021110110\Symfony\Component\Yaml\Yaml::parse($dumpedYaml, \ConfigTransformer2021110110\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS);
    ...
    private function dumpYaml(array $yamlArray) : string
    {
        ...
        return \ConfigTransformer2021110110\Symfony\Component\Yaml\Yaml::dump($yamlArray, 10, 4, \ConfigTransformer2021110110\Symfony\Component\Yaml\Yaml::DUMP_MULTI_LINE_LITERAL_BLOCK);
    }
}
