...
final class ConfigFormatConverter
{
    ...
    public function __construct(\ConfigTransformer202206075\Symplify\ConfigTransformer\ConfigLoader $configLoader, \ConfigTransformer202206075\Symplify\ConfigTransformer\Converter\YamlToPhpConverter $yamlToPhpConverter, \ConfigTransformer202206075\Symplify\PhpConfigPrinter\Provider\CurrentFilePathProvider $currentFilePathProvider, \ConfigTransformer202206075\Symplify\ConfigTransformer\Collector\XmlImportCollector $xmlImportCollector, \ConfigTransformer202206075\Symplify\ConfigTransformer\DependencyInjection\ContainerBuilderCleaner $containerBuilderCleaner, \ConfigTransformer202206075\Symplify\PackageBuilder\Reflection\PrivatesAccessor $privatesAccessor, \ConfigTransformer202206075\Symplify\PackageBuilder\Yaml\ParametersMerger $parametersMerger)
    {
    ...
    public function convert(\ConfigTransformer202206075\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
        ...
        if ($smartFileInfo->getSuffix() === \ConfigTransformer202206075\Symplify\ConfigTransformer\Enum\Format::YAML) {
        ...
        if ($smartFileInfo->getSuffix() === \ConfigTransformer202206075\Symplify\ConfigTransformer\Enum\Format::XML) {
        ...
        throw new \ConfigTransformer202206075\Symplify\ConfigTransformer\Exception\NotImplementedYetException($message);
    }
    private function dumpContainerBuilderToYaml(\ConfigTransformer202206075\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : string
    {
        $yamlDumper = new \ConfigTransformer202206075\Symfony\Component\DependencyInjection\Dumper\YamlDumper($containerBuilder);
    ...
    private function decorateWithCollectedXmlImports(string $dumpedYaml) : string
    {
        ...
        $yamlArray = \ConfigTransformer202206075\Symfony\Component\Yaml\Yaml::parse($dumpedYaml, \ConfigTransformer202206075\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS);
    ...
    private function dumpYaml(array $yamlArray) : string
    {
        ...
        return \ConfigTransformer202206075\Symfony\Component\Yaml\Yaml::dump($yamlArray, 10, 4, \ConfigTransformer202206075\Symfony\Component\Yaml\Yaml::DUMP_MULTI_LINE_LITERAL_BLOCK);
    }
}
