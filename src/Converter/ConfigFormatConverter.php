...
namespace ConfigTransformer2022051110\Symplify\ConfigTransformer\Converter;

use ConfigTransformer2022051110\Symfony\Component\DependencyInjection\ContainerBuilder;
use ConfigTransformer2022051110\Symfony\Component\DependencyInjection\Dumper\YamlDumper;
use ConfigTransformer2022051110\Symfony\Component\Yaml\Yaml;
use ConfigTransformer2022051110\Symplify\ConfigTransformer\Collector\XmlImportCollector;
use ConfigTransformer2022051110\Symplify\ConfigTransformer\ConfigLoader;
use ConfigTransformer2022051110\Symplify\ConfigTransformer\DependencyInjection\ContainerBuilderCleaner;
use ConfigTransformer2022051110\Symplify\ConfigTransformer\Enum\Format;
use ConfigTransformer2022051110\Symplify\ConfigTransformer\Exception\NotImplementedYetException;
...
use ConfigTransformer2022051110\Symplify\PhpConfigPrinter\Provider\CurrentFilePathProvider;
...
final class ConfigFormatConverter
{
    ...
    public function __construct(\ConfigTransformer2022051110\Symplify\ConfigTransformer\ConfigLoader $configLoader, \ConfigTransformer2022051110\Symplify\ConfigTransformer\Converter\YamlToPhpConverter $yamlToPhpConverter, \ConfigTransformer2022051110\Symplify\PhpConfigPrinter\Provider\CurrentFilePathProvider $currentFilePathProvider, \ConfigTransformer2022051110\Symplify\ConfigTransformer\Collector\XmlImportCollector $xmlImportCollector, \ConfigTransformer2022051110\Symplify\ConfigTransformer\DependencyInjection\ContainerBuilderCleaner $containerBuilderCleaner, \ConfigTransformer2022051110\Symplify\PackageBuilder\Reflection\PrivatesAccessor $privatesAccessor, \ConfigTransformer2022051110\Symplify\PackageBuilder\Yaml\ParametersMerger $parametersMerger)
    {
    ...
    public function convert(\ConfigTransformer2022051110\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
        ...
        if ($smartFileInfo->getSuffix() === \ConfigTransformer2022051110\Symplify\ConfigTransformer\Enum\Format::YAML) {
        ...
        if ($smartFileInfo->getSuffix() === \ConfigTransformer2022051110\Symplify\ConfigTransformer\Enum\Format::XML) {
        ...
        throw new \ConfigTransformer2022051110\Symplify\ConfigTransformer\Exception\NotImplementedYetException($message);
    }
    private function dumpContainerBuilderToYaml(\ConfigTransformer2022051110\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : string
    {
        $yamlDumper = new \ConfigTransformer2022051110\Symfony\Component\DependencyInjection\Dumper\YamlDumper($containerBuilder);
    ...
    private function decorateWithCollectedXmlImports(string $dumpedYaml) : string
    {
        ...
        $yamlArray = \ConfigTransformer2022051110\Symfony\Component\Yaml\Yaml::parse($dumpedYaml, \ConfigTransformer2022051110\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS);
    ...
    private function dumpYaml(array $yamlArray) : string
    {
        ...
        return \ConfigTransformer2022051110\Symfony\Component\Yaml\Yaml::dump($yamlArray, 10, 4, \ConfigTransformer2022051110\Symfony\Component\Yaml\Yaml::DUMP_MULTI_LINE_LITERAL_BLOCK);
    }
}
