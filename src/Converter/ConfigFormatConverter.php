...
namespace ConfigTransformer202112063\Symplify\ConfigTransformer\Converter;

use ConfigTransformer202112063\Symfony\Component\DependencyInjection\ContainerBuilder;
use ConfigTransformer202112063\Symfony\Component\DependencyInjection\Dumper\YamlDumper;
...
use ConfigTransformer202112063\Symplify\ConfigTransformer\ConfigLoader;
use ConfigTransformer202112063\Symplify\ConfigTransformer\DependencyInjection\ContainerBuilderCleaner;
use ConfigTransformer202112063\Symplify\ConfigTransformer\Enum\Format;
use ConfigTransformer202112063\Symplify\ConfigTransformer\Exception\NotImplementedYetException;
use ConfigTransformer202112063\Symplify\PackageBuilder\Reflection\PrivatesAccessor;
use ConfigTransformer202112063\Symplify\PackageBuilder\Yaml\ParametersMerger;
use ConfigTransformer202112063\Symplify\PhpConfigPrinter\Provider\CurrentFilePathProvider;
...
final class ConfigFormatConverter
{
    ...
    public function __construct(\ConfigTransformer202112063\Symplify\ConfigTransformer\ConfigLoader $configLoader, \ConfigTransformer202112063\Symplify\ConfigTransformer\Converter\YamlToPhpConverter $yamlToPhpConverter, \ConfigTransformer202112063\Symplify\PhpConfigPrinter\Provider\CurrentFilePathProvider $currentFilePathProvider, \ConfigTransformer202112063\Symplify\ConfigTransformer\Collector\XmlImportCollector $xmlImportCollector, \ConfigTransformer202112063\Symplify\ConfigTransformer\DependencyInjection\ContainerBuilderCleaner $containerBuilderCleaner, \ConfigTransformer202112063\Symplify\PackageBuilder\Reflection\PrivatesAccessor $privatesAccessor, \ConfigTransformer202112063\Symplify\PackageBuilder\Yaml\ParametersMerger $parametersMerger)
    {
    ...
    public function convert(\ConfigTransformer202112063\Symplify\SmartFileSystem\SmartFileInfo $smartFileInfo) : string
    {
        ...
        if ($smartFileInfo->getSuffix() === \ConfigTransformer202112063\Symplify\ConfigTransformer\Enum\Format::YAML) {
        ...
        if ($smartFileInfo->getSuffix() === \ConfigTransformer202112063\Symplify\ConfigTransformer\Enum\Format::XML) {
        ...
        throw new \ConfigTransformer202112063\Symplify\ConfigTransformer\Exception\NotImplementedYetException($message);
    }
    private function dumpContainerBuilderToYaml(\ConfigTransformer202112063\Symfony\Component\DependencyInjection\ContainerBuilder $containerBuilder) : string
    {
        $yamlDumper = new \ConfigTransformer202112063\Symfony\Component\DependencyInjection\Dumper\YamlDumper($containerBuilder);
    ...
    private function decorateWithCollectedXmlImports(string $dumpedYaml) : string
    {
        ...
        $yamlArray = \ConfigTransformer202112063\Symfony\Component\Yaml\Yaml::parse($dumpedYaml, \ConfigTransformer202112063\Symfony\Component\Yaml\Yaml::PARSE_CUSTOM_TAGS);
    ...
    private function dumpYaml(array $yamlArray) : string
    {
        ...
        return \ConfigTransformer202112063\Symfony\Component\Yaml\Yaml::dump($yamlArray, 10, 4, \ConfigTransformer202112063\Symfony\Component\Yaml\Yaml::DUMP_MULTI_LINE_LITERAL_BLOCK);
    }
}
