...
final class ConvertedContentFactory
{
    ...
    public function __construct(\ConfigTransformer202108250\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \ConfigTransformer202108250\Symplify\ConfigTransformer\Converter\ConfigFormatConverter $configFormatConverter)
    {
     ...
     */
    public function createFromFileInfos(array $fileInfos, \ConfigTransformer202108250\Symplify\ConfigTransformer\ValueObject\Configuration $configuration) : array
    {
        ...
        foreach ($fileInfos as $fileInfo) {
            ...
            $convertedContentFromFileInfo[] = new \ConfigTransformer202108250\Symplify\ConfigTransformer\ValueObject\ConvertedContent($convertedContent, $fileInfo);
        }
