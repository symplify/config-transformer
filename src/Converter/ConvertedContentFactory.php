...
final class ConvertedContentFactory
{
    ...
    public function __construct(\ConfigTransformer2022051110\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \ConfigTransformer2022051110\Symplify\ConfigTransformer\Converter\ConfigFormatConverter $configFormatConverter)
    {
    ...
    public function createFromFileInfos(array $fileInfos) : array
    {
        ...
        foreach ($fileInfos as $fileInfo) {
            ...
            $convertedContentFromFileInfo[] = new \ConfigTransformer2022051110\Symplify\ConfigTransformer\ValueObject\ConvertedContent($convertedContent, $fileInfo);
        }
