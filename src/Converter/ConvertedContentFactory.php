...
final class ConvertedContentFactory
{
    ...
    public function __construct(\ConfigTransformer202204179\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \ConfigTransformer202204179\Symplify\ConfigTransformer\Converter\ConfigFormatConverter $configFormatConverter)
    {
    ...
    public function createFromFileInfos(array $fileInfos) : array
    {
        ...
        foreach ($fileInfos as $fileInfo) {
            ...
            $convertedContentFromFileInfo[] = new \ConfigTransformer202204179\Symplify\ConfigTransformer\ValueObject\ConvertedContent($convertedContent, $fileInfo);
        }
