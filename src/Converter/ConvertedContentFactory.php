...
final class ConvertedContentFactory
{
    ...
    public function __construct(\ConfigTransformer202109309\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \ConfigTransformer202109309\Symplify\ConfigTransformer\Converter\ConfigFormatConverter $configFormatConverter)
    {
     ...
     */
    public function createFromFileInfos(array $fileInfos, \ConfigTransformer202109309\Symplify\ConfigTransformer\ValueObject\Configuration $configuration) : array
    {
        ...
        foreach ($fileInfos as $fileInfo) {
            ...
            $convertedContentFromFileInfo[] = new \ConfigTransformer202109309\Symplify\ConfigTransformer\ValueObject\ConvertedContent($convertedContent, $fileInfo);
        }
