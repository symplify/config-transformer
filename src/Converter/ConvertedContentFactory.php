...
final class ConvertedContentFactory
{
    ...
    public function __construct(\ConfigTransformer2022031610\Symfony\Component\Console\Style\SymfonyStyle $symfonyStyle, \ConfigTransformer2022031610\Symplify\ConfigTransformer\Converter\ConfigFormatConverter $configFormatConverter)
    {
    ...
    public function createFromFileInfos(array $fileInfos) : array
    {
        ...
        foreach ($fileInfos as $fileInfo) {
            ...
            $convertedContentFromFileInfo[] = new \ConfigTransformer2022031610\Symplify\ConfigTransformer\ValueObject\ConvertedContent($convertedContent, $fileInfo);
        }
